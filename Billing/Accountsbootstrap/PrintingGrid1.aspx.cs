...
{
    public partial class PrintingGrid1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet pending = objBs.pendinglotdetail("tblJpPrinting", "tbltransJpPrinting", drpbranch.SelectedValue, drppending.SelectedValue, "PrintingId");
        ...
        protected void Barcode_indexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dss.Tables[0].Rows.Count > 0)
                {
                    ...
                    Response.Redirect("Printing.aspx?name=Receive&lotid=" + muti);
                }
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Editt")
            {
                ...
                Response.Redirect("Printing.aspx?name=Edit&Printingid=" + e.CommandArgument.ToString());
            ...
            else if (e.CommandName == "Received")
            {
              ...
              //  ds = objBs.checkprocessthereornot(e.CommandArgument.ToString());
                ...
                {
                    Response.Redirect("Printing.aspx?name=Receive&Printingid=" + e.CommandArgument.ToString());
                }
                //else
                //{
            ...
            else if (e.CommandName == "partial")
            {
                ...
                //if (ds.Tables[0].Rows.Count > 0)
                {
                    Response.Redirect("Printing.aspx?name=partial&Printingid=" + e.CommandArgument.ToString());
                }
                //else
                //{
                //    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Check This Lot number Because this is used in another Process.Thank You!!!')", true);
            ...
            else if (e.CommandName == "Payment")
            {
                ...
                //if (ds.Tables[0].Rows.Count > 0)
                {
                    Response.Redirect("PaymentScreen.aspx?name=Print&id=" + e.CommandArgument.ToString());
                }
                //else
                //{
                //    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Check This Lot number Because this is used in another Process.Thank You!!!')", true);
            ...
            //{
            //    Response.Redirect("PrintingG.aspx?Printingid=" + e.CommandArgument.ToString());

            //}
            else if (e.CommandName == "printt")
            {
               string YourURL="StitchingG.aspx?PrintIdForAll=" + e.CommandArgument.ToString() + "&ScreenName=Print";
            ...
            {
               string YourURL = "StitchingG.aspx?PrintIdForAllrec=" + e.CommandArgument.ToString() + "&ScreenName=Print";
            ...
            {
                Response.Redirect("Print.aspx?Printingid=" + e.CommandArgument.ToString());
        ...
        protected void Date_OnTextChanged(object sender, EventArgs e)
        {
            ...
            DataSet pending = objBs.getallProcessdetails("tblJpPrinting", "tbltransjpPrinting", "PrintingId", drpbranch.SelectedValue, drppending.SelectedValue, ddljobworker.SelectedValue, FromDate, ToDate);
            if (pending.Tables[0].Rows.Count > 0)
            {
                gvcust.DataSource = pending;
                gvcust.DataBind();
