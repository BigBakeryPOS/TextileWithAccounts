...
{
    public partial class NDilloEmbroideringGrid : System.Web.UI.Page
    {
        ...
        protected void gvcustinfo_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                ...
                //{
                //    Response.Redirect("NDilloEmbroideringProcess.aspx?LotId=" + e.CommandArgument.ToString() + "&name=" + e.CommandName);
                //}
        ...
        {
            Response.Redirect("NDillo_Stiching.aspx");
        }
    }
}