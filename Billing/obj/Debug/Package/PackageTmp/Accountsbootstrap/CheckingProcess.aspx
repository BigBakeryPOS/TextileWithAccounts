<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckingProcess.aspx.cs" Inherits="Billing.Accountsbootstrap.CheckingProcess" %>
...
<head id="Head1" runat="server">
    ...
    <title>Flexible Apparels || Checking Process</title>
...
<body>
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-top: 6px">
            <h1 id="head" runat="server" class="page-header" style="text-align: center; color: #fe0002">Checking Process
            </h1>
        ...
        <div class="col-lg-12">
            ...
            <ContentTemplate>
                    ...
                    <div id="add" runat="server" class="row">
                        ...
                        <div class="col-lg-3">
                           ...
                           <div class="form-group" style="display:none;" >
                            ...
                            <div id="divPiece" class="form-group" runat="server" style="display:none;">
                                <label>
                                    Total Quantity</label>
                                <asp:TextBox CssClass="form-control" ID="txtTotalQantity" Enabled="false" MaxLength="30" Text="0" runat="server"></asp:TextBox>
                            </div>
                             <div id="Div1" class="form-group" runat="server" style="display:none;">
                                <label>
                                    Design No</label>
                         ...
                         <label runat="server" id="processs"  style="font-weight: bold;display:none;">
                                ...
                                <asp:GridView runat="server" BorderWidth="1" ID="GridView1" CssClass="myleft" GridLines="Both"
                                    ...
                                    <%--   <asp:BoundField DataField="Processmasterid" ItemStyle-Font-Bold="true"  HeaderText="Process Name" Visible="false"  />--%>
                                     ...
                                     <asp:BoundField HeaderText="Stiching Finished Qty" ItemStyle-Font-Bold="true" DataField="FinishedQty" ItemStyle-HorizontalAlign="Center" />
                                ...
                                <label runat="server" id="ratee"  style="font-weight: bold;display:none;">
                                    Rate Details</label>
                                <asp:GridView runat="server" BorderWidth="1" ID="GridView2" CssClass="myleft" GridLines="Both" Caption="RATE DETAILS"
                                    AlternatingRowStyle-CssClass="even" AutoGenerateColumns="false" ShowHeader="true" ShowFooter="true"
                    ...
                    <asp:Button ID="btnadd" runat="server" class="btn btn-info" Text="Save" 
                            ...
                            <asp:Button ID="btnexit" runat="server" class="btn btn-warning" Text="Exit"  PostBackUrl="CheckingProcessGrid.aspx"
