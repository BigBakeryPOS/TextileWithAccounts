...
{
    public partial class PartyMasterGrid : System.Web.UI.Page
    {
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                ...
                {
                    Response.Redirect("PartyMaster.aspx?LedgerID=" + e.CommandArgument.ToString());
                }
            }
