...
namespace Billing.Accountsbootstrap
{
    public partial class Width : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                DataSet dsCategory = objbs.Widthsrchgridforupdate(Convert.ToInt32(txtid.Text), txtWidth.Text);
                 if (dsCategory != null)
                 {
                     if (dsCategory.Tables[0].Rows.Count > 0)
                     {
                     ...
                     else
                     {
                         ...
                         objbs.updateWidthMaster(Convert.ToInt32(txtid.Text), txtWidth.Text, ddlIsActive.SelectedValue, "tblAuditMaster_" + sTableName, lblUser.Text);
                         Response.Redirect("Width.aspx");
                     }
                 }
                 else
                 {
