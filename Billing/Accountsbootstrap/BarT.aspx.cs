    ...
    public partial class BarT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (BarTagid != null)
            {
                ...
                DataSet ds2 = objBs.JpBarTagfor(BarTagid);
                if (ds2.Tables[0].Rows.Count > 0)
                {
                    ...
                    DataSet ds23 = objBs.Get_JpBarT(Convert.ToString(BarTagid), "9", "Btag");
        ...
        protected void btnclick(object sender, EventArgs e)
        {
            ...
            int isucess = objBs.updprintforall(BarTagid, "tbltransjpBarTaghistory", "BarTagId");
        }
