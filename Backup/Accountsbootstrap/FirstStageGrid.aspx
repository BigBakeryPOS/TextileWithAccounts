<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FirstStageGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.FirstStageGrid" %>
...
<head>
    ...
    <title>First Stage Process - bootsrap</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="panel panel-default">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-16">
                                ...
                                <asp:TextBox CssClass="form-control" onkeyup="Search_Gridview(this, 'gvcust')" Enabled="true" ID="txtsearch" runat="server"
                            ...
                            <div class="col-lg-17">
                                <asp:Button ID="btnadd" runat="server" class="btn btn-danger" Text="Add New" Width="130px"
                                    OnClick="Add_Click" />
                                     <asp:Button ID="Button2" runat="server" class="btn btn-success"  Text="Bulk Addition" style="width:120px;margin-top: -34px;margin-left:430px;"  Height="32px" onclick="Button1_Click"/>
                            </div>
                        </div>
                    </div>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gvcust" EmptyDataText="No records Found" runat="server" CssClass="myGridStyle"
                                        ...
                                        <Columns>
                                            <asp:BoundField HeaderText="Invoice No" Visible="false" DataField="FirstStageid" />
                                            <asp:BoundField HeaderText="Item Type" DataField="ite" DataFormatString='{0:dd/MM/yyyy}' />
                                            <asp:BoundField HeaderText="Supplier Name" DataField="ledgername" />
                                          
                                            <asp:BoundField HeaderText="Design No" DataField="Designno" />
                                             <asp:BoundField HeaderText="Shade/colour code" DataField="color" />
                                             <asp:BoundField HeaderText="Ordered/Unordered" DataField="ord" />
                                            <asp:BoundField HeaderText="WSP" DataField="WSP" DataFormatString='{0:f}' />
                                            <asp:BoundField HeaderText="MRP" DataField="MRP" DataFormatString='{0:f}' />

                                            <asp:BoundField HeaderText="Generated Code" DataField="SampleCode" />
                                            ...
                                            <asp:TemplateField HeaderText="Edit"  ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("FirstStageid") %>'
                                                        CommandName="edit">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("FirstStageid") %>' />
                ...
                <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Bind("ToCheque") %>' />--%>
                                            ...
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("FirstStageid") %>'
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" Visible="false" HeaderText="Print">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint" runat="server" CommandArgument='<%#Eval("FirstStageid") %>'
                                                        CommandName="print">
                                                        <asp:Image ID="print" runat="server" ImageUrl="~/images/Print_Icon.jpg" /></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                               <asp:TemplateField ItemStyle-HorizontalAlign="Center"  Visible="false" HeaderText="PrintCR">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprintCR" runat="server" CommandArgument='<%#Eval("FirstStageid") %>'
                                                        CommandName="printCR">
