<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NDilloKajaGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.NDilloKajaGrid" %>
                        ...
                        <div class="col-lg-12" align="center">
                            ...
                            <div class="col-lg-17">
                                <asp:Button ID="btnadd" runat="server" class="btn btn-danger" Text="Add New" Width="130px"
                                    PostBackUrl="~/Accountsbootstrap/NDilloKajaProcess.aspx" />
                            </div>
                            <%--<div class="col-lg-17">
                                    ...
                                    <asp:GridView ID="gvcustinfo" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("NewKajaProcessid") %>'
                                                        CommandName="edit">
                                                    ...
                                                    <asp:HiddenField ID="csinfoID" runat="server" Value='<%# Bind("NewKajaProcessid") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Received" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnrec" runat="server" CommandArgument='<%#Eval("NewKajaProcessid") %>'
                                                    ...
                                                    <asp:ImageButton ID="imgdisablerec" ImageUrl="~/images/edit.png" runat="server" Visible="false"
                                                        Enabled="false" ToolTip="Not Allow To Delete" />
                                                    <asp:HiddenField ID="csinfoIDrec" runat="server" Value='<%# Bind("NewKajaProcessid") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("NewKajaProcessid") %>'
                                            ...
                                            <asp:TemplateField HeaderText="Copy" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btncopy" runat="server" CommandArgument='<%#Eval("NewKajaProcessid") %>'
                                                        CommandName="copy">
                                                        <asp:Image ID="imgcpy" runat="server" Style="height: 23px; width: 18px" ImageUrl="~/images/copy.png" /></asp:LinkButton>
                                                    <asp:HiddenField ID="csinfocopyID" runat="server" Value='<%# Bind("NewKajaProcessid") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
