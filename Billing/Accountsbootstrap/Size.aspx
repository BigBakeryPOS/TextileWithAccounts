<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Size.aspx.cs" Inherits="Billing.Accountsbootstrap.Size" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-16">
                    <asp:TextBox CssClass="form-control" ID="txtsearch" runat="server" placeholder="Enter Search Text"
                        MaxLength="50" Style="width: 250px"></asp:TextBox>
                ...
                <div class="col-lg-7">
                    <div style="height: 392px; overflow: auto" class="table-responsive">
                        <table class="table table-bordered table-striped">
                            <tr>
                                <td>
                                    <asp:GridView ID="gv" runat="server" DataKeyNames="SizeID" OnSelectedIndexChanged="gv_selectedindex"
                                        OnRowCommand="edit" EmptyDataText="Oops! No Activity Performed." AllowPaging="true"
                                        Width="100%" PageSize="1000" OnPageIndexChanging="Page_Change" HeaderStyle-BackColor="#e0e0e0"
                                        ...
                                        <Columns>
                                            <asp:BoundField HeaderText="SizeID" DataField="SizeID" Visible="false" />
                                            <asp:BoundField HeaderText="Size" DataField="Size" SortExpression="Size" HeaderStyle-ForeColor="white" />
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Modify">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" CommandArgument='<%#Eval("SizeID") %>' CommandName="EditRow"
                                                        runat="server">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("SizeID") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" Visible="false" HeaderText="Delete">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndel" CommandArgument='<%#Eval("SizeID") %>' CommandName="Del"
                                                        runat="server">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                          <div class="panel-heading" style="background-color: #336699; color: White;">
                            <i class="fa fa-briefcase"></i>Add Size
                        </div>
                        <!-- /.panel-heading -->
...
ValidChars=" ./\!@#$%^&*,"  TargetControlID="txtuom" />
                                  <br />--%>
                                <label>
                                    Size</label>
                                ...
                                <asp:TextBox placeholder="Enter Size" Visible="true" ID="txtSize" Text="0" runat="server"
                                    CssClass="form-control"></asp:TextBox>
                                <br />
                               <%-- <label>
                                    Sleeve</label>
                                <asp:DropDownList ID="ddlSleeve" runat="server" class="form-control">
                                </asp:DropDownList>--%>
