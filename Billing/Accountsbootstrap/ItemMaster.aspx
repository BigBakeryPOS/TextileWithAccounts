<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemMaster.aspx.cs" Inherits="Billing.Accountsbootstrap.ItemMaster" %>
                                    ...
                                    <div id="Div1" runat="server" style="height: 520px; overflow: scroll;" align="center">
                                        <asp:GridView ID="gridview" runat="server" Width="100%" EmptyDataText="No Records Found"
                                           DataKeyNames="Itemid" AutoGenerateColumns="false"
                                            CssClass="myGridStyle1" AllowSorting="true" OnRowCommand="gvcat_RowCommand" 
                                            ...
                                            <Columns>
                                                <asp:BoundField Visible="false" DataField="Itemid" />
                                                <asp:BoundField DataField="ItemCode" HeaderText="Item Code" SortExpression="Category"
                                                    HeaderStyle-ForeColor="White" ItemStyle-Width="5%" />
                                                <asp:BoundField DataField="ItemName" HeaderText="Item Name" SortExpression="Category"
                                                    HeaderStyle-ForeColor="White" ItemStyle-Width="55%" />
                                                <asp:BoundField DataField="avggms" HeaderText="Avg.Gms" DataFormatString='{0:f3}'
                                                    SortExpression="Category" HeaderStyle-ForeColor="White" ItemStyle-Width="5%" />
                                                <asp:BoundField DataField="rate" HeaderText="Rate" DataFormatString='{0:f2}' SortExpression="Category"
                                                    HeaderStyle-ForeColor="White" ItemStyle-Width="5%" />
                                                <asp:BoundField DataField="tax" HeaderText="GST" SortExpression="Category" HeaderStyle-ForeColor="White"
                                                    ItemStyle-Width="5%" />
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Delete" ItemStyle-Width="10%" Visible="false">
                                                    <ItemTemplate>
        ...
        <div class="col-lg-4" style="margin-left: -14px">
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color: #59d3b4; color: #333333; border-color: #06090c">
                    ...
                    <asp:Label ID="lblName" Text="Add Item" runat="server"></asp:Label>
                </div>
                <div class="panel-body">
                    <div class="list-group">
                        ...
                        <div class="form-group">
                            <label>
                                Item Code</label>
                            <asp:RequiredFieldValidator runat="server" ID="txtcat" ControlToValidate="txtitemcode"
                        ...
                        <div class="form-group">
                            <label>
                                Item Name</label>
                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtitemname"
                                ValidationGroup="val2" Text="*" ErrorMessage="Please enter your Category!" Style="color: Red" />
                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                FilterType="LowercaseLetters, UppercaseLetters,Numbers,Custom" ValidChars=" /-"
                                TargetControlID="txtitemname" />
                            <asp:TextBox CssClass="form-control" ID="txtitemname" runat="server" placeholder="To Add New Item Name"></asp:TextBox>
                            <asp:Label ID="Label1" runat="server" Style="color: Red"></asp:Label>
                        </div>
                        <div class="form-group">
                            <label>
                                Avg.Gms</label>
                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator3" ControlToValidate="txtavggms"
                                ValidationGroup="val2" Text="*" ErrorMessage="Please enter your Avg.Gms!" Style="color: Red" />
                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server"
                                FilterType="Numbers,Custom" ValidChars="." TargetControlID="txtavggms" />
                            <asp:TextBox CssClass="form-control" ID="txtavggms" runat="server" placeholder="To Add New Avg.Gms"></asp:TextBox>
                            <asp:Label ID="Label2" runat="server" Style="color: Red"></asp:Label>
                        </div>
                        <div class="form-group">
                            <label>
                                Rate</label>
                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator4" ControlToValidate="txtavggms"
                                ValidationGroup="val2" Text="*" ErrorMessage="Please enter your Rate!" Style="color: Red" />
                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server"
                                FilterType="Numbers,Custom" ValidChars="." TargetControlID="txtavggms" />
                            <asp:TextBox CssClass="form-control" ID="txtrate" runat="server" placeholder="To Add New Rate"></asp:TextBox>
                            <asp:Label ID="Label3" runat="server" Style="color: Red"></asp:Label>
                        </div>
                        <div class="form-group">
                            <label>
                                Tax(GST)</label>
                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator5" ControlToValidate="txtavggms"
                                ValidationGroup="val2" Text="*" ErrorMessage="Please enter your Tax!" Style="color: Red" />
                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server"
                                FilterType="Numbers,Custom" ValidChars="." TargetControlID="txtavggms" />
                            <asp:TextBox CssClass="form-control" ID="txttax" runat="server" placeholder="To Add New Tax"></asp:TextBox>
                        ...
                        <div class="form-group">
                            <label>
                                Narrations</label>
                            <asp:TextBox CssClass="form-control" ID="txtnarration" runat="server" TextMode="MultiLine"
                                placeholder="Enter Narrations"></asp:TextBox>
                        </div>
