...
{
    public partial class DespatchReturn : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet dsdespatchdc = objBs.getdespatchdc(drpbranch.SelectedValue);
                if (dsdespatchdc.Tables[0].Rows.Count > 0)
                {
                    ddldcno.DataSource = dsdespatchdc.Tables[0];
                    ddldcno.DataTextField = "DcNo";
                    ddldcno.DataValueField = "DespatchId";
                    ddldcno.DataBind();
                    ddldcno.Items.Insert(0, "Select DcNo");
                }


                //DataSet dsdcno = objBs.getdespatchnore(drpbranch.SelectedValue);
        ...
        protected void ddldcno_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataSet DsDespatchStock = objBs.geteditforDespatchStock(Convert.ToInt32(ddldcno.SelectedValue));
            if (DsDespatchStock.Tables[0].Rows.Count > 0)
            {
                ...
                for (int vLoop = 0; vLoop < gvdeliverstock.Rows.Count; vLoop++)
                {
                    ...
                    lbl30FS.Text =(Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["30FS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret30F"])).ToString();
                    txtR30FS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["30FS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret30F"])).ToString();

                    lbl32FS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["32FS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret32F"])).ToString();
                    txtR32FS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["32FS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret32F"])).ToString();

                    lbl34FS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["34FS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret34F"])).ToString();
                    txtR34FS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["34FS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret34F"])).ToString();

                    lbl36FS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["36FS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret36F"])).ToString();
                    txtR36FS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["36FS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret36F"])).ToString();

                    lblXSFS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["XSFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetXSF"])).ToString();
                    txtRXSFS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["XSFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetXSF"])).ToString();

                    lblSFS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["SFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetSF"])).ToString();
                    txtRSFS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["SFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetSF"])).ToString();

                    lblMFS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["MFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetMF"])).ToString();
                    txtRMFS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["MFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetMF"])).ToString();

                    lblLFS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["LFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetLF"])).ToString();
                    txtRLFS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["LFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetLF"])).ToString();

                    lblXLFS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["XLFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetXLF"])).ToString();
                    txtRXLFS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["XLFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetXLF"])).ToString();

                    lblXXLFS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["XXLFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetXXLF"])).ToString();
                    txtRXXLFS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["XXLFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetXXLF"])).ToString();

                    lbl3XLFS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["3XLFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret3XLF"])).ToString();
                    txtR3XLFS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["3XLFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret3XLF"])).ToString();

                    lbl4XLFS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["4XLFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret4XLF"])).ToString();
                    txtR4XLFS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["4XLFS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret4XLF"])).ToString();

                    lbl30HS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["30HS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret30H"])).ToString();
                    txtR30HS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["30HS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret30H"])).ToString();

                    lbl32HS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["32HS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret32H"])).ToString();
                    txtR32HS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["32HS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret32H"])).ToString();

                    lbl34HS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["34HS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret34H"])).ToString();
                    txtR34HS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["34HS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret34H"])).ToString();

                    lbl36HS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["36HS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret36H"])).ToString();
                    txtR36HS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["36HS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret36H"])).ToString();

                    lblXSHS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["XSHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetXSH"])).ToString();
                    txtRXSHS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["XSHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetXSH"])).ToString();

                    lblSHS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["SHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetSH"])).ToString();
                    txtRSHS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["SHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetSH"])).ToString();

                    lblMHS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["MHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetMH"])).ToString();
                    txtRMHS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["MHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetMH"])).ToString();

                    lblLHS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["LHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetLH"])).ToString();
                    txtRLHS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["LHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetLH"])).ToString();

                    lblXLHS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["XLHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetXLH"])).ToString();
                    txtRXLHS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["XLHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetXLH"])).ToString();

                    lblXXLHS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["XXLHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetXXLH"])).ToString();
                    txtRXXLHS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["XXLHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["RetXXLH"])).ToString();

                    lbl3XLHS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["3XLHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret3XLH"])).ToString();
                    txtR3XLHS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["3XLHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret3XLH"])).ToString();

                    lbl4XLHS.Text = (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["4XLHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret4XLH"])).ToString();
                    txtR4XLHS.Text = "0"; (Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["4XLHS"]) - Convert.ToInt32(DsDespatchStock.Tables[0].Rows[vLoop]["Ret4XLH"])).ToString();
        ...
        {
            DataSet dsdcno = objBs.getdespatchnouserre(txtdcno.Text,drpbranch.SelectedValue);
        ...
        protected void chkinvnochanged(object sender, EventArgs e)
        {
            ...
            // if (chkinvno.SelectedIndex >= 0)
            {
                ...
                for (int vLoop = 0; vLoop < GVLotqty.Rows.Count; vLoop++)
                {
                    ...
                    {
                        DataSet ds = objBs.getselectstkforlot(item.Text, drpbranch.SelectedValue);
                        if (ds != null)
                        {
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            if (ddldcno.SelectedValue == "Select DcNo")
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "myscript", "alert('Please Select DcNo. Thank you !!!');", true);
                return;
            }
            #endregion
            ...
            if (btnSave.Text == "Save")
            {
                ...
                int savedespatch = objBs.savedespatchdetailsRet(txtdcno.Text, Date, Convert.ToInt32(ddlpacker.SelectedValue), txtnarration.Text, Convert.ToInt32(lblalltotalqty.Text), Convert.ToInt32(ddlcustomer.SelectedValue), Convert.ToInt32(drpbranch.SelectedValue), Convert.ToInt32(Empid), Convert.ToInt32(ddldcno.SelectedValue), Convert.ToDouble(lblalltotalamt.Text));
            ...
            else
            {
                ...
                //////int updespatch = objBs.newupdespatch(Convert.ToInt32(DespatchId));
                ...
                //////    if (lbldespatchqty.Text != "0")
                //////    {
                //////        int transsavedespatch = objBs.savetransdespatchdetails(Convert.ToInt32(DespatchId), Convert.ToInt32(lblFinishedStockRatioId.Text), Convert.ToInt32(lblCutid.Text), lblItemname.Text, lblCompanyLotNo.Text, Convert.ToInt32(txtR30FS.Text), Convert.ToInt32(txtR32FS.Text), Convert.ToInt32(txtR34FS.Text), Convert.ToInt32(txtR36FS.Text), Convert.ToInt32(txtRXSFS.Text), Convert.ToInt32(txtRSFS.Text), Convert.ToInt32(txtRMFS.Text), Convert.ToInt32(txtRLFS.Text), Convert.ToInt32(txtRXLFS.Text), Convert.ToInt32(txtRXXLFS.Text), Convert.ToInt32(txtR3XLFS.Text), Convert.ToInt32(txtR4XLFS.Text), Convert.ToInt32(txtR30HS.Text), Convert.ToInt32(txtR32HS.Text), Convert.ToInt32(txtR34HS.Text), Convert.ToInt32(txtR36HS.Text), Convert.ToInt32(txtRXSHS.Text), Convert.ToInt32(txtRSHS.Text), Convert.ToInt32(txtRMHS.Text), Convert.ToInt32(txtRLHS.Text), Convert.ToInt32(txtRXLHS.Text), Convert.ToInt32(txtRXXLHS.Text), Convert.ToInt32(txtR3XLHS.Text), Convert.ToInt32(txtR4XLHS.Text), Convert.ToInt32(lbldespatchqty.Text), lblDesignCode.Text);
                //////    }
