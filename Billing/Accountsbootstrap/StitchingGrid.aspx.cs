...
{
    public partial class StitchingGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                // DataSet dunit = objBs.JpStichingformulti();
                DataSet pending = objBs.pendinglotdetail("tbljpstiching", "tbltransjpstiching", drpbranch.SelectedValue, drppending.SelectedValue, "stichingid");
        ...
        protected void Date_OnTextChanged(object sender, EventArgs e)
        {
            ...
            if (ddljobworker.SelectedValue == "")
                jobworker = "0";
            else
                jobworker = ddljobworker.SelectedValue;

            DataSet pending = objBs.getallProcessdetails("tbljpstiching", "tbltransjpstiching", "stichingid", drpbranch.SelectedValue, drppending.SelectedValue, jobworker, FromDate, ToDate);
            if (pending.Tables[0].Rows.Count > 0)
            {
                gvcust.DataSource = pending;
                gvcust.DataBind();
        ...
        protected void Barcode_indexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dss.Tables[0].Rows.Count > 0)
                {
                    ...
                    Response.Redirect("Stitching.aspx?name=Receive&lotid=" + muti);
                }
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Editt")
            {
                ...
                Response.Redirect("Stitching.aspx?name=Edit&Stitchingid=" + e.CommandArgument.ToString());
            ...
            else if (e.CommandName == "partial")
            {
                ...
                {
                    Response.Redirect("Stitching.aspx?name=partial&Stitchingid=" + e.CommandArgument.ToString());
                }
                //else
                //{
            ...
            else if (e.CommandName == "Received")
            {
                ...
                //if (ds.Tables[0].Rows.Count > 0)
                {
                    Response.Redirect("Stitching.aspx?name=Receive&Stitchingid=" + e.CommandArgument.ToString());
                }
                //else
                //{
                //    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Check This Lot number Because this is used in another Process.Thank You!!!')", true);
            ...
            else if (e.CommandName == "Payment")
            {
                ...
                //if (ds.Tables[0].Rows.Count > 0)
                {
                    Response.Redirect("PaymentScreen.aspx?name=Stc&id=" + e.CommandArgument.ToString());
                }
                //else
                //{
                //    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Check This Lot number Because this is used in another Process.Thank You!!!')", true);
            ...
            //{
            //    Response.Redirect("StitchingG.aspx?Stitchingid=" + e.CommandArgument.ToString());

            //}
            //else if (e.CommandName == "printtrec")
            //{
            //    Response.Redirect("StitchingG.aspx?Stitchingidrec=" + e.CommandArgument.ToString());

            //}
            else if (e.CommandName == "printt")
            {
                string YourURL = "StitchingG.aspx?PrintIdForAll=" + e.CommandArgument.ToString() + "&ScreenName=Stitch";
            ...
            {
                //             Response.Redirect("StitchingG.aspx?PrintIdForAllrec=" + e.CommandArgument.ToString() + "&ScreenName=Stitch");



                string YourURL = "StitchingG.aspx?PrintIdForAllrec=" + e.CommandArgument.ToString() + "&ScreenName=Stitch";
            ...
            {
                Response.Redirect("Stc.aspx?Stitchingid=" + e.CommandArgument.ToString());
        ...
        protected void gvRowdatabound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[8].Text = TotalIssue.ToString();
                e.Row.Cells[9].Text = TotalReceive.ToString();
                e.Row.Cells[10].Text = TotalDamage.ToString();

                e.Row.Cells[11].Text = PaidAmount.ToString("f2");

                e.Row.Cells[12].Text = DebitAmount.ToString("f2");
                e.Row.Cells[13].Text = Miscellaneous.ToString("f2");
