<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CuttingQtyDetails.aspx.cs"
    Inherits="Billing.Accountsbootstrap.CuttingQtyDetails" %>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-2">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList ID="ddlReportType" runat="server" Height="30px" Width="100%" AutoPostBack="true"
                                        OnSelectedIndexChanged="ddlReportType_OnSelectedIndexChanged">
                                        <asp:ListItem Text="Summary Report" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="Detailed Report" Value="2"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label>
                                        Buyer Code:</label>
                                    <asp:DropDownList ID="ddlBuyerCode" OnSelectedIndexChanged="buyer_order" AutoPostBack="true"
                        ...
                        <div id="Excel" runat="server">
                            <div class="col-lg-12">
                                ...
                                <br />
                                <br />
                                <asp:GridView ID="gvCuttingQtyDetails" CssClass="" runat="server" EmptyDataText="No Records Found"
                                    Width="100%">
