...
{
    public partial class TrimmingProcessGrid : System.Web.UI.Page
    {
        ...
        {
            DataSet dunit = objBs.Trimming_Unit_Pending(drpunit.SelectedValue, drppending.SelectedValue);
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "view")
            {
                ...
                ds = objBs.Check_TrimmingProcess_Availability(e.CommandArgument.ToString());
                if (ds.Tables[0].Rows.Count > 0)
                {

                    Response.Redirect("CheckingProcess.aspx?Trimmingid=" + e.CommandArgument.ToString());
                }
                else
                {
