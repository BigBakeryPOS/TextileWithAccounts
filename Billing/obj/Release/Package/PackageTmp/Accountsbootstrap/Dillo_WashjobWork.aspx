<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dillo_WashjobWork.aspx.cs" Inherits="Billing.Accountsbootstrap.Dillo_WashjobWork" %>
...
<body style="background-color:#c6efce">
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-top: 6px">
            <h1 id="head" runat="server" class="page-header" style="text-align: center; color: #fe0002">Washing Received Process
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
                    ...
                    <div id="add" runat="server" class="row">
                        ...
                        <div class="col-lg-2">
                            ...
                            <div runat="server" visible="false" class="form-group" >
                                <label>
                                    Job Work</label>
                                <asp:CheckBox ID="chckJobWork" MaxLength="150" Checked="true" runat="server" OnCheckedChanged="Change_JobWork" AutoPostBack="true"></asp:CheckBox>
                            </div>
                            ...
                            <div class="form-group" >
                                ...
                                <asp:DropDownList CssClass="form-control" Enabled="false" ID="ddlUnit" OnSelectedIndexChanged="UnitChange" AutoPostBack="true" MaxLength="150" runat="server"></asp:DropDownList>
                            </div>
                             ...
                             <div id="div6" class="form-group" runat="server">
                              ...
                              <div id="div7" class="form-group" runat="server">
                               ...
                               <asp:DropDownList ID="drpsupervisor" runat="server" CssClass="form-control"></asp:DropDownList>
                                         ...
                                         <div id="divreceivedate" class="form-group" runat="server">
                                <label>
                                ...
                                <asp:TextBox CssClass="form-control" ID="txtreceivingdate"  runat="server" onkeyup="ValidateDate(this, event.keyCode)"
                                                                    onkeydown="return DateFormat(this, event.keyCode)" style="width: 200px;"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td colspan="7">
                                                        <asp:GridView ID="gvcustomerorder" AutoGenerateColumns="False" ShowFooter="True"
                                                            ...
                                                            CssClass="chzn-container"  Width="80%" runat="server">
                                                            ...
                                                            <Columns>
                                                              <asp:TemplateField HeaderText="S.No" ItemStyle-Width="10%">
                                                                    ...
                                                                    <%# Container.DataItemIndex + 1 %>
                                                                     ...
                                                                     <asp:TemplateField HeaderText="Transid" ItemStyle-Width="10%" Visible="false">
                                                                    <ItemTemplate>
                                                                 <asp:TextBox ID="txttransid" Height="30px" runat="server"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="Process Type" visible="false" ItemStyle-Width="35%">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Employee Name" visible="false" ItemStyle-Width="35%">
                                                                   ...
                                                                   <asp:TemplateField HeaderText="Total Quantity" ItemStyle-Width="0%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txttotqty" runat="server" Width="100%"  Height="26px" AppendDataBoundItems="true"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField >
                                                                    <ItemTemplate>
                                                                       <%-- <asp:Button ID="ButtonAdd1" runat="server" Visible="false" AutoPostback="false" EnableTheming="false" Text="Add" OnClick="ButtonAdd1_Click" />--%>
                                                                        <asp:Button ID="ButtonAdd1" runat="server" Text="Add" OnClick="ButtonAdd1_Click" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
