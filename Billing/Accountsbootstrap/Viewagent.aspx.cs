...
namespace Billing.Accountsbootstrap
{
    public partial class Viewagent : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objBs.selectcustomerDetforagent(8, 1);
                if (ds != null)
                {
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            {
                button = btnadd.Text;
                Response.Redirect("Agentmaster.aspx?name=" + button.ToString());
            }
        ...
        protected void Page_Change(object sender, GridViewPageEventArgs e)
        {
            ...
            {
                ds = objBs.selectcustomerDetforagent(8, 1);
            }
            else
            {
        ...
        protected void refresh_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("../Accountsbootstrap/agentmaster.aspx");
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                ...
                {
                    Response.Redirect("agentmaster.aspx?LedgerID=" + e.CommandArgument.ToString());
                }
            }
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            string filename = "agentmaster_" + DateTime.Now.ToString() + ".xls";
