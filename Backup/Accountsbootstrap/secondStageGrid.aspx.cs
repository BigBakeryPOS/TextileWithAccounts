...
{
    public partial class secondStageGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet ds = objBs.selectsecondstageprocess();
                if (ds != null)
                {
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("../Accountsbootstrap/SecondStageProcess.aspx");
        ...
        protected void refresh_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("../Accountsbootstrap/SecondStageGrid.aspx");
