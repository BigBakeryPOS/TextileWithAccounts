<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DespatchGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.DespatchGrid" %>
                                                        ...
                                                        <td id="Td1" runat="server" visible="true">
                                                            <asp:GridView ID="gridcatqty" Visible="true" runat="server" EmptyDataText="Sorry Data Not Found!"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="CustomerName" HeaderText="Customer Name" ItemStyle-Width="15%" />
                                                                    <asp:BoundField DataField="LedgerName" HeaderText="Prepared" />
                                                                    ...
                                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Delete" Visible="true">
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("DespatchId") %>'
                                                                                CommandName="Delete">
