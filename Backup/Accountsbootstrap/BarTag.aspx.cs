...
{
    public partial class BarTag : System.Web.UI.Page
    {
        ...
        {
            string BarTagid = string.Empty;
            string Requests = string.Empty;
            BarTagid = Request.QueryString.Get("Bartagid");
            ...
            if (!IsPostBack)
            {
                ...
                //DataSet dsLotNo = objbs.Select_LotDetails("Btag");
                ...
                if (BarTagid != null)
                {
                    if (Requests == "Edit")
                    {
                        ...
                        DataSet dgetcheck = objbs.getJpBarTagLot(BarTagid);
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            DataSet dsLot = objbs.Select_Lot("Btag", drpbranch.SelectedValue);
                            ...
                            dlotprocess = objbs.Get_LotDetails(Convert.ToString(dgetcheck.Tables[0].Rows[0]["LotDetailID"]), "9", "Btag");
                            ...
                            btnadd.Visible = true;
                            btnadd.Text = "Update";
                            txtid.Text = dgetcheck.Tables[0].Rows[0]["BarTagid"].ToString();
                            txtmultiid.Text = dgetcheck.Tables[0].Rows[0]["BarTagid"].ToString();
                            txtmultiplecode.Text = dgetcheck.Tables[0].Rows[0]["BarTagid"].ToString();
                            ...
                            DataSet ds = objbs.Get_JpBarTag(Convert.ToString(BarTagid), "9", "Btag");
                    ...
                    else if (Requests == "partial")
                    {
                        ...
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            ...
                            txtAmount.Text = dgetcheck.Tables[0].Rows[0]["TotalAmount"].ToString();
                            txtAmount.Enabled = false;
                            DataSet ds = objbs.Get_LotDetails(Convert.ToString(dgetcheck.Tables[0].Rows[0]["LotDetailID"]), "9", "Btag");
                                //= objbs.Get_JpBarTag(Convert.ToString(BarTagid), "9", "Btag");
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                DataSet temp = new DataSet();
                                DataTable dtt = new DataTable();
                    ...
                    else if (Requests == "Receive")
                    {
                        ...
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                dsstichinglot = objbs.Get_dsbartaglotcolor(Convert.ToInt32(BarTagid));
                                ...
                                gvnewbartag.DataSource = dssstichinglot;
                                gvnewbartag.DataBind();

                                for (int i = 0; i < gvnewbartag.Rows.Count; i++)
                                {
                                    Label lblStockRatioId = (Label)gvnewbartag.Rows[i].FindControl("lblStockRatioId");
                                    Label lblMasterid = (Label)gvnewbartag.Rows[i].FindControl("lblMasterid");
                                    Label lblTransfabid = (Label)gvnewbartag.Rows[i].FindControl("lblTransfabid");

                                    Label lbldesignno = (Label)gvnewbartag.Rows[i].FindControl("lbldesignno");
                                    TextBox txts30fs = (TextBox)gvnewbartag.Rows[i].FindControl("txts30fs");
                                    TextBox txts32fs = (TextBox)gvnewbartag.Rows[i].FindControl("txts32fs");
                                    TextBox txts34fs = (TextBox)gvnewbartag.Rows[i].FindControl("txts34fs");
                                    TextBox txts36fs = (TextBox)gvnewbartag.Rows[i].FindControl("txts36fs");
                                    TextBox txtsxsfs = (TextBox)gvnewbartag.Rows[i].FindControl("txtsxsfs");
                                    TextBox txtssfs = (TextBox)gvnewbartag.Rows[i].FindControl("txtssfs");
                                    TextBox txtsmfs = (TextBox)gvnewbartag.Rows[i].FindControl("txtsmfs");
                                    TextBox txtslfs = (TextBox)gvnewbartag.Rows[i].FindControl("txtslfs");
                                    TextBox txtsxlfs = (TextBox)gvnewbartag.Rows[i].FindControl("txtsxlfs");
                                    TextBox txtsxxlfs = (TextBox)gvnewbartag.Rows[i].FindControl("txtsxxlfs");
                                    TextBox txts3xlfs = (TextBox)gvnewbartag.Rows[i].FindControl("txts3xlfs");
                                    TextBox txts4xlfs = (TextBox)gvnewbartag.Rows[i].FindControl("txts4xlfs");

                                    TextBox txts30hs = (TextBox)gvnewbartag.Rows[i].FindControl("txts30hs");
                                    TextBox txts32hs = (TextBox)gvnewbartag.Rows[i].FindControl("txts32hs");
                                    TextBox txts34hs = (TextBox)gvnewbartag.Rows[i].FindControl("txts34hs");
                                    TextBox txts36hs = (TextBox)gvnewbartag.Rows[i].FindControl("txts36hs");
                                    TextBox txtsxshs = (TextBox)gvnewbartag.Rows[i].FindControl("txtsxshs");
                                    TextBox txtsshs = (TextBox)gvnewbartag.Rows[i].FindControl("txtsshs");
                                    TextBox txtsmhs = (TextBox)gvnewbartag.Rows[i].FindControl("txtsmhs");
                                    TextBox txtslhs = (TextBox)gvnewbartag.Rows[i].FindControl("txtslhs");
                                    TextBox txtsxlhs = (TextBox)gvnewbartag.Rows[i].FindControl("txtsxlhs");
                                    TextBox txtsxxlhs = (TextBox)gvnewbartag.Rows[i].FindControl("txtsxxlhs");
                                    TextBox txts3xlhs = (TextBox)gvnewbartag.Rows[i].FindControl("txts3xlhs");
                                    TextBox txts4xlhs = (TextBox)gvnewbartag.Rows[i].FindControl("txts4xlhs");

                                    TextBox txtsendFQty = (TextBox)gvnewbartag.Rows[i].FindControl("txtsendFQty");
                                    ...
                                    TextBox txts30fsac = (TextBox)gvnewbartag.Rows[i].FindControl("txts30fsac");
                                    TextBox txts32fsac = (TextBox)gvnewbartag.Rows[i].FindControl("txts32fsac");
                                    TextBox txts34fsac = (TextBox)gvnewbartag.Rows[i].FindControl("txts34fsac");
                                    TextBox txts36fsac = (TextBox)gvnewbartag.Rows[i].FindControl("txts36fsac");
                                    TextBox txtsxsfsac = (TextBox)gvnewbartag.Rows[i].FindControl("txtsxsfsac");
                                    TextBox txtssfsac = (TextBox)gvnewbartag.Rows[i].FindControl("txtssfsac");
                                    TextBox txtsmfsac = (TextBox)gvnewbartag.Rows[i].FindControl("txtsmfsac");
                                    TextBox txtslfsac = (TextBox)gvnewbartag.Rows[i].FindControl("txtslfsac");
                                    TextBox txtsxlfsac = (TextBox)gvnewbartag.Rows[i].FindControl("txtsxlfsac");
                                    TextBox txtsxxlfsac = (TextBox)gvnewbartag.Rows[i].FindControl("txtsxxlfsac");
                                    TextBox txts3xlfsac = (TextBox)gvnewbartag.Rows[i].FindControl("txts3xlfsac");
                                    TextBox txts4xlfsac = (TextBox)gvnewbartag.Rows[i].FindControl("txts4xlfsac");

                                    TextBox txts30hsac = (TextBox)gvnewbartag.Rows[i].FindControl("txts30hsac");
                                    TextBox txts32hsac = (TextBox)gvnewbartag.Rows[i].FindControl("txts32hsac");
                                    TextBox txts34hsac = (TextBox)gvnewbartag.Rows[i].FindControl("txts34hsac");
                                    TextBox txts36hsac = (TextBox)gvnewbartag.Rows[i].FindControl("txts36hsac");
                                    TextBox txtsxshsac = (TextBox)gvnewbartag.Rows[i].FindControl("txtsxshsac");
                                    TextBox txtsshsac = (TextBox)gvnewbartag.Rows[i].FindControl("txtsshsac");
                                    TextBox txtsmhsac = (TextBox)gvnewbartag.Rows[i].FindControl("txtsmhsac");
                                    TextBox txtslhsac = (TextBox)gvnewbartag.Rows[i].FindControl("txtslhsac");
                                    TextBox txtsxlhsac = (TextBox)gvnewbartag.Rows[i].FindControl("txtsxlhsac");
                                    TextBox txtsxxlhsac = (TextBox)gvnewbartag.Rows[i].FindControl("txtsxxlhsac");
                                    TextBox txts3xlhsac = (TextBox)gvnewbartag.Rows[i].FindControl("txts3xlhsac");
                                    TextBox txts4xlhsac = (TextBox)gvnewbartag.Rows[i].FindControl("txts4xlhsac");

                                    TextBox txtsendFQtyac = (TextBox)gvnewbartag.Rows[i].FindControl("txtsendFQtyac");
        ...
        protected void company_SelectedIndexChnaged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSet dsLotNo = objbs.Select_LotDetails("Btag", drpbranch.SelectedValue);
                if (dsLotNo.Tables[0].Rows.Count > 0)
                {
                    DataSet dsLotNoval = objbs.Select_LotDetailsnew("Btag", drpbranch.SelectedValue, 8);
        ...
        protected void StitchingInfo_Load(object sender, EventArgs e)
        {
            ...
            if (ddlLotNo.SelectedValue != "Select Lot No")
            {
                int dcheck = objbs.checkcurrent(ddlLotNo.SelectedValue, "Btag");
                if (dcheck == 1)
                {
                    #region
                    ...
                    DataSet rateforprecost = objbs.getrateforprecost(Convert.ToString(ddlLotNo.SelectedItem.Text), "BarTag Process");
                    if (rateforprecost.Tables[0].Rows.Count > 0)
                    {
                        bartagrate = Convert.ToDouble(rateforprecost.Tables[0].Rows[0]["Cost"].ToString());
                    }
                    else
                    {
                    ...
                    DataSet dlotprocess = new DataSet();
                    dlotprocess = objbs.Get_LotDetails(Convert.ToString(ddlLotNo.SelectedValue), "9", "Btag");
                    txttotalqty.Text = dlotprocess.Tables[0].Rows[0]["TotalQuantity"].ToString();
                    ...
                    if (dlotprocess.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < gvcustomerorder.Rows.Count; i++)
                        {
                            ...
                            lblfitid.Text = temp.Tables[0].Rows[i]["fitid"].ToString();
                           // txtrate.Text = temp.Tables[0].Rows[i]["rate"].ToString();
                            txtrate.Text = bartagrate.ToString();
                            drpProcess.SelectedValue = temp.Tables[0].Rows[i]["ProcessTypeID"].ToString();
                            lblPattern.Text = temp.Tables[0].Rows[i]["Pattern"].ToString();
                            lblPatternid.Text = temp.Tables[0].Rows[i]["Patternid"].ToString();
                            txtdamageqty.Text = temp.Tables[0].Rows[i]["damageqty"].ToString();
                    ...
                    dsstichinglot = objbs.Get_dsBartaglot(Convert.ToInt32(ddlLotNo.SelectedValue), BarTagProcess);
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Not Ready To BarTag Process.Thank You!!!')", true);
                    return;
                }
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            drpProcess = objbs.SelectAllProcessTypeLotProcess("9");
        ...
        protected void Add_LotProcessDetails(object sender, EventArgs e)
        {
            ...
            if (btnadd.Text == "Save")
            {
                ...
                int istatus3 = objbs.insertJpBarTag(Convert.ToDouble(txtAmount.Text), Convert.ToInt32(ddlLotNo.SelectedValue), lbllotno.Text, MultiDate, Convert.ToInt32(drpMultiemployee.SelectedValue), Convert.ToDouble(txttotalqty.Text), empid, drpbranch.SelectedValue, ddlLotNo.SelectedItem.Text, Convert.ToInt32(txtsendFQtymain.Text),txtnarration.Text);



                for (int vLoop = 0; vLoop < gvnewbartag.Rows.Count; vLoop++)
                {
                    int vLoopp = 0;
                    ...
                    #region
                    Label lblitemname = (Label)gvnewbartag.Rows[vLoop].FindControl("lbldesignno");

                    TextBox txts30fs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txts30fs");
                    TextBox txts32fs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txts32fs");
                    TextBox txts34fs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txts34fs");
                    TextBox txts36fs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txts36fs");
                    TextBox txtsxsfs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txtsxsfs");
                    TextBox txtssfs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txtssfs");
                    TextBox txtsmfs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txtsmfs");
                    TextBox txtslfs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txtslfs");
                    TextBox txtsxlfs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txtsxlfs");
                    TextBox txtsxxlfs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txtsxxlfs");
                    TextBox txts3xlfs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txts3xlfs");
                    TextBox txts4xlfs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txts4xlfs");

                    TextBox txts30hs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txts30hs");
                    TextBox txts32hs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txts32hs");
                    TextBox txts34hs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txts34hs");
                    TextBox txts36hs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txts36hs");
                    TextBox txtsxshs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txtsxshs");
                    TextBox txtsshs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txtsshs");
                    TextBox txtsmhs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txtsmhs");
                    TextBox txtslhs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txtslhs");
                    TextBox txtsxlhs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txtsxlhs");
                    TextBox txtsxxlhs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txtsxxlhs");
                    TextBox txts3xlhs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txts3xlhs");
                    TextBox txts4xlhs = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txts4xlhs");

                    Label lblStockRatioId = (Label)gvnewbartag.Rows[vLoop].FindControl("lblStockRatioId");
                    Label lblMasterid = (Label)gvnewbartag.Rows[vLoop].FindControl("lblMasterid");
                    Label lblTransfabid = (Label)gvnewbartag.Rows[vLoop].FindControl("lblTransfabid");

                    TextBox txtsendFQtycolor = (TextBox)gvnewbartag.Rows[vLoop].FindControl("txtsendFQty");
                    ...
                    else
                    {
                        ...
                        {
                            int istasHistory = objbs.inserttransjpIBarTagHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            int istas = objbs.inserttransJpBarTag(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            if (vLoop == 0)
                            {
                                int istas1 = objbs.JpBarTag(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                ...
                int istatus3l = objbs.statusJpBarTag(Convert.ToInt32(ddlLotNo.SelectedValue));
            ...
            else if (btnadd.Text == "Partial")
            {
                ...
                string BarTagid = Request.QueryString.Get("BarTagid");
                DateTime MultiDate = DateTime.ParseExact(txtmultidate.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture);

                int istatus3 = objbs.UpdJpBarTag(Convert.ToDouble(txtAmount.Text), Convert.ToInt32(ddlLotNo.SelectedValue), lbllotno.Text, MultiDate, Convert.ToInt32(drpMultiemployee.SelectedValue), Convert.ToDouble(txttotalqty.Text), BarTagid, empid);
                ...
                for (int vLoop = 0; vLoop < gvcustomerorder.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        ...
                        int istas = objbs.inserttransJpBarTagPartial(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                  recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Convert.ToInt32(ddlLotNo.SelectedValue), empid, Convert.ToInt32(txtsendFQty.Text), BarTagid);
            ...
            else if (btnadd.Text == "Update")
            {
                ...
                for (int vLoop = 0; vLoop < gvcustomerorder.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        ...
                        int istas = objbs.updatetransJpBarTag(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                  recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtsendFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Convert.ToInt32(ddlLotNo.SelectedValue), BarTagid);
            ...
            else if (btnadd.Text == "Received")
            {
                ...
                if (ddltype.SelectedValue == "Damage")
                {
                    int istasHistory = objbs.processmaintablebartag(Convert.ToInt32(BarTagid), Convert.ToInt32(txtdamageqtymain.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }
                else
                {
                    int istasHistory = objbs.processmaintablebartag(Convert.ToInt32(BarTagid), Convert.ToInt32(txtrecFQty.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }
                ...
                for (int vLoop = 0; vLoop < gvnewbartag.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        if (txtsendFQtycolor.Text != "0")
                        {
                            int istasHistory = objbs.inserttransjpbartagHistory1new(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), recdate,
                                      recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), BarTagid, empid, Convert.ToInt32(txtsendFQty.Text), Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), ddltype.SelectedItem.Text);

                            if (vLoop == 0)
                            {
                                //int istasHistory = objbs.inserttransjpIBarTagHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                //          recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), BarTagid, empid, Convert.ToInt32(txtsendFQty.Text));

                                int istas = objbs.JpBarTagREC(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            if (ddltype.SelectedValue == "Damage")
                            {
                                int rec = objbs.DamageProcessStockRatiobartag(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text), BarTagProcess);
                            }
                            else
                            {
                                int rec = objbs.updateProcessStockRatiobartag(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text));
        ...
        protected void gvnewbartag_RowDataBound(object sender, GridViewRowEventArgs e)
        {
