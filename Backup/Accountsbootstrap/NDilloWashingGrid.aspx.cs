...
{
    public partial class NDilloWashingGrid : System.Web.UI.Page
    {
        ...
        protected void gvcustinfo_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                ...
                //{
                //    Response.Redirect("NDilloWashingProcess.aspx?LotId=" + e.CommandArgument.ToString() + "&name=" + e.CommandName);
                //}
