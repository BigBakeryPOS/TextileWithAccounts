<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseOrderGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.PurchaseOrderGrid" %>
                    ...
                    <div class="row">
                        <div class="col-lg-12" align="center">
                            ...
                            <div class="col-lg-16">
                                ...
                                <asp:TextBox CssClass="form-control" Enabled="true" onkeyup="Search_Gridview(this, 'GVPurchaseOrder')"
                                    ID="txtsearch" runat="server" Style="width: 165px;margin-top: 0px;" placeholder="Enter Text to Search"></asp:TextBox>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="GVPurchaseOrder" runat="server" CssClass="myGridStyle1" EmptyDataText="No records Found"
                                        Width="100%" AutoGenerateColumns="false" OnRowCommand="GVPurchaseOrder_RowCommand">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("POId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("POId") %>'
                                                        CommandName="dele" OnClientClick="alertMessage()">
