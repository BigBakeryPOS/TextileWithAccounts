<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dillo_EmbJobWork.aspx.cs" Inherits="Billing.Accountsbootstrap.Dillo_EmbJobWork" %>
...
<body style="background-color:#c6efce">
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-top: 6px">
            <h1 id="head" runat="server" class="page-header" style="text-align: center; color: #fe0002">Embroidering Received Process
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body" style="background-color:#c6efce">
                        ...
                        <div class="col-lg-2">
                          ...
                          <div id="divreceivedate" class="form-group" runat="server">
                            <label>Receiving Date</label>
                                <asp:TextBox CssClass="form-control" ID="txtreceivingdate" onkeyup="ValidateDate(this, event.keyCode)"
                    ...
                    <asp:Button ID="btnadd" runat="server" class="btn btn-info" Text="Save" 
                            ...
                            <asp:Button ID="btnexit" runat="server" PostBackUrl="~/Accountsbootstrap/Dillo_Embrodarygrid.aspx" class="btn btn-warning" Text="Exit" 
