<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IroningGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.IroningGrid" %>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-2">
                                ...
                                <asp:TextBox CssClass="form-control" Enabled="true" onkeyup="Search_Gridview(this, 'gvcust')"
                                    ID="txtsearch" runat="server" placeholder="Enter Text to Search" Width="200px"></asp:TextBox>
                            ...
                            <div class="col-lg-1">
                                <asp:Label ID="Label5" runat="server" Style="color: Red"></asp:Label><br />
                                <asp:Button ID="Button3" runat="server" class="btn btn-success" Text="Add New" PostBackUrl="~/Accountsbootstrap/Ironing.aspx"
                                    Width="100px" />
                            </div>
                            <div class="col-lg-1">
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gvcust" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        AllowPaging="true" PageSize="100000" DataKeyNames="IroningId" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                         ...
                                         <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20%" HeaderText="FabDetails"
                                            ...
                                            <asp:BoundField HeaderText="Companyid" DataField="Companyid" Visible="true" />

                                            <asp:BoundField DataField="ItemCode" HeaderText="ItemCode" />

                                            <asp:BoundField DataField="IroningId" Visible="true" HeaderText="Work Order" />
                                            ...
                                            <asp:BoundField HeaderText="Alter Qty" DataField="AlterQty" Visible="false" />
                                            <asp:BoundField HeaderText="TotalAmount" DataField="TotalAmount" Visible="false"
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("IroningId") %>'
                                                        CommandName="Editt">
                                              ...
                                              <asp:BoundField HeaderText="RecDate" DataField="ReceiveDate" DataFormatString="{0:dd/MM/yyyy}" />
                                            <asp:BoundField HeaderText="Delay Days" DataField="DiffReceiveDate" />

                                            <asp:TemplateField HeaderText="Received" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnreceived" runat="server" CommandArgument='<%#Eval("IroningId") %>'
                                                    ...
                                                    <asp:ImageButton ID="imgdisablerec" ImageUrl="~/images/edit.png" runat="server" Visible="false"
                                                        Enabled="false" ToolTip="Not Allow To Delete" />
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("IroningId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Issue Print" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint" runat="server" CommandArgument='<%#Eval("IroningId") %>'
                                                        CommandName="printt">
                                                        <asp:Image ID="imgep" runat="server" ImageUrl="~/images/print (2).png" /></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Rec Print" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprintRec" runat="server" CommandArgument='<%#Eval("IroningId") %>'
                                            ...
                                            <asp:TemplateField HeaderText="Received Print" ItemStyle-HorizontalAlign="Center"
                                                Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint1" runat="server" CommandArgument='<%#Eval("IroningId") %>'
                                                        CommandName="printt1">
                                            ...
                                            <asp:TemplateField HeaderText="Payment" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnPayment" runat="server" CommandArgument='<%#Eval("IroningId") %>'
                                                        CommandName="Payment">
                                                    ...
                                                    <asp:HiddenField ID="ldgID1" runat="server" Value='<%# Bind("IroningId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("IroningId") %>'
