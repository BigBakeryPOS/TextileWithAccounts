<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessOrderPrint.aspx.cs"
    Inherits="Billing.Accountsbootstrap.ProcessOrderPrint" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Production Order Print</title>
...
<body>
    ...
    <asp:Label ID="lblhead" runat="server" Visible="false" Text=" Order Print" ></asp:Label>
    ...
    <table width="100%" border="0">
            ...
            <td colspan="2">
                <asp:GridView ID="gvCuttingProcessEntryStyles" runat="server" EmptyDataText="No Records Found" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TotalIssued" HeaderText="Qty" />
        ...
        <tr>
            <td runat="server" visible="false" style="width: 10%">
