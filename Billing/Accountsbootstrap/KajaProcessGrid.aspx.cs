...
{
    public partial class KajaProcessGrid : System.Web.UI.Page
    {
        ...
        {
            DataSet dunit = objBs.Kaja_Unit_Pending(drpunit.SelectedValue, drppending.SelectedValue);
        ...
        {
            DataSet pending = objBs.Kaja_Unit_Pending(drpunit.SelectedValue, drppending.SelectedValue);
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "view")
            {
                ...
                ds = objBs.Check_KajaProcess_Availability(e.CommandArgument.ToString());
                if (ds.Tables[0].Rows.Count > 0)
                {

                    Response.Redirect("CheckingProcess.aspx?kajaid=" + e.CommandArgument.ToString());
                }
                else
                {
