<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobWorkMaster.aspx.cs"
    Inherits="Billing.Accountsbootstrap.JobWorkMaster" %>
...
<head id="Head1" runat="server">
    ...
    <title>Flexible Apparels || Job Work</title>
                    ...
                    <asp:UpdatePanel ID="Updatepanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group" runat="server" visible="false">
                                                <label>
                                                    Contact ID</label>
                                                <asp:TextBox CssClass="form-control" ID="txtCustomerid" runat="server" Enabled="false"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group" runat="server" visible="false" style="margin-left: -115px">
                                                <label id="Label1" runat="server">
                                                    Inital</label>
                                                <asp:TextBox CssClass="form-control" Width="65px" Style="text-transform: uppercase"
                                                    ID="TextBox1" runat="server">0</asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator runat="server" ValidationGroup="val1" ID="RequiredFieldValidator2"
                                                Text="*" ControlToValidate="txtpersonname" ErrorMessage="Please enter your name!"
                                                Style="color: Red" />
                                            <asp:TextBox CssClass="form-control" ID="txtpersonname" MaxLength="50" AutoPostBack="true"
                                                runat="server"></asp:TextBox>
                                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server"
                                                FilterType="LowercaseLetters, UppercaseLetters,Numbers,Custom" ValidChars=" ."
                                                TargetControlID="txtpersonname" />
                                        </div>
                                        <label>
                                            Mobile No</label>
                                ...
                                <asp:RegularExpressionValidator runat="server" ID="RegularExpressionValidator1" ValidationGroup="val1"
                                    ...
                                    Style="color: Red" />--%>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlHeading" runat="server" class="form-control">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="form-group">
                                            <label>
                                        ...
                                        <div class="form-group" id="divIsActive" runat="server">
                                            <label>
                                                Is Active</label>
                                    ...
                                    Contact Type</asp:Label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group" runat="server" visible="false">
                                                <label>
                                                    Choose Type</label>
                                                <asp:DropDownList ID="ddlCDType" runat="server" class="form-control">
                                                    <asp:ListItem Text="Credit" Value="Credit Note"></asp:ListItem>
                                                    <asp:ListItem Text="Debit" Value="Debit Note"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div id="divTionNo" class="form-group" runat="server" runat="server" visible="false">
                                            <label>
                                                Tin No</label>
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtstc" runat="server" CssClass="form-control">0</asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtprint" runat="server" CssClass="form-control">0</asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtemb" runat="server" CssClass="form-control">0</asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtiron" runat="server" CssClass="form-control">0</asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:GridView ID="gridprocesstype" OnRowDeleting="GridView2_RowDeleting" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Stc." ControlStyle-Width="100%" ItemStyle-Width="3%"
                                                        HeaderStyle-Width="2%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblstcid" Visible="false" Text='<%# Eval("stc")%>' runat="server"></asp:Label>
                                                            <asp:TextBox ID="lblstcrate" Text='<%# Eval("stcrate")%>' runat="server"></asp:TextBox>
                                                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender454" runat="server"
                                                                FilterType="Numbers,Custom" ValidChars="." TargetControlID="lblstcrate" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Emb." ControlStyle-Width="100%" ItemStyle-Width="3%"
                                                        HeaderStyle-Width="2%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblEmbid" Visible="false" Text='<%# Eval("Emb")%>' runat="server"></asp:Label>
                                                            <asp:TextBox ID="lblEmbrate" Text='<%# Eval("Embrate")%>' runat="server"></asp:TextBox>
                                                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender451" runat="server"
                                                                FilterType="Numbers,Custom" ValidChars="." TargetControlID="lblEmbrate" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Print." ControlStyle-Width="100%" ItemStyle-Width="3%"
                                                        HeaderStyle-Width="2%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblPrintid" Visible="false" Text='<%# Eval("Print")%>' runat="server"></asp:Label>
                                                            <asp:TextBox ID="lblPrintrate" Text='<%# Eval("Printrate")%>' runat="server"></asp:TextBox>
                                                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender452" runat="server"
                                                                FilterType="Numbers,Custom" ValidChars="." TargetControlID="lblPrintrate" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Iron." ControlStyle-Width="100%" ItemStyle-Width="3%"
                                                        HeaderStyle-Width="2%">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblIronid" Visible="false" Text='<%# Eval("Iron")%>' runat="server"></asp:Label>
                                                            <asp:TextBox ID="lblIronrate" Text='<%# Eval("Ironrate")%>' runat="server"></asp:TextBox>
                                                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender453" runat="server"
                                                                FilterType="Numbers,Custom" ValidChars="." TargetControlID="lblIronrate" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="col-lg-4">
                                        <asp:Button ID="Button3" Text="Add" runat="server" class="btn btn-info" OnClick="processbankclick_click" />
                                    </div>
                                    <div class="col-lg-8">
                                        <label>
                                            Bank Details:</label>
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <label>
                                                        Bank Description</label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:TextBox ID="txtbankname" runat="server" CssClass="form-control">0</asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtbankaccno" runat="server" CssClass="form-control">0</asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="txtbankdesc" runat="server" TextMode="MultiLine" CssClass="form-control">0</asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:GridView ID="gridbank" OnRowDeleting="gridbank_RowDeleting" runat="server" CssClass="chzn-container"
                                        GridLines="Both" AutoGenerateColumns="false">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Bank Name" ControlStyle-Width="100%" ItemStyle-Width="3%"
                                                HeaderStyle-Width="2%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblbankname" Text='<%# Eval("bankname")%>' runat="server"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Bank Acc.no" ControlStyle-Width="100%" ItemStyle-Width="3%"
                                                HeaderStyle-Width="2%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblbankaccno" Text='<%# Eval("bankaccno")%>' runat="server"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Bank Description" ControlStyle-Width="100%" ItemStyle-Width="3%"
                                                HeaderStyle-Width="2%">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblbankdes" Text='<%# Eval("bankdes")%>' runat="server"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:CommandField HeaderStyle-Width="2%" ShowDeleteButton="True" ButtonType="Button" />
                                        </Columns>
