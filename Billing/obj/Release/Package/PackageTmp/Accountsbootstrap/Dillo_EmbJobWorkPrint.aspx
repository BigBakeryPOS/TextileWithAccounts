<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dillo_EmbJobWorkPrint.aspx.cs" Inherits="Billing.Accountsbootstrap.Dillo_EmbJobWorkPrint" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Embroiding Job Print</title>
                        ...
                        <td style="border-bottom: 1px solid black" colspan="3" width="595px">
                            <asp:GridView runat="server" BorderWidth="1" ID="gridprint" CssClass="left" GridLines="Vertical"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Total Qantity" DataField="TotalQty" DataFormatString="{0:0}" ItemStyle-Height="60" />
