<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dillo_Designation.aspx.cs"
    Inherits="Billing.Accountsbootstrap.Dillo_Designation" %>
...
<head>
    ...
    <title>Affordable Exports || Designation</title>
                ...
                <div class="col-lg-7">
                    <div style="height: 392px; overflow: auto" class="table-responsive">
                        <table class="table table-bordered table-striped">
                            <tr>
                                <td>
                                    <asp:GridView ID="gv" runat="server" DataKeyNames="DesiginationId" OnSelectedIndexChanged="gv_selectedindex"
                                        OnRowCommand="edit" EmptyDataText="Oops! No Activity Performed." AllowPaging="true"
                                        PageSize="1000" OnPageIndexChanging="Page_Change" HeaderStyle-BackColor="#e0e0e0"
                                        Width="85%" AutoGenerateColumns="false" CssClass="myGridStyle1" AllowSorting="true">
                                        <HeaderStyle BackColor="#3366FF" />
                                        <EmptyDataRowStyle HorizontalAlign="Center" BackColor="#59d3b4" ForeColor="Black" />
                                        <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                                            NextPageText="Next" PreviousPageText="Previous" />
                                        <Columns>
                                            <asp:BoundField HeaderText="DesiginationId" DataField="DesiginationId" Visible="false" />
                                            <asp:BoundField HeaderText="Designation Name" DataField="DesiginationName" HeaderStyle-ForeColor="White" />
                                            <asp:BoundField HeaderText="Check Followed By" DataField="Chkfollowedby" HeaderStyle-ForeColor="White" />
                                            
                                            <%--<asp:BoundField HeaderText="IsActive" DataField="IsActive"  SortExpression="IsActive" HeaderStyle-ForeColor="Black"   />--%>
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Edit">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" CommandArgument='<%#Eval("DesiginationId") %>' CommandName="EditRow"
                                                        runat="server">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("DesiginationId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" Visible="false" HeaderText="Delete">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndel" CommandArgument='<%#Eval("DesiginationId") %>' CommandName="Del"
                                                        runat="server">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-briefcase"></i>Add Designation
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="list-group">
                                ...
                                <asp:TextBox placeholder="Enter Designation" ID="txtdep" runat="server" CssClass="form-control"></asp:TextBox>
...
ValidChars=" /,.\-#"  TargetControlID="txtaddress" />
 <asp:RequiredFieldValidator runat="server" ValidationGroup="val1" ID="RequiredFieldValidator111"
                                ...
                                <div class="form-group">
                                    <label>
                                        Check For Followed By Approval List</label>
                                    <asp:CheckBox ID="chkfollowedbyapprovallist" runat="server" />
                                </div>
                            </div>
                            <!-- /.list-group -->
                            <div>
