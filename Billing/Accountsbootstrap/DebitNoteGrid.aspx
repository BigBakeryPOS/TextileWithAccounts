<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DebitNoteGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.DebitNoteGrid"%>
                 ...
                 <%--  <div class="form-group">--%>
                              ...
                              <div>
                                 ...
                                 Style="color: White" InitialValue="0" ControlToValidate="ddlfilter" ValueToCompare="0"   Text="." 
                                    ...
                                    <div class="col-lg-2">
                                     <asp:TextBox CssClass="form-control"  Enabled="true" ID="txtsearch1" runat="server" placeholder="Search Text"  style="width:170px;margin-top: -12px;margin-left:-670px;" onkeyup="Search_Gridview(this, 'CreditDebitGrid')" ></asp:TextBox></div>
                                    ...
                                    TargetControlID="txtsearch" />
                                       ...
                                       <div class="col-lg-2">
                                        <asp:Button ID="btnsearch" runat="server" class="btn btn-success" Text="Search" Visible="false"   ValidationGroup="val1"
                                             
                                              onclick="btnsearch_Click" /> </div>
                                        <div class="col-lg-2">
                                        <asp:Button ID="btnrefresh" runat="server" class="btn btn-primary" Text="Reset"  
                                              style="width:120px;margin-top: -50px;margin-left: 200px;" 
                                              onclick="btnrefresh_Click"   /> </div>
                                              <div class="col-lg-2">
                                        <asp:Button ID="btnadd" runat="server" class="btn btn-danger" Text="Add New"  
                                              style="width:120px;margin-top: -50px;margin-left: 500px;" 
                        ...
                        <div class="panel-body">
                            ...
                            <tr>
                              ...
                              <div style="overflow:auto; height:300px">
                                <asp:GridView ID="CreditDebitGrid"  runat="server" CssClass="myGridStyle1" AllowPaging="true" 
                                        PageSize="10"  OnPageIndexChanging="CreditDebitGrid_PageIndexChanging" EmptyDataText="No records Found" 
                                        AutoGenerateColumns="false" onrowcommand="CreditDebitGrid_RowCommand"  ShowHeader="false"
