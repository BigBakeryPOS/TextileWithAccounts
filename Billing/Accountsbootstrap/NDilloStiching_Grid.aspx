<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NDilloStiching_Grid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.NDilloStiching_Grid" %>
                                    ...
                                    <asp:GridView ID="gvcustinfo" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("NewLotProcessId") %>'
                                                        CommandName="edit">
                                                    ...
                                                    <asp:HiddenField ID="csinfoID" runat="server" Value='<%# Bind("NewLotProcessId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Received" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnrec" runat="server" CommandArgument='<%#Eval("NewLotProcessId") %>'
                                                    ...
                                                    <asp:ImageButton ID="imgdisablerec" ImageUrl="~/images/edit.png" runat="server" Visible="false"
                                                        Enabled="false" ToolTip="Not Allow To Delete" />
                                                    <asp:HiddenField ID="csinfoIDrec" runat="server" Value='<%# Bind("NewLotProcessId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("NewLotProcessId") %>'
                                            ...
                                            <asp:TemplateField HeaderText="Copy" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btncopy" runat="server" CommandArgument='<%#Eval("NewLotProcessId") %>'
                                                        CommandName="copy">
                                                        <asp:Image ID="imgcpy" runat="server" Style="height: 23px; width: 18px" ImageUrl="~/images/copy.png" /></asp:LinkButton>
                                                    <asp:HiddenField ID="csinfocopyID" runat="server" Value='<%# Bind("NewLotProcessId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
