...
{
    public partial class CuttingInfoGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objBs.SelectCuttingInfoDet();
                if (ds != null)
                {
        ...
        protected void gvcustinfo_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                ...
                {
                    Response.Redirect("StitchingDetails.aspx?CuttingInformationID=" + e.CommandArgument.ToString());
                }
            }
            ...
            {
                Response.Redirect("CuttingInfoGrid.aspx?CuttingInformationID=" + e.CommandArgument.ToString() + "&Name=" + e.CommandName);
        ...
        {
            Response.Redirect("StitchingDetails.aspx");
        }
    }
}