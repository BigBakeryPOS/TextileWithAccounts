...
{
    public partial class Dillo_Embrodarygrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objBs.SelectEmbrodingGrid(drpsts.SelectedValue);
                if (ds != null)
                {
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("Dillo_Embroidering.aspx?lotid=" + e.CommandArgument.ToString());
            }
            else if (e.CommandName == "Edit")
            {
                Response.Redirect("Dillo_EmbJobwork.aspx?lotid=" + e.CommandArgument.ToString());
            }
        }
