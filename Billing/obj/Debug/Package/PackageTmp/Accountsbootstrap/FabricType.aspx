<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FabricType.aspx.cs" Inherits="Billing.Accountsbootstrap.FabricType" %>
    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <asp:Button ID="Button2" runat="server" class="btn btn-success" Text="Bulk Addition"
                Style="width: 120px; margin-top: -34px; margin-left: 430px;" Height="32px" OnClick="btnFormat_Click" Visible="false"/>
        </div>
        <div class="col-lg-2">
                         ...
                         Delete
                                    ...
                                    <div id="Div1" runat="server" style="height: 520px; overflow: scroll;" align="center">
                                        <asp:GridView ID="gridview" runat="server" Width="100%" EmptyDataText="No Records Found"
                                            OnPageIndexChanging="Page_Change" DataKeyNames="FabricTypeID" AutoGenerateColumns="false"
                                            ...
                                            <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                                                NextPageText="Next" PreviousPageText="Previous" />   <Columns>
                                                <asp:BoundField Visible="false" DataField="FabricTypeID" />
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Edit" ItemStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnedit" CommandArgument='<%#Eval("FabricTypeID") %>' CommandName="Select"
                                                            runat="server">
                                                            <asp:Image ID="imdedit" ImageUrl="~/images/pen-checkbox-128.png" runat="server" />
                                                        </asp:LinkButton>
                                                        <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("FabricTypeID") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Delete" ItemStyle-Width="10%" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btndel" CommandArgument='<%#Eval("FabricTypeID") %>' CommandName="Del"
                                                            runat="server">
        ...
        <div class="col-lg-4" style="margin-left: -14px">
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color: #59d3b4; color: #333333; border-color: #06090c">
                    ...
                    <asp:Label ID="lblName" Text="Add FabricType" runat="server"></asp:Label>
                </div>
                <div class="panel-body">
                    <div class="list-group">
                        ...
                        <div class="form-group">
                            <asp:TextBox CssClass="form-control" ID="txtFabricTypeId" runat="server" Visible="false"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label>
                                FabricType</label>
                            <asp:RequiredFieldValidator runat="server" ID="txtcat" ControlToValidate="txtFabricType"
                                ValidationGroup="val2" Text="*" ErrorMessage="Please enter your FabricType!"
                                Style="color: Red" />
                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server"
                                FilterType="LowercaseLetters, UppercaseLetters,Numbers,Custom" ValidChars=" "
                                TargetControlID="txtFabricType" />
                            <asp:TextBox CssClass="form-control" ID="txtFabricType" Style="text-transform: capitalize;"
                                runat="server" placeholder="To Add New FabricType"></asp:TextBox>
