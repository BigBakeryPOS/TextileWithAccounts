<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitMaster.aspx.cs" Inherits="Billing.Accountsbootstrap.UnitMaster" %>
...
<head>
    ...
    <title>Flexible Apparels || Unit Master</title>
                ...
                <div class="col-lg-7">
                    <div style="height: 392px; overflow: auto" class="table-responsive">
                        <table class="table table-bordered table-striped">
                            <tr>
                                <td>
                                    <asp:GridView ID="gv" runat="server" DataKeyNames="UnitID" OnSelectedIndexChanged="gv_selectedindex"
                                        ...
                                        Width="100%" AutoGenerateColumns="false" CssClass="myGridStyle1" AllowSorting="true">
                                        <HeaderStyle BackColor="#3366FF" />
                                        <EmptyDataRowStyle HorizontalAlign="Center" BackColor="#59d3b4" ForeColor="Black" />
                                        <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                                            NextPageText="Next" PreviousPageText="Previous" />
                                        <Columns>
                                            <asp:BoundField HeaderText="UnitID" DataField="UnitID" Visible="false" />
                                            <asp:BoundField HeaderText="Unit Name" DataField="UnitName" SortExpression="Category"
                                                HeaderStyle-ForeColor="Black" />
                                            <asp:BoundField HeaderText="IsActive" DataField="IsActive" SortExpression="IsActive"
                                                HeaderStyle-ForeColor="Black" />
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Edit">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" CommandArgument='<%#Eval("UnitID") %>' CommandName="EditRow"
                                                        runat="server">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("UnitID") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" Visible="false" HeaderText="Delete">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndel" CommandArgument='<%#Eval("UnitID") %>' CommandName="Del"
                                                        runat="server">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-briefcase"></i>Add Unit
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="list-group">
                                ...
                                <label>
                                    Unit Name</label>
                                <asp:TextBox placeholder="Enter Unit" ID="txtUnitName" runat="server" CssClass="form-control"></asp:TextBox>
