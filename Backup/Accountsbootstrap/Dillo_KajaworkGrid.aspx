<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dillo_KajaworkGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.Dillo_KajaworkGrid" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12" align="center">
                            ...
                            <div class="col-lg-17">
                                <asp:Button ID="btnadd" runat="server" class="btn btn-danger" Text="Add New"  PostBackUrl="~/Accountsbootstrap/Dillo_Kajawork.aspx"
                                    Width="130px" />
                            </div>
                                    ...
                                    <asp:GridView ID="gvcust" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                      ...
                                      <%--  <asp:BoundField  DataField="Sno" HeaderText="S.No" />--%>
                                            <%--<asp:BoundField HeaderText="Customer ID" DataField="CustomerID" Visible="false" />--%>
                                             <asp:BoundField  DataField="kajaid" Visible="false" />
                                            ...
                                            <asp:TemplateField HeaderText="Print" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("kajaid") %>'
                                                        CommandName="Print">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("kajaid") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                                               <ItemTemplate>
                                                    <asp:LinkButton ID="btnupdate" runat="server" CommandArgument='<%#Eval("kajaid") %>'
                                                        CommandName="Edit">
                                                        <asp:Image ID="img1" runat="server" ImageUrl="~/images/pen-checkbox-128.png" /></asp:LinkButton>
                                                    <asp:ImageButton ID="img1disable" ImageUrl="~/images/edit.png" runat="server" Visible="false"
                                                        Enabled="false" ToolTip="Not Allow To Delete" />
                                                    <asp:HiddenField ID="ldg1ID" runat="server" Value='<%# Bind("kajaid") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("kajaid") %>'
