<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dillo_Embroidering.aspx.cs" Inherits="Billing.Accountsbootstrap.Dillo_Embroidering" %>
...
<body>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 id="head" runat="server" class="page-header" style="text-align: center; color: #fe0002">Embroidering Process
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
