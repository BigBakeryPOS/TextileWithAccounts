...
{
    public partial class KajaButton1 : System.Web.UI.Page
    {
        ...
        {
            string KajaButtonid = string.Empty;
            string Requests = string.Empty;
            KajaButtonid = Request.QueryString.Get("KajaButtonid");
            ...
            if (!IsPostBack)
            {
                ...
                //DataSet dsLotNo = objbs.Select_LotDetails("Kaja");
               ...
               //MultiUnit_SelectedIndex(sender, e);
                ...
                if (KajaButtonid != null)
                {
                    if (Requests == "Edit")
                    {

                        DataSet dgetcheck = objbs.getJpKajaButtonLot(KajaButtonid);
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            DataSet dsLot = objbs.Select_Lot("Kaja", drpbranch.SelectedValue);
                            ...
                            dlotprocess = objbs.Get_LotDetails(Convert.ToString(dgetcheck.Tables[0].Rows[0]["LotDetailID"]), "2", "Kaja");
                            ...
                            btnadd.Visible = true;
                            btnadd.Text = "Update";
                            txtid.Text = dgetcheck.Tables[0].Rows[0]["KajaButtonid"].ToString();
                            txtmultiid.Text = dgetcheck.Tables[0].Rows[0]["KajaButtonid"].ToString();
                            txtmultiplecode.Text = dgetcheck.Tables[0].Rows[0]["KajaButtonid"].ToString();
                            ...
                            DataSet ds = objbs.Get_JpKajaButton(Convert.ToString(KajaButtonid), "2", "Kaja");
                    ...
                    else if (Requests == "partial")
                    {
                        ...
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            ...
                            txtAmount.Text = dgetcheck.Tables[0].Rows[0]["TotalAmount"].ToString();
                            txtAmount.Enabled = false;
                            DataSet ds = objbs.Get_LotDetails(Convert.ToString(dgetcheck.Tables[0].Rows[0]["LotDetailID"]), "2", "Kaja");
                                //= objbs.Get_JpKajaButton(Convert.ToString(KajaButtonid), "2", "Kaja");
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                DataSet temp = new DataSet();
                                DataTable dtt = new DataTable();
                        ...
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                           ...
                           DataSet ds = objbs.Get_JpKajaButton(Convert.ToString(KajaButtonid), "2", "Kaja");
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                dsstichinglot = objbs.Get_dskajalotcolor(Convert.ToInt32(KajaButtonid));
                                ...
                                gvnewkaja.DataSource = dssstichinglot;
                                gvnewkaja.DataBind();

                                for (int i = 0; i < gvnewkaja.Rows.Count; i++)
                                {
                                    Label lblStockRatioId = (Label)gvnewkaja.Rows[i].FindControl("lblStockRatioId");
                                    Label lblMasterid = (Label)gvnewkaja.Rows[i].FindControl("lblMasterid");
                                    Label lblTransfabid = (Label)gvnewkaja.Rows[i].FindControl("lblTransfabid");

                                    Label lbldesignno = (Label)gvnewkaja.Rows[i].FindControl("lbldesignno");
                                    TextBox txts30fs = (TextBox)gvnewkaja.Rows[i].FindControl("txts30fs");
                                    TextBox txts32fs = (TextBox)gvnewkaja.Rows[i].FindControl("txts32fs");
                                    TextBox txts34fs = (TextBox)gvnewkaja.Rows[i].FindControl("txts34fs");
                                    TextBox txts36fs = (TextBox)gvnewkaja.Rows[i].FindControl("txts36fs");
                                    TextBox txtsxsfs = (TextBox)gvnewkaja.Rows[i].FindControl("txtsxsfs");
                                    TextBox txtssfs = (TextBox)gvnewkaja.Rows[i].FindControl("txtssfs");
                                    TextBox txtsmfs = (TextBox)gvnewkaja.Rows[i].FindControl("txtsmfs");
                                    TextBox txtslfs = (TextBox)gvnewkaja.Rows[i].FindControl("txtslfs");
                                    TextBox txtsxlfs = (TextBox)gvnewkaja.Rows[i].FindControl("txtsxlfs");
                                    TextBox txtsxxlfs = (TextBox)gvnewkaja.Rows[i].FindControl("txtsxxlfs");
                                    TextBox txts3xlfs = (TextBox)gvnewkaja.Rows[i].FindControl("txts3xlfs");
                                    TextBox txts4xlfs = (TextBox)gvnewkaja.Rows[i].FindControl("txts4xlfs");

                                    TextBox txts30hs = (TextBox)gvnewkaja.Rows[i].FindControl("txts30hs");
                                    TextBox txts32hs = (TextBox)gvnewkaja.Rows[i].FindControl("txts32hs");
                                    TextBox txts34hs = (TextBox)gvnewkaja.Rows[i].FindControl("txts34hs");
                                    TextBox txts36hs = (TextBox)gvnewkaja.Rows[i].FindControl("txts36hs");
                                    TextBox txtsxshs = (TextBox)gvnewkaja.Rows[i].FindControl("txtsxshs");
                                    TextBox txtsshs = (TextBox)gvnewkaja.Rows[i].FindControl("txtsshs");
                                    TextBox txtsmhs = (TextBox)gvnewkaja.Rows[i].FindControl("txtsmhs");
                                    TextBox txtslhs = (TextBox)gvnewkaja.Rows[i].FindControl("txtslhs");
                                    TextBox txtsxlhs = (TextBox)gvnewkaja.Rows[i].FindControl("txtsxlhs");
                                    TextBox txtsxxlhs = (TextBox)gvnewkaja.Rows[i].FindControl("txtsxxlhs");
                                    TextBox txts3xlhs = (TextBox)gvnewkaja.Rows[i].FindControl("txts3xlhs");
                                    TextBox txts4xlhs = (TextBox)gvnewkaja.Rows[i].FindControl("txts4xlhs");

                                    TextBox txtsendFQty = (TextBox)gvnewkaja.Rows[i].FindControl("txtsendFQty");
                                    ...
                                    TextBox txts30fsac = (TextBox)gvnewkaja.Rows[i].FindControl("txts30fsac");
                                    TextBox txts32fsac = (TextBox)gvnewkaja.Rows[i].FindControl("txts32fsac");
                                    TextBox txts34fsac = (TextBox)gvnewkaja.Rows[i].FindControl("txts34fsac");
                                    TextBox txts36fsac = (TextBox)gvnewkaja.Rows[i].FindControl("txts36fsac");
                                    TextBox txtsxsfsac = (TextBox)gvnewkaja.Rows[i].FindControl("txtsxsfsac");
                                    TextBox txtssfsac = (TextBox)gvnewkaja.Rows[i].FindControl("txtssfsac");
                                    TextBox txtsmfsac = (TextBox)gvnewkaja.Rows[i].FindControl("txtsmfsac");
                                    TextBox txtslfsac = (TextBox)gvnewkaja.Rows[i].FindControl("txtslfsac");
                                    TextBox txtsxlfsac = (TextBox)gvnewkaja.Rows[i].FindControl("txtsxlfsac");
                                    TextBox txtsxxlfsac = (TextBox)gvnewkaja.Rows[i].FindControl("txtsxxlfsac");
                                    TextBox txts3xlfsac = (TextBox)gvnewkaja.Rows[i].FindControl("txts3xlfsac");
                                    TextBox txts4xlfsac = (TextBox)gvnewkaja.Rows[i].FindControl("txts4xlfsac");

                                    TextBox txts30hsac = (TextBox)gvnewkaja.Rows[i].FindControl("txts30hsac");
                                    TextBox txts32hsac = (TextBox)gvnewkaja.Rows[i].FindControl("txts32hsac");
                                    TextBox txts34hsac = (TextBox)gvnewkaja.Rows[i].FindControl("txts34hsac");
                                    TextBox txts36hsac = (TextBox)gvnewkaja.Rows[i].FindControl("txts36hsac");
                                    TextBox txtsxshsac = (TextBox)gvnewkaja.Rows[i].FindControl("txtsxshsac");
                                    TextBox txtsshsac = (TextBox)gvnewkaja.Rows[i].FindControl("txtsshsac");
                                    TextBox txtsmhsac = (TextBox)gvnewkaja.Rows[i].FindControl("txtsmhsac");
                                    TextBox txtslhsac = (TextBox)gvnewkaja.Rows[i].FindControl("txtslhsac");
                                    TextBox txtsxlhsac = (TextBox)gvnewkaja.Rows[i].FindControl("txtsxlhsac");
                                    TextBox txtsxxlhsac = (TextBox)gvnewkaja.Rows[i].FindControl("txtsxxlhsac");
                                    TextBox txts3xlhsac = (TextBox)gvnewkaja.Rows[i].FindControl("txts3xlhsac");
                                    TextBox txts4xlhsac = (TextBox)gvnewkaja.Rows[i].FindControl("txts4xlhsac");

                                    TextBox txtsendFQtyac = (TextBox)gvnewkaja.Rows[i].FindControl("txtsendFQtyac");
        ...
        protected void company_SelectedIndexChnaged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSet dsLotNo = objbs.Select_LotDetails("Kaja", drpbranch.SelectedValue);
                if (dsLotNo.Tables[0].Rows.Count > 0)
                {
                    DataSet dsLotNoval = objbs.Select_LotDetailsnew("Kaja", drpbranch.SelectedValue, 1);
        ...
        protected void StitchingInfo_Load(object sender, EventArgs e)
        {
            ...
            if (ddlLotNo.SelectedValue != "Select Lot No")
            {
                int dcheck = objbs.checkcurrent(ddlLotNo.SelectedValue, "Kaja");
                if (dcheck == 1)
                {
                    #region
                    double kajarate = 0;

                    DataSet rateforprecost = objbs.getrateforprecost(Convert.ToString(ddlLotNo.SelectedItem.Text), "KAJA BUTTON");
                    if (rateforprecost.Tables[0].Rows.Count > 0)
                    {
                        kajarate = Convert.ToDouble(rateforprecost.Tables[0].Rows[0]["Cost"].ToString());
                    }
                    else
                    {
                    ...
                    DataSet dlotprocess = new DataSet();
                    dlotprocess = objbs.Get_LotDetails(Convert.ToString(ddlLotNo.SelectedValue), "2", "Kaja");
                    txttotalqty.Text = dlotprocess.Tables[0].Rows[0]["TotalQuantity"].ToString();
                    ...
                    if (dlotprocess.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < gvcustomerorder.Rows.Count; i++)
                        {
                            ...
                            lblfitid.Text = temp.Tables[0].Rows[i]["fitid"].ToString();
                            //txtrate.Text = temp.Tables[0].Rows[i]["rate"].ToString();
                            txtrate.Text = kajarate.ToString();
                            drpProcess.SelectedValue = temp.Tables[0].Rows[i]["ProcessTypeID"].ToString();
                            lblPattern.Text = temp.Tables[0].Rows[i]["Pattern"].ToString();
                            lblPatternid.Text = temp.Tables[0].Rows[i]["Patternid"].ToString();
                            txtdamageqty.Text = temp.Tables[0].Rows[i]["damageqty"].ToString();
                    ...
                    dsstichinglot = objbs.Get_dsKajalot(Convert.ToInt32(ddlLotNo.SelectedValue), KAJABUTTON);
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Not Ready To Kaja Button Process.Thank You!!!')", true);
                    return;
                }
            }
            //DataSet dataSet = objbs.getLotNoTransDetails(Convert.ToInt32(ddlLotNo.SelectedValue));
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            drpProcess = objbs.SelectAllProcessTypeLotProcess("2");
        ...
        protected void Add_LotProcessDetails(object sender, EventArgs e)
        {
            ...
            if (btnadd.Text == "Save")
            {
                ...
                int istatus3 = objbs.insertJpKajaButton(Convert.ToDouble(txtAmount.Text), Convert.ToInt32(ddlLotNo.SelectedValue), lbllotno.Text, MultiDate, Convert.ToInt32(drpMultiemployee.SelectedValue), Convert.ToDouble(txttotalqty.Text), empid, drpbranch.SelectedValue, ddlLotNo.SelectedItem.Text, Convert.ToInt32(txtsendFQtymain.Text),txtnarration.Text);



                for (int vLoop = 0; vLoop < gvnewkaja.Rows.Count; vLoop++)
                {
                    int vLoopp = 0;
                    ...
                    #region
                    Label lblitemname = (Label)gvnewkaja.Rows[vLoop].FindControl("lbldesignno");

                    TextBox txts30fs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txts30fs");
                    TextBox txts32fs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txts32fs");
                    TextBox txts34fs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txts34fs");
                    TextBox txts36fs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txts36fs");
                    TextBox txtsxsfs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txtsxsfs");
                    TextBox txtssfs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txtssfs");
                    TextBox txtsmfs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txtsmfs");
                    TextBox txtslfs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txtslfs");
                    TextBox txtsxlfs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txtsxlfs");
                    TextBox txtsxxlfs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txtsxxlfs");
                    TextBox txts3xlfs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txts3xlfs");
                    TextBox txts4xlfs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txts4xlfs");

                    TextBox txts30hs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txts30hs");
                    TextBox txts32hs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txts32hs");
                    TextBox txts34hs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txts34hs");
                    TextBox txts36hs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txts36hs");
                    TextBox txtsxshs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txtsxshs");
                    TextBox txtsshs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txtsshs");
                    TextBox txtsmhs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txtsmhs");
                    TextBox txtslhs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txtslhs");
                    TextBox txtsxlhs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txtsxlhs");
                    TextBox txtsxxlhs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txtsxxlhs");
                    TextBox txts3xlhs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txts3xlhs");
                    TextBox txts4xlhs = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txts4xlhs");

                    Label lblStockRatioId = (Label)gvnewkaja.Rows[vLoop].FindControl("lblStockRatioId");
                    Label lblMasterid = (Label)gvnewkaja.Rows[vLoop].FindControl("lblMasterid");
                    Label lblTransfabid = (Label)gvnewkaja.Rows[vLoop].FindControl("lblTransfabid");

                    TextBox txtsendFQtycolor = (TextBox)gvnewkaja.Rows[vLoop].FindControl("txtsendFQty");
                    ...
                    else
                    {
                        ...
                        {
                            int istasHistory = objbs.inserttransjpKajaButtonHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            int istas = objbs.inserttransJpKajaButton(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            if (vLoop == 0)
                            {
                                int istas1 = objbs.JpKajaButton(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                ...
                int istatus3l = objbs.statusJpKajaButton(Convert.ToInt32(ddlLotNo.SelectedValue));
            ...
            else if (btnadd.Text == "Partial")
            {
                ...
                string KajaButtonid = Request.QueryString.Get("KajaButtonid");
                DateTime MultiDate = DateTime.ParseExact(txtmultidate.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture);

                int istatus3 = objbs.UpdJpKajaButton(Convert.ToDouble(txtAmount.Text), Convert.ToInt32(ddlLotNo.SelectedValue), lbllotno.Text, MultiDate, Convert.ToInt32(drpMultiemployee.SelectedValue), Convert.ToDouble(txttotalqty.Text), KajaButtonid, empid);
                    ...
                    else
                    {
                      //  int istasHistory = objbs.inserttransjpKajaButtonHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                       //           recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), "0", empid, Convert.ToInt32(txtsendFQty.Text));
                        ...
                        int istas = objbs.inserttransJpKajaButtonpartial(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                  recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Convert.ToInt32(ddlLotNo.SelectedValue), empid, Convert.ToInt32(txtsendFQty.Text), KajaButtonid);
            ...
            else if (btnadd.Text == "Update")
            {
                ...
                for (int vLoop = 0; vLoop < gvcustomerorder.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        ...
                        int istas = objbs.updatetransJpKajaButton(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text),date11,
                                  recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtsendFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Convert.ToInt32(ddlLotNo.SelectedValue), KajaButtonid);
            ...
            else if (btnadd.Text == "Received")
            {
                ...
                if (ddltype.SelectedValue == "Damage")
                {
                    int istasHistory = objbs.processmaintablekaja(Convert.ToInt32(KajaButtonid), Convert.ToInt32(txtdamageqtymain.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }
                else
                {
                    int istasHistory = objbs.processmaintablekaja(Convert.ToInt32(KajaButtonid), Convert.ToInt32(txtrecFQty.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }
                for (int vLoop = 0; vLoop < gvnewkaja.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        ...
                        if (txtsendFQtycolor.Text != "0")
                        {
                            int istasHistory = objbs.inserttransjpkajaHistory1new(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), recdate,
                                      recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), KajaButtonid, empid, Convert.ToInt32(txtsendFQty.Text), Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), ddltype.SelectedItem.Text);

                            if (vLoop == 0)
                            {
                                //int istasHistory = objbs.inserttransjpKajaButtonHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                //          recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), KajaButtonid, empid, Convert.ToInt32(txtsendFQty.Text));

                                int istas = objbs.JpKajaButtonREC(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            if (ddltype.SelectedValue == "Damage")
                            {
                                int rec = objbs.DamageProcessStockRatiokaja(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text), KAJABUTTON);
                            }
                            else
                            {
                                int rec = objbs.updateProcessStockRatiokaja(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text));
        ...
        protected void gvnewkaja_RowDataBound(object sender, GridViewRowEventArgs e)
        {
