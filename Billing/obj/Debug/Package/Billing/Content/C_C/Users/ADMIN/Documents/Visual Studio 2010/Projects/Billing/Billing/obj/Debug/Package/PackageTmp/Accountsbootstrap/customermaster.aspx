<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customermaster.aspx.cs" Inherits="Billing.Accountsbootstrap.AccPage" %>
...
--%>
                                ...
                                <div class="col-lg-6">
                                       ...
                                       <asp:RegularExpressionValidator runat="server" id="RegularExpressionValidator1" controltovalidate="txtpincode" validationexpression="^[0-9]{6}$" errormessage="Please enter a 6 digit pin code!" style="color:Red"/>
										...
										<asp:Button ID="btnadd" runat="server" class="btn btn-success" Text="Save" OnClick="Add_Click" ValidationGroup="val1"/>
