<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Washing.aspx.cs" Inherits="Billing.Accountsbootstrap.Washing" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            var grid = document.getElementById('gvnewwash');
                               ...
                               <ajaxToolkit:ModalPopupExtender ID="mpe1" runat="server" PopupControlID="plpop"
                                ...
                                <div class="row">
                                    ...
                                    <ContentTemplate>--%>
                                        ...
                                        <asp:GridView ID="gvnewwash" AutoGenerateColumns="False" ShowFooter="True" CssClass="chzn-container"
                                            Width="100%" runat="server" OnRowDataBound="gvnewwash_RowDataBound">
                                            <HeaderStyle BackColor="#59d3b4" />
                                            <EmptyDataRowStyle HorizontalAlign="Center" BackColor="#59d3b4" ForeColor="Black" />
                                            <Columns>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="col-lg-4">
                                                <div id="but" runat="server" class="row">
                                                    ...
                                                    <asp:Button ID="btnexit" runat="server" class="btn btn-warning" Text="Exit" PostBackUrl="WashingGrid.aspx"
