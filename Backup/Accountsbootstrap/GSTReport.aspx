<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GSTReport.aspx.cs" Inherits="Billing.Accountsbootstrap.GSTReport" %>
                                        ...
                                        <div class="col-lg-12">
                                            <div align="center">
                                                <asp:GridView runat="server" Width="100%" ID="gvCash" GridLines="Both" ShowFooter="true"
                                                    ...
                                                    OnRowCommand="gvCash_RowCommand">
                                                    <Columns>
                                                        <asp:BoundField DataField="id" HeaderText="id" ItemStyle-HorizontalAlign="Center"
                                                            Visible="false" />
                                                        <asp:BoundField DataField="name" HeaderText="Type" ItemStyle-HorizontalAlign="Center" />
                                                        ...
                                                        <asp:BoundField DataField="RoundOff" HeaderStyle-HorizontalAlign="Right" HeaderText="RoundOff"
                                                            DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right" />
                                                        <asp:BoundField DataField="Debit" HeaderStyle-HorizontalAlign="Right" HeaderText="Debit"
                                                            DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right" />
                                                        <asp:BoundField DataField="Credit" HeaderStyle-HorizontalAlign="Right" HeaderText="Credit"
                                                            DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right" />
                                                        <asp:TemplateField ItemStyle-Width="2%" HeaderText="Print" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnprint" runat="server" CommandArgument='<%#Eval("name") + "," + Eval("ID")  %>'
                                                                    CommandName="print">
