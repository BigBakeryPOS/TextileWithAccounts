<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updatecategory.aspx.cs" Inherits="Billing.Accountsbootstrap.updatecategory" %>
...
<usc:Header ID="Header" runat="server" />
                                ...
                                <div class="col-lg-6">
                                    <form id="Form1" runat="server" method="post">
                                        <div class="form-group">
                                           ...
                                           <asp:DropDownList runat="server" Enabled="false" ID="ddlcategory" CssClass="form-control">
    ...
    <asp:ListItem Text="Blouse" Value="7" ></asp:ListItem>
                                        ...
                                        <asp:Button ID="btnupdate" runat="server" class="btn  btn-danger" Text="Update" 
                                            onclick="btnupdate_Click" />
                                            <asp:Button ID="btnadd" runat="server" class="btn btn-success" Text="Exit" 
