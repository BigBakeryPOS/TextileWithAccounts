...
{
    public partial class LotRawGrid : System.Web.UI.Page
    {
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("../Accountsbootstrap/LotRaw.aspx");
        ...
        protected void refresh_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("../Accountsbootstrap/LotRawGrid.aspx");
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                ...
                {
                    Response.Redirect("LotRaw.aspx?RawID=" + e.CommandArgument.ToString());
                }
            }

            else if (e.CommandName == "delete")
            {
                int iSucess = objBs.deleteLotRaw(Convert.ToInt32(e.CommandArgument.ToString()));
        ...
        protected void gvcust_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                string lotno = e.Row.Cells[1].Text;


                if (objBs.CeckIflotcompletedornot(lotno))
                {
