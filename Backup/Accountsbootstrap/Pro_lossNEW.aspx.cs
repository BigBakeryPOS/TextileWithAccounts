...
{
    public partial class Pro_lossNEW : System.Web.UI.Page
    {
                ...
                for (int i = 0; i < 6; i++)
                {
                    ...
                    if (debitTotal > creditTotal)
                    {
                        if (i == 1)
                        {
                            ...
                            tablecell.Text = Convert.ToDouble(doub).ToString("f2");// Convert.ToString(doub);
                            tablecell.ForeColor = System.Drawing.Color.Red;
                ...
                for (int i = 0; i < 6; i++)
                {
                    ...
                    //  if (debitTotal > creditTotal)
                    {
                        if (i == 1)
                        {
                            ...
                            tablecell.Text = Convert.ToDouble(tot).ToString("f2"); //Convert.ToString(tot);
                            tablecell.ForeColor = System.Drawing.Color.Red;
                            tablecell.HorizontalAlign = HorizontalAlign.Right;
                        }
                    }
                    //   else
                    {
                        if (i == 2)
                        {
                            ...
                            tablecell.Text = Convert.ToDouble(tot1).ToString("f2"); //Convert.ToString(tot); Convert.ToString(tot1);
                            tablecell.ForeColor = System.Drawing.Color.Red;
                            tablecell.HorizontalAlign = HorizontalAlign.Right;
                        }
        ...
        public void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[0].Text = "Total";
                e.Row.Cells[1].Text = purchasetotal.ToString("f2");
        ...
        public void GridView3_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[0].Text = "Total";
                e.Row.Cells[1].Text = salesdeb.ToString("f2");
        ...
        public void PL()
        {
            ...
            lblDXTotal.Text = (DExpensesTot).ToString("f2");
            gvIDirectExp.DataSource = objBs.plGetExpenseIncomeSplit("IDX", ddloutlet.SelectedValue);
            gvIDirectExp.DataBind();

            gvDirectExp.DataSource = objBs.plGetExpenseIncomeSplit("DX", ddloutlet.SelectedValue);
            gvDirectExp.DataBind();

            gvDirectInc.DataSource = objBs.plGetExpenseIncomeSplit(" ", ddloutlet.SelectedValue);
            gvDirectInc.DataBind();

            gvIDirectInc.DataSource = objBs.plGetExpenseIncomeSplit("IDI", ddloutlet.SelectedValue);
            gvIDirectInc.DataBind();

            lblIDXExptotal.Text = IDExpensesTot.ToString("f2");

            //lblDIncome.Text = (DIncomeTot - salesReturnTot).ToString("f2");
            lblDIncome.Text = (DIncomeTot).ToString("f2");
            ...
            //lblDbTot.Text = (gPurchase + DExpensesTot + dGp).ToString("f2");
            //lblCrTotal.Text = (gSales + (DIncomeTot - salesReturnTot) + (dGl)).ToString("f2");

            lblDbTot.Text = Convert.ToDouble(Convert.ToDouble(lblFirstMidTotal.Text) + Convert.ToDouble(lblDXTotal.Text) + Convert.ToDouble(lblGP.Text)).ToString("f2");
            lblCrTotal.Text = Convert.ToDouble(Convert.ToDouble(lblSecondMidTotal.Text) + Convert.ToDouble(lblDIncome.Text) + Convert.ToDouble(lblGL.Text)).ToString("f2");
            ...
            lblDbNetTotal.Text = Convert.ToDouble(Convert.ToDouble(lblGrossLossBF.Text) + Convert.ToDouble(lblIDXExptotal.Text) + Convert.ToDouble(lblNetProfit.Text)).ToString("f2");
            lblCrNetTotal.Text = Convert.ToDouble(Convert.ToDouble(lblGrossProfitBF.Text) + Convert.ToDouble(lblIDIncome.Text) + Convert.ToDouble(lblNetLoss.Text)).ToString("f2");
            DataSet ds = new DataSet();
