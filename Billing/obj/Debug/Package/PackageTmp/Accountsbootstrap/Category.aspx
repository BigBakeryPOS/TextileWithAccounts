<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="Billing.Accountsbootstrap.Category" %>
                                ...
                                <td>
                                    <div id="Div2" runat="server" style="height: 520px; overflow: scroll;" align="center">
                                        <asp:GridView ID="gridview" runat="server" Width="100%" EmptyDataText="No Records Found"
                                            DataKeyNames="CategoryId" AutoGenerateColumns="false" CssClass="myGridStyle1"
        ...
        <div class="col-lg-4" style="margin-left: -14px">
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color: #336699; color: White;">
                    ...
                    <asp:Label ID="lblName" Text="Add Category" runat="server"></asp:Label>
                </div>
                <div class="panel-body">
                    <div class="list-group">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtCategory"
