...
{
    public partial class Dillo_Embroidering : System.Web.UI.Page
    {
        ...
        protected void UnitChange(object sender, EventArgs e)
        {
            ...
            if (chckJobWork.Checked == true)
            {
                ...
                DataSet drpEmp = objbs.SelectEmbroidingEmpName(Convert.ToInt32(ddlUnit.SelectedValue));
            ...
            else
            {
                ...
                DataSet drpEmp = objbs.SelectEmbroidingEmpName(Convert.ToInt32(ddlUnit.Text));
                DropDownList dEmp = (DropDownList)gvcustomerorder.Rows[0].FindControl("drpEmp");
        ...
        protected void Add_LotProcessDetails(object sender, EventArgs e)
        {
            ...
            if (ds.Tables[0].Rows.Count == 0)
            {
                ...
                int iStatus23 = objbs.insertembroProcess(Convert.ToInt32(ddlLotNo.SelectedValue), Convert.ToString(ddlLotNo.SelectedItem.Text), Convert.ToInt32(txtledgerid.Text),
                ...
                for (int i = 0; i < gvcustomerorder.Rows.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        if (txtTotalQantity.Text != "")
                        {
                            ...
                            int istas = objbs.inserttransembroidProcess(Convert.ToInt32(drpprocess.SelectedValue), Convert.ToInt32(drpEmp.SelectedValue), Convert.ToInt32(txtrecQty.Text),
                    ...
                    else
                    {
                        ...
                        if (txtTotalQantity.Text != "")
                        {
                           // string chk = "";
                            ...
                            int istas = objbs.UpdatetransembroProcess(Convert.ToInt32(drpprocess.SelectedValue), Convert.ToInt32(drpEmp.SelectedValue), Convert.ToInt32(txtrecQty.Text),
                            recdate, Convert.ToDecimal(txtrate.Text), ddlLotNo.SelectedValue, Convert.ToInt32(txtTotalQantity.Text), chk);
                        }
                        else
                        {
