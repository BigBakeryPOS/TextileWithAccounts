...
{
    public partial class SampleReportNew : System.Web.UI.Page
    {
        string sTableName = "";
        ...
        double dblSubTotalDmgQuantity = 0;
        ...
        double dblGrandTotalDmgQuantity = 0;
        ...
        protected void gridPurchase_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            if (IsSubTotalRowNeedToAdd)
            {
                ...
                cell = new TableCell();
                cell.Text = string.Format("{0:0}", dblSubTotalDmgQuantity);
                cell.HorizontalAlign = HorizontalAlign.Right;
                cell.CssClass = "SubTotalRowStyle";
                row.Cells.Add(cell);
            ...
            if (IsGrandTotalRowNeedtoAdd)
            {
                ...
                cell = new TableCell();
                cell.Text = string.Format("{0:0}", dblGrandTotalDmgQuantity);
                cell.HorizontalAlign = HorizontalAlign.Right;
                cell.CssClass = "GrandTotalRowStyle";
                row.Cells.Add(cell);
                //Adding Unit Price Column          
        ...
        protected void gridPurchase_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                double dblDmgQuantity = Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "damageqty").ToString());
        ...
        protected void Process_Details(object sender, EventArgs e)
        {
           ...
           divLot1.Visible = false;
            ...
            if (button.Text == "All")
            {
                //STICHING PROCESS
                   ...
                   dgett = objBs.getalldetailsforcalculation(Convert.ToInt32(ddlLotNo.SelectedValue), "3");
                     ...
                     DataSet dshirtall = objBs.getLotNoReportGenerateNew(Convert.ToInt32(ddlLotNo.SelectedValue));
                    lblLot.Text = ddlLotNo.SelectedItem.Text;
                ...
                //KAJA PROCESS
                    ...
                    dgett = objBs.getalldetailsforcalculation(Convert.ToInt32(ddlLotNo.SelectedValue), "2");
               ...
               // DataSet dshirtall = objBs.getLotNoReportGenerate(Convert.ToInt32(ddlLotNo.SelectedValue));
                ...
                //EMBROIDING
                 ...
                 dgett = objBs.getalldetailsforcalculation(Convert.ToInt32(ddlLotNo.SelectedValue),"4");
            ...
            //    DataSet dshirtall = objBs.getLotNoReportGenerate(Convert.ToInt32(ddlLotNo.SelectedValue));
                ...
                if (dgett.Tables[0].Rows.Count > 0)
                {
                    ...
                    Gridprintall.DataSource = temp;
                    Gridprintall.DataBind();
                    //Gridoverall.DataSource = temp;
                    //Gridoverall.DataBind();
                }
                else
                {
                    Gridprintall.DataSource = null;
                    Gridprintall.DataBind();
                    //Gridoverall.DataSource = null;
                    //Gridoverall.DataBind();
                }
          ...
          //IRON AND PACKING
            ...
            {
                divAllreport.Visible = true;
                DataSet ds = objBs.GetLotDetailsProcess("tblJpStiching", "tbltransjpstichinghistory", "stichingid", Convert.ToInt32(ddlLotNo.SelectedValue), "Stc");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    if (ds != null)
                    {
            ...
            {
                divAllreport.Visible = true;
              //  DataSet ds = objBs.GetLotDetailsProcess("tblkajaprocess","tbltranskajaprocessHistory", "kajaprocessId" , Convert.ToInt32(ddlLotNo.SelectedValue), 5);
                DataSet ds = objBs.GetLotDetailsProcess("tblJpKajaButton", "tbltransJpKajaButtonhistory", "kajabuttonid", Convert.ToInt32(ddlLotNo.SelectedValue), "Kaja");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    if (ds != null)
                    {
            ...
            {
                divAllreport.Visible = true;
              //  DataSet ds = objBs.GetLotDetailsProcess("tblEmbroidingprocess", "tblTransEmbroidingProcessHistory", "EmbroidingProcessID", Convert.ToInt32(ddlLotNo.SelectedValue), 6);
                DataSet ds = objBs.GetLotDetailsProcess("tblJpEmbroiding", "tbltransJpEmbroidinghistory", "EmbroidingId", Convert.ToInt32(ddlLotNo.SelectedValue), "Emb");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    if (ds != null)
                    {
            ...
            {
                divAllreport.Visible = true;
             //   DataSet ds = objBs.GetLotDetailsProcess("tblwashingprocess", "tblTransWashingProcessHistory", "WashingProcessID", Convert.ToInt32(ddlLotNo.SelectedValue),7);
                DataSet ds = objBs.GetLotDetailsProcess("tblJpWashing", "tbltransJpWashinghistory", "Washingid", Convert.ToInt32(ddlLotNo.SelectedValue), "Wash");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    if (ds != null)
                    {
            ...
            else if (button.Text == "Priting Details")
            {
                divAllreport.Visible = true;
                //   DataSet ds = objBs.GetLotDetailsProcess("tblIronandpackProcess", "tbltransIronandpackProcessHistory", "IronandpackProcessID", Convert.ToInt32(ddlLotNo.SelectedValue), 8);
                DataSet ds = objBs.GetLotDetailsProcess("tblJpPrinting", "tbltransJpPrintinghistory", "Printingid", Convert.ToInt32(ddlLotNo.SelectedValue), "Print");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    if (ds != null)
                    {
            ...
            else if (button.Text == "Iron & Packing Details")
            {
                divAllreport.Visible = true;
             //   DataSet ds = objBs.GetLotDetailsProcess("tblIronandpackProcess", "tbltransIronandpackProcessHistory", "IronandpackProcessID", Convert.ToInt32(ddlLotNo.SelectedValue), 8);
                DataSet ds = objBs.GetLotDetailsProcess("tblJpIroning", "tbltransJpIroninghistory", "IroningId", Convert.ToInt32(ddlLotNo.SelectedValue), "Iron");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    if (ds != null)
                    {
        ...
        protected void PreCutting_GetDetails(object sender, EventArgs e)
        {
           ...
           divoverall.Visible = true;
            ...
            if (dcc.Tables[0].Rows.Count > 0)
            {
                ...
                DataSet ds2 = objBs.Cuttingprintreport(Convert.ToInt32(cutid));
