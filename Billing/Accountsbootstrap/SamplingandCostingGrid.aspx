<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SamplingandCostingGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.SamplingandCostingGrid" %>
                    ...
                    <div class="row">
                        <div class="col-lg-12" align="center">
                            ...
                            <div class="col-lg-16">
                                ...
                                <asp:TextBox CssClass="form-control" Enabled="true" onkeyup="Search_Gridview(this, 'GVSamplingandCosting')"
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="GVSamplingandCosting" runat="server" CssClass="myGridStyle1" EmptyDataText="No records Found"
                                        Width="100%" AutoGenerateColumns="false" OnRowCommand="GVSamplingandCosting_RowCommand">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("SamplingCostingId") %>'
                                                        CommandName="Edit">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("SamplingCostingId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("SamplingCostingId") %>'
