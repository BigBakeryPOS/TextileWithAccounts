<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SheetDatewise.aspx.cs" Inherits="Billing.Accountsbootstrap.SheetDatewise" %>
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-lg-2" style="margin-top: -40px; margin-left: 340px;" runat="server" visible="true">
        ...
        <div class="col-lg-2" style="margin-top: -40px; margin-left: 40px;" runat="server" visible="true">
            <div class="form-group">
                <label>
                    To Date</label>
        ...
        <div class="col-lg-2" style="margin-top: -40px; margin-left: 250px;">
            <div class="form-group">
                <label>
        ...
        <div class="col-lg-2" style="margin-top: -48px; margin-left: 254px">
            <div class="form-group">
                                        ...
                                        <div align="center">
                                            <asp:GridView runat="server" Width="100%" ID="gvLiaLedger" ShowFooter="true" GridLines="Both"
                                                ...
                                                <Columns>
                                                    ...
                                                    <%--  <asp:BoundField DataField="Debit" DataFormatString="{0:f3}" ItemStyle-HorizontalAlign="right"
                                                                 HeaderStyle-HorizontalAlign="Center" />
                                                            <asp:BoundField DataField="Credit" DataFormatString="{0:f3}" ItemStyle-HorizontalAlign="right"
                                                                 HeaderStyle-HorizontalAlign="Center" />--%>
                                                                                                                ...
                                                                                                                <ItemTemplate>
                                                                                                                    ...
                                                                                                                    <div id="dva<%# Eval("GroupID") %>" style="display: none; position: relative;">
                                                                                                                        <asp:GridView runat="server" ID="gvAssetLedger" CssClass="myGridStyle" GridLines="Both"
                                                                                                                            ...
                                                                                                                            <Columns>
                                                                                                                                <asp:BoundField DataField="LedgerName" ItemStyle-HorizontalAlign="Left" HeaderText="Ledger Name" />
                                                                                                                                <asp:BoundField DataField="Debit" ItemStyle-HorizontalAlign="right" DataFormatString="{0:f3}"
                                                                                                                                    HeaderText="Debit" />
                                                                                                                                <asp:BoundField DataField="Credit" ItemStyle-HorizontalAlign="right" DataFormatString="{0:f3}"
                                                                                                                                    HeaderText="Credit" />
                                                                                                                            </Columns>
                                                                                                                        </asp:GridView>
                                                                                                                    </div>
