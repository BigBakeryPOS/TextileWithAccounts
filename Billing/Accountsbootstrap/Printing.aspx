<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Printing.aspx.cs" Inherits="Billing.Accountsbootstrap.Printing" %>
...
<head id="Head1" runat="server">
    ...
    <title>Printing Issue / Receive</title>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            var grid = document.getElementById('gvnewprint');
                            ...
                            <div id="Div1" runat="server" class="row">
                                ...
                                <div class="col-lg-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList CssClass="chzn-select" Width="120px" Height="150px" ID="ddlLotNo"
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtitemnarration" runat="server"  Enabled="false" TextMode="MultiLine" CssClass="form-control"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div>
                                    ...
                                    <asp:GridView ID="gvnewprint" AutoGenerateColumns="False" ShowFooter="True" CssClass="chzn-container"
                                        Width="100%" runat="server" OnRowDataBound="gvnewprint_RowDataBound">
                                        <HeaderStyle BackColor="#59d3b4" />
                                        <EmptyDataRowStyle HorizontalAlign="Center" BackColor="#59d3b4" ForeColor="Black" />
                                        <Columns>
                                            <asp:TemplateField HeaderText="S.No">
                                ...
                                <div class="col-lg-12">
                                    <div class="col-lg-4">
                                        <div id="but" runat="server" class="row">
                                            ...
                                            <asp:Button ID="btnexit" runat="server" class="btn btn-warning" Text="Exit" PostBackUrl="PrintingGrid1.aspx"
