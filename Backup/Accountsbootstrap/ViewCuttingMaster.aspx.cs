...
{
    public partial class ViewCuttingMaster : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objBs.selectcustomerDet(7, 7);
                if (ds != null)
                {
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            {
                button = btnadd.Text;
                Response.Redirect("Cuttingmaster.aspx?name=" + button.ToString());
            }
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                ...
                {
                    Response.Redirect("Cuttingmaster.aspx?LedgerID=" + e.CommandArgument.ToString());
                }
            }
            ...
            else if (e.CommandName == "delete")
            {
                ...
                Response.Redirect("viewcuttingmaster.aspx");
            }
        }
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            string filename = "Cuttingmaster_" + DateTime.Now.ToString() + ".xls";
            ...
            if (ds != null)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    dt.Columns.Add(new DataColumn("CuttingName"));
                    ...
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        dr_export["CuttingName"] = dr["LedgerName"];
