<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kaja_Process.aspx.cs" Inherits="Billing.Accountsbootstrap.Kaja_Process" %>
...
<head id="Head1" runat="server">
    ...
    <title>Flexible Apparels || Kaja Process</title>
...
<body>
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-top: 6px">
            <h1 id="head" runat="server" class="page-header" style="text-align: center; color: #fe0002">Kaja Process
            </h1>
                         ...
                         <label runat="server" id="processs"  style="font-weight: bold;display:none;">
                                ...
                                <asp:GridView runat="server" BorderWidth="1" ID="GridView1" CssClass="myleft" GridLines="Both"
                                    ...
                                    <%--   <asp:BoundField DataField="Processmasterid" ItemStyle-Font-Bold="true"  HeaderText="Process Name" Visible="false"  />--%>
                                     ...
                                     <asp:BoundField HeaderText="Checking Finished Qty" ItemStyle-Font-Bold="true" DataField="FinishedQty" ItemStyle-HorizontalAlign="Center" />
