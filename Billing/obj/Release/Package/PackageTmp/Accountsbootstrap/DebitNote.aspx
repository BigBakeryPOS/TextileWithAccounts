<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DebitNote.aspx.cs" Inherits="Billing.Accountsbootstrap.DebitNote"%>
    ...
    <asp:Label runat="server" ID="lblUserID" ForeColor="White" CssClass="label" Visible="false"> </asp:Label>
        ...
        <div class="row">
                <div class="col-lg-12" style="margin-top:-11px">
                    <%--<h2 style="text-align:left;color:#fe0002;">Debit Note</h2>--%>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <asp:Label ID="lblName" Text="Debit Note " runat="server"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
    ...
    <form id="Form1" runat="server">
        ...
        <ContentTemplate>
                        ...
                        <div class="panel-body"  >
                                           ...
                                           <asp:RadioButtonList ID="RbtnCD" Enabled="false" runat="server" RepeatDirection="Horizontal"  style="margin-top:-8px;">     
                                           <asp:ListItem Text="Credit" Value="Credit Note"> </asp:ListItem>
                                            <asp:ListItem Text="Debit" Value="Debit Note"  Selected="True">  </asp:ListItem>
                                           </asp:RadioButtonList>
                                            </div>
                                        </div>
                                        </div>
