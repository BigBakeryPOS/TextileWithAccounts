<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyerOrderBookingStyles.aspx.cs"
    Inherits="Billing.Accountsbootstrap.BuyerOrderBookingStyles" %>
...
<head id="Head1" runat="server">
    ...
    <title>BuyerOrder Booking Styles</title>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-3">
                                <h1 class="page-header" style="text-align: center; color: #fe0002; font-size: 20px;
                                    font-weight: bold">
                                    BuyerOrder Booking Styles
                                </h1>
                            </div>
                            <div class="col-lg-1">
                                <div class="form-group" id="FromDate" runat="server" visible="true">
                                    <asp:Label ID="lblFrom" runat="server" Text="Order From" Width="110px" Style="font-weight: bold">
                                    </asp:Label>
                            ...
                            <div class="col-lg-1">
                                <div class="form-group" id="ToDate" runat="server" visible="true">
                                    <asp:Label ID="lblTo" runat="server" Text="Order To" Width="110px" Style="font-weight: bold">
                                    </asp:Label>
                            ...
                            <div class="col-lg-2">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList ID="ddlType" runat="server" CssClass="chzn-select" Width="100%">
                                        ...
                                        <asp:ListItem Text="Canceled" Value="True">
                                        </asp:ListItem>
                                        <asp:ListItem Text="UnCanceled" Value="False">
                                        </asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                        ...
                        <div id="Excel" runat="server">
                            <div class="col-lg-12">
                                ...
                                <br />
                                <br />
                                <asp:GridView ID="gvBuyerOrderBookingSummary" Caption="BuyerOrder Booking Styles"
