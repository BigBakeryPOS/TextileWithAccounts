...
{
    public partial class Trimming : System.Web.UI.Page
    {
        ...
        {
            string Trimmingid = string.Empty;
            string Requests = string.Empty;
            Trimmingid = Request.QueryString.Get("Trimmingid");
            ...
            if (!IsPostBack)
            {
                ...
                //DataSet dsLotNo = objbs.Select_LotDetails("Trm");
                ...
                if (Trimmingid != null)
                {
                    if (Requests == "Edit")
                    {
                        ...
                        DataSet dgetcheck = objbs.getJpTrimmingLot(Trimmingid);
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            drpbranch.SelectedValue = dgetcheck.Tables[0].Rows[0]["Companyid"].ToString();
                            drpbranch.Enabled = false;
                            DataSet dsLot = objbs.Select_Lot("Trm", drpbranch.SelectedValue);
                            ...
                            dlotprocess = objbs.Get_LotDetails(Convert.ToString(dgetcheck.Tables[0].Rows[0]["LotDetailID"]), "10", "Trm");
                            ...
                            btnadd.Visible = true;
                            btnadd.Text = "Update";
                            txtid.Text = dgetcheck.Tables[0].Rows[0]["Trimmingid"].ToString();
                            txtmultiid.Text = dgetcheck.Tables[0].Rows[0]["Trimmingid"].ToString();
                            txtmultiplecode.Text = dgetcheck.Tables[0].Rows[0]["Trimmingid"].ToString();
                            ...
                            DataSet ds = objbs.Get_JpTrimming(Convert.ToString(Trimmingid), "10", "Trm");
                    ...
                    else if (Requests == "partial")
                    {
                        ...
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            ...
                            txtAmount.Text = dgetcheck.Tables[0].Rows[0]["TotalAmount"].ToString();
                            txtAmount.Enabled = false;
                            DataSet ds = objbs.Get_LotDetails(Convert.ToString(dgetcheck.Tables[0].Rows[0]["LotDetailID"]), "10", "Trm");
                                //= objbs.Get_JpTrimming(Convert.ToString(Trimmingid), "10", "Trm");
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                DataSet temp = new DataSet();
                                DataTable dtt = new DataTable();
                    ...
                    else if (Requests == "Receive")
                    {
                        ...
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                dsstichinglot = objbs.Get_dstrimlotcolor(Convert.ToInt32(Trimmingid));
                                ...
                                gvnewtrimming.DataSource = dssstichinglot;
                                gvnewtrimming.DataBind();

                                for (int i = 0; i < gvnewtrimming.Rows.Count; i++)
                                {
                                    Label lblStockRatioId = (Label)gvnewtrimming.Rows[i].FindControl("lblStockRatioId");
                                    Label lblMasterid = (Label)gvnewtrimming.Rows[i].FindControl("lblMasterid");
                                    Label lblTransfabid = (Label)gvnewtrimming.Rows[i].FindControl("lblTransfabid");

                                    Label lbldesignno = (Label)gvnewtrimming.Rows[i].FindControl("lbldesignno");
                                    TextBox txts30fs = (TextBox)gvnewtrimming.Rows[i].FindControl("txts30fs");
                                    TextBox txts32fs = (TextBox)gvnewtrimming.Rows[i].FindControl("txts32fs");
                                    TextBox txts34fs = (TextBox)gvnewtrimming.Rows[i].FindControl("txts34fs");
                                    TextBox txts36fs = (TextBox)gvnewtrimming.Rows[i].FindControl("txts36fs");
                                    TextBox txtsxsfs = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsxsfs");
                                    TextBox txtssfs = (TextBox)gvnewtrimming.Rows[i].FindControl("txtssfs");
                                    TextBox txtsmfs = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsmfs");
                                    TextBox txtslfs = (TextBox)gvnewtrimming.Rows[i].FindControl("txtslfs");
                                    TextBox txtsxlfs = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsxlfs");
                                    TextBox txtsxxlfs = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsxxlfs");
                                    TextBox txts3xlfs = (TextBox)gvnewtrimming.Rows[i].FindControl("txts3xlfs");
                                    TextBox txts4xlfs = (TextBox)gvnewtrimming.Rows[i].FindControl("txts4xlfs");

                                    TextBox txts30hs = (TextBox)gvnewtrimming.Rows[i].FindControl("txts30hs");
                                    TextBox txts32hs = (TextBox)gvnewtrimming.Rows[i].FindControl("txts32hs");
                                    TextBox txts34hs = (TextBox)gvnewtrimming.Rows[i].FindControl("txts34hs");
                                    TextBox txts36hs = (TextBox)gvnewtrimming.Rows[i].FindControl("txts36hs");
                                    TextBox txtsxshs = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsxshs");
                                    TextBox txtsshs = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsshs");
                                    TextBox txtsmhs = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsmhs");
                                    TextBox txtslhs = (TextBox)gvnewtrimming.Rows[i].FindControl("txtslhs");
                                    TextBox txtsxlhs = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsxlhs");
                                    TextBox txtsxxlhs = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsxxlhs");
                                    TextBox txts3xlhs = (TextBox)gvnewtrimming.Rows[i].FindControl("txts3xlhs");
                                    TextBox txts4xlhs = (TextBox)gvnewtrimming.Rows[i].FindControl("txts4xlhs");

                                    TextBox txtsendFQty = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsendFQty");
                                    ...
                                    TextBox txts30fsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txts30fsac");
                                    TextBox txts32fsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txts32fsac");
                                    TextBox txts34fsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txts34fsac");
                                    TextBox txts36fsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txts36fsac");
                                    TextBox txtsxsfsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsxsfsac");
                                    TextBox txtssfsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txtssfsac");
                                    TextBox txtsmfsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsmfsac");
                                    TextBox txtslfsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txtslfsac");
                                    TextBox txtsxlfsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsxlfsac");
                                    TextBox txtsxxlfsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsxxlfsac");
                                    TextBox txts3xlfsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txts3xlfsac");
                                    TextBox txts4xlfsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txts4xlfsac");

                                    TextBox txts30hsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txts30hsac");
                                    TextBox txts32hsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txts32hsac");
                                    TextBox txts34hsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txts34hsac");
                                    TextBox txts36hsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txts36hsac");
                                    TextBox txtsxshsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsxshsac");
                                    TextBox txtsshsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsshsac");
                                    TextBox txtsmhsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsmhsac");
                                    TextBox txtslhsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txtslhsac");
                                    TextBox txtsxlhsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsxlhsac");
                                    TextBox txtsxxlhsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsxxlhsac");
                                    TextBox txts3xlhsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txts3xlhsac");
                                    TextBox txts4xlhsac = (TextBox)gvnewtrimming.Rows[i].FindControl("txts4xlhsac");

                                    TextBox txtsendFQtyac = (TextBox)gvnewtrimming.Rows[i].FindControl("txtsendFQtyac");
        ...
        protected void company_SelectedIndexChnaged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSet dsLotNo = objbs.Select_LotDetails("Trm", drpbranch.SelectedValue);
                if (dsLotNo.Tables[0].Rows.Count > 0)
                {
                    DataSet dsLotNoval = objbs.Select_LotDetailsnew("Trm", drpbranch.SelectedValue, 9);
        ...
        protected void StitchingInfo_Load(object sender, EventArgs e)
        {
            ...
            if (ddlLotNo.SelectedValue != "Select Lot No")
            {
                int dcheck = objbs.checkcurrent(ddlLotNo.SelectedValue, "Trm");
                if (dcheck == 1)
                {
                    ...
                    double trimmingrate = 0;

                    DataSet rateforprecost = objbs.getrateforprecost(Convert.ToString(ddlLotNo.SelectedItem.Text), "Trimming Process");
                    if (rateforprecost.Tables[0].Rows.Count > 0)
                    {
                        trimmingrate = Convert.ToDouble(rateforprecost.Tables[0].Rows[0]["Cost"].ToString());
                    }
                    else
                    {
                    ...
                    DataSet dlotprocess = new DataSet();
                    dlotprocess = objbs.Get_LotDetails(Convert.ToString(ddlLotNo.SelectedValue), "10", "Trm");
                    txttotalqty.Text = dlotprocess.Tables[0].Rows[0]["TotalQuantity"].ToString();
                    ...
                    if (dlotprocess.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < gvcustomerorder.Rows.Count; i++)
                        {
                            ...
                            lblfitid.Text = temp.Tables[0].Rows[i]["fitid"].ToString();
                            //txtrate.Text = temp.Tables[0].Rows[i]["rate"].ToString();
                            txtrate.Text = trimmingrate.ToString();
                            drpProcess.SelectedValue = temp.Tables[0].Rows[i]["ProcessTypeID"].ToString();
                            lblPattern.Text = temp.Tables[0].Rows[i]["Pattern"].ToString();
                            lblPatternid.Text = temp.Tables[0].Rows[i]["Patternid"].ToString();
                            txtdamageqty.Text = temp.Tables[0].Rows[i]["damageqty"].ToString();
                    ...
                    dsstichinglot = objbs.Get_dsTrimlot(Convert.ToInt32(ddlLotNo.SelectedValue), TrimmingProcess);
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Not Ready To Trimming Process.Thank You!!!')", true);
                    return;
                }
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            drpProcess = objbs.SelectAllProcessTypeLotProcess("10");
        ...
        protected void Add_LotProcessDetails(object sender, EventArgs e)
        {
            ...
            if (btnadd.Text == "Save")
            {
                ...
                int istatus3 = objbs.insertJpTrimming(Convert.ToDouble(txtAmount.Text), Convert.ToInt32(ddlLotNo.SelectedValue), lbllotno.Text, MultiDate, Convert.ToInt32(drpMultiemployee.SelectedValue), Convert.ToDouble(txttotalqty.Text), empid, drpbranch.SelectedValue, ddlLotNo.SelectedItem.Text, Convert.ToInt32(txtsendFQtymain.Text),txtnarration.Text);



                for (int vLoop = 0; vLoop < gvnewtrimming.Rows.Count; vLoop++)
                {
                    ...
                    #region
                    Label lblitemname = (Label)gvnewtrimming.Rows[vLoop].FindControl("lbldesignno");

                    TextBox txts30fs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txts30fs");
                    TextBox txts32fs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txts32fs");
                    TextBox txts34fs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txts34fs");
                    TextBox txts36fs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txts36fs");
                    TextBox txtsxsfs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txtsxsfs");
                    TextBox txtssfs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txtssfs");
                    TextBox txtsmfs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txtsmfs");
                    TextBox txtslfs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txtslfs");
                    TextBox txtsxlfs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txtsxlfs");
                    TextBox txtsxxlfs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txtsxxlfs");
                    TextBox txts3xlfs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txts3xlfs");
                    TextBox txts4xlfs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txts4xlfs");

                    TextBox txts30hs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txts30hs");
                    TextBox txts32hs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txts32hs");
                    TextBox txts34hs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txts34hs");
                    TextBox txts36hs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txts36hs");
                    TextBox txtsxshs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txtsxshs");
                    TextBox txtsshs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txtsshs");
                    TextBox txtsmhs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txtsmhs");
                    TextBox txtslhs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txtslhs");
                    TextBox txtsxlhs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txtsxlhs");
                    TextBox txtsxxlhs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txtsxxlhs");
                    TextBox txts3xlhs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txts3xlhs");
                    TextBox txts4xlhs = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txts4xlhs");

                    Label lblStockRatioId = (Label)gvnewtrimming.Rows[vLoop].FindControl("lblStockRatioId");
                    Label lblMasterid = (Label)gvnewtrimming.Rows[vLoop].FindControl("lblMasterid");
                    Label lblTransfabid = (Label)gvnewtrimming.Rows[vLoop].FindControl("lblTransfabid");

                    TextBox txtsendFQtycolor = (TextBox)gvnewtrimming.Rows[vLoop].FindControl("txtsendFQty");
                    ...
                    else
                    {
                        ...
                        {
                            int istasHistory = objbs.inserttransjpITrimmingHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            int istas = objbs.inserttransJpTrimming(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            if (vLoop == 0)
                            {
                                int istas1 = objbs.JpTrimming(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                ...
                int istatus3l = objbs.statusJpTrimming(Convert.ToInt32(ddlLotNo.SelectedValue));
            ...
            else if (btnadd.Text == "Partial")
            {
                ...
                int istatus3 = objbs.UpdJpTrimming(Convert.ToDouble(txtAmount.Text), Convert.ToInt32(ddlLotNo.SelectedValue), lbllotno.Text, MultiDate, Convert.ToInt32(drpMultiemployee.SelectedValue), Convert.ToDouble(txttotalqty.Text), Trimmingid, empid);
                ...
                for (int vLoop = 0; vLoop < gvcustomerorder.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        ...
                        int istas = objbs.inserttransJpTrimmingPartial(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                  recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Convert.ToInt32(ddlLotNo.SelectedValue), empid, Convert.ToInt32(txtsendFQty.Text), Trimmingid);
            ...
            else if (btnadd.Text == "Update")
            {
                ...
                for (int vLoop = 0; vLoop < gvcustomerorder.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        ...
                        int istas = objbs.updatetransJpTrimming(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                  recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtsendFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Convert.ToInt32(ddlLotNo.SelectedValue), Trimmingid);
            ...
            else if (btnadd.Text == "Received")
            {
                ...
                if (ddltype.SelectedValue == "Damage")
                {
                    int istasHistory = objbs.processmaintabletrimm(Convert.ToInt32(Trimmingid), Convert.ToInt32(txtdamageqtymain.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }
                else
                {
                    int istasHistory = objbs.processmaintabletrimm(Convert.ToInt32(Trimmingid), Convert.ToInt32(txtrecFQty.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }
                ...
                for (int vLoop = 0; vLoop < gvnewtrimming.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        if (txtsendFQtycolor.Text != "0")
                        {
                            int istasHistory = objbs.inserttransjptrimmHistory1new(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), recdate,
                                      recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Trimmingid, empid, Convert.ToInt32(txtsendFQty.Text), Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), ddltype.SelectedItem.Text);

                            if (vLoop == 0)
                            {
                                //int istasHistory = objbs.inserttransjpITrimmingHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                //          recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Trimmingid, empid, Convert.ToInt32(txtsendFQty.Text));

                                int istas = objbs.JpTrimmingREC(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            if (ddltype.SelectedValue == "Damage")
                            {
                                int rec = objbs.DamageProcessStockRatiotrim(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text), TrimmingProcess);
                            }
                            else
                            {
                                int rec = objbs.updateProcessStockRatiotrim(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text));
        ...
        protected void gvnewtrimming_RowDataBound(object sender, GridViewRowEventArgs e)
        {
