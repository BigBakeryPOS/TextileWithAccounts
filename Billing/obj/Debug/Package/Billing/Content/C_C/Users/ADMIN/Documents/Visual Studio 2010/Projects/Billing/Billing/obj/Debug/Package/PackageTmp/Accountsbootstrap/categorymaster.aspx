<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="categorymaster.aspx.cs" Inherits="Billing.Accountsbootstrap.categorymaster" %>
                        ...
                        <div class="panel-body">
                            <div class="row">
                               ...
                               <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator runat="server" id="txtcat" controltovalidate="txtcategory" ValidationGroup="val1" errormessage="Please enter your Category!" style="color:Red" />
                                        </div>	
                                        ...
                                        <asp:Button ID="btnedit" runat="server" class="btn btn-warning" Text="Edit" AutoPostBack="true" OnClick="Edit_Click" />
