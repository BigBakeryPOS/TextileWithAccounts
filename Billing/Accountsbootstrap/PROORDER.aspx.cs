...
{
    public partial class PROORDER : System.Web.UI.Page
    {
        ...
        protected void GVSize_rowdatabound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
              ...
              //  TotRQty = RQty + Convert.ToInt32(txtReceiveQty.Text);
              //  TotDQty = DQty + Convert.ToInt32(txtDamageQty.Text);
        ...
        protected void Receive_changed(object sender, EventArgs e)
        {
            ...
            for (int vLoop = 0; vLoop < GVSizes.Rows.Count; vLoop++)
            {
                ...
                TotQty = Qty + Convert.ToInt32(lblQty.Text);

                TotIQty = IQty + Convert.ToInt32(txtIssueQty.Text);
                TotRQty = RQty + Convert.ToInt32(txtReceiveQty.Text);
                TotDQty = DQty + Convert.ToInt32(txtDamageQty.Text);
            }
...
//            ddlProcessFrom.Items.Insert(0, "Select ProcessFrom");
            ...
            if (ddlExcNo.SelectedValue != "" && ddlExcNo.SelectedValue != "0" && ddlExcNo.SelectedValue != "Select ExcNo")
            {
                ...
                DataSet dsProcess = objBs.GetPRocessBy_EXCNO_Order(Convert.ToInt32(ddlExcNo.SelectedValue));
                if (dsProcess.Tables[0].Rows.Count > 0)
                {
                    ddlProcess.Items.Clear();
                    ddlProcess.DataSource = dsProcess.Tables[0];
                ...
                if (ddlExcNo.SelectedValue != "" && ddlExcNo.SelectedValue != "0" && ddlExcNo.SelectedValue != "Select ExcNo")
                {
                    ...
                    DataSet dsBuyerOrderCuttingrItems = objBs.GetTransBuyerOrderCuttingItems_ProOrder(Convert.ToInt32(ddlExcNo.SelectedValue));
                    ...
                    DataSet dsBuyerOrderCuttingSizes = objBs.GetTransBuyerOrderCuttingSizes_Proorder(Convert.ToInt32(ddlExcNo.SelectedValue));
        ...
        protected void ddlProcessFrom_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlExcNo.SelectedValue != "" && ddlExcNo.SelectedValue != "0" && ddlExcNo.SelectedValue != "Select ExcNo" )
            {
                ...
                DataSet dsCuttingProcessEntryrItems = objBs.GetTransCuttingProcessEntryItems(Convert.ToInt32(ddlExcNo.SelectedValue), Convert.ToInt32(0));
                ...
                DataSet dsCuttingProcessEntrySizes = objBs.GetTransCuttingProcessEntrySizes(Convert.ToInt32(ddlExcNo.SelectedValue), Convert.ToInt32(0));
                if (dsCuttingProcessEntrySizes.Tables[0].Rows.Count > 0)
                {
                    DataSet dstd1 = new DataSet();
                    DataTable dtddd1 = new DataTable();
        ...
        protected void GVItem_OnRowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Modify")
            {
                ...
                if (e.CommandArgument.ToString() != "")
                {
                    ...
                    Qty.Text = RowsGVSizeDetails[0]["CQty"].ToString();
        ...
        protected void btnSave_OnClick(object sender, EventArgs e)
        {
            ...
            if (btnSave.Text == "Save")
            {
                ...
                int ProcessEntryId = objBs.InsertCuttingProcessEntry(txtEntryNo.Text, YearCode, Convert.ToInt32(dsEntryNo.Tables[0].Rows[0]["EntryNo"].ToString()), EntryDate, Convert.ToInt32(ddlExcNo.SelectedValue), Convert.ToInt32(0), Convert.ToInt32(ddlProcess.SelectedValue), MaxRowId, txtRemarks.Text, Convert.ToInt32(ddlFinishingProcess.SelectedValue), Convert.ToInt32(ddlCompanyName.SelectedValue), Convert.ToInt32(ddlProcessLedger.SelectedValue), FromDate, ToDate);
            ...
            Response.Redirect("PRoorder_grid.aspx");
