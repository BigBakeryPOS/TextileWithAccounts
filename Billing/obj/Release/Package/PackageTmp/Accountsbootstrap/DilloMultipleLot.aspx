<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DilloMultipleLot.aspx.cs" Inherits="Billing.Accountsbootstrap.DilloMultipleLot" %>
...
<head id="Head1" runat="server">
    ...
    <title>Flexible Apparels || Multi Lot Process</title>
...
<body style="background-color:#c6efce">
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-top: 6px">
            <h1 id="head" runat="server" class="page-header" style="text-align: center; color: #fe0002">Multiple Lot Process
            </h1>
                    ...
                    <div runat="server" class="row">
                        ...
                        <asp:ValidationSummary runat="server" HeaderText="Validation Messages" ValidationGroup="val1"
                         ...
                         <div class="form-group" >
                                ...
                                <asp:DropDownList CssClass="form-control" ID="drpmultiunit" MaxLength="150" runat="server"
                                  OnSelectedIndexChanged="MultiUnit_SelectedIndex" AutoPostBack="true"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-2">     
                        
                            <div class="form-group" >
                                <label>Multiple No</label>
                        ...
                        <label>Date</label>
                         <asp:TextBox ID="txtmultidate" runat="server" onkeyup="ValidateDate(this, event.keyCode)"
                                                                    onkeydown="return DateFormat(this, event.keyCode)" CssClass="form-control" Text="" Width="100%" Height="26px" AppendDataBoundItems="true"></asp:TextBox>
                        ...
                        <div class="col-lg-2">     
                              <div class="form-group" >
                                ...
                                <asp:DropDownList CssClass="form-control" ID="drpMultiemployee" MaxLength="150" runat="server"></asp:DropDownList>
                            </div>
                             </div>
                         <div class="col-lg-2">     
                              <div class="form-group" >
                               ...
                               <asp:TextBox CssClass="form-control" ID="txttotalqty" MaxLength="150" Enabled="false" runat="server">0</asp:TextBox>
                            </div>
                             </div>
                              ...
                              <div class="form-group" >
                               ...
                               <asp:TextBox CssClass="form-control" ID="txtreceivedQty" MaxLength="150" Enabled="false" runat="server">0</asp:TextBox>
                            </div>
                             </div>
                            ...
                            <span onclick="openNav()">Process Details
                               ...
                               <asp:CheckBox ID="Ratedetail" runat="server" OnCheckedChanged="RateDetail_checked" AutoPostBack="true" Text="" />
                                                            ...
                                                            <div id="mySidenav"  runat="server" class="sidenav" style="width: 400px;padding-left: 28px;">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                             ...
                             <label runat="server" id="processs"  style="font-weight: bold">
                                ...
                                <asp:GridView runat="server" BorderWidth="1" ID="GridView1" CssClass="myleft" GridLines="Both"
                                    ...
                                    <HeaderStyle BorderStyle="Solid" BorderWidth="1px" />
                                     ...
                                     <asp:BoundField DataField="Processtype" ItemStyle-Font-Bold="true" HeaderText="Process Name"  ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="166px" />
                        ...
                        <div runat="server" visible="false" class="col-lg-3">
                           ...
                           <div runat="server" visible="false" class="form-group" >
                             ...
                             <div runat="server" visible="false" style="width:50%" class="form-group col-lg-3">
                            ...
                            <div runat="server" visible="false" id="divPiece" class="form-group" runat="server">
                             ...
                             <div runat="server" visible="false" id="Div1" class="form-group" runat="server">
                                <label>
                                    Design No</label>
                                            ...
                                            <EmptyDataRowStyle HorizontalAlign="Center" BackColor="#59d3b4" ForeColor="Black" />
                                                            <Columns>
                                                              <asp:TemplateField HeaderText="S.No" ControlStyle-Width="100%" ItemStyle-Width="3%">
                                                                   ...
                                                                   <asp:TemplateField HeaderText="Lot No" ControlStyle-Width="100%" ItemStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                        <asp:DropDownList ID="drpLotno" OnSelectedIndexChanged="drpLot_selected" CssClass="chzn-select"  AutoPostBack="true"
                                                                ...
                                                                <asp:TemplateField HeaderText="Stiching Process Type" ControlStyle-Width="100%" ItemStyle-Width="25%">
                                                                    <ItemTemplate>
                                                                        <asp:DropDownList ID="drpProcess" OnSelectedIndexChanged="drpprocess_selected" CssClass="chzn-select"  AutoPostBack="true"
                                                                          Width="100%" runat="server" Height="26px" AppendDataBoundItems="true">
                                                                        </asp:DropDownList>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                              ...
                                                              <%--  <asp:TemplateField HeaderText="Employee Name" ItemStyle-Width="25%">
                                                                ...
                                                                <asp:TemplateField HeaderText="Send Qty" ControlStyle-Width="100%" ItemStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtsendFQty" OnTextChanged="txtsendfqtychnaged_text" AutoPostBack="true" runat="server" Width="100%" Height="26px" AppendDataBoundItems="true"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                  <asp:TemplateField HeaderText="Remain Qty" ItemStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtRemainQty" Enabled="false"  runat="server" Width="100%" Height="26px" AppendDataBoundItems="true"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                  <asp:TemplateField HeaderText="Snd HS Qty" Visible="false" ItemStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtsendHQty" OnTextChanged="txtsendhqtychnaged_text" AutoPostBack="true" runat="server" Width="100%" Height="26px" AppendDataBoundItems="true"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Rec. Qty" ControlStyle-Width="100%" ItemStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtrecFQty" OnTextChanged="txtrecfqtychnaged_text" AutoPostBack="true" runat="server" Width="100%" Height="26px" AppendDataBoundItems="true"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                  <asp:TemplateField HeaderText="Rec.HS Qty" Visible="false" ItemStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtrecHQty" OnTextChanged="txtrechqtychnaged_text" AutoPostBack="true" runat="server" Width="100%" Height="26px" AppendDataBoundItems="true"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="Received Date"  ControlStyle-Width="100%" ItemStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                    <asp:TextBox ID="Recdate" runat="server" Enabled="false" onkeyup="ValidateDate(this, event.keyCode)"
                                                                    onkeydown="return DateFormat(this, event.keyCode)" Text="" Width="100%" Height="26px" AppendDataBoundItems="true"></asp:TextBox>
                                                                    <ajaxToolkit:CalendarExtender ID="CalendarExtender65" TargetControlID="Recdate"
                                                                    PopupButtonID="Recdate" EnabledOnClient="true" Format="dd/MM/yyyy" runat="server"
                                                                    CssClass="cal_Theme1"></ajaxToolkit:CalendarExtender>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                    ...
                    <asp:Button ID="btnadd" runat="server" class="btn btn-info" Text="Save" 
                            ...
                            <asp:Button ID="btnexit" runat="server" class="btn btn-warning" Text="Exit"  PostBackUrl="DilloMultiLotGrid.aspx"
