<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BarTag.aspx.cs" Inherits="Billing.Accountsbootstrap.BarTag" %>
    ...
    <![endif]-->
        <script type="text/javascript">
            ...
            window.onload = function () {
                var grid = document.getElementById('gvnewbartag');
                                ...
                                <div class="row">
                                    ...
                                    <ContentTemplate>--%>
                                            <div class="panel-body">
                                              ...
                                              <asp:GridView ID="gvnewbartag" AutoGenerateColumns="False" ShowFooter="True" CssClass="chzn-container"
                                                                    Width="100%" runat="server" OnRowDataBound="gvnewbartag_RowDataBound">
                                                                    <HeaderStyle BackColor="#59d3b4" />
                                                                    <EmptyDataRowStyle HorizontalAlign="Center" BackColor="#59d3b4" ForeColor="Black" />
                                                                    <Columns>
                                                                        <asp:TemplateField HeaderText="S.No" >
                                        ...
                                        <div class="col-lg-12">
                                            <div class="col-lg-4">
                                                <div id="but" runat="server" class="row">
                                                    ...
                                                    <asp:Button ID="btnexit" runat="server" class="btn btn-warning" Text="Exit" PostBackUrl="BarTagGrid.aspx"
