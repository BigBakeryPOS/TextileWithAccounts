<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Stitching.aspx.cs" Inherits="Billing.Accountsbootstrap.Stitching" %>
...
<head id="Head1" runat="server">
    ...
    <title>Stitching Issue / Receive</title>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            var grid = document.getElementById('gvnewstiching');
                ...
                <div class="panel panel-default" style="background-color: #c6efce">
                    <div class="panel-body" style="background-color: #c6efce">
                        <div class="form-group">
                            <div id="Div1" runat="server" class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group ">
                                        ...
                                        <asp:CheckBoxList ID="chkSizes" RepeatDirection="Horizontal" RepeatColumns="2" Visible="false"
                                            CssClass="chkChoice1" runat="server">
                                        </asp:CheckBoxList>
                                    </div>
                                </div>
                                <div class="col-lg-1">
                                ...
                                <div class="col-lg-2" runat="server">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtitemnarration" runat="server" TextMode="MultiLine" Enabled="false"
                                ...
                                <div class="col-lg-1" runat="server">
                                    <div runat="server" visible="false" class="form-group">
                                        <label>
                                            Amount</label>
                                        <asp:TextBox CssClass="form-control" Enabled="false" ID="txtAmount" MaxLength="150"
                                            runat="server">0</asp:TextBox>
                                    </div>
                                    <div class="form-group" runat="server" visible="false">
                                        <label>
                            ...
                            <!-- /.col-lg-6 (nested) -->
                            <div id="Div7" runat="server" visible="false" class="col-lg-3">
                                <div class="form-group ">
                                    <label>
                                        Process Date</label>
                                ...
                                <div id="Div9" runat="server" visible="false" style="width: 50%" class="form-group col-lg-3">
                                    <label>
                                        Full Qty</label>
                                ...
                                <div runat="server" visible="false" id="Div11" class="form-group" runat="server">
                                    <label>
                                        Design No</label>
                                                ...
                                                <td colspan="5">
                                                    <asp:GridView ID="gvcustomerorder" AutoGenerateColumns="False" ShowFooter="True"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="ItemName" Visible="false" ControlStyle-Width="100%"
                                                                ItemStyle-Width="10%">
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Send Qty" ControlStyle-Width="100%" ItemStyle-Width="10%">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtsendFQty" Enabled="false" OnTextChanged="sendqty_chnaged" AutoPostBack="true"
                        ...
                        <asp:GridView ID="gvnewstiching" AutoGenerateColumns="False" ShowFooter="True" CssClass="chzn-container"
                            Width="100%" runat="server" OnRowDataBound="gvnewstiching_RowDataBound">
                            <HeaderStyle BackColor="#59d3b4" />
                            <EmptyDataRowStyle HorizontalAlign="Center" BackColor="#59d3b4" ForeColor="Black" />
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Color">
                                    <ItemTemplate>
                                        <asp:Label ID="lblonlycolor" Visible="true" Text='<%#Eval("color") %>' runat="server"></asp:Label>
                                        <asp:Label ID="lbldesignno" Visible="false" Text='<%#Eval("Design") %>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Transfabid" Visible="false">
                                    <ItemTemplate>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div id="Div2" runat="server" class="row">
                                    <asp:Button ID="Button1" runat="server" class="btn btn-info" Text="Calc" Style="width: 120px;
                                        margin-top: 25px" OnClick="Add1_Click" Visible="false" />
                                    ...
                                    <asp:Button ID="btnexit" runat="server" class="btn btn-warning" Text="Exit" PostBackUrl="StitchingGrid.aspx"
