<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrimmingProcess.aspx.cs" Inherits="Billing.Accountsbootstrap.TrimmingProcess" %>
...
<head id="Head1" runat="server">
    ...
    <title>Flexible Apparels || Trimming Process</title>
...
<body>
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-top: 6px">
            <h1 id="head" runat="server" class="page-header" style="text-align: center; color: #fe0002">Trimming Process
            </h1>
