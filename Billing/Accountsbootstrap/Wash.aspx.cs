    ...
    public partial class Wash : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Washingid != null)
            {
                ...
                DataSet ds2 = objBs.JpWashingfor(Washingid);
                if (ds2.Tables[0].Rows.Count > 0)
                {
                    ...
                    DataSet ds23 = objBs.Get_JpWash(Convert.ToString(Washingid), "5", "Wash");
        ...
        protected void btnclick(object sender, EventArgs e)
        {
            ...
            int isucess = objBs.updprintforall(Washingid, "tbltransjpWashinghistory", "WashingId");
        }
