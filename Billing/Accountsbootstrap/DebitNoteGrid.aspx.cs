...
{
    public partial class DebitNoteGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dacess = objBs.getuseraccessscreen(Session["EmpId"].ToString(), "dbtnote");
        ...
        protected void CreditDebitGrid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                ...
                {
                    Response.Redirect("DebitNote.aspx?DayBook_ID=" + e.CommandArgument.ToString());
                }
            }
