...
{
    public partial class Stitching : System.Web.UI.Page
    {
                    ...
                    if (Requests == "Receive")
                    {
                        ...
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                dsstichinglot = objbs.Get_dsstichinglotcolor(Convert.ToInt32(Stitchingid));
                                ...
                                {
                                    gvnewstiching.Columns[2].Visible = false; //30FS
                                    gvnewstiching.Columns[3].Visible = false; //32FS

                                    gvnewstiching.Columns[4].Visible = false;//34Fs
                                    gvnewstiching.Columns[5].Visible = false;//36Fs

                                    gvnewstiching.Columns[6].Visible = false; //XSFS
                                    gvnewstiching.Columns[7].Visible = false; //SFS

                                    gvnewstiching.Columns[8].Visible = false; //MFS
                                    gvnewstiching.Columns[9].Visible = false; //LFS

                                    gvnewstiching.Columns[10].Visible = false; //XLFS
                                    gvnewstiching.Columns[11].Visible = false; //xxlFS

                                    gvnewstiching.Columns[12].Visible = false; //3xlHS
                                    gvnewstiching.Columns[13].Visible = false; //4xlHS

                                    gvnewstiching.Columns[14].Visible = false; //30HS

                                    gvnewstiching.Columns[15].Visible = false; //32HS

                                    gvnewstiching.Columns[16].Visible = false; //34HS
                                    gvnewstiching.Columns[17].Visible = false; //36HS

                                    gvnewstiching.Columns[18].Visible = false; //XSHS
                                    gvnewstiching.Columns[19].Visible = false; //SHS

                                    gvnewstiching.Columns[20].Visible = false; //MHS
                                    gvnewstiching.Columns[21].Visible = false; //LHS

                                    gvnewstiching.Columns[22].Visible = false; //XLHS
                                    gvnewstiching.Columns[23].Visible = false; //XXLHS

                                    gvnewstiching.Columns[24].Visible = false; //3XLHS
                                    gvnewstiching.Columns[25].Visible = false; //4XLHS
                                    ...
                                    foreach (ListItem item in chkSizes.Items)
                                    {
                                        ...
                                        if (item.Selected)
                                        {

                                            {
                                                if (item.Text == "30FS")
                                                {
                                                    gvnewstiching.Columns[2].Visible = true;
                                                }
                                                if (item.Text == "32FS")
                                                {
                                                    gvnewstiching.Columns[3].Visible = true;
                                                }
                                                if (item.Text == "34FS")
                                                {
                                                    gvnewstiching.Columns[4].Visible = true;
                                                }
                                                if (item.Text == "36FS")
                                                {
                                                    gvnewstiching.Columns[5].Visible = true;
                                                }
                                                if (item.Text == "XSFS")
                                                {
                                                    gvnewstiching.Columns[6].Visible = true;
                                                }
                                                if (item.Text == "SFS")
                                                {
                                                    gvnewstiching.Columns[7].Visible = true;
                                                }
                                                if (item.Text == "MFS")
                                                {
                                                    gvnewstiching.Columns[8].Visible = true;
                                                }
                                                if (item.Text == "LFS")
                                                {
                                                    gvnewstiching.Columns[9].Visible = true;
                                                }
                                                if (item.Text == "XLFS")
                                                {
                                                    gvnewstiching.Columns[10].Visible = true;
                                                }
                                                if (item.Text == "XXLFS")
                                                {
                                                    gvnewstiching.Columns[11].Visible = true;
                                                }
                                                if (item.Text == "3XLFS")
                                                {
                                                    gvnewstiching.Columns[12].Visible = true;
                                                }
                                                if (item.Text == "4XLFS")
                                                {
                                                    gvnewstiching.Columns[13].Visible = true;
                                                }
                                                ...
                                                if (item.Text == "30HS")
                                                {
                                                    gvnewstiching.Columns[14].Visible = true;
                                                }

                                                if (item.Text == "32HS")
                                                {
                                                    gvnewstiching.Columns[15].Visible = true;
                                                }

                                                if (item.Text == "34HS")
                                                {
                                                    gvnewstiching.Columns[16].Visible = true;
                                                }

                                                if (item.Text == "36HS")
                                                {
                                                    gvnewstiching.Columns[17].Visible = true;

                                                }

                                                if (item.Text == "XSHS")
                                                {
                                                    gvnewstiching.Columns[18].Visible = true;
                                                }

                                                if (item.Text == "SHS")
                                                {
                                                    gvnewstiching.Columns[19].Visible = true;
                                                }

                                                if (item.Text == "MHS")
                                                {
                                                    gvnewstiching.Columns[20].Visible = true;
                                                }

                                                if (item.Text == "LHS")
                                                {
                                                    gvnewstiching.Columns[21].Visible = true;
                                                }

                                                if (item.Text == "XLHS")
                                                {
                                                    gvnewstiching.Columns[22].Visible = true;
                                                }

                                                if (item.Text == "XXLHS")
                                                {
                                                    gvnewstiching.Columns[23].Visible = true;
                                                }

                                                if (item.Text == "3XLHS")
                                                {
                                                    gvnewstiching.Columns[24].Visible = true;
                                                }

                                                if (item.Text == "4XLHS")
                                                {
                                                    gvnewstiching.Columns[25].Visible = true;
                                                }
                                ...
                                {
                                    Label lblStockRatioId = (Label)gvnewstiching.Rows[i].FindControl("lblStockRatioId");
                                    ...
                                    Label lblonlycolor = (Label)gvnewstiching.Rows[i].FindControl("lblonlycolor");
        ...
        protected void company_SelectedIndexChnaged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSet dsLotNo = objbs.Select_LotDetails("Stc", drpbranch.SelectedValue);
                if (dsLotNo.Tables[0].Rows.Count > 0)
                {
                    DataSet dsLotNoval = objbs.Select_LotDetailsnew("Stc", drpbranch.SelectedValue, 2);
        ...
        protected void EmployeeRate_chnaged(object sender, EventArgs e)
        {
            if (ddlLotNo.SelectedValue != "Select Lot No")
            {
                ...
                {
                    DataSet getrate = objbs.getrateforjobworker(drpMultiemployee.SelectedValue, lblitemid.Text, "Stc");
                    ...
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "myscript", "alert('Please Enter Rate For this Item.Something Went Wrong to this " + ddlLotNo.SelectedItem.Text + ". Thank you');", true);
                        return;
                    }
        ...
        protected void StitchingInfo_Load(object sender, EventArgs e)
        {
            ...
            if (ddlLotNo.SelectedValue != "Select Lot No")
            {
                ...
                int dcheck = objbs.checkcurrent(ddlLotNo.SelectedValue, "Stc");
                if (dcheck == 1)
                {
                    #region
                    double stitchrate = 0;
                    ...
                    DataSet dlotprocess = new DataSet();
                    dlotprocess = objbs.Get_LotDetails(Convert.ToString(ddlLotNo.SelectedValue), "3", "Stc");
                    if (dlotprocess.Tables[0].Rows.Count > 0)
                    {
                        txttotalqty.Text = dlotprocess.Tables[0].Rows[0]["TotalQuantity"].ToString();
                        lblbrandnid.Text = dlotprocess.Tables[0].Rows[0]["Brandid"].ToString();
        ...
        protected void Add_LotProcessDetails(object sender, EventArgs e)
        {
            ...
            if (btnadd.Text == "Save")
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "myscript", "alert('Cutting Date And Stiching Issue date MisMatch.Thank you!!!');", true);
                    return;
            ...
            else if (btnadd.Text == "Received")
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "myscript", "alert('Stiching Issue Date And Stiching Receive date MisMatch.Thank you!!!');", true);
                    return;
            ...
            if (btnadd.Text == "Save")
            {
                ...
                int istatus3 = objbs.insertJpStiching(Convert.ToDouble(txtAmount.Text), Convert.ToInt32(ddlLotNo.SelectedValue), lbllotno.Text, MultiDate, Convert.ToInt32(drpMultiemployee.SelectedValue), Convert.ToDouble(txttotalqty.Text), empid, drpbranch.SelectedValue, ddlLotNo.SelectedItem.Text, Convert.ToInt32(txtsendFQtymain.Text), ReceiveDate, txtitemnarration.Text);

                for (int vLoop = 0; vLoop < gvnewstiching.Rows.Count; vLoop++)
                {
                    int vLoopp = 0;
                    ...
                    //////  Label lblitemname = (Label)gvcustomerorder.Rows[vLoopp].FindControl("lblitemname");
                    ...
                    #region
                    Label lblitemname = (Label)gvnewstiching.Rows[vLoop].FindControl("lbldesignno");

                    TextBox txts30fs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txts30fs");
                    TextBox txts32fs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txts32fs");
                    TextBox txts34fs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txts34fs");
                    TextBox txts36fs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txts36fs");
                    TextBox txtsxsfs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txtsxsfs");
                    TextBox txtssfs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txtssfs");
                    TextBox txtsmfs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txtsmfs");
                    TextBox txtslfs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txtslfs");
                    TextBox txtsxlfs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txtsxlfs");
                    TextBox txtsxxlfs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txtsxxlfs");
                    TextBox txts3xlfs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txts3xlfs");
                    TextBox txts4xlfs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txts4xlfs");

                    TextBox txts30hs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txts30hs");
                    TextBox txts32hs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txts32hs");
                    TextBox txts34hs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txts34hs");
                    TextBox txts36hs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txts36hs");
                    TextBox txtsxshs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txtsxshs");
                    TextBox txtsshs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txtsshs");
                    TextBox txtsmhs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txtsmhs");
                    TextBox txtslhs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txtslhs");
                    TextBox txtsxlhs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txtsxlhs");
                    TextBox txtsxxlhs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txtsxxlhs");
                    TextBox txts3xlhs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txts3xlhs");
                    TextBox txts4xlhs = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txts4xlhs");

                    Label lblStockRatioId = (Label)gvnewstiching.Rows[vLoop].FindControl("lblStockRatioId");
                    Label lblMasterid = (Label)gvnewstiching.Rows[vLoop].FindControl("lblMasterid");
                    Label lblTransfabid = (Label)gvnewstiching.Rows[vLoop].FindControl("lblTransfabid");

                    TextBox txtsendFQtycolor = (TextBox)gvnewstiching.Rows[vLoop].FindControl("txtsendFQty");
                    ...
                    else
                    {
                        ...
                        {
                            int istasHistoryid = objbs.inserttransjpstichingHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            int istas = objbs.inserttransJpStiching(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            if (vLoop == 0)
                            {
                                int istas1 = objbs.JpStiching(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                ...
                int istatus3l = objbs.statusJpStiching(Convert.ToInt32(ddlLotNo.SelectedValue));
            ...
            else if (btnadd.Text == "Received")
            {
                ...
                string Stitchingid = Request.QueryString.Get("Stitchingid");
                ...
                if (ddltype.SelectedValue == "Damage")
                {
                    int istasHistory = objbs.processmaintablestich(Convert.ToInt32(Stitchingid), Convert.ToInt32(txtdamageqtymain.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }
                else
                {
                    int istasHistory = objbs.processmaintablestich(Convert.ToInt32(Stitchingid), Convert.ToInt32(txtrecFQty.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }

                DataSet gprocessstock = objbs.storestichingprocessstock(ddlLotNo.SelectedItem.Text);
                string DesignCode = gprocessstock.Tables[0].Rows[0]["DesignCode"].ToString();
                string BrandId = gprocessstock.Tables[0].Rows[0]["BrandId"].ToString();
                string Fit = gprocessstock.Tables[0].Rows[0]["Fit"].ToString();
                string Itemname = gprocessstock.Tables[0].Rows[0]["Itemname"].ToString();
                string Companyid = gprocessstock.Tables[0].Rows[0]["Companyid"].ToString();
                string CompanyLotNo = gprocessstock.Tables[0].Rows[0]["CompanyLotNo"].ToString();
                ...
                for (int vLoop = 0; vLoop < gvnewstiching.Rows.Count; vLoop++)
                {
                    ...
                    //////  Label lblitemname = (Label)gvcustomerorder.Rows[vLooppp].FindControl("lblitemname");
                    ...
                    else
                    {
                        if (txtsendFQtycolor.Text != "0")
                        {
                            ...
                            if (ddltype.SelectedValue == "Damage")
                            {
                                int rec = objbs.DamageProcessStockRatio(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text), STICHING);
                            }
                            else
                            {
                                int rec = objbs.updateProcessStockRatio(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text));

                                string CompleteStitching = "";
                                DataSet dcalculate = objbs.Getstichingsnocontraval(Convert.ToInt32(ddlLotNo.SelectedValue));
                                CompleteStitching = dcalculate.Tables[0].Rows[0]["CompleteStitching"].ToString();
                                if (CompleteStitching == "Yes")
                                {
                                    if (drpbranch.SelectedValue == "4")
                                    {
                                        #region Insert BC Finished Stock

                                        string LotNoSplict = ddlLotNo.SelectedItem.Text;
                                        string[] arg = LotNoSplict.Split('/');

                                        int args = arg.Length;
                                        if (args == 2)
                                        {
                                            string BCLotNo = arg[0];

                                            // DataSet dsGetFinishdetails = objbs.GetFinishdetailsBC(Convert.ToString(lblfitid.Text), BCLotNo, lblitemname.Text);
                                            // DataSet dsGetFinishdetails = objbs.GetFinishdetailsBC(Convert.ToString(lblfitid.Text), ddlLotNo.SelectedItem.Text, lblitemname.Text);
                                            DataSet dsGetFinishdetails = objbs.GetFinishdetailsBC(Convert.ToString(lblfitid.Text), BCLotNo, lblitemname.Text);
                                            if (dsGetFinishdetails.Tables[0].Rows.Count > 0)
                                            {
                                                ...
                                                int istockid = objbs.UPDATEFinishedstockwisestockStitch(Convert.ToString(lblStockRatioId.Text), Convert.ToString(txtsendFQtycolor.Text), txts30fs.Text, txts32fs.Text, txts34fs.Text, txts36fs.Text, txtsxsfs.Text, txtssfs.Text, txtsmfs.Text, txtslfs.Text, txtsxlfs.Text, txtsxxlfs.Text, txts3xlfs.Text, txts4xlfs.Text, txts30hs.Text, txts32hs.Text, txts34hs.Text, txts36hs.Text, txtsxshs.Text, txtsshs.Text, txtsmhs.Text, txtslhs.Text, txtsxlhs.Text, txtsxxlhs.Text, txts3xlhs.Text, txts4xlhs.Text, "Y", Convert.ToString(BCLotNo), lblitemname.Text, Convert.ToString(lblfitid.Text));
                                                #endregion
                                            }
                                            else
                                            {
                                                ...
                                                string R4xlfs = txts4xlfs.Text;
                                                string R4xlhs = txts4xlhs.Text;
                                                //  int istockid = objbs.insertFinishedstockwisestockStitchBC(Convert.ToString(lblStockRatioId.Text), "0", "0", "0", lblitemname.Text, BrandId, lblfitid.Text, Itemname, drpbranch.SelectedValue, ddlLotNo.SelectedItem.Text, txtsendFQtycolor.Text, "0", txts30fs.Text, txts32fs.Text, txts34fs.Text, txts36fs.Text, txtsxsfs.Text, txtssfs.Text, txtsmfs.Text, txtslfs.Text, txtsxlfs.Text, txtsxxlfs.Text, txts3xlfs.Text, txts4xlfs.Text, txts30hs.Text, txts32hs.Text, txts34hs.Text, txts36hs.Text, txtsxshs.Text, txtsshs.Text, txtsmhs.Text, txtslhs.Text, txtsxlhs.Text, txtsxxlhs.Text, txts3xlhs.Text, txts4xlhs.Text, "Y", BCLotNo);
                                                int istockid = objbs.insertFinishedstockwisestockStitchBC(Convert.ToString(lblStockRatioId.Text), "0", "0", "0", lblitemname.Text, BrandId, lblfitid.Text, Itemname, drpbranch.SelectedValue, BCLotNo, txtsendFQtycolor.Text, "0", txts30fs.Text, txts32fs.Text, txts34fs.Text, txts36fs.Text, txtsxsfs.Text, txtssfs.Text, txtsmfs.Text, txtslfs.Text, txtsxlfs.Text, txtsxxlfs.Text, txts3xlfs.Text, txts4xlfs.Text, txts30hs.Text, txts32hs.Text, txts34hs.Text, txts36hs.Text, txtsxshs.Text, txtsshs.Text, txtsmhs.Text, txtslhs.Text, txtsxlhs.Text, txtsxxlhs.Text, txts3xlhs.Text, txts4xlhs.Text, "Y", BCLotNo);
                                                #endregion
                                            }
                                        }
                                        else
                                        {
                                            #region
                                            DataSet dsGetFinishdetails = objbs.GetFinishdetails(Convert.ToString(lblfitid.Text), Convert.ToString(ddlLotNo.SelectedItem.Text), lblitemname.Text);
                                            if (dsGetFinishdetails.Tables[0].Rows.Count > 0)
                                            {
                                                #region
                                                string R30fs = txts30fs.Text;
                                                ...
                                                string R4xlfs = txts4xlfs.Text;
                                                string R4xlhs = txts4xlhs.Text;
                                                int istockid = objbs.UPDATEFinishedstockwisestockStitch(Convert.ToString(lblStockRatioId.Text), Convert.ToString(txtsendFQtycolor.Text), txts30fs.Text, txts32fs.Text, txts34fs.Text, txts36fs.Text, txtsxsfs.Text, txtssfs.Text, txtsmfs.Text, txtslfs.Text, txtsxlfs.Text, txtsxxlfs.Text, txts3xlfs.Text, txts4xlfs.Text, txts30hs.Text, txts32hs.Text, txts34hs.Text, txts36hs.Text, txtsxshs.Text, txtsshs.Text, txtsmhs.Text, txtslhs.Text, txtsxlhs.Text, txtsxxlhs.Text, txts3xlhs.Text, txts4xlhs.Text, "Y", Convert.ToString(ddlLotNo.SelectedItem.Text), lblitemname.Text, Convert.ToString(lblfitid.Text));
                                                #endregion
                                            }
                                            else
                                            {
                                                ...
                                                string R4xlfs = txts4xlfs.Text;
                                                string R4xlhs = txts4xlhs.Text;
                                                int istockid = objbs.insertFinishedstockwisestockStitch(Convert.ToString(lblStockRatioId.Text), "0", "0", "0", lblitemname.Text, BrandId, lblfitid.Text, Itemname, drpbranch.SelectedValue, CompanyLotNo, txtsendFQtycolor.Text, "0", txts30fs.Text, txts32fs.Text, txts34fs.Text, txts36fs.Text, txtsxsfs.Text, txtssfs.Text, txtsmfs.Text, txtslfs.Text, txtsxlfs.Text, txtsxxlfs.Text, txts3xlfs.Text, txts4xlfs.Text, txts30hs.Text, txts32hs.Text, txts34hs.Text, txts36hs.Text, txtsxshs.Text, txtsshs.Text, txtsmhs.Text, txtslhs.Text, txtsxlhs.Text, txtsxxlhs.Text, txts3xlhs.Text, txts4xlhs.Text, "Y");
                                                #endregion
                                            }
                                    ...
                                    {
                                        #region Insert RPL Finished Stock

                                        DataSet dsGetFinishdetails = objbs.GetFinishdetails(Convert.ToString(lblfitid.Text), Convert.ToString(ddlLotNo.SelectedItem.Text), lblitemname.Text);
                                        ////// DataSet dsManualStock_Details = objbs.storestichingfinishstock(lblStockRatioId.Text);
                                        if (dsGetFinishdetails.Tables[0].Rows.Count > 0)
                                        {
                                            #region
                                            string R30fs = txts30fs.Text;
            ...
            else if (btnadd.Text == "Partial")
            {
                ...
                int istatus3 = objbs.UpdJpStiching(Convert.ToDouble(txtAmount.Text), Convert.ToInt32(ddlLotNo.SelectedValue), lbllotno.Text, MultiDate, Convert.ToInt32(drpMultiemployee.SelectedValue), Convert.ToDouble(txttotalqty.Text), Stitchingid, empid);
                ...
                for (int vLoop = 0; vLoop < gvcustomerorder.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        ...
                        int istas = objbs.inserttransJpStichingpartial(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                  recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Convert.ToInt32(ddlLotNo.SelectedValue), empid, Convert.ToInt32(txtsendFQty.Text), Stitchingid);
