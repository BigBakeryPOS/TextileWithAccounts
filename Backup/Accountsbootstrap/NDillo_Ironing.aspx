<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NDillo_Ironing.aspx.cs" Inherits="Billing.Accountsbootstrap.NDillo_Ironing" %>
...
<head id="Head1" runat="server">
    ...
    <title>Flexible Apparels || Ironing Lot Process</title>
                                  ...
                                  OnSelectedIndexChanged="StitchingInfo_Load" AutoPostBack="true"></asp:DropDownList>
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <div id="but" runat="server" class="row">
                                                ...
                                                <asp:Button ID="btnexit" runat="server" class="btn btn-warning" Text="Exit" PostBackUrl="NDilloIroning_Grid.aspx"
