                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div id="Excel" runat="server">
                            <asp:GridView ID="gvPOPending" runat="server" CssClass="myGridStyle1" EmptyDataText="No Records Found" OnRowDataBound="gvOrderReport_OnRowDataBound" ShowFooter="true"
                                Width="100%" AutoGenerateColumns="false" Caption="Purchase Order Pending Report">
