...
{
    public partial class BuyerOrderSalesReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet dsRecPONo = objBs.GetBuyerOrderSalesBuyerList();
                if (dsRecPONo.Tables[0].Rows.Count > 0)
                {
                    ddlBuyerName.DataSource = dsRecPONo.Tables[0];
        ...
        protected void btnSearch_OnClick(object sender, EventArgs e)
        {
            ...
            //if (ddlBuyerName.SelectedValue != "" && ddlBuyerName.SelectedValue != "" && ddlBuyerName.SelectedValue != "Select BuyerName")
            //{
            ...
            DataSet dsBODetails = objBs.GetBuyerOrderSalesReportBuyerwise(ddlBuyerName.SelectedValue,Convert.ToDateTime(txtFromDate.Text),Convert.ToDateTime(txtToDate.Text));
                if (dsBODetails.Tables[0].Rows.Count > 0)
                {
                    ...
                    gvBuyerOrderDetails.DataSource = dsBODetails;
