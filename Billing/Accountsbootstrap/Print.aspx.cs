    ...
    public partial class Print : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Printingid != null)
            {
                ...
                DataSet ds2 = objBs.JpPrintingfor(Printingid);
                if (ds2.Tables[0].Rows.Count > 0)
                {
                    ...
                    DataSet ds23 = objBs.Get_JpPrint(Convert.ToString(Printingid), "8", "Print");
        ...
        protected void btnclick(object sender, EventArgs e)
        {
            ...
            int isucess = objBs.updprintforall(Printingid, "tbltransjpPrintinghistory", "PrintingId");
        }
