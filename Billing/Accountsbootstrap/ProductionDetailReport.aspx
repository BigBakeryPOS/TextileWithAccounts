<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionDetailReport.aspx.cs"
    Inherits="Billing.Accountsbootstrap.ProductionDetailReport" %>
                            ...
                            <div class="col-lg-12">
                                ...
                                <asp:GridView ID="gvProductionReport" CssClass="" runat="server" Caption="Production Detail Report"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="FullEntryNo" HeaderText="EntryNo" />
                                        ...
                                        <asp:BoundField DataField="LedgerName" HeaderText="Name" />
                                        ...
                                        <asp:BoundField DataField="Issued" HeaderText="Issued" DataFormatString="{0:f0}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Center"/>
                                        <asp:BoundField DataField="Received" HeaderText="Received" DataFormatString="{0:f0}"
                                            ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Center"/>
                                        <asp:BoundField DataField="Damaged" HeaderText="Damaged" DataFormatString="{0:f0}"
                                            ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Center"/>
                                    </Columns>
                                </asp:GridView>
                            </div>
