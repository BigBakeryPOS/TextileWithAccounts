...
{
    public partial class Dillo_WashjobWork : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (lot != null)
                {
                    DataSet ds = objbs.SelectwashinggetGridView(lot);
                    {
                        ...
                        drpjobwork.SelectedValue = ds.Tables[0].Rows[0]["WashJobWorkId"].ToString();
        ...
        protected void StitchingInfo_Load(object sender, EventArgs e)
        {
            ...
            {
                 DataSet dgetunit = objbs.getcurrentunit(ddlLotNo.SelectedValue,"Wash");
                 if (dgetunit.Tables[0].Rows.Count > 0)
                 {
                     ...
                     if (dcheck == 1)
                     {
                         ...
                         if (dataSet.Tables[0].Rows.Count > 0)
                         {
                             ...
                             DataSet getdc = objbs.getdcforjobworkwash(ddlLotNo.SelectedValue);
        ...
        protected void jobworker_indexchanged(object sender, EventArgs e)
        {
            ...
            getallinformation = objbs.getnewjobworkprocesswash(drpjobwork.SelectedValue);
            ...
            if (getallinformation.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < getallinformation.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (dss.Tables[0].Rows.Count > 0)
                    {
                        if (chckJobWork.Checked == true)
                        {
                            DataSet dgetunit = objbs.getcurrentunit(cutid, "Wash");
                            if (dgetunit.Tables[0].Rows.Count > 0)
                            {
                                ddlUnit.SelectedValue = dgetunit.Tables[0].Rows[0]["Unit"].ToString();

                                int dcheck = objbs.checkcurrentforalljobwork(unit, cutid, "Wash");
                                if (dcheck == 1)
                                {
                                }
                                else
        ...
        protected void ButtonAdd1_Click(object sender, EventArgs e)
        {
            ...
            for (int vLoop = 0; vLoop < gvcustomerorder.Rows.Count; vLoop++)
            {
                ...
                else
                {
                    ...
                    {
                        ds = objbs.SelectwashinggetGridView(lot);
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                            {
        ...
        protected void Add_LotProcessDetails(object sender, EventArgs e)
        {
            ...
            if (ds.Tables[0].Rows.Count == 0)
            {
                ...
                int iStatus23 = objbs.insertWashingProcess1(Convert.ToInt32(ddlLotNo.SelectedValue), Convert.ToString(ddlLotNo.SelectedItem.Text), Convert.ToInt32(txtledgerid.Text),
                ...
                if (iStatus23 == 1)
                {
                    int iscuscc = objbs.updatewashwork (Convert.ToInt32(washid), Convert.ToInt32(txtdcno.Text), receivingdate );
                }
                    ...
                    else
                    {
                        ...
                        if (txtTotalQantity.Text != "")
                        {
                          //  string chk = "";
                            ...
                            int istasHistory = objbs.inserttranswashingProcessHistory1(Convert.ToInt32(drpprocess.SelectedValue), Convert.ToInt32(drpjobwork.SelectedValue), Convert.ToInt32(txtrecQty.Text),
                            ...
                            int istas = objbs.inserttranswashingProcess(Convert.ToInt32(drpprocess.SelectedValue), Convert.ToInt32(drpjobwork.SelectedValue), Convert.ToInt32(txtrecQty.Text),
                    ...
                    else
                    {
                        ...
                        if (txtTotalQantity.Text != "")
                        {
                          //  string chk = "";
                            ...
                            int istas = objbs.UpdatetransWashingProcess(Convert.ToInt32(drpprocess.SelectedValue), Convert.ToInt32(drpjobwork.SelectedValue), Convert.ToInt32(txtrecQty.Text),
                            recdate, Convert.ToDecimal(txtrate.Text), ddlLotNo.SelectedValue, Convert.ToInt32(txtTotalQantity.Text), chk);
                  ...
                  //  return;
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        if (dt.Rows[i]["Process"].ToString() != "")
                        {
                            ...
                            objbs.pre_Updation_Wash(Transid, ProcessTypeID, EmpID, RecQty, recdate, Rate, ddlLotNo.SelectedValue, totalQty, chk, lbldesignno.Text);
                        }
                    }
                    ...
                    for (int i = 0; i < gvcustomerorder.Rows.Count; i++)
                    {
                      ...
                      //  date.Text = DateTime.Now.ToString("dd/MM/yyyy");
                        ...
                        else
                        {
                                ...
                                if (istas == 1)
                                {
                                    int iscuscc = objbs.updatewashwork(0, Convert.ToInt32(txtdcno.Text), receivingdate );
                                }
