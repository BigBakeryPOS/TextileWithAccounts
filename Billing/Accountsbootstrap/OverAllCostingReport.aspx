<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OverAllCostingReport.aspx.cs"
    Inherits="Billing.Accountsbootstrap.OverAllCostingReport" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function Denomination() {
            ...
            var gridData = document.getElementById('pntt1');
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlLotNo" runat="server" OnSelectedIndexChanged="drpsamplechanged"
                                    Width="200px" Height="500px" AutoPostBack="true" CssClass="chzn-select">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-2">
                        ...
                        <div id="pntt1" runat="server">
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <label style="font-size: large; font-weight: bold">
                                                                Costing Process</label>
                                                            <asp:Label ID="lbbllott" Style="font-size: large; font-weight: bold" Visible="false"
                                                                runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table runat="server" visible="true" width="595px" height="100px" border="0" class="style1">
                                                    <tr>
                                                        <td valign="top" align="left">
                                                            <asp:Label ID="lblperrawmaterialcost" runat="server" Visible="false">0</asp:Label>
                                                            <asp:Label ID="lblrawmaterialcost" runat="server" Visible="false">0</asp:Label>
                                                            <asp:Label ID="lblfabriccost" runat="server" Visible="false">0</asp:Label>
                                                            <asp:Label ID="lbltotalshirt" runat="server" Visible="false">0</asp:Label>
                                                            <asp:Label ID="lblproductioncost" runat="server" Visible="false">0</asp:Label>
                                ...
                                Fit : </asp:Label>
                                                ...
                                                <table width="100%" height="100px" border="0" class="style1">
                                                    <tr>
                                                        ...
                                                        <td id="Td2" runat="server" visible="true" valign="top" align="left" style="width: 40%">
                                                            <label style="font-weight: bold">
                                                                TOTAL Fabric Meter USED</label>
                                                            <div>
                                                                <asp:GridView runat="server" BorderWidth="1" ID="fablistcalcalcuationgrid" CssClass="myleft"
                                                                    ...
                                                                    <HeaderStyle BorderStyle="Solid" BorderWidth="1px" />
                                                                    <Columns>
                                                                        <asp:BoundField HeaderText="FABRIC" DataField="nam" />
                                                                        <asp:BoundField HeaderText="Given Meter" DataFormatString='{0:f}' DataField="gvmeter" />
                                                                        <asp:BoundField HeaderText="Used Meter" DataFormatString='{0:f}' DataField="usedmeter" />
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="col-lg-4">
                                                        ...
                                                        <div>
                                                            <asp:GridView runat="server" BorderWidth="1" ID="gridavg" CssClass="myleft" GridLines="Both"
                                                                AlternatingRowStyle-CssClass="even" AutoGenerateColumns="false" ShowHeader="true"
                                                                PrintPageSize="30" AllowPrintPaging="true" Width="100%" ShowFooter="true" OnRowDataBound="gridavg_rowdatabound"
                                                                Style="font-family: 'Trebuchet MS'; font-size: 13px;">
                                                                <HeaderStyle BorderStyle="Solid" BorderWidth="1px" />
                                                                <Columns>
                                                                    <asp:BoundField HeaderText="Costing Type" DataField="type" />
                                                                    <asp:BoundField HeaderText="Total Cost" DataFormatString='{0:f}' DataField="Cost" />
                                                                    <asp:BoundField HeaderText="Cost Per shirt" DataFormatString='{0:f}' DataField="value" />
                                                                </Columns>
                                                            </asp:GridView>
                                                        </div>
                                                        <asp:Label ID="Lblvalue" Visible="false" runat="server"></asp:Label>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <label>
                                                            Fab.Rate +Prod.Cost + RawMaterial.Cost :</label>
                                                        <asp:Label ID="lblratee" runat="server"></asp:Label>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <label>
                                                            Margin %</label>
                                                        <asp:TextBox ID="txtmargin" OnTextChanged="margin_textchnaged" AutoPostBack="true"
                                                            runat="server">0</asp:TextBox>
                                                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server"
                                                            FilterType="Numbers,Custom" ValidChars="." TargetControlID="txtmargin" />
                                                        <br />
                                                        <label>
                                                            Sale Rate / Shirt :</label>
                                                        <asp:Label ID="lblsalesrate" runat="server"></asp:Label>
                                                    </div>
                                                </div>
                                                <br />
                                </div>
                            ...
                            <br />
                            <div class="col-lg-10" style="margin-top: 26px" id="divoverall" runat="server">
                                <asp:Label Visible="false" runat="server" ID="lblLot"></asp:Label>
                                            ...
                                            <td colspan="2" id="Td1" runat="server" valign="top" align="left" style="width: 100%">
                                                ...
                                                <div>
                                                    <asp:GridView runat="server" BorderWidth="1" ID="GridView2" CssClass="myGridStyle"
                                                        ...
                                                        Width="100%" OnRowDataBound="gridview2_rowbound" Style="font-family: 'Trebuchet MS';
                                                        font-size: 13px;">
                                                        <HeaderStyle BorderStyle="Solid" BorderWidth="1px" />
                                                        <Columns>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div align="center">
                                                    ...
                                                    <asp:GridView ID="gridprocesstype" runat="server" AllowPaging="false" CssClass="myGridStyle"
                                                        ShowFooter="true" AutoGenerateColumns="false" EmptyDataText="No data found!"
                                                        OnRowDataBound="gridprocesstypee" ShowHeaderWhenEmpty="True">
                                                        <Columns>
                                                            <asp:BoundField DataField="type" HeaderText="Process Type" ItemStyle-HorizontalAlign="Center" />
                                                            <asp:BoundField DataField="TotalAmount" DataFormatString='{0:f}' HeaderText="Total Amount"
                                                                ItemStyle-HorizontalAlign="Center" />
                                                        </Columns>
                                                        <HeaderStyle BackColor="#990000" />
                                                        <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                        ...
                        <div id="tabs" runat="server" visible="false" style="background-color: #D0D3D6; padding-left: 30px">
                            <ul>
                                <li><a href="#tabs-1">Fabric Costing</a></li>
                                <li><a href="#tabs-2">Raw-Materials Costing</a></li>
                                <li><a href="#tabs-3">Production Costing</a></li>
                                <li><a href="#tabs-4"></a></li>
                                <li><a href="#tabs-5"></a></li>
                            </ul>
                            <div id="pntt" runat="server">
                                <div class="row" id="tabs-1" style="background-color: White; padding-top: 30px">
                                    <div style="background-color: #D0D3D6;">
                                        <h2 align="center">
                                            <asp:Label ID="Label2" Style="color: Blue;" runat="server">FABRIC COSTING</asp:Label></h2>
                                        <div class=" form-group">
                                ...
                                <div class="row" id="tabs-2" style="background-color: #D0D3D6; padding-top: 30px">
                                    <div style="background-color: #D0D3D6;">
                                        <h2 align="center">
                                            <asp:Label ID="Label7" Style="color: Blue;" runat="server">RAW MATERIALS COSTING</asp:Label></h2>
                                        <div class=" form-group">
                                            <div class="table-responsive">
                                ...
                                <div class="row" id="tabs-3" style="background-color: #D0D3D6; padding-top: 30px">
                                    <div style="background-color: #D0D3D6;">
                                        <h2 align="center">
                                            <asp:Label ID="Label8" Style="color: Blue;" runat="server">PRODUCTION COSTING</asp:Label></h2>
                                        <div class=" form-group">
                                            <div class="table-responsive">
                                                <table style="width: 85%">
                                                </table>
                                                        ...
                                                        <td>
                                                            <asp:GridView ID="gridwash" runat="server" AllowPaging="false" CssClass="myGridStyle"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="PerRate" Visible="false" HeaderText="Rate Per Quantity"
                                                                    ...
                                                                    <asp:BoundField DataField="Rate" Visible="false" HeaderText="Total Rate" DataFormatString='{0:f}'
                                                                        ItemStyle-HorizontalAlign="Center" />
                                                                </Columns>
                                                                <HeaderStyle BackColor="#990000" />
                                                                <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                    ...
                    <div class="col-lg-2" runat="server" id="reportDetails">
                        <div class="form-group">
                            <asp:Button ID="btnAllLotProcess" Visible="false" class="btn btn-warning" runat="server"
                                Style="width: 180px;" Text="All" OnClick="Process_Details" />
                        </div>
                        <div class="form-group">
                            <asp:Button ID="btnInv" class="btn btn-info" Visible="false" runat="server" Style="width: 180px;"
                                Text="Purchase Invoice Details" OnClick="Process_Details" />
                        </div>
                        <div class="form-group">
                            <asp:Button ID="btnCutting" class="btn btn-success" Visible="false" runat="server"
                                Style="width: 180px;" Text="Pre - Cutting Details" OnClick="PreCutting_GetDetails" />
                        </div>
                        <div class="form-group">
                            <asp:Button ID="btnStitching" class="btn btn-primary" Visible="false" runat="server"
                                Style="width: 180px;" Text="Stitching Details" OnClick="Process_Details" />
                        </div>
                        <div class="form-group">
                            <asp:Button ID="btnKaja" class="btn btn-info" Visible="false" runat="server" Style="width: 180px;"
                                Text="Kaja Details" OnClick="Process_Details" />
                        </div>
                        <div class="form-group">
                            <asp:Button ID="btnEmb" class="btn btn-warning" runat="server" Visible="false" Style="width: 180px;"
                                Text="Embroiding Details" OnClick="Process_Details" />
                        </div>
                        <div class="form-group">
                            <asp:Button ID="btnWashing" class="btn btn-danger" runat="server" Visible="false"
                                Style="width: 180px;" Text="Washing Details" OnClick="Process_Details" />
                        </div>
                        <div class="form-group">
                            <asp:Button ID="btnIron" class="btn btn-success" runat="server" Visible="false" Style="width: 180px;"
