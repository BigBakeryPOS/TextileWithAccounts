...
namespace Billing.Accountsbootstrap
{
    public partial class AccPage : System.Web.UI.Page
    {
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            ddlCustomerType.SelectedItem.Text = "Customer";
            if (ddlCustomerType.SelectedItem.Text == "Customer")
            {
             Grupid=1;
            ...
            if (btnadd.Text == "Save")
            {
                if (ddlCDType.SelectedValue == "Credit Note")
                {
                    ...
                    int i = objBs.ledgercr(txtcustomername.Text, txtmobileno.Text, txtphoneno.Text, txtarea.Text, txtaddress.Text, txtcity.Text, txtpincode.Text, txtemail.Text, Grupid, ddlIsActive.SelectedValue, Convert.ToDouble(Credite), Convert.ToDouble("0"), ddlCDType.SelectedValue, Convert.ToInt32("1"), Convert.ToInt32(txtCustomerid.Text), Tinno, "tblAuditMaster_" + sTableName, lblUser.Text, "Customer", ddlCDType.SelectedItem.Text, openingbalance, txtCustomerid.Text, TextBox1.Text, txtCST.Text, txtPAN.Text, txtDesignation.Text, txtDelivery.Text, 0, 0, 0, Convert.ToInt32(ddlPrice.SelectedValue), date, dat, Convert.ToInt32(txtCreditDays.Text), drpagent.SelectedValue, txtprintname.Text, txtgstin.Text,ddlProvince.SelectedValue);
            ...
            else
            {
                ...
                if (ddlCDType.SelectedValue == "Credit Note")
                {
                    ...
                    int iStatus = objBs.updatecustomer(Convert.ToInt32(iCusID), txtcustomername.Text, txtmobileno.Text, txtphoneno.Text, txtarea.Text, txtaddress.Text, txtcity.Text, txtpincode.Text, txtemail.Text, Convert.ToInt32("1"), ddlIsActive.SelectedItem.Text, Convert.ToDouble(Credite), Convert.ToDouble("0"), ddlCDType.SelectedValue, Convert.ToInt32(txtCustomerid.Text), Tinno, "tblAuditMaster_" + sTableName, lblUser.Text, "Customer", ddlCDType.SelectedItem.Text, openingbalance, txtCustomerid.Text, TextBox1.Text, txtCST.Text, txtPAN.Text, txtDesignation.Text, txtDelivery.Text, 0, 0, 0, Convert.ToInt32(ddlPrice.SelectedValue), date, dat, Convert.ToInt32(txtCreditDays.Text), drpagent.SelectedValue, txtprintname.Text, txtgstin.Text,ddlProvince.SelectedValue);
                    Response.Redirect("../Accountsbootstrap/viewcustomer.aspx");
                }
                else
                {
                    string Debit = txtOBalance.Text;
                    int iStatus = objBs.updatecustomer(Convert.ToInt32(iCusID), txtcustomername.Text, txtmobileno.Text, txtphoneno.Text, txtarea.Text, txtaddress.Text, txtcity.Text, txtpincode.Text, txtemail.Text, Convert.ToInt32("1"), ddlIsActive.SelectedItem.Text, Convert.ToDouble("0"), Convert.ToDouble(Debit), ddlCDType.SelectedValue, Convert.ToInt32(txtCustomerid.Text), Tinno, "tblAuditMaster_" + sTableName, lblUser.Text, "Customer", ddlCDType.SelectedItem.Text, openingbalance, txtCustomerid.Text, TextBox1.Text, txtCST.Text, txtPAN.Text, txtDesignation.Text, txtDelivery.Text, 0, 0, 0, Convert.ToInt32(ddlPrice.SelectedValue), date, dat, Convert.ToInt32(txtCreditDays.Text), drpagent.SelectedValue, txtprintname.Text, txtgstin.Text, ddlProvince.SelectedValue);
                    Response.Redirect("../Accountsbootstrap/viewcustomer.aspx");
                }
            }
        ...
        protected void txtcustomername_TextChanged(object sender, EventArgs e)
        {
            ...
            ds = objBs.expensivenamenew(txtcustomername.Text);
            if ((ds.Tables[0].Rows.Count) > 0)
            {
