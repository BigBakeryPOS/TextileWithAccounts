...
{
    public partial class BarTagGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet dunit = objBs.pendinglotdetail("tbljpbartag", "tbltransjpbartag", drpbranch.SelectedValue, drppending.SelectedValue, "bartagid");
                    //= objBs.JpBarTagformulti();
        ...
        protected void pending_changed(object sender, EventArgs e)
        {
            ...
            //////DataSet pending = objBs.pendinglotdetail("tbljpbartag", "tbltransjpbartag", drpbranch.SelectedValue, drppending.SelectedValue, "bartagid");
        ...
        protected void Barcode_indexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dss.Tables[0].Rows.Count > 0)
                {
                    ...
                    Response.Redirect("BarTag.aspx?name=Receive&lotid=" + muti);
                }
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Editt")
            {
                ...
                Response.Redirect("BarTag.aspx?name=Edit&BarTagid=" + e.CommandArgument.ToString());
            ...
            else if (e.CommandName == "partial")
            {
                ...
                {
                    Response.Redirect("BarTag.aspx?name=partial&BarTagid=" + e.CommandArgument.ToString());
                }
                //else
                //{
            ...
            else if (e.CommandName == "Received")
            {
                ...
                //if (ds.Tables[0].Rows.Count > 0)
                {
                    Response.Redirect("BarTag.aspx?name=Receive&BarTagid=" + e.CommandArgument.ToString());
                }
                //else
                //{
                //    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Check This Lot number Because this is used in another Process.Thank You!!!')", true);
            ...
            //{
            //    Response.Redirect("BarTagG.aspx?BarTagid=" + e.CommandArgument.ToString());

            //}
            else if (e.CommandName == "printt")
            {
                Response.Redirect("StitchingG.aspx?PrintIdForAll=" + e.CommandArgument.ToString() + "&ScreenName=Bartag");

            }
            else if (e.CommandName == "printtrec")
            {
                Response.Redirect("StitchingG.aspx?PrintIdForAllrec=" + e.CommandArgument.ToString() + "&ScreenName=Bartag");

            }
            else if (e.CommandName == "printt1")
            {
                Response.Redirect("BarTag.aspx?BarTagid=" + e.CommandArgument.ToString());
        ...
        protected void Date_OnTextChanged(object sender, EventArgs e)
        {
            ...
            DataSet pending = objBs.getallProcessdetails("tblJpBarTag", "tbltransjpBarTag", "BarTagid", drpbranch.SelectedValue, drppending.SelectedValue, ddljobworker.SelectedValue, FromDate, ToDate);
            if (pending.Tables[0].Rows.Count > 0)
            {
                gvcust.DataSource = pending;
                gvcust.DataBind();
