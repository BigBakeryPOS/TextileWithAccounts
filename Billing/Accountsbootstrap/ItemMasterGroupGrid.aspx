<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemMasterGroupGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.ItemMasterGroupGrid" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12" align="center">
                            ...
                            <div class="col-lg-16">
                                ...
                                <asp:TextBox CssClass="form-control" Enabled="true" onkeyup="Search_Gridview(this, 'gvItemMaster')"
                    ...
                    <div style="height: 392px; overflow: auto" class="table-responsive">
                        <table class="table table-bordered table-striped">
                            <tr>
                                <td>
                                    <asp:GridView ID="gvItemMaster" runat="server" CssClass="myGridStyle1" EmptyDataText="No records Found"
                                        Width="100%" AutoGenerateColumns="false" OnRowCommand="gvItemMaster_RowCommand">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Item Group" DataField="Itemgroupname" />
                                            <asp:BoundField HeaderText="Item Head" DataField="category" />
                                            <asp:BoundField HeaderText="Item Name" DataField="ItemDescription" />
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("ItemMasterId") %>'
                                                        CommandName="Edit">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("ItemMasterId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("ItemMasterId") %>'
