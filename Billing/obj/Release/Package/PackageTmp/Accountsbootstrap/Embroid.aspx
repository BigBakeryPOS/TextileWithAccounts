<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Embroid.aspx.cs" Inherits="Billing.Accountsbootstrap.Embroid" %>
...
<head id="Head1" runat="server">
    ...
    <title>Embroiding Issue / Receive</title>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            var grid = document.getElementById('gvnewemb');
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div>
                                    ...
                                    <asp:GridView ID="gvnewemb" AutoGenerateColumns="False" ShowFooter="True" CssClass="chzn-container"
                                        Width="100%" runat="server" OnRowDataBound="gvnewemb_RowDataBound">
                                        <HeaderStyle BackColor="#59d3b4" />
                                        <EmptyDataRowStyle HorizontalAlign="Center" BackColor="#59d3b4" ForeColor="Black" />
                                        <Columns>
                                            <asp:TemplateField HeaderText="S.No">
                                    ...
                                    <div class="col-lg-4">
                                        <div id="but" runat="server" class="row">
                                            <asp:Button ID="Button1" runat="server" class="btn btn-info" Text="Calc" Visible="false"
                                                ValidationGroup="val1" Style="width: 120px; margin-top: 25px" OnClick="Add1_Click" />
                                            ...
                                            <asp:Button ID="btnexit" runat="server" class="btn btn-warning" Text="Exit" PostBackUrl="EmbroidingGrid1.aspx"
