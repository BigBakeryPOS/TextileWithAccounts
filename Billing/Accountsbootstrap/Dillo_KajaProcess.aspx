<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dillo_KajaProcess.aspx.cs" Inherits="Billing.Accountsbootstrap.Dillo_KajaProcess" %>
                ...
                <div class="panel-body">
                  ...
                  <%--  <asp:UpdatePanel ID="Updatepanel2" runat="server" UpdateMode="Conditional">
                    ...
                    <div id="add" runat="server" class="row">
                        ...
                        <div class="col-lg-3" runat="server" id="divWork">
                             <label style="font-weight: bold">
                                    Work Process</label>
                        ...
                        <div class="col-lg-2" runat="server" id="divWorkManual">
                             <label style="font-weight: bold">
                                    Work Process</label>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body" style="height:300px">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="Table1" width="120%">
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="gvcustomerorder" AutoGenerateColumns="False" ShowFooter="True" EnableViewState="true"
                                                            ...
                                                            CssClass="chzn-container"  Width="100%" Height="300px" runat="server">
                                                              ...
                                                              <asp:TemplateField HeaderText="S.No" ItemStyle-Width="2%">
                                                               ...
                                                               <asp:TemplateField HeaderText="36HS" ItemStyle-Width="3%">
                                                                ...
                                                                <asp:TemplateField HeaderText="Received Quantity" ItemStyle-Width="0%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtRecQuantity" runat="server" Width="100%" AutoPostBack="true" OnTextChanged="txtRange_Change" Height="26px" AppendDataBoundItems="true"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
