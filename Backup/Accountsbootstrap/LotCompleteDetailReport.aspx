<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LotCompleteDetailReport.aspx.cs"
    Inherits="Billing.Accountsbootstrap.LotCompleteDetailReport" %>
...
<head id="Head1" runat="server">
    ...
    <title>LotQuantity Details</title>
    <!-- Bootstrap Core CSS -->
                            ...
                            <asp:UpdatePanel ID="update" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <asp:TextBox ID="txtsearching" runat="server" onkeyup="Search_Gridview(this, 'gridcatqty')"
                                        ...
                                        <div class="col-lg-1" runat="server" visible="false">
                                            ...
                                            <asp:Button ID="btnadd" runat="server" Text="Add New" Visible="true" CssClass="btn btn-danger"
                                                PostBackUrl="~/Accountsbootstrap/DespatchStock.aspx" Width="100px" />
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                <asp:RadioButtonList ID="rdbtype" RepeatColumns="2" runat="server" CssClass="center-block">
                                        ...
                                        <div class="col-lg-2">
                                            <asp:Button runat="server" ID="Button1" class="btn btn-success" OnClick="btnsearchnew_Click"
                                                    ...
                                                    <tr>
                                                        <td id="Td1" runat="server" visible="true">
                                                            <asp:GridView ID="gridcatqty" Visible="true" runat="server" EmptyDataText="Sorry Data Not Found!"
                                                                Width="90%" CssClass="myGridStyle" AutoGenerateColumns="false" OnRowCommand="gvCustsales_RowCommand">
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="CompanyLotNo" HeaderText="CompanyLotNo" />
                                                                    <asp:BoundField DataField="TotalShirt" HeaderText="TotalShirt" ItemStyle-Width="100%" />
                                                                    <%--<asp:BoundField DataField="StoreQty" HeaderText="StoreQty" />--%>
                                                                    <asp:BoundField DataField="BalanceQty" HeaderText="UnReceived" />
                                                                    <asp:BoundField DataField="ReadyForDesPatch" HeaderText="ReadyForDesPatch" />
                                                                    <asp:BoundField DataField="TotalDiffQty" HeaderText="DesPatchedQty" />
