...
{
    public partial class BuyerOrderMasterGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet ds = objBs.GetBuyerOrderData(drpyear.SelectedValue, "2");
                ...
                DataSet dss = objBs.GetBuyerOrderData_summary(drpyear.SelectedValue, "2");
                if (dss.Tables[0].Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dss.Tables[0].Rows)
                    {
                        ...
                        DataSet dss1 = objBs.GetBuyerOrderData_summarycount(drpyear.SelectedValue, "2", dr["currencyid"].ToString());
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            {
                button = btnadd.Text;
                Response.Redirect("BuyerOrderMaster.aspx");
            }
        ...
        protected void gvBuyerOrder_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                ...
                {
                    Response.Redirect("BuyerOrderMaster.aspx?BuyerOrderId=" + e.CommandArgument.ToString());
                }
            }
            else if (e.CommandName == "ExportExcel")
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    Response.Buffer = true;
                    Response.AddHeader("content-disposition", string.Format("attachment; filename={0}", "BuyerOrderMaster.xls"));
