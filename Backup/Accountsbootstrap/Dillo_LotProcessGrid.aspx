<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dillo_LotProcessGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.Dillo_LotProcessGrid" %>
...
<head>
    ...
    <title>Flexible Apparels || Lot Process Grid</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12" align="center">
                            ...
                            <div class="col-lg-17">
                                <asp:Button ID="btnadd" runat="server" class="btn btn-danger" Text="Add New"  PostBackUrl="~/Accountsbootstrap/Dillo_LotProcess.aspx"
                                    Width="130px" />
                            </div>
                            <div id="Div4" runat="server"  class="col-lg-17">
                                <asp:Button ID="Button3" runat="server" class="btn btn-success" Text="Add Multiple Entry" PostBackUrl="~/Accountsbootstrap/DilloMultipleLot.aspx"
                                    Width="130px"  />
                            </div>
                            <div class="col-lg-17">
                                    ...
                                    <asp:GridView ID="gvcust" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        ...
                                        <Columns>
                                            <%--<asp:BoundField HeaderText="Customer ID" DataField="CustomerID" Visible="false" />--%>
                                             <asp:BoundField  DataField="LotProcessID" Visible="false" />
                                            ...
                                            <asp:TemplateField HeaderText="view" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("LotProcessID") %>'
                                                        CommandName="view">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("LotProcessID") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("LotProcessID") %>'
