...
{
    public partial class DilloStitchingInfoGrid : System.Web.UI.Page
    {
        ...
        protected void gvcustinfo_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                ...
                {
                    Response.Redirect("DilloStitchingDetails.aspx?CuttingInformationID=" + e.CommandArgument.ToString());
                }
            }
        ...
        {
            Response.Redirect("DilloStitchingDetails.aspx");
        }
    }
}