<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewJobWork.aspx.cs" Inherits="Billing.Accountsbootstrap.ViewJobWork" %>
                                ...
                                <td>
                                    <asp:GridView ID="gvcust" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Contact Type" Visible="false" DataField="contactTypeName" />
