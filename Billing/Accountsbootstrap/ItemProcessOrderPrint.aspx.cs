...
{
    public partial class ItemProcessOrderPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (ItemPOId != null && ItemPOId != "")
                {
                    #region Purchase Print

                    

                    DataSet ds = objBs.ItemProcessOrderPrint(Convert.ToInt32(ItemPOId));
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        DataSet dsItem = objBs.TransItemProcessOrderPrint(Convert.ToInt32(ItemPOId));
                    ...
                    DataSet dsBOSketch = objBs.ItemProcessOrderSketchPrint(Convert.ToInt32(ItemPOId));
