...
{
    public partial class Dillo_EmbWorkGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objBs.embworkgridshow();
                if (ds != null)
                {
        ...
        protected void ddlstatus_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSet ds = objBs.ProcessDetails_ByStatus("Emb", status);
                if (ds != null)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("Dillo_EmbJobWorkPrint.aspx?EmbId=" + e.CommandArgument.ToString());
            }
            else if (e.CommandName == "Edit")
            {
                Response.Redirect("Dillo_EmbWorks.aspx?lotid=" + e.CommandArgument.ToString());
            }
        }
    }
}