<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dillo_Embrodarygrid.aspx.cs" Inherits="Billing.Accountsbootstrap.Dillo_Embrodarygrid" %>
...
<head>
    ...
    <title>Embroidering Grid Master - bootsrap</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-top: 6px">
            <h1 class="page-header" style="text-align: center; color: #fe0002;font-size:16px; font-weight:bold">
                Embroidering Process Details</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <div class="row">
                        ...
                        <div class="col-lg-12" align="center">
                            ...
                            <div class="col-lg-16">
                                ...
                                <asp:TextBox CssClass="form-control" Enabled="true" onkeyup="Search_Gridview(this, 'gvcust')"  ID="txtsearch" runat="server" style="margin-top:-20px"
                                    placeholder="Enter Text to Search" Width="175px"></asp:TextBox>
                            ...
                            <div id="Div3" runat="server"  class="col-lg-18">
                                <asp:Button ID="btnrefresh" Visible="false" runat="server" class="btn btn-primary" Text="Reset"
                                    Width="130px" />
                                    <asp:DropDownList ID="drpsts" runat="server" CssClass="form-control" OnSelectedIndexChanged="Status_chnaged" AutoPostBack="true">
                            ...
                            <div class="col-lg-4">
                                  <asp:Button ID="btnaddembwork" runat="server" class="btn btn-danger" Text="Add New Job-Work"  PostBackUrl="~/Accountsbootstrap/Dillo_EmbJobwork.aspx"
                                    Width="150px" />
                            </div>
                            <div class="col-lg-17">
                                <asp:Button ID="btnadd" runat="server" class="btn btn-danger" Text="Add New"  PostBackUrl="~/Accountsbootstrap/Dillo_Embroidering.aspx"
                                    Width="130px" />
                            </div>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gvcust" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        AllowPaging="true" PageSize="100000"  ShowFooter="true" 
                                        ...
                                        <Columns>
                                            <%--<asp:BoundField HeaderText="Customer ID" DataField="CustomerID" Visible="false" />--%>
                                             <asp:BoundField Visible="false"  DataField="EmbroidingProcessID" />
                                               <asp:TemplateField HeaderText="S.No" ItemStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                    <%# Container.DataItemIndex + 1 %>
                                                                    </ItemTemplate>
                                                   </asp:TemplateField>
                                            <asp:BoundField HeaderText="Status" DataField="st" />       
                                            ...
                                            <asp:BoundField HeaderText="Job Worker" DataField="name" />
                                            ...
                                            <asp:TemplateField HeaderText="view" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint" runat="server" CommandArgument='<%#Eval("EmbroidingProcessID") %>'
                                                        CommandName="view">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("EmbroidingProcessID") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("EmbroidingProcessID") %>'
                                                        CommandName="Edit">
                                                        <asp:Image ID="img2" runat="server" ImageUrl="~/images/pen-checkbox-128.png" /></asp:LinkButton>
                                                    <asp:ImageButton ID="imgdisable2" ImageUrl="~/images/edit.png" runat="server" Visible="false"
                                                        Enabled="false" ToolTip="Not Allow To Delete" />
                                                    <asp:HiddenField ID="ldgID2" runat="server" Value='<%# Bind("EmbroidingProcessID") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("EmbroidingProcessID") %>'
