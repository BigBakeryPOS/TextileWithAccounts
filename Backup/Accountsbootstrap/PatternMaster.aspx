<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatternMaster.aspx.cs" Inherits="Billing.Accountsbootstrap.PatternMaster" %>
 ...
 <usc:Header ID="Header" runat="server" />
  <asp:Label runat="server" ID="lblWelcome" ForeColor="White" CssClass="label" >Welcome : </asp:Label>
             ...
             <div class="col-lg-12" style="margin-top:6px">
                   <h1 class="page-header" style="text-align:center;color:#fe0002;font-size:16px; font-weight:bold">Pattern Master</h1> 
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div >
                 ...
                 <div style="height:392px; overflow:auto" class="table-responsive" >
                              <table class="table table-bordered table-striped">
                                ...
                                <asp:GridView ID="gv" runat="server" 
                                        DataKeyNames="PatternId" OnSelectedIndexChanged="gv_selectedindex" OnRowCommand="edit" EmptyDataText="Oops! No Activity Performed." 
                             AllowPaging="true" PageSize="100" OnPageIndexChanging="Page_Change"  HeaderStyle-BackColor="#e0e0e0" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="UnitID" DataField="PatternId" Visible="false" />
                                    <asp:BoundField HeaderText="Pattern Name" DataField="Patternname"  SortExpression="Category" HeaderStyle-ForeColor="Black"  />
     ...
     <ItemTemplate>
     <asp:LinkButton ID="btnedit"   CommandArgument='<%#Eval("PatternId") %>' CommandName="EditRow" runat="server">
      <asp:Image ID="imdedit"  ImageUrl="~/images/pen-checkbox-128.png" runat="server" />
                                ...
                                <%--<asp:LinkButton ID="btnedit" runat="server"  Text="edit"  CommandArgument='<%#Eval("categoryid") %>' CommandName="edit"></asp:LinkButton>--%>
                                  <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("PatternId") %>' />
                                 </ItemTemplate>
     ...
     <asp:LinkButton ID="btndel"   CommandArgument='<%#Eval("PatternId") %>' CommandName="Del" runat="server">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-briefcase"></i> Add Pattern
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                          ...
                          <%--  <label>Select Contact-Type</label>--%>
                            ...
                            <label>Pattern Name</label>
                                <asp:TextBox placeholder="Enter Pattern Name" ID="txtPatternName" runat="server" CssClass="form-control"></asp:TextBox>
...
ValidChars=" ./\!@#$%^&*,"  TargetControlID="txtPatternName" />
                                  <br />
...
<ProgressTemplate>
<div style="possion:fixed; text-align: center ;
                 height:100%; width:100%; top:0;right:0;left:0; z-index:9999999; opacity:0.7;">
                 <asp:Image ID="imgUpdateProgress" runat="server" ImageUrl="../images/01-progress.gif"
                  AlternateText="Loading..." ToolTip="Loading..."
                  style="width: 150px; padding:10px; possion:fixed; top:50%; left:40%" />
</div>
</ProgressTemplate>
</asp:UpdateProgress>--%>
