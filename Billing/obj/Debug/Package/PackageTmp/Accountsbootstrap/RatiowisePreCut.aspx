    ...
    <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header" style="text-align: center; color: #fe0002;">
                Ratio-Wise Pre-Cutting Process</h4>
        </div>
    </div>
    <div class="row">
                        ...
                        <ContentTemplate>
                            <div style="background-color: #D0D3D6;">
                                ...
                                <asp:Panel ID="Panel3" runat="server" ScrollBars="Both" Height="300" Width="100%">
                                    <asp:GridView ID="NewSizeRatioGrid" AutoGenerateColumns="False" ShowFooter="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Process T-Shirts" ControlStyle-Width="100%">
                                                <ItemTemplate>
                                                        ...
                                                        <div id="Div16" runat="server" style="overflow: scroll; height: 24pc">
                                                            <asp:GridView ID="contrastgridfab" AutoGenerateColumns="False" ShowFooter="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Avl.KG" Visible="true" HeaderStyle-Width="3%" ItemStyle-Width="3%">
                                                                        <ItemTemplate>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div>
                                            ...
                                            <asp:TextBox ID="txtcompanysublot" Width="30%" Style="margin-left: 14pc; margin-top: -2pc;"
                                                OnTextChanged="Companylotchecked" Visible="false" MaxLength="2" AutoPostBack="true"
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div id="Div17" visible="false" class="form-group" runat="server">
                                        <label>
                                            Sample:</label>
                                    ...
                                    <div id="Div18" visible="false" class="form-group" runat="server">
                                        <label>
                                            Contrasts:</label>
                                            ...
                                            <div class="panel panel-default" style="width: 265px">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <label style="margin-left: 2.5pc; margin-bottom: -0.5pc">
                                                                IN</label>
                                                            <label style="margin-left: 5.5pc; margin-top: -1pc">
                                                                JobWork</label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Button ID="btnclear" runat="server" class="btn btn-primary" OnClick="btnclear_OnClick"
                                                                Text="Clear" />
                                            </div>
                                            </td> </tr> </table>
                                        </div>
