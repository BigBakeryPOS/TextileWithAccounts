    ...
    public partial class SampleReport : System.Web.UI.Page
    {
        ...
        protected void Process_Details(object sender, EventArgs e)
        {
            ...
            if (button.Text == "All")
            {
             ...
             //   ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('This Process is Working Stage.Thank You!!!')", true);
             //   return;
                {
                    divLot1.Visible = true;
                    DataSet dgett = objBs.getalldetailsforcalculation(Convert.ToInt32(ddlLotNo.SelectedValue),"");
