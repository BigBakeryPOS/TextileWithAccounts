...
{
    public partial class Emb : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Embroidingid != null)
            {
                ...
                DataSet ds2 = objBs.JpEmbroidingfor(Embroidingid);
                if (ds2.Tables[0].Rows.Count > 0)
                {
                    ...
                    DataSet ds23 = objBs.Get_JpEmb(Convert.ToString(Embroidingid), "4", "Emb");
        ...
        protected void btnclick(object sender, EventArgs e)
        {
            ...
            int isucess = objBs.updprintforall(Embroidingid, "tbltransjpEmbroidinghistory", "EmbroidingId");
        }
