...
{
    public partial class DespatchSalesGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet dss = objBs.getalldespatch(Convert.ToDateTime(txtFromDate.Text), Convert.ToDateTime(txtToDate.Text));
        ...
        public void gvCustsales_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("DespatchSales.aspx?DespatchId=" + e.CommandArgument.ToString());
            }
