<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessHeading.aspx.cs" Inherits="Billing.Accountsbootstrap.ProcessHeading" %>
...
<meta content="" charset="utf-8"/>
    ...
    <title>Flexible Apparels || Process Names</title>
 ...
 <usc:Header ID="Header" runat="server" />
  <asp:Label runat="server" ID="lblWelcome" ForeColor="White" CssClass="label" >Welcome : </asp:Label>
             ...
             <div class="col-lg-12" style="margin-top:6px">
                   <h1 class="page-header" style="text-align:center;color:#fe0002;font-size:16px; font-weight:bold">Process Heading Master</h1> 
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div >
                 ...
                 <div style="height:392px; overflow:auto" class="table-responsive" >
                              <table class="table table-bordered table-striped">
                                ...
                                <asp:GridView ID="gv" runat="server" 
                                        DataKeyNames="ProcessHeadingID" OnSelectedIndexChanged="gv_selectedindex" OnRowCommand="edit" EmptyDataText="Oops! No Activity Performed." 
                             AllowPaging="true" PageSize="100" OnPageIndexChanging="Page_Change"  HeaderStyle-BackColor="#e0e0e0" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="ProcessHeadingID" DataField="ProcessHeadingID" Visible="false" />
     ...
     <ItemTemplate>
     <asp:LinkButton ID="btnedit"   CommandArgument='<%#Eval("ProcessHeadingID") %>' CommandName="EditRow" runat="server">
      <asp:Image ID="imdedit"  ImageUrl="~/images/pen-checkbox-128.png" runat="server" />
                                ...
                                <%--<asp:LinkButton ID="btnedit" runat="server"  Text="edit"  CommandArgument='<%#Eval("categoryid") %>' CommandName="edit"></asp:LinkButton>--%>
                                  <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("ProcessHeadingID") %>' />
                                 </ItemTemplate>
     ...
     <asp:LinkButton ID="btndel"   CommandArgument='<%#Eval("ProcessHeadingID") %>' CommandName="Del" runat="server">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-briefcase"></i> Add Process Name
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                          ...
                          <%--  <label>Select Contact-Type</label>--%>
                            ...
                            <label>Process Name</label>
                                <asp:TextBox placeholder="Enter Process Name" ID="txtProcessName" runat="server" CssClass="form-control"></asp:TextBox>
...
ValidChars=" ./\!@#$%^&*,"  TargetControlID="txtProcessName" />
                                  <br />
