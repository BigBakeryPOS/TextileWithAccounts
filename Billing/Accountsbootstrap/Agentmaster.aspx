<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Agentmaster.aspx.cs" Inherits="Billing.Accountsbootstrap.Agentmaster" %>
...
ValidChars="_-@."  TargetControlID="txtemail" />
                            ...
                            <div id="Div1" class="form-group" runat="server" visible="false">
                                ...
                                <asp:DropDownList ID="ddlCustomerType" runat="server" AutoPostBack="true" class="form-control" Visible="false"
                            ...
                            <div id="Div22" class="form-group" runat="server">
                                <label>
                                    Tin No</label>
