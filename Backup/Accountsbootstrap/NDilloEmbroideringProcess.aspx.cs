...
{
    public partial class NDilloEmbroideringProcess : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                drpEmp = objbs.getjobcardlistNew("6");
                ...
                if (lot != null)
                {
                    if (name == "Received")
                    {
                        ...
                        DataSet dgetcheck = objbs.Embinfogridupdate(lot);
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            ...
                            DataSet ds = objbs.transEmbinfogridupdate(lot);
        ...
        protected void LotIndex_Chnaged(object sender, EventArgs e)
        {
            ...
            {
                DataSet dlotno = objbs.NewCommonprocess(drplotno.SelectedValue, "6");
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (btnadd.Text == "Save")
            {
                dsLotNo = objbs.Select_Lotnewstichforkajaprocess("6", "Emb");
            }
            else
            {
        ...
        protected void Add_LotProcessDetails(object sender, EventArgs e)
        {
            ...
            if (btnadd.Text == "Save")
            {
                ...
                // if (ds.Tables[0].Rows.Count == 0)
                {
                    ...
                    int iStatus23 = objbs.insertembprocessN(drpemployee.SelectedValue, recdate1);
                    ...
                    for (int i = 0; i < gvcustomerorder.Rows.Count; i++)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                int istasinsert = objbs.insertTransembprocessN(drplotno.SelectedValue, drpprocess.SelectedValue, txtsendQuantity.Text, recdate, txtrate.Text, drplotno.SelectedItem.Text);
            ...
            else if (btnadd.Text == "Received")
            {
                ...
                for (int i = 0; i < gvcustomerorder.Rows.Count; i++)
                {
                    ...
                    // if (Convert.ToInt32(txtsendQuantity.Text) >= Convert.ToInt32(txtRecQuantity.Text))
                    {
                        ...
                        int istasinsert = objbs.updateTransembprocessN(drpLotno.SelectedValue, drpProcess.SelectedValue, txtsendQuantity.Text, recdatee, txtRate.Text, lbltrans.Text, txtnewlotprocess.Text, txtRecQuantity.Text);
                    }
            ...
            Response.Redirect("NDilloEmbroideringGrid.aspx");
