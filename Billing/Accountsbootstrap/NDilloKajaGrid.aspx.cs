...
{
    public partial class NDilloKajaGrid : System.Web.UI.Page
    {
        ...
        protected void gvcustinfo_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                ...
                //{
                //    Response.Redirect("NDilloKajaProcess.aspx?LotId=" + e.CommandArgument.ToString() + "&name=" + e.CommandName);
                //}
