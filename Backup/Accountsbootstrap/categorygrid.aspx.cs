        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Button1.Text == "Save")
            {
                ...
                if (dsCategory != null)
                {
                    ...
                    {
                        int iStatus = objBs.InsertCategoryLabel(txtcategory.Text, ddlIsActive.SelectedValue, "tblAuditMaster_" + sTableName, lblUser.Text, sTableName, Poorder, ProcessOrder, LabelProcess, ShowMainFabricDetails);
            ...
            else
            {
                ...
                if (dsCategory != null)
                {
                    ...
                    else
                    {
                        ...
                        objBs.updatecategoryMaster(Convert.ToInt32(txtcategoryId.Text), txtcategory.Text, ddlIsActive.SelectedValue, "tblAuditMaster_" + sTableName, lblUser.Text, sTableName, Poorder, ProcessOrder, LabelProcess, ShowMainFabricDetails);
                        DataSet ds = objBs.gridcategory();
                        gridview.DataSource = ds;
                        gridview.DataBind();
