<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Viewagent.aspx.cs" Inherits="Billing.Accountsbootstrap.Viewagent" %>
...
<head>
    ...
    <title>Agent Grid Master - bootsrap</title>
    <!-- Bootstrap Core CSS -->
                        ...
                        <div class="col-lg-12" align="center">
                            ...
                            <div id="Div1" runat="server" visible="false" class="col-lg-16">
                                ...
                                <asp:DropDownList CssClass="form-control" ID="ddlfilter" Width="150px" style="margin-top:-20px" runat="server">
                                    ...
                                    <asp:ListItem Text="Agent Name" Value="1"></asp:ListItem>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gvcust" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        ...
                                        <Columns>
                                            <asp:BoundField HeaderText="Ledger ID" DataField="LedgerID" Visible="false" />
