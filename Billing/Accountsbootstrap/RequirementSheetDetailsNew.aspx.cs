...
{
    public partial class RequirementSheetDetailsNew : System.Web.UI.Page
    {
        ...
        protected void btnSearch_OnClick(object sender, EventArgs e)
        {
            ...
            if (chkSwatch.SelectedValue != "")
            {
                dvswatch.Visible = true;
                dvother.Visible = false;
                //Swatch Sheet
                #region SwatchSheet
                string IsFirst1 = "Yes";
                string BuyerOrderId1 = "";
                foreach (ListItem listItem in chkExcNo.Items)
                {
                    #region
                    if (chkExcNo.SelectedIndex < 0)
                    {
                        if (IsFirst1 == "Yes")
                        {
                            BuyerOrderId1 = listItem.Value;
                            IsFirst1 = "No";
                        }
                        else
                        {
                            BuyerOrderId1 = BuyerOrderId1 + "," + listItem.Value;
                        }
                    }
                    else
                    {
                ...
                if (BuyerOrderId1 != "" && BuyerOrderId1 != "" && BuyerOrderId1 != "Select ExcNo")
                {
                    DataSet ds = objBs.SwatchSheet1New(BuyerOrderId1);
                    ...
                    DataSet dsSS = objBs.SwatchSheet2New(BuyerOrderId1, Convert.ToInt32(lblProcessforMasterId.Text));
