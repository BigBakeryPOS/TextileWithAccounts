...
{
    public partial class ItemProcessReceiveReport : System.Web.UI.Page
    {
        ...
        protected void btnSearch_OnClick(object sender, EventArgs e)
        {
            ...
            DataSet dsStyles = objBs.getTransItemProcessOrderReceive_Report(ItemPOId, chkUseDate.Checked, From, To, ddlPartyCode.SelectedValue);
        ...
        {
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename= ItemProcessReceiveReport.xls");
            Response.Charset = "";
