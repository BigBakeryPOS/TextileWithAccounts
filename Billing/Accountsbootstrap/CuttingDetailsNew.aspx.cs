...
{
    public partial class CuttingDetailsNew : System.Web.UI.Page
    {
        ...
        protected void btnSearchNew_OnClick(object sender, EventArgs e)
        {
            if (ddlChallan.SelectedValue == "CuttingDetails")
            {
                //string url1 = "CuttingDetails.aspx";
                //Response.Write("<script type='text/javascript'>window.open('" + url1 + "');</script>");
                Response.Redirect("CuttingDetails.aspx");
            }

            if (ddlChallan.SelectedValue == "CuttingQty")
            {
                //string url2 = "CuttingQtyDetails.aspx";
                //Response.Write("<script type='text/javascript'>window.open('" + url2 + "');</script>");
                Response.Redirect("CuttingQtyDetails.aspx");
            }

            if (ddlChallan.SelectedValue == "MasterCutting")
            {
                //string url3 = "MasterCuttingDetailReport.aspx";
                //Response.Write("<script type='text/javascript'>window.open('" + url3 + "');</script>");
                Response.Redirect("MasterCuttingDetailReport.aspx");
            }
        }
