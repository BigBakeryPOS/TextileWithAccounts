    ...
    public partial class Suppliermaster : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (name == "Add New")
            {
                add.Visible = true;
                div1.Visible = false;
                head.InnerText = "Supplier Master";
            }
        ...
        protected void Add_Click(object sender, EventArgs e)
        {
            ...
            if (btnadd.Text == "Save")
            {
                if (ddlCDType.SelectedValue == "Credit Note")
                {
                    ...
                    int i = objBs.ledgercr(txtcustomername.Text, txtmobileno.Text, txtphoneno.Text, txtarea.Text, txtaddress.Text, txtcity.Text, txtpincode.Text, txtemail.Text, Grupid, ddlIsActive.SelectedValue, Convert.ToDouble(Credite), Convert.ToDouble("0"), ddlCDType.SelectedValue, Convert.ToInt32("6"), Convert.ToInt32(txtCustomerid.Text), Tinno, "tblAuditMaster_" + sTableName, lblUser.Text, "Vendor", ddlCDType.SelectedItem.Text, openingbalance, txtCustomerid.Text, TextBox1.Text, txtCST.Text, txtPAN.Text, txtDesignation.Text, txtDelivery.Text, 0, 0, 0, Convert.ToInt32(ddlPrice.SelectedValue), date, dat, Convert.ToInt32(txtCreditDays.Text), drpagent.SelectedValue, txtprintname.Text, txtgstin.Text, "1");
