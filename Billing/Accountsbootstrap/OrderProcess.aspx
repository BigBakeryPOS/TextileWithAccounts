<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderProcess.aspx.cs" Inherits="Billing.Accountsbootstrap.OrderProcess" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <h2 style="text-align: left; color: #fe0002; margin-top: 0px">
                <asp:Label ID="lblTitle" Text="Purchase Order Process" runat="server"></asp:Label></h2>
            <h4>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                  <div id="Div19" runat="server" class="form-group">
                                    ...
                                    <div id="Div42" runat="server" class="form-group">
                                        ...
                                        <asp:TextBox CssClass="form-control" ID="txtsupplierorderno"
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <div id="Div41" runat="server"  class="form-group">
                                        <label>
                                            Order Date</label>
                                ...
                                <div class="col-lg-2">
                                     ...
                                     <div id="Div16" runat="server"  class="form-group">
                                        <label>
                                            Address</label>
                                        <asp:TextBox CssClass="form-control" Height="100px" TextMode="MultiLine" ID="addressshow" TabIndex="2" runat="server"></asp:TextBox>
                                    </div>
                                ...
                                <asp:DropDownList ID="drpagent" CssClass="form-control" runat="server"></asp:DropDownList></div>
                                <div class="form-group" >
                                <label>Company Name</label>
                                <asp:DropDownList ID="drpcompany" CssClass="form-control" runat="server"></asp:DropDownList></div>
                                    <div id="Div20" runat="server" visible="false" class="form-group">
                                        <label>
                                    ...
                                    <div id="Div18" runat="server" visible="false" class="form-group">
                                        <label>
                                            Mobile No.</label>
                                    ...
                                    <div id="Div199" runat="server" visible="false" class="form-group">
                                        <label>
                                            Cheque No</label>
                                ...
                                <div id="Div43" class="form-group" runat="server" >
                                        <label>
                                            Total Meter</label>
                                 ...
                                 <div class="form-group" runat="server" visible="false">
                                    ...
                                    <div id="Div200" runat="server" visible="false" class="form-group">
                                        <label>
                                            Width</label>
                                    ...
                                    <div id="Div22" runat="server" visible="false" class="form-group">
                                        <label>
                                            <%-- Lr date--%></label>
                                    ...
                                    <div id="Div23" runat="server" visible="false" class="form-group">
                                        <label>
                                            Disc %</label>
                                    ...
                                    <%--    <div class="col-lg-4" >--%>
                                    <div id="Div30" runat="server" visible="false" class="form-group">
                                        <asp:TextBox CssClass="form-control" Width="50px" ID="txtcustomername" runat="server"
                                            Enabled="false" Visible="false"></asp:TextBox>
                                    </div>
                                    <div id="Div31" runat="server" visible="false" class="form-group">
                                        <asp:Label ID="Label1" runat="server" ForeColor="Red"></asp:Label>
                                    </div>
                                    <div id="Div32" runat="server" visible="false" class="form-group">
                                        <label>
                                        </label>
                                ...
                                <div class="col-lg-2">
                                   ...
                                   <div class="form-group" runat="server" visible="false">
                                    ...
                                    <div id="Div34" runat="server" visible="false" class="form-group">
                                        <label>
                                            Details</label>
                                        <asp:TextBox CssClass="form-control" ID="txtdestination" runat="server"></asp:TextBox>
                                    </div>
                                    <div id="Div35" runat="server" visible="false" class="form-group">
                                        <label>
                                            <%--Order date--%></label>
                                ...
                                <div class="col-lg-2">
                                    <div id="Div36" runat="server" visible="false" class="form-group">
                                        <label>
                                            Chase no.</label>
                                        <asp:TextBox CssClass="form-control" ID="txtorderno" runat="server"></asp:TextBox>
                                    </div>
                                    <div id="Div37" runat="server" visible="false" class="form-group">
                                        <label>
                                            Delivery Date</label>
                                    ...
                                    <div id="Div38" runat="server" visible="false" class="form-group">
                                    ...
                                    <div id="Div39" class="form-group" visible="false" runat="server">
                                        <label>
                                            Price List</label>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="Table1" width="100%">
                                                <tr>
                                                    <td colspan="2">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Color" ControlStyle-Width="100%" ItemStyle-Width="6%">
                                                                        <ItemTemplate>
                                                                          ...
                                                                          <%-- <asp:DropDownList ID="drpcolor" runat="server"></asp:DropDownList>--%>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>

                                                                    <asp:TemplateField HeaderText="Roll / Taka" ControlStyle-Width="100%" ItemStyle-Width="6%">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtpiece" Height="30px" runat="server"></asp:TextBox>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>

                                                                     <asp:TemplateField HeaderText="Width" ControlStyle-Width="100%" HeaderStyle-Width="5%" ItemStyle-Width="8%">
                                                                        <ItemTemplate>
                                                                           <asp:DropDownList ID="drpwid"  Width="75%" Height="26px" runat="server"></asp:DropDownList>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Meter" ControlStyle-Width="100%" ItemStyle-Width="6%">
                                                                        <ItemTemplate>
                                                                          <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender0312" runat="server"
                                                                            ...
                                                                            <asp:TextBox ID="txtmeter" OnTextChanged="txtmeter_textchanged" AutoPostBack="true"  Height="30px"  runat="server"></asp:TextBox>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="remMeter" ControlStyle-Width="100%" ItemStyle-Width="6%">
                                                                        <ItemTemplate>
                                                                          <%--<ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender0312" runat="server"
                                                                            TargetControlID="txtmeter" ValidChars="." FilterType="Numbers, Custom" />--%>
                                                                            <asp:TextBox ID="txtrempiece"   Height="30px"  runat="server"></asp:TextBox>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="File Upload" ControlStyle-Width="100%" ItemStyle-Width="8%">
                                                                        <ItemTemplate>
                                                                     ...
                                                                     <asp:TemplateField HeaderText="ImageLabel" Visible="false" ControlStyle-Width="100%" ItemStyle-Width="12%">
                                                                        <ItemTemplate>
                                                                           <asp:Label ID="imgpreview" runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Image"  ControlStyle-Width="39%" ItemStyle-Width="12%">
                                                                        <ItemTemplate>
                                                                     ...
                                                                     <asp:TemplateField HeaderText="CancelMeter" ControlStyle-Width="100%" ItemStyle-Width="6%">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtcancelmeter"   Height="30px"  runat="server" OnTextChanged="txtcancelmeter_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                        ...
                                                        <div id="Div40" runat="server" visible="false" style="padding-left: 200px">
                                                            <div class="col-lg-2">
                                                                <label>
                                                                    Freight Charges
                                                            ...
                                                            <div style="padding-left: 923px" class="col-lg-3">
                                                                <label>
                                                                    Round Off
