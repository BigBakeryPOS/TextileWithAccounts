<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PendingLotReport.aspx.cs" Inherits="Billing.Accountsbootstrap.PendingLotReport" %>
         ...
         <link rel="stylesheet" href="../css/chosen.css" />
          <script type="text/javascript">
              function Denomination() {
                  ...
                  var gridData = document.getElementById('pntt');
    ...
    <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>--%>
                        ...
                        <div class="panel-body">
                           <div class="row">
                            ...
                            <div class="col-lg-2" runat="server" id="reportDetails">
                                ...
                                <div class="form-group">
                                    <asp:Button ID="btnAllLotProcess" Visible="false" class="btn btn-warning" runat="server" style="width:180px;" Text="All" OnClick="Process_Details"/>
                                </div>

                                <div class="form-group">
                                    <asp:Button ID="btnInv" class="btn btn-info" Visible="false" runat="server" style="width:180px;" Text="Purchase Invoice Details" OnClick="Process_Details"/>
                                </div>

                                <div class="form-group">
                                    <asp:Button ID="btnCutting" class="btn btn-success" Visible="false" runat="server" style="width:180px;"  Text="Pre - Cutting Details" OnClick="PreCutting_GetDetails"/>
                                </div>

                                <div class="form-group">
                                    <asp:Button ID="btnStitching" class="btn btn-primary" Visible="false" runat="server" style="width:180px;"  Text="Stitching Details" OnClick="Process_Details"/>
                                </div>

                                <div class="form-group">
                                    <asp:Button ID="btnKaja" class="btn btn-info" Visible="false" runat="server" style="width:180px;"  Text="Kaja Details" OnClick="Process_Details"/>
                                </div>
                                        
                                <div class="form-group">
                                    <asp:Button ID="btnEmb" class="btn btn-warning" runat="server" Visible="false" style="width:180px;"  Text="Embroiding Details" OnClick="Process_Details"/>
                                </div>

                                <div class="form-group">
                                    <asp:Button ID="btnWashing" class="btn btn-danger" runat="server" Visible="false" style="width:180px;"  Text="Washing Details" OnClick="Process_Details"/>
                                </div>

                                <div class="form-group">
                                    <asp:Button ID="btnIron" class="btn btn-success" runat="server" Visible="false" style="width:180px;"  Text="Iron & Packing Details" OnClick="Process_Details"/>
                                </div>
           ...
           <div style="background-color: #D0D3D6;" >
                                     ...
                                     <h2 align="center"> <asp:Label ID="Label2" style="color:Blue;" runat="server">Stiching Process</asp:Label></h2>
                                          <div class=" form-group">
