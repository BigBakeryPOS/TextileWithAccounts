<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fabricreport.aspx.cs" Inherits="Billing.Accountsbootstrap.fabricreport" %>
...
<asp:scriptmanager id="ScriptManager1" runat="server">
                ...
                <div class="col-lg-12" style="margin-top:6px">
                    <h1  class="page-header" style="text-align:center;color:#fe0002;">Fabric Report</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
   <%-- <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div runat="server" class="col-lg-12">
                            <div class="col-lg-1">
                             <asp:TextBox CssClass="form-control"  Enabled="true" onkeyup="Search_Gridview(this, 'gvcust')" ID="txtsearch" runat="server" style="margin-top:-15px" placeholder="Search Text" Width="260px" ></asp:TextBox>
                            </div>
                            <div runat="server" visible="false" class="col-lg-16">
                              ...
                              <div class="table-responsive" >
                                ...
                                <asp:GridView ID="gvcust" EmptyDataText="No records Found"   runat="server" 
                                        CssClass="myGridStyle" AllowPaging="true" PageSize="10"  
    ...
    <Columns>
     <asp:BoundField HeaderText="Process ID" Visible="false"  DataField="ProcessID"   />
    ...
    <asp:BoundField HeaderText="Meter" DataField="Meter" DataFormatString='{0:f}' />
    ...
    <asp:BoundField HeaderText="Rate" DataField="Rate" DataFormatString='{0:f}'/>
     <asp:BoundField HeaderText="RMCode" DataField="RMCode" />
      <asp:BoundField HeaderText="Checked Sign" DataField="SupplierName" />
   
    <asp:TemplateField HeaderText="Edit" Visible="false" ItemStyle-HorizontalAlign="Center">
     <ItemTemplate>
     <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("ProcessID") %>' CommandName="edit"><asp:Image ID="img" runat="server" ImageUrl="~/images/pen-checkbox-128.png" /></asp:LinkButton>
     ...
     <ItemTemplate>
           <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("ProcessID") %>' CommandName="delete" OnClientClick="alertMessage()"><asp:Image ID="dlt" runat="server"  ImageUrl="~/images/DeleteIcon_btn.png" /></asp:LinkButton>
