            ...
            <div class="row">
                ...
                <div runat="server" visible="false" class="col-lg-16">
                    ...
                    <asp:DropDownList CssClass="form-control" ID="ddlfilter" Style="margin-top: -20px"
                        ...
                        <asp:ListItem Text="UOM" Value="1"></asp:ListItem>
                ...
                <div class="col-lg-7">
                    <div style="height: 392px; overflow: auto" class="table-responsive">
                        <table class="table table-bordered table-striped">
                            <tr>
                                <td>
                                    <asp:GridView ID="gv" runat="server" DataKeyNames="UOMID" OnSelectedIndexChanged="gv_selectedindex" Width="100%"
                                        CssClass="myGridStyle1" OnRowCommand="edit" EmptyDataText="Oops! No Activity Performed."
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Measurement Type" DataField="Units" SortExpression="Category" HeaderStyle-ForeColor="white" />
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="background-color: #336699; color: White;">
                            ...
                            <asp:Label ID="lblName" Text="Add Measurement Type" runat="server"></asp:Label>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="list-group">
                                ...
                                <asp:TextBox placeholder="Enter Measurement Type" ID="txtuom" runat="server" CssClass="form-control"></asp:TextBox>
