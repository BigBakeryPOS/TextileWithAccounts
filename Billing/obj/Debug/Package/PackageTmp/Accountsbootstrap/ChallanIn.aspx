<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChallanIn.aspx.cs" Inherits="Billing.Accountsbootstrap.ChallanIn" %>
                    ...
                    <div class="row">
                        ...
                        <div id="Excel" runat="server">
                            <div class="col-lg-12">
                                ...
                                <br />
                                <br />
                                <asp:GridView ID="gvChallanOut" CssClass="" runat="server" Caption="Challan In" EmptyDataText="No Records Found" GridLines="Horizontal"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Received" HeaderText="Rec" DataFormatString="{0:f0}"
                                            ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Center" />
                                        <asp:BoundField DataField="Damaged" HeaderText="Dmg" DataFormatString="{0:f0}"
                                            ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Center" />
