<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WashingGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.WashingGrid" %>
...
<head runat="server">
    ...
    <title>Washing Issue / Receive</title>
    <!-- Bootstrap Core CSS -->
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-1">
                              <asp:Label ID="Label4" runat="server" Style="color: Red"></asp:Label><br />
                                <asp:Button ID="Button3" runat="server" class="btn btn-success" Text="Add New" PostBackUrl="~/Accountsbootstrap/Washing.aspx"
                                    Width="100px" />
                            </div>
                            <div class="col-lg-1">
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gvcust" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        AllowPaging="true" PageSize="100000" DataKeyNames="WashingId" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="WashingId" Visible="false" />
                                   ...
                                   <asp:BoundField HeaderText="Sent Quantity" DataField="sendQty" DataFormatString='{0:f}' />
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("WashingId") %>'
                                                        CommandName="Editt">
                                            ...
                                            <asp:TemplateField HeaderText="Partial Send" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnpartial" runat="server" CommandArgument='<%#Eval("WashingId") %>'
                                                        CommandName="partial">
                                            ...
                                            <asp:TemplateField HeaderText="Received" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnreceived" runat="server" CommandArgument='<%#Eval("WashingId") %>'
                                                    ...
                                                    <asp:ImageButton ID="imgdisablerec" ImageUrl="~/images/edit.png" runat="server" Visible="false"
                                                        Enabled="false" ToolTip="Not Allow To Delete" />
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("WashingId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Issue Print" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint" runat="server" CommandArgument='<%#Eval("WashingId") %>'
                                                        CommandName="printt">
                                            ...
                                            <asp:TemplateField HeaderText="Receive Print" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprintrec" runat="server" CommandArgument='<%#Eval("WashingId") %>'
                                            ...
                                            <asp:TemplateField HeaderText="Received Print" ItemStyle-HorizontalAlign="Center"
                                                Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint1" runat="server" CommandArgument='<%#Eval("WashingId") %>'
                                                        CommandName="printt1">
                                            ...
                                            <asp:TemplateField HeaderText="Payment" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnPayment" runat="server" CommandArgument='<%#Eval("WashingId") %>'
                                                        CommandName="Payment">
                                                    ...
                                                    <asp:ImageButton ID="imgdisablerec1" ImageUrl="~/images/edit.png" runat="server"
                                                        Visible="false" Enabled="false" ToolTip="Not Allow To Delete" />
                                                    <asp:HiddenField ID="ldgID1" runat="server" Value='<%# Bind("WashingId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("WashingId") %>'
