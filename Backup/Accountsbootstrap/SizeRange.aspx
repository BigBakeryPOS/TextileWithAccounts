<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SizeRange.aspx.cs" Inherits="Billing.Accountsbootstrap.SizeRange" %>
                                ...
                                <td>
                                    <div id="Div2" runat="server" style="height: 520px; overflow: scroll;" align="center">
                                        <asp:GridView ID="gridview" runat="server" Width="100%" EmptyDataText="No Records Found"
                                            DataKeyNames="RangeId" AutoGenerateColumns="false" CssClass="myGridStyle1" OnSelectedIndexChanged="gridview_OnSelectedIndexChanged">
                                            <HeaderStyle BackColor="White" />
                                            <EmptyDataRowStyle HorizontalAlign="Center" BackColor="White" ForeColor="Black" />
                                            <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                                                NextPageText="Next" PreviousPageText="Previous" />
                                            <Columns>
                                                <asp:BoundField DataField="Range" SortExpression="Range" HeaderText="Range" ItemStyle-Width="55%" />
                                                ...
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" HeaderText="Modify">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btnedit" CommandArgument='<%#Eval("RangeId") %>' CommandName="Select"
                                                            runat="server">
                                                            <asp:Image ID="imdedit" ImageUrl="~/images/pen-checkbox-128.png" runat="server" />
                                                        </asp:LinkButton>
                                                        <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("RangeId") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%" HeaderText="Delete"
                                                    Visible="false">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="btndel" CommandArgument='<%#Eval("RangeId") %>' CommandName="Del"
                                                            runat="server">
        ...
        <div class="col-lg-4" style="margin-left: -14px">
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color: #336699; color: White;">
                    ...
                    <asp:Label ID="lblName" Text="Add SizeRange" runat="server"></asp:Label>
                </div>
                <div class="panel-body">
                    <div class="list-group">
                        ...
                        <div class="form-group">
                            <asp:TextBox CssClass="form-control" ID="txtRangeID" runat="server" Visible="false"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label>
                                Enter SizeRange</label>
                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtSizeRange"
                                ValidationGroup="val2" Text="*" ErrorMessage="Please enter your SizeRange." Style="color: Red" />
                            <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                FilterType="LowercaseLetters, UppercaseLetters,Numbers,Custom" ValidChars=" -/*"
                                TargetControlID="txtSizeRange" />
                            <asp:TextBox CssClass="form-control" ID="txtSizeRange" runat="server" placeholder="To Add New SizeRange"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label>
                                Sizes</label>
                            <asp:CheckBoxList ID="chksize" CssClass="chkChoice" runat="server" RepeatColumns="4"
                                RepeatDirection="Horizontal" Style="overflow: auto">
                            </asp:CheckBoxList>
                        </div>
                        <div class="form-group">
                            <label>
