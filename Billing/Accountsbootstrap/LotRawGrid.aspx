<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LotRawGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.LotRawGrid" %>
            ...
            <div class="panel panel-default">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-17">
                                &nbsp;&nbsp;</div>
                            <div class="col-lg-17">
                                <asp:Button ID="btnadd1" runat="server" class="btn btn-danger" Text="Add New" Width="150px"
                                    OnClick="Add1_Click" /><%--<asp:Button ID="Btnnew" runat="server" class="btn btn-danger" Text="Add New Cutting" Width="130px"  OnClick="Add1_Click" />--%>
                            </div>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gvcust" EmptyDataText="No records Found" runat="server" CssClass="myGridStyle"
                                        ...
                                        <Columns>
                                            <asp:BoundField HeaderText="RawId" Visible="false" DataField="RawId" />
                                            <asp:BoundField HeaderText="Lot" DataField="Lot" />
                                              <asp:BoundField HeaderText="LotNo" DataField="CompanyLotNo" />
                                            <asp:BoundField HeaderText="Full SL" DataField="FullSL" />
                                            <asp:BoundField HeaderText="Half SL" DataField="HalfSL" />
                                            <asp:BoundField HeaderText="TotalQty" DataField="TotalQty" />
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("RawId") %>'
                                                        CommandName="edit">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("RawId") %>' />
                ...
                <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Bind("ToCheque") %>' />--%>
                                            ...
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("RawId") %>'
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Admin Print" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint" runat="server" CommandArgument='<%#Eval("RawId") %>'
                                                        CommandName="print">
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" Visible="false" HeaderText="Cutting Print">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint1" runat="server" CommandArgument='<%#Eval("RawId") %>'
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" Visible="false" HeaderText="Label Print">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint12" runat="server" CommandArgument='<%#Eval("RawId") %>'
