<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessMaster.aspx.cs" Inherits="Billing.Accountsbootstrap.ProcessMaster" %>
...
<meta content="" charset="utf-8"/>
    ...
    <title>Flexible Apparels || Process Master</title>
 ...
 <usc:Header ID="Header" runat="server" />
  <asp:Label runat="server" ID="lblWelcome" ForeColor="White" CssClass="label" >Welcome : </asp:Label>
             ...
             <div class="col-lg-12" style="margin-top:6px">
                   <h1 class="page-header" style="text-align:center;color:#fe0002;font-size:16px; font-weight:bold">Process Master</h1> 
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div >
                 ...
                 <div style="height:392px; overflow:auto" class="table-responsive" >
                              <table class="table table-bordered table-striped">
                                ...
                                <asp:GridView ID="gv" runat="server" 
                                        DataKeyNames="ProcessMasterID" OnSelectedIndexChanged="gv_selectedindex" OnRowCommand="edit" EmptyDataText="Oops! No Activity Performed." 
                             AllowPaging="true" PageSize="100" OnPageIndexChanging="Page_Change"  HeaderStyle-BackColor="#e0e0e0" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="ProcessMasterID" DataField="ProcessMasterID" Visible="false" />
                                    <asp:BoundField HeaderText="Heading Name" DataField="HeadingName"  SortExpression="Category" HeaderStyle-ForeColor="Black"  />
                                    <asp:BoundField HeaderText="Type" DataField="Type"  SortExpression="Category" HeaderStyle-ForeColor="Black"  />
                                    <asp:BoundField HeaderText="Process Type" DataField="ProcessType"  SortExpression="Category" HeaderStyle-ForeColor="Black"  />
                                    <asp:BoundField HeaderText="Print Name" DataField ="PrintName" SortExpression="Category" HeaderStyle-ForeColor="Black" />
     ...
     <ItemTemplate>
     <asp:LinkButton ID="btnedit"   CommandArgument='<%#Eval("ProcessMasterID") %>' CommandName="EditRow" runat="server">
      <asp:Image ID="imdedit"  ImageUrl="~/images/pen-checkbox-128.png" runat="server" />
                                ...
                                <%--<asp:LinkButton ID="btnedit" runat="server"  Text="edit"  CommandArgument='<%#Eval("categoryid") %>' CommandName="edit"></asp:LinkButton>--%>
                                  <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("ProcessMasterID") %>' />
                                 </ItemTemplate>
     ...
     <asp:LinkButton ID="btndel"   CommandArgument='<%#Eval("ProcessMasterID") %>' CommandName="Del" runat="server">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-briefcase"></i> Add Process Type Name
                        </div>
                        <!-- /.panel-heading -->
                          ...
                          <%--  <label>Select Contact-Type</label>--%>
                            ...
                            <label>Process Heading</label>
                                ...
                                <asp:DropDownList ID="ddlType" runat="server" class="form-control">
                                    ...
                                    <asp:ListItem Text="Full Sleeve" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Half Sleeve" Value="2"></asp:ListItem>
                                </asp:DropDownList>
                                <br />
                            <label>Process Type</label>
                                <asp:TextBox placeholder="Enter Process Type" ID="txtProcessType" runat="server" CssClass="form-control"></asp:TextBox>
...
ValidChars=" ./\!@#$%^&*,"  TargetControlID="txtProcessType" />
                                  <br />


                                  <labeL> Print Name</labeL>
                                  <asp:TextBox placeholder="Enter Print Name" ID="txtPrintName" runat="server" CssClass="form-control"></asp:TextBox>

                                  <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="LowercaseLetters, UppercaseLetters,Custom,Numbers" 
