<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewbrands.aspx.cs" Inherits="Billing.Accountsbootstrap.viewbrands" %>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gvcust" EmptyDataText="No records Found" runat="server" CssClass="myGridStyle"
                                        AllowPaging="true" PageSize="10000" OnPageIndexChanging="Page_Change" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Brand Name" SortExpression="BrandName" DataField="BrandName" HeaderStyle-ForeColor="Black" />
                                            <asp:BoundField HeaderText="Brand Code" Visible="false" DataField="BrandCode" HeaderStyle-ForeColor="Black" />
                                            <asp:BoundField HeaderText="Fit Name" DataField="Fit" HeaderStyle-ForeColor="Black" />
                                            <%--<asp:BoundField HeaderText="Size" DataField="Size" HeaderStyle-ForeColor="Black" />--%>
                                            <asp:BoundField HeaderText="IsActive" SortExpression="IsActive" DataField="IsActive" HeaderStyle-ForeColor="Black" />
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Edit">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("BrandID") %>'
                                                        CommandName="edit">
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Delete">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("BrandID") %>'
