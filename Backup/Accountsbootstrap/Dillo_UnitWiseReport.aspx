<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dillo_UnitWiseReport.aspx.cs" Inherits="Billing.Accountsbootstrap.Dillo_UnitWiseReport" %>
...
<head id="Head1" runat="server">
   <meta content="" charset="utf-8"/>
    ...
    <title>Flexible Apparels || UnitWise Report</title>
    <style type="text/css">
        .GroupHeaderStyle
        {
    ...
    <script type="text/javascript">
        function Denomination() {
            ...
            prtWindow.document.write(("Unit Wise Report"));
...
<asp:Label runat="server" ID="lblWelcome" ForeColor="White" CssClass="label" >Welcome : </asp:Label>
   ...
   <div class="row">
                <div class="col-lg-12" >
                    <h1 class="page-header" style="text-align:center;color:Red">Lot UnitWise Report </h1>
                </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12" id="report">
                                 ...
                                 <div class="col-lg-2">
                                    <div class="form-group">
                                        <label>
                                            Select Unit</label>
                                 <asp:DropDownList ID="drpUnit" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-lg-1">
                                    <div class="form-group">
                                        <label>
                                            Lot No</label>
                                 <asp:DropDownList ID="ddlLotNo" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2">
                                 ...
                                 <asp:DropDownList ID="drpProcess" runat="server" CssClass="form-control"></asp:DropDownList>
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group">
                                        <label>
                                            Start Date</label>
                                    <asp:TextBox ID="txtstartdate" Width="130%" onkeydown="return DateFormat(this, event.keyCode)" runat="server" CssClass="form-control"></asp:TextBox>
                                    ...
                                    <asp:Label runat="server" Visible="false" ID="lblStartdate"></asp:Label>
                                    </div>
                                 </div>
                                  <div class="col-lg-1">
                                    <div class="form-group">
                                        <label>
                                            End Date</label>
                                     <asp:TextBox ID="txtenddate" Width="130%" onkeydown="return DateFormat(this, event.keyCode)" runat="server" CssClass="form-control"></asp:TextBox>
                                    ...
                                    <asp:Label Visible="false" runat="server" ID="lblEnddate"></asp:Label>
                                    </div>

                                    <div class="col-lg-2">
                                    <div class="form-group">
                                     <asp:Button ID="btnsearch" style="margin-top: -50px; margin-left: 223px;" class="btn btn-success" runat="server" Text="Generate Process" OnClick="btnsearch_click" />
                                 ...
                                 <td align="center" style="font-size: small;width:8%">
                                  ...
                                  <Columns>
                                       ...
                                       <%-- <asp:BoundField HeaderText="Employee ID" Visible="false" DataField="Employee_Id" />--%>
                                        ...
                                        <asp:BoundField HeaderText="Total Rate" ItemStyle-HorizontalAlign="Right" Visible="false" DataField="ratee" DataFormatString='{0:f}' />
