<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BarTagG.aspx.cs" Inherits="Billing.Accountsbootstrap.BarTagG" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>BarTag Print</title>
        ...
        <table width="595px" class="style1">
            <tr>
                <td align="center">
                    ...
                    <asp:Button ID="btnexit" runat="server" Text="Exit"  PostBackUrl="BarTagGrid.aspx" />
                </td>
            </tr>
        </table>
    </center>
