...
{
    public partial class TrimmingGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataSet dunit = objBs.pendinglotdetail("tbljptrimming", "tbltransjptrimming", drpbranch.SelectedValue, drppending.SelectedValue, "trimmingid");
                    //= objBs.JpTrimmingformulti();
        ...
        protected void pending_changed(object sender, EventArgs e)
        {
            ...
            //////DataSet pending = objBs.pendinglotdetail("tbljptrimming", "tbltransjptrimming", drpbranch.SelectedValue, drppending.SelectedValue, "trimmingid");
        ...
        protected void Barcode_indexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dss.Tables[0].Rows.Count > 0)
                {
                    ...
                    Response.Redirect("Trimming.aspx?name=Receive&lotid=" + muti);
                }
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Editt")
            {
                ...
                Response.Redirect("Trimming.aspx?name=Edit&Trimmingid=" + e.CommandArgument.ToString());
            ...
            else if (e.CommandName == "partial")
            {
                ...
                {
                    Response.Redirect("Trimming.aspx?name=partial&Trimmingid=" + e.CommandArgument.ToString());
                }
                //else
                //{
            ...
            else if (e.CommandName == "Received")
            {
                ...
                //if (ds.Tables[0].Rows.Count > 0)
                {
                    Response.Redirect("Trimming.aspx?name=Receive&Trimmingid=" + e.CommandArgument.ToString());
                }
                //else
                //{
                //    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Check This Lot number Because this is used in another Process.Thank You!!!')", true);
            ...
            else if (e.CommandName == "Payment")
            {
                ...
                //if (ds.Tables[0].Rows.Count > 0)
                {
                    Response.Redirect("PaymentScreen.aspx?name=Btag&id=" + e.CommandArgument.ToString());
                }
                //else
                //{
                //    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Check This Lot number Because this is used in another Process.Thank You!!!')", true);
            ...
            //{
            //    Response.Redirect("TrimmingG.aspx?Trimmingid=" + e.CommandArgument.ToString());

            //}
            else if (e.CommandName == "printt")
            {
                Response.Redirect("StitchingG.aspx?PrintIdForAll=" + e.CommandArgument.ToString() + "&ScreenName=Trim");

            }
            else if (e.CommandName == "printtrec")
            {
                Response.Redirect("StitchingG.aspx?PrintIdForAllrec=" + e.CommandArgument.ToString() + "&ScreenName=Trim");

            }
            else if (e.CommandName == "printt1")
            {
                Response.Redirect("Trim.aspx?Trimmingid=" + e.CommandArgument.ToString());
        ...
        protected void Date_OnTextChanged(object sender, EventArgs e)
        {
            ...
            DataSet pending = objBs.getallProcessdetails("tblJpTrimming", "tbltransjpTrimming", "Trimmingid", drpbranch.SelectedValue, drppending.SelectedValue, ddljobworker.SelectedValue, FromDate, ToDate);
            if (pending.Tables[0].Rows.Count > 0)
            {
                gvcust.DataSource = pending;
                gvcust.DataBind();
