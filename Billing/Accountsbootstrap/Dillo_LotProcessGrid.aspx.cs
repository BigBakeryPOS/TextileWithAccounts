...
{
    public partial class Dillo_LotProcessGrid : System.Web.UI.Page
    {
        ...
        {
            DataSet dunit = objBs.unitpending(drpunit.SelectedValue, drppending.SelectedValue);
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "view")
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    Response.Redirect("Dillo_LotProcess.aspx?lotid=" + e.CommandArgument.ToString());
                }
                else
                {
