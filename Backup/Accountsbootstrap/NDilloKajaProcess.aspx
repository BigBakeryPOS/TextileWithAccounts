<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NDilloKajaProcess.aspx.cs" Inherits="Billing.Accountsbootstrap.NDilloKajaProcess" %>
                                  ...
                                  OnSelectedIndexChanged="StitchingInfo_Load" AutoPostBack="true"></asp:DropDownList>
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <div id="but" runat="server" class="row">
                                                ...
                                                <asp:Button ID="btnexit" runat="server" class="btn btn-warning" Text="Exit" PostBackUrl="NDilloKajaGrid.aspx"
