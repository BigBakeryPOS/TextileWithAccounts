<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DilloStitchingDetails.aspx.cs" Inherits="Billing.Accountsbootstrap.DilloStitchingDetails" %>
...
<head id="Head1" runat="server">
    ...
    <title>Flexible Apparels || StitchingInfo Info</title>
...
<body>
    ...
    <div class="col-lg-12" style="margin-top:6px">
                <h1  class="page-header" style="text-align:center;color:#fe0002;">Flexible Apparels STITCHING INFORMATION</h1>
            </div>
            <!-- /.col-lg-12 -->
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-body">
               ...
               <div class="form-group" runat="server" visible="false">
                    ...
                    <label>Employee Name</label>
                      <asp:CompareValidator ID="CompareValidator1" runat="server" ValidationGroup="val1"
                        ...
                        <asp:DropDownList ID="ddlSignature" runat="server" TabIndex="4" CssClass="form-control">
                                            </asp:DropDownList>
                    ...
                    <div class="form-group">
                        ...
                        <%--<asp:DropDownList CssClass="form-control" ID="ddlItem" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlItem_Changed">
                            ...
                            <asp:ListItem Text="M.L.XL" Value="M.L.XL"></asp:ListItem>
               ...
               <div class="col-lg-4" style="margin-top:73px">
                ...
                <div class="form-group" style="margin-top:45px">
                         <label>Shirt</label>
                            <asp:CheckBox id="chckShirt" TextAlign="Right" runat="server"/>
               ...
               <div class="form-group" runat="server" visible="false">
                   ...
                   <div class="form-group" id="Div11" runat="server" style="margin-top: 275px;" runat="server" visible="false">
                        <label>
                   ...
                   <div id="Div12" runat="server" visible="false">
                    ...
                    <div class="form-group" id="Div2" runat="server" style="margin-top: -270px;margin-left: 229px;" runat="server" visible="false">
                        <label>
                    ...
                    <div id="Div3" runat="server" style="margin-left: 230px;" visible="false">
