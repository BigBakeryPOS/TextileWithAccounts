<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewPrecutprocess.aspx.cs"
    Inherits="Billing.Accountsbootstrap.NewPrecutprocess" %>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                   ...
                                   <%-- <div class="form-group ">
                                        <label>
                                            Inner Type</label>
                                        <asp:RadioButtonList ID="rdbinnertype" CssClass="chkChoice1" runat="server" RepeatColumns="3"
                                ...
                                <div id="mul" runat="server" visible="false" runat="server">
                                    <div id="Div5" runat="server" class="col-lg-5">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div id="Div9" runat="server" class="col-lg-6">
                                </div>
                                <div runat="server" visible="false" class="col-lg-6">
                                    <div class="form-group">
                                        <label>
                                ...
                                <td>
                                    <div style="overflow-y: scroll; width: 400px; height: 490px">
                                        <div class="panel panel-default">
                                            ...
                                            <div id="Div14" runat="server" style="overflow: scroll; height: 24pc">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                <ContentTemplate>
                                    <tr id="tr1" visible="false" runat="server">
                                        ...
                                        <td id="Td6" runat="server" style="width: 5%">
                                            <label>
                                                Act.Shirt</label>
