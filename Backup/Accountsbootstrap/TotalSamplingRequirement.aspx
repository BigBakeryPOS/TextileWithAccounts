<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TotalSamplingRequirement.aspx.cs"
    Inherits="Billing.Accountsbootstrap.TotalSamplingRequirement" %>
...
<head id="Head1" runat="server">
    ...
    <title>Sampling Requirement </title>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-1">
                                <div class="form-group" id="Date" runat="server" visible="true">
                                    <asp:Label ID="lblDate" runat="server" Text="Requirement Date" Width="110px" Style="font-weight: bold"></asp:Label>
                                    <br />
                        ...
                        <div id="Excel" runat="server">
                            <div class="col-lg-12">
                                ...
                                <br />
                                <br />
                                <asp:GridView ID="gvRequirement" CssClass="" runat="server" AutoGenerateColumns="false"
                                    Caption="Total Sampling Requirement" EmptyDataText="No Records Found" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ColorPrint" HeaderText="Color/Print" />
