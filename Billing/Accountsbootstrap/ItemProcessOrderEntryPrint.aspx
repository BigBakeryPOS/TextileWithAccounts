<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemProcessOrderEntryPrint.aspx.cs" Inherits="Billing.Accountsbootstrap.ItemProcessOrderEntryPrint" %>
                    ...
                    <Columns>
                        ...
                        <%--<asp:BoundField DataField="IssueItem" HeaderText="Item" HeaderStyle-HorizontalAlign="Left" />--%>
                         <asp:TemplateField HeaderText="Item">
                            <ItemTemplate>
                                <asp:Label ID="lblIssueItem" runat="server" Text='<%#Eval("ReceiveItem")%>'></asp:Label><br />
                                <asp:Label ID="lblRemarks" runat="server" Text='<%#Eval("Remarks")%>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="ReceiveColor" HeaderText="Color" FooterStyle-HorizontalAlign="Right"
