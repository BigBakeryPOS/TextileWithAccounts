<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NDilloEmbroideringGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.NDilloEmbroideringGrid" %>
                        ...
                        <div class="col-lg-12" align="center">
                            ...
                            <div class="col-lg-17">
                                <asp:Button ID="btnadd" runat="server" class="btn btn-danger" Text="Add New" Width="130px"
                                    PostBackUrl="~/Accountsbootstrap/NDilloEmbroideringProcess.aspx" />
                            </div>
                            <%--<div class="col-lg-17">
                                ...
                                <td>
                                    <asp:GridView ID="gvcustinfo" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Sending Total" DataField="sndqty" DataFormatString="{0:0.00}" />
                                            <asp:BoundField HeaderText="Receiving Total" DataField="rec" DataFormatString="{0:0.00}" />
                                            <asp:BoundField HeaderText="Remaining Total" DataField="rem" DataFormatString="{0:0.00}" />
                                            ...
                                            <asp:TemplateField HeaderText="Edit" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("NewEmbProcessid") %>'
                                                        CommandName="edit">
                                                    ...
                                                    <asp:HiddenField ID="csinfoID" runat="server" Value='<%# Bind("NewEmbProcessid") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="Received" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnrec" runat="server" CommandArgument='<%#Eval("NewEmbProcessid") %>'
                                                        CommandName="Received">
                                                        <asp:Image ID="imgrec" runat="server" ImageUrl="~/images/stock_task.png" /></asp:LinkButton>
                                                    <asp:ImageButton ID="imgdisablerec" ImageUrl="~/images/edit.png" runat="server" Visible="false"
                                                        Enabled="false" ToolTip="Not Allow To Delete" />
                                                    <asp:HiddenField ID="csinfoIDrec" runat="server" Value='<%# Bind("NewEmbProcessid") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("NewEmbProcessid") %>'
                                            ...
                                            <asp:TemplateField HeaderText="Copy" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btncopy" runat="server" CommandArgument='<%#Eval("NewEmbProcessid") %>'
                                                        CommandName="copy">
                                                        <asp:Image ID="imgcpy" runat="server" Style="height: 23px; width: 18px" ImageUrl="~/images/copy.png" /></asp:LinkButton>
                                                    <asp:HiddenField ID="csinfocopyID" runat="server" Value='<%# Bind("NewEmbProcessid") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
