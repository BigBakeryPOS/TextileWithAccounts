<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintingG.aspx.cs" Inherits="Billing.Accountsbootstrap.PrintingG" %>
        ...
        <table width="595px" class="style1">
            <tr>
                <td align="center">
                    ...
                    <asp:Button ID="btnexit" runat="server" Text="Exit" PostBackUrl="PrintingGrid1.aspx" />
                </td>
            </tr>
        </table>
    </center>
