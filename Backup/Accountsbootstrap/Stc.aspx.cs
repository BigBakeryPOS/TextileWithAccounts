...
{
    public partial class Stc : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Stitchingid != null)
            {
                ...
                DataSet ds2 = objBs.JpStichingfor(Stitchingid);
                if (ds2.Tables[0].Rows.Count > 0)
                {
                    ...
                    DataSet ds23 = objBs.Get_JpStc(Convert.ToString(Stitchingid), "3", "Stc");
        ...
        protected void btnclick(object sender, EventArgs e)
        {
         //   Response.Redirect("StitchingGrid.aspx");
            ...
            int isucess = objBs.updprintforall(Stitchingid, "tbltransjpstichinghistory", "StichingId");
