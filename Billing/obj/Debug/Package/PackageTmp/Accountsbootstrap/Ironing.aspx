<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ironing.aspx.cs" Inherits="Billing.Accountsbootstrap.Ironing" %>
...
<head id="Head1" runat="server">
        ...
        function check() {
            ...
            if (tmp && tmp.length > 0) {
                ...
                if (arg && arg.length > 0) {
                    ...
                    check = arg[0].length <= 3;
                    if (arg.length > 1 && check) {
                        check = arg[1].length <= 6;
                    }
                }
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            var grid = document.getElementById('gvcustomerorder');
...
<body style="background-color: #c6efce">
    ...
    <div class="row">
        ...
        <div class="form-group" align="center">
            <label>
                Item Name :</label>
            <asp:Label ID="lblitemname" runat="server" Font-Bold="true" Font-Size="X-Large"></asp:Label>
        </div>
        <!-- /.row -->
                    ...
                    <div class="panel-body" style="background-color: #c6efce">
                        <div class="col-lg-12">
                            <div class="col-lg-2">
                                <div class="form-group ">
                                    ...
                                    <asp:Label ID="lblbrandnid" runat="server" Visible="false"></asp:Label>
                                    <asp:Label ID="lblfitid" runat="server" Visible="false"></asp:Label>
                                    <asp:Label ID="lblcuttingdate" runat="server" Visible="false"></asp:Label>
                                    <asp:CheckBoxList ID="CheckBoxList1" RepeatDirection="Horizontal" RepeatColumns="2"
                                        Visible="false" CssClass="chkChoice1" runat="server">
                                    </asp:CheckBoxList>
                            ...
                            <div class="col-lg-1">
                                <div class="form-group">
                                    <label>
                                        Lot No</label><br />
                                    <asp:DropDownList CssClass="chzn-select" ID="ddlLotNo" Width="120px" Height="150px"
                            ...
                            <div class="col-lg-1">
                                <div class="form-group">
                                    <label>
                                        In/Out</label>
                                    <asp:RadioButtonList ID="checkinoutprocess" runat="server" AutoPostBack="true" Width="100" OnSelectedIndexChanged="checkedinoutproceschnaged">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" runat="server" id="emp" visible="true">
                                    ...
                                    <asp:DropDownList CssClass="form-control" ID="drpMultiemployee" OnSelectedIndexChanged="EmployeeRate_chnaged"
                                        AutoPostBack="true" MaxLength="150" runat="server">
                                    </asp:DropDownList>
                                </div>
                                ...
                                <div id="Div3" runat="server" visible="false" class="form-group">
                                    <label>
                                        Amount</label>
                                    <asp:TextBox CssClass="form-control" ID="txtAmount" MaxLength="170" runat="server"
                                        Enabled="false">0</asp:TextBox>
                                </div>
                                <div id="Div13" class="form-group" runat="server" visible="false">
                                    <label>
                                        Received Qty</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtitemnarration" runat="server" TextMode="MultiLine" CssClass="form-control"
                                        Enabled="false" Width="280px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-1">
                                <div id="idType" runat="server" visible="false" class="form-group ">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList CssClass="form-control" ID="ddltype" MaxLength="170" runat="server">
                                            ...
                                            <%--<asp:ListItem Text="Alter" Value="Alter"></asp:ListItem>--%>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div runat="server" visible="false" class="col-lg-2">
                                <label>
                                    Brand:</label>
                                <asp:Label runat="server" ID="lblbrand" Visible="true" ForeColor="Black" Font-Size="Large"></asp:Label>
                            </div>
                            <div class="col-lg-10">
                            </div>
                        </div>
                            ...
                            <div id="Div1" runat="server" class="row">
                                <div class="col-lg-6" id="sizediv" runat="server" visible="false" style="margin-left: -3pc;">
                                    <div class="panel panel-default" style="width: 170px">
                                        ...
                                        <asp:Label ID="lbllotdetailid" runat="server" Visible="false"></asp:Label>
                                    </div>
                                </div>
                                                        ...
                                                        <asp:GridView ID="gvcustomerorder" AutoGenerateColumns="False" ShowFooter="True"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Color">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblonlycolor" Visible="true" runat="server"></asp:Label>
                                                                        <asp:Label ID="lbldesignno" runat="server" Visible="false"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Fit">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblfitid" Style="display: none" runat="server"></asp:Label>
                                                                        <asp:Label ID="lblfit" runat="server"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Pattern" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblPatternid" Style="display: none" runat="server"></asp:Label>
                                                                        <asp:Label ID="lblPattern" runat="server"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText=" Process Type" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:DropDownList ID="drpProcess" OnSelectedIndexChanged="drpprocess_selected" Width="50px"
                                                                            AutoPostBack="true" runat="server" Height="26px" AppendDataBoundItems="true">
                                                                        </asp:DropDownList>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="XXL ">
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:TextBox ID="txtsxxlfs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="3XL ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txts3xlfsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txts3xlfs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="4XL ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txts4xlfsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txts4xlfs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="30 ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txts30hsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txts30hs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="32 ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txts32hsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txts32hs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="34 ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txts34hsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txts34hs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="36 ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txts36hsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txts36hs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="XS ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtsxshsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txtsxshs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="S ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtsshsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txtsshs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="M ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtsmhsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txtsmhs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="L ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtslhsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txtslhs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="XL ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtsxlhsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txtsxlhs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="XXL ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtsxxlhsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txtsxxlhs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="3XL ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txts3xlhsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txts3xlhs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="4XL ">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txts4xlhsac" Width="100%" Enabled="false" runat="server" Height="26px">0</asp:TextBox>
                                                                        <asp:TextBox ID="txts4xlhs" Width="100%" Enabled="true" runat="server" Height="26px">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Send Qty" Visible="true">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtsendFQty" Enabled="false" runat="server" Width="100%" Height="26px"
                                                                            AppendDataBoundItems="true"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Remain Qty" ItemStyle-Width="10%" Visible="false">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Sending Date" ItemStyle-Width="10%" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="date" runat="server" Enabled="false" onkeyup="ValidateDate(this, event.keyCode)"
                                                                ...
                                                                <asp:TemplateField HeaderText="Rec. Qty" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtrecFQty" runat="server" Width="100%" Height="26px" AppendDataBoundItems="true">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Damage Qty" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtdamageqty" runat="server" Width="100%" Height="26px" AppendDataBoundItems="true">0</asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Received Date">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="Recdate" runat="server" Enabled="true" onkeyup="ValidateDate(this, event.keyCode)"
                                                                            onkeydown="return DateFormat(this, event.keyCode)" Text="" Width="100%" Height="26px"
                                                                            AutoPostBack="true" OnTextChanged="Recdate_OnTextChanged" AppendDataBoundItems="true"></asp:TextBox>
                                                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender65" TargetControlID="Recdate" PopupButtonID="Recdate"
                                                                            EnabledOnClient="true" Format="dd/MM/yyyy" runat="server" CssClass="cal_Theme1">
                                                                        </ajaxToolkit:CalendarExtender>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Rate" Visible="false" ItemStyle-Width="10%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtRate" Enabled="false" runat="server" Width="100%" Height="26px"
                                                                ...
                                                                <asp:TemplateField HeaderText="ironTransId" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblIronTransID" runat="server"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="StockRatioId" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblStockRatioId" runat="server"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                ...
                                <div class="col-lg-12">
                                    <div class="col-lg-4">
                                        <div id="but" runat="server" class="row">
                                            ...
                                            <asp:Button ID="btnexit" runat="server" class="btn btn-warning" Text="Exit" PostBackUrl="IroningGrid.aspx"
                                    ...
                                    <div class="col-lg-2">
                                        <div id="idConsiderStock" runat="server" visible="false" class="form-group ">
                                            <div class="form-group">
                                                <label>
                                                    Consider To Stock</label>
                                                <asp:DropDownList CssClass="form-control" ID="ddlConsiderStock" MaxLength="170" runat="server">
                                    ...
                                    <div class="col-lg-4">
                                        <div id="ironmaterial" runat="server" visible="false">
                                            <asp:GridView ID="gvironstock" EmptyDataText="No records Found" runat="server" CssClass="myGridStyle"
                                                AutoGenerateColumns="false">
                                                <Columns>
                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Allow" Visible="true">
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="chkiron" runat="server" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Accessories" Visible="true">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDefinition" runat="server" Text='<%#Eval("Definition")%>' Width="50px"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Qty" Visible="true">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtissueironstock" Width="50px" runat="server">0</asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Stock" Visible="true">
                                                        <ItemTemplate>
                                                            <asp:Label ID="txtironstock" runat="server" Text='<%#Eval("Available_QTY")%>' Width="50px"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
