<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckingProcessGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.CheckingProcessGrid" %>
...
<head>
    ...
    <title>Flexible Apparels || Checking Process Grid</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12" align="center">
                            ...
                            <div class="col-lg-17">
                                <asp:Button ID="btnadd" runat="server" class="btn btn-danger" Text="Add New"  PostBackUrl="~/Accountsbootstrap/CheckingProcess.aspx"
                                    Width="130px" />
                            </div>
                                    ...
                                    <asp:GridView ID="gvcust" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="view" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("CheckingProcessID") %>'
                                                        CommandName="view">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("CheckingProcessID") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("CheckingProcessID") %>'
