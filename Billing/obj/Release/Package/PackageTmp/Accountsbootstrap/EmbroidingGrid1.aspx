<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmbroidingGrid1.aspx.cs"
    Inherits="Billing.Accountsbootstrap.EmbroidingGrid1" %>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-1">
                                ...
                                <asp:Button ID="Button3" runat="server" class="btn btn-success" Text="Add New" PostBackUrl="~/Accountsbootstrap/Embroid.aspx"
                                    Width="100px" />
                            </div>
                            <div class="col-lg-1">
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gvcust" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        AllowPaging="true" PageSize="100000" DataKeyNames="EmbroidingId" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                         ...
                                         <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20%" HeaderText="FabDetails"
                                            ...
                                            <asp:BoundField DataField="EmbroidingId" Visible="true" HeaderText="Work Order" />
                                         ...
                                         <asp:BoundField HeaderText="Entry Date" DataField="CreatedDate" DataFormatString="{0:dd/MM/yyyy}" />
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("EmbroidingId") %>'
                                                        CommandName="Editt">
                                            ...
                                            <asp:TemplateField HeaderText="Partial Send" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnpartial" runat="server" CommandArgument='<%#Eval("EmbroidingId") %>'
                                                        CommandName="partial">
                                            ...
                                            <asp:TemplateField HeaderText="Received" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnreceived" runat="server" CommandArgument='<%#Eval("EmbroidingId") %>'
                                                    ...
                                                    <asp:ImageButton ID="imgdisablerec" ImageUrl="~/images/edit.png" runat="server" Visible="false"
                                                        Enabled="false" ToolTip="Not Allow To Delete" />
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("EmbroidingId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Issue Print" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint" runat="server" CommandArgument='<%#Eval("EmbroidingId") %>'
                                                        CommandName="printt">
                                            ...
                                            <asp:TemplateField HeaderText="Receive Print" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprintrec" runat="server" CommandArgument='<%#Eval("EmbroidingId") %>'
                                            ...
                                            <asp:TemplateField HeaderText="Received Print" ItemStyle-HorizontalAlign="Center"
                                                Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint1" runat="server" CommandArgument='<%#Eval("EmbroidingId") %>'
                                                        CommandName="printt1">
                                            ...
                                            <asp:TemplateField HeaderText="Payment" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnPayment" runat="server" CommandArgument='<%#Eval("EmbroidingId") %>'
                                                        CommandName="Payment">
                                                    ...
                                                    <asp:ImageButton ID="imgdisablerec1" ImageUrl="~/images/edit.png" runat="server"
                                                        Visible="false" Enabled="false" ToolTip="Not Allow To Delete" />
                                                    <asp:HiddenField ID="ldgID1" runat="server" Value='<%# Bind("EmbroidingId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("EmbroidingId") %>'
