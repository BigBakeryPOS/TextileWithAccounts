<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CuttingProcessEntryPrint.aspx.cs"
    Inherits="Billing.Accountsbootstrap.CuttingProcessEntryPrint" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Production Challan Print</title>
            ...
            <td style="width: 90%">
                <asp:GridView ID="gvProcessEntryStylesImages" runat="server" EmptyDataText="No Records Found"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Image ID="Image1" runat="server" Height="160px" Width="160px" ImageUrl='<%# Eval("Sketch1") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Image ID="Image2" runat="server" Height="160px" Width="160px" ImageUrl='<%# Eval("Sketch2") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Image ID="Image3" runat="server" Height="160px" Width="160px" ImageUrl='<%# Eval("Sketch3") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Image ID="Image4" runat="server" Height="160px" Width="160px" ImageUrl='<%# Eval("Sketch4") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Image ID="Image5" runat="server" Height="160px" Width="160px" ImageUrl='<%# Eval("Sketch5") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Image ID="Image6" runat="server" Height="160px" Width="160px" ImageUrl='<%# Eval("Sketch6") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Image ID="Image7" runat="server" Height="160px" Width="160px" ImageUrl='<%# Eval("Sketch7") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
