<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NDilloWashingProcess.aspx.cs" Inherits="Billing.Accountsbootstrap.NDilloWashingProcess" %>
                                  ...
                                  OnSelectedIndexChanged="StitchingInfo_Load" AutoPostBack="true"></asp:DropDownList>
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <div id="but" runat="server" class="row">
                                                ...
                                                <asp:Button ID="btnexit" runat="server" class="btn btn-warning" Text="Exit" PostBackUrl="NDilloWashingGrid.aspx"
