<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KajaButton1.aspx.cs" Inherits="Billing.Accountsbootstrap.KajaButton1" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            var grid = document.getElementById('gvnewkaja');
                               ...
                               <ajaxToolkit:ModalPopupExtender ID="mpe1" runat="server" PopupControlID="plpop"
                                ...
                                <div class="row">
                                    ...
                                    <ContentTemplate>--%>
                                            ...
                                            <asp:GridView ID="gvnewkaja" AutoGenerateColumns="False" ShowFooter="True" CssClass="chzn-container"
                                                Width="100%" runat="server" OnRowDataBound="gvnewkaja_RowDataBound">
                                                <HeaderStyle BackColor="#59d3b4" />
                                                <EmptyDataRowStyle HorizontalAlign="Center" BackColor="#59d3b4" ForeColor="Black" />
                                                <Columns>
                                                    <asp:TemplateField HeaderText="S.No">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="col-lg-4">
                                                <div id="but" runat="server" class="row">
                                                    ...
                                                    <asp:Button ID="btnexit" runat="server" class="btn btn-warning" Text="Exit" PostBackUrl="KajaButtonGrid.aspx"
