<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Setting.aspx.cs" Inherits="Billing.Accountsbootstrap.Setting" %>
...
<asp:Label runat="server" ID="lblWelcome" ForeColor="White" CssClass="label" >Welcome : </asp:Label>
   ...
   <div class="row">
          ...
          <div class="col-lg-12"  style="margin-top:-5px">
                 <div class="col-lg-2">
                    <h2 class="page-header" style="text-align:left;color:Red">Setting Entry</h2>
                    </div>
                     ...
                     <form id="form1" runat="server">
                                ...
                                <asp:DropDownList CssClass="form-control" Width="150px" ID="ddlfilter" style="margin-top:-80px;margin-left:-200px" runat="server">
                                    ...
                                    <asp:Button ID="btnsearch" runat="server" Width="130px" style="margin-top:-95px;margin-left:645px" class="btn btn-success" ValidationGroup="val1"
                                      ...
                                      <div class="col-lg-2">
                                    <asp:Button ID="btnreset" runat="server" Width="130px" style="margin-top:-65px;margin-left:589px" class="btn btn-primary" 
                                              Text="Reset" onclick="btnreset_Click"  /> 
                                    </div>
                                      <div class="col-lg-2">
                                    <asp:Button ID="btnadd" runat="server" Width="130px" style="margin-top:-65px;margin-left:530px" class="btn btn-danger " 
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                              ...
                              <table class="table table-bordered table-striped">
                                ...
                                <table id="Table1" runat="server" visible="false" style="border: 1px solid Grey; height: 15px; background-color: #59d3b4;color:Black;
                                ...
                                <td align="center" style="font-size: small;;width:10%" >
                                 ...
                                 <td align="center" style="font-size: small;;width:10%">
                                   Delete                          
                                     ...
                                     <asp:GridView ID="gridOpening" runat="server" CssClass="myGridStyle1"  PageSize="10" width="100%" AllowPaging="false"    EmptyDataText="No records Found" 
                                     ...
                                     <Columns>
                                      <asp:BoundField DataField="Screen" HeaderText="Screen" ItemStyle-Width="25%"  />
                                     <asp:BoundField DataField="SettingDate" HeaderText="SettingDate" ItemStyle-Width="15%" />
                              <asp:BoundField DataField="Branchname" HeaderText="Emp" ItemStyle-Width="30%"  />
                                          <asp:BoundField DataField="BranchCode" HeaderText="BranchCode" ItemStyle-Width="20%"  />
                                        
                                         <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5%" Visible="false">
                                         <ItemTemplate>
                                         <asp:LinkButton ID="btnedit"    CommandArgument='<%#Eval("SettingId") %>' CommandName="Edit" runat="server"> <asp:Image ID="imdedit"  ImageUrl="~/images/pen-checkbox-128.png" runat="server" /></asp:LinkButton>
                                            </ItemTemplate>
                                            
     </asp:TemplateField>
          <asp:TemplateField ItemStyle-Width="5%" HeaderText="Delete" ItemStyle-HorizontalAlign="Center">
     <ItemTemplate>
    
     <asp:LinkButton ID="btndel"   CommandArgument='<%#Eval("SettingId") %>' CommandName="Del" OnClientClick="alertMessage()" runat="server"> <asp:Image ID="Image1"  ImageUrl="~/images/DeleteIcon_btn.png" runat="server" /></asp:LinkButton>
