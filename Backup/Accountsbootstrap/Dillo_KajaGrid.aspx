<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dillo_KajaGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.Dillo_KajaGrid" %>
                        ...
                        <div class="col-lg-12" align="center">
                            ...
                            <div id="Div3" runat="server" class="col-lg-18">
                                <asp:Button ID="btnrefresh" runat="server" Visible="false" class="btn btn-primary" Text="Reset"
                                    Width="130px" />
                                    <asp:DropDownList ID="drpsts" runat="server" OnSelectedIndexChanged="Status_chnaged" AutoPostBack="true" CssClass="form-control">
                            ...
                            <div class="col-lg-4">
                                 <asp:Button ID="btnaddjobwork" runat="server" class="btn btn-danger" Text="Add New Job-Work"  PostBackUrl="~/Accountsbootstrap/Dillo_KajaJobwork.aspx"
                                    Width="150px" />
                            </div>
                            <div class="col-lg-17">
                                <asp:Button ID="btnadd" runat="server" class="btn btn-danger" Text="Add New"  PostBackUrl="~/Accountsbootstrap/Dillo_KajaProcess.aspx"
                                    Width="130px" />
                            </div>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gvcust" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        AllowPaging="false" PageSize="100000" ShowFooter="true"  
                                        ...
                                        <Columns>
                                            <%--<asp:BoundField HeaderText="Customer ID" DataField="CustomerID" Visible="false" />--%>
                                             <asp:BoundField Visible="false"  DataField="KajaProcessID" />
                                             <asp:BoundField HeaderText="Status Type" DataField="st" />
                                             <asp:BoundField HeaderText="Process Type" DataField="checkstatus" />
                                            ...
                                            <asp:TemplateField HeaderText="view" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint" runat="server" CommandArgument='<%#Eval("KajaProcessID") %>'
                                                        CommandName="view">
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:ImageButton ID="imgdisable2" ImageUrl="~/images/edit.png" runat="server" Visible="false"
                                                        Enabled="false" ToolTip="Not Allow To Delete" />
                                                    <asp:HiddenField ID="ldgID2" runat="server" Value='<%# Bind("KajaProcessID") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
