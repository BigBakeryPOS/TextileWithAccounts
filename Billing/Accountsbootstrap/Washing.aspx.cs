...
namespace Billing.Accountsbootstrap
{
    public partial class Washing : System.Web.UI.Page
    {
        ...
        {
            string Washingid = string.Empty;
            string Requests = string.Empty;
            Washingid = Request.QueryString.Get("Washingid");
            ...
            if (!IsPostBack)
            {
                ...
                //DataSet dsLotNo = objbs.Select_LotDetails("Wash");
                ...
                if (Washingid != null)
                {
                    if (Requests == "Edit")
                    {
                        ...
                        DataSet dgetcheck = objbs.getJpWashingLot(Washingid);
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            DataSet dsLot = objbs.Select_Lot("Wash", drpbranch.SelectedValue);
                            ...
                            dlotprocess = objbs.Get_LotDetails(Convert.ToString(dgetcheck.Tables[0].Rows[0]["LotDetailID"]), "5", "Wash");
                            ...
                            btnadd.Visible = true;
                            btnadd.Text = "Update";
                            txtid.Text = dgetcheck.Tables[0].Rows[0]["Washingid"].ToString();
                            txtmultiid.Text = dgetcheck.Tables[0].Rows[0]["Washingid"].ToString();
                            txtmultiplecode.Text = dgetcheck.Tables[0].Rows[0]["Washingid"].ToString();
                            ...
                            DataSet ds = objbs.Get_JpWashing(Convert.ToString(Washingid), "5", "Wash");
                    ...
                    else if (Requests == "partial")
                    {
                        ...
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            ...
                            txtAmount.Text = dgetcheck.Tables[0].Rows[0]["TotalAmount"].ToString();
                            txtAmount.Enabled = false;
                            DataSet ds = objbs.Get_LotDetails(Convert.ToString(dgetcheck.Tables[0].Rows[0]["LotDetailID"]), "5", "Wash");
                                //= objbs.Get_JpWashing(Convert.ToString(Washingid), "5", "Wash");
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                DataSet temp = new DataSet();
                                DataTable dtt = new DataTable();
                    ...
                    else if (Requests == "Receive")
                    {
                        ...
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                dsstichinglot = objbs.Get_dswashlotcolor(Convert.ToInt32(Washingid));
                                ...
                                gvnewwash.DataSource = dssstichinglot;
                                gvnewwash.DataBind();

                                for (int i = 0; i < gvnewwash.Rows.Count; i++)
                                {
                                    Label lblStockRatioId = (Label)gvnewwash.Rows[i].FindControl("lblStockRatioId");
                                    Label lblMasterid = (Label)gvnewwash.Rows[i].FindControl("lblMasterid");
                                    Label lblTransfabid = (Label)gvnewwash.Rows[i].FindControl("lblTransfabid");

                                    Label lbldesignno = (Label)gvnewwash.Rows[i].FindControl("lbldesignno");
                                    TextBox txts30fs = (TextBox)gvnewwash.Rows[i].FindControl("txts30fs");
                                    TextBox txts32fs = (TextBox)gvnewwash.Rows[i].FindControl("txts32fs");
                                    TextBox txts34fs = (TextBox)gvnewwash.Rows[i].FindControl("txts34fs");
                                    TextBox txts36fs = (TextBox)gvnewwash.Rows[i].FindControl("txts36fs");
                                    TextBox txtsxsfs = (TextBox)gvnewwash.Rows[i].FindControl("txtsxsfs");
                                    TextBox txtssfs = (TextBox)gvnewwash.Rows[i].FindControl("txtssfs");
                                    TextBox txtsmfs = (TextBox)gvnewwash.Rows[i].FindControl("txtsmfs");
                                    TextBox txtslfs = (TextBox)gvnewwash.Rows[i].FindControl("txtslfs");
                                    TextBox txtsxlfs = (TextBox)gvnewwash.Rows[i].FindControl("txtsxlfs");
                                    TextBox txtsxxlfs = (TextBox)gvnewwash.Rows[i].FindControl("txtsxxlfs");
                                    TextBox txts3xlfs = (TextBox)gvnewwash.Rows[i].FindControl("txts3xlfs");
                                    TextBox txts4xlfs = (TextBox)gvnewwash.Rows[i].FindControl("txts4xlfs");

                                    TextBox txts30hs = (TextBox)gvnewwash.Rows[i].FindControl("txts30hs");
                                    TextBox txts32hs = (TextBox)gvnewwash.Rows[i].FindControl("txts32hs");
                                    TextBox txts34hs = (TextBox)gvnewwash.Rows[i].FindControl("txts34hs");
                                    TextBox txts36hs = (TextBox)gvnewwash.Rows[i].FindControl("txts36hs");
                                    TextBox txtsxshs = (TextBox)gvnewwash.Rows[i].FindControl("txtsxshs");
                                    TextBox txtsshs = (TextBox)gvnewwash.Rows[i].FindControl("txtsshs");
                                    TextBox txtsmhs = (TextBox)gvnewwash.Rows[i].FindControl("txtsmhs");
                                    TextBox txtslhs = (TextBox)gvnewwash.Rows[i].FindControl("txtslhs");
                                    TextBox txtsxlhs = (TextBox)gvnewwash.Rows[i].FindControl("txtsxlhs");
                                    TextBox txtsxxlhs = (TextBox)gvnewwash.Rows[i].FindControl("txtsxxlhs");
                                    TextBox txts3xlhs = (TextBox)gvnewwash.Rows[i].FindControl("txts3xlhs");
                                    TextBox txts4xlhs = (TextBox)gvnewwash.Rows[i].FindControl("txts4xlhs");

                                    TextBox txtsendFQty = (TextBox)gvnewwash.Rows[i].FindControl("txtsendFQty");
                                    ...
                                    TextBox txts30fsac = (TextBox)gvnewwash.Rows[i].FindControl("txts30fsac");
                                    TextBox txts32fsac = (TextBox)gvnewwash.Rows[i].FindControl("txts32fsac");
                                    TextBox txts34fsac = (TextBox)gvnewwash.Rows[i].FindControl("txts34fsac");
                                    TextBox txts36fsac = (TextBox)gvnewwash.Rows[i].FindControl("txts36fsac");
                                    TextBox txtsxsfsac = (TextBox)gvnewwash.Rows[i].FindControl("txtsxsfsac");
                                    TextBox txtssfsac = (TextBox)gvnewwash.Rows[i].FindControl("txtssfsac");
                                    TextBox txtsmfsac = (TextBox)gvnewwash.Rows[i].FindControl("txtsmfsac");
                                    TextBox txtslfsac = (TextBox)gvnewwash.Rows[i].FindControl("txtslfsac");
                                    TextBox txtsxlfsac = (TextBox)gvnewwash.Rows[i].FindControl("txtsxlfsac");
                                    TextBox txtsxxlfsac = (TextBox)gvnewwash.Rows[i].FindControl("txtsxxlfsac");
                                    TextBox txts3xlfsac = (TextBox)gvnewwash.Rows[i].FindControl("txts3xlfsac");
                                    TextBox txts4xlfsac = (TextBox)gvnewwash.Rows[i].FindControl("txts4xlfsac");

                                    TextBox txts30hsac = (TextBox)gvnewwash.Rows[i].FindControl("txts30hsac");
                                    TextBox txts32hsac = (TextBox)gvnewwash.Rows[i].FindControl("txts32hsac");
                                    TextBox txts34hsac = (TextBox)gvnewwash.Rows[i].FindControl("txts34hsac");
                                    TextBox txts36hsac = (TextBox)gvnewwash.Rows[i].FindControl("txts36hsac");
                                    TextBox txtsxshsac = (TextBox)gvnewwash.Rows[i].FindControl("txtsxshsac");
                                    TextBox txtsshsac = (TextBox)gvnewwash.Rows[i].FindControl("txtsshsac");
                                    TextBox txtsmhsac = (TextBox)gvnewwash.Rows[i].FindControl("txtsmhsac");
                                    TextBox txtslhsac = (TextBox)gvnewwash.Rows[i].FindControl("txtslhsac");
                                    TextBox txtsxlhsac = (TextBox)gvnewwash.Rows[i].FindControl("txtsxlhsac");
                                    TextBox txtsxxlhsac = (TextBox)gvnewwash.Rows[i].FindControl("txtsxxlhsac");
                                    TextBox txts3xlhsac = (TextBox)gvnewwash.Rows[i].FindControl("txts3xlhsac");
                                    TextBox txts4xlhsac = (TextBox)gvnewwash.Rows[i].FindControl("txts4xlhsac");

                                    TextBox txtsendFQtyac = (TextBox)gvnewwash.Rows[i].FindControl("txtsendFQtyac");
        ...
        protected void company_SelectedIndexChnaged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSet dsLotNo = objbs.Select_LotDetails("Wash", drpbranch.SelectedValue);
                if (dsLotNo.Tables[0].Rows.Count > 0)
                {
                    DataSet dsLotNoval = objbs.Select_LotDetailsnew("Wash", drpbranch.SelectedValue, 4);
        ...
        protected void StitchingInfo_Load(object sender, EventArgs e)
        {
            ...
            if (ddlLotNo.SelectedValue != "Select Lot No")
            {
                int dcheck = objbs.checkcurrent(ddlLotNo.SelectedValue, "Wash");
                if (dcheck == 1)
                {
                    #region

                    double washingrate = 0;

                    DataSet rateforprecost = objbs.getrateforprecost(Convert.ToString(ddlLotNo.SelectedItem.Text), "WASHING");
                    if (rateforprecost.Tables[0].Rows.Count > 0)
                    {
                        washingrate = Convert.ToDouble(rateforprecost.Tables[0].Rows[0]["Cost"].ToString());
                    }
                    else
                    {
                    ...
                    DataSet dlotprocess = new DataSet();
                    dlotprocess = objbs.Get_LotDetails(Convert.ToString(ddlLotNo.SelectedValue), "5", "Wash");
                    txttotalqty.Text = dlotprocess.Tables[0].Rows[0]["TotalQuantity"].ToString();
                    ...
                    if (dlotprocess.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < gvcustomerorder.Rows.Count; i++)
                        {
                            ...
                            lblfitid.Text = temp.Tables[0].Rows[i]["fitid"].ToString();
                           // txtrate.Text = temp.Tables[0].Rows[i]["rate"].ToString();
                            txtrate.Text = washingrate.ToString();
                            drpProcess.SelectedValue = temp.Tables[0].Rows[i]["ProcessTypeID"].ToString();
                            lblPattern.Text = temp.Tables[0].Rows[i]["Pattern"].ToString();
                            lblPatternid.Text = temp.Tables[0].Rows[i]["Patternid"].ToString();
                            txtdamageqty.Text = temp.Tables[0].Rows[i]["damageqty"].ToString();
                    ...
                    dsstichinglot = objbs.Get_dsWashlot(Convert.ToInt32(ddlLotNo.SelectedValue), WASHING);
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Not Ready To Washing Process.Thank You!!!')", true);
                    return;
                }
            }
            //DataSet dataSet = objbs.getLotNoTransDetails(Convert.ToInt32(ddlLotNo.SelectedValue));
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            drpProcess = objbs.SelectAllProcessTypeLotProcess("5");
        ...
        protected void Add_LotProcessDetails(object sender, EventArgs e)
        {
            ...
            if (btnadd.Text == "Save")
            {
                ...
                int istatus3 = objbs.insertJpWashing(Convert.ToDouble(txtAmount.Text), Convert.ToInt32(ddlLotNo.SelectedValue), lbllotno.Text, MultiDate, Convert.ToInt32(drpMultiemployee.SelectedValue), Convert.ToDouble(txttotalqty.Text), empid, drpbranch.SelectedValue, ddlLotNo.SelectedItem.Text, Convert.ToInt32(txtsendFQtymain.Text),txtnarration.Text);



                for (int vLoop = 0; vLoop < gvnewwash.Rows.Count; vLoop++)
                {
                    int vLoopp = 0;
                    ...
                    #region
                    Label lblitemname = (Label)gvnewwash.Rows[vLoop].FindControl("lbldesignno");

                    TextBox txts30fs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txts30fs");
                    TextBox txts32fs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txts32fs");
                    TextBox txts34fs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txts34fs");
                    TextBox txts36fs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txts36fs");
                    TextBox txtsxsfs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txtsxsfs");
                    TextBox txtssfs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txtssfs");
                    TextBox txtsmfs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txtsmfs");
                    TextBox txtslfs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txtslfs");
                    TextBox txtsxlfs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txtsxlfs");
                    TextBox txtsxxlfs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txtsxxlfs");
                    TextBox txts3xlfs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txts3xlfs");
                    TextBox txts4xlfs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txts4xlfs");

                    TextBox txts30hs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txts30hs");
                    TextBox txts32hs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txts32hs");
                    TextBox txts34hs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txts34hs");
                    TextBox txts36hs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txts36hs");
                    TextBox txtsxshs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txtsxshs");
                    TextBox txtsshs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txtsshs");
                    TextBox txtsmhs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txtsmhs");
                    TextBox txtslhs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txtslhs");
                    TextBox txtsxlhs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txtsxlhs");
                    TextBox txtsxxlhs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txtsxxlhs");
                    TextBox txts3xlhs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txts3xlhs");
                    TextBox txts4xlhs = (TextBox)gvnewwash.Rows[vLoop].FindControl("txts4xlhs");

                    Label lblStockRatioId = (Label)gvnewwash.Rows[vLoop].FindControl("lblStockRatioId");
                    Label lblMasterid = (Label)gvnewwash.Rows[vLoop].FindControl("lblMasterid");
                    Label lblTransfabid = (Label)gvnewwash.Rows[vLoop].FindControl("lblTransfabid");

                    TextBox txtsendFQtycolor = (TextBox)gvnewwash.Rows[vLoop].FindControl("txtsendFQty");
                    ...
                    else
                    {
                        ...
                        {
                            int istasHistory = objbs.inserttransjpWashingHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            int istas = objbs.inserttransJpWashing(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            if (vLoop == 0)
                            {
                                int istas1 = objbs.JpWashing(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                ...
                int istatus3l = objbs.statusJpWashing(Convert.ToInt32(ddlLotNo.SelectedValue));
            ...
            else if (btnadd.Text == "Partial")
            {
                ...
                string Washingid = Request.QueryString.Get("Washingid");
                DateTime MultiDate = DateTime.ParseExact(txtmultidate.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture);

                int istatus3 = objbs.UpdJpWashing(Convert.ToDouble(txtAmount.Text), Convert.ToInt32(ddlLotNo.SelectedValue), lbllotno.Text, MultiDate, Convert.ToInt32(drpMultiemployee.SelectedValue), Convert.ToDouble(txttotalqty.Text), Washingid, empid);
                ...
                for (int vLoop = 0; vLoop < gvcustomerorder.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        ...
                        int istas = objbs.inserttransJpWashingpartial(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                 recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Convert.ToInt32(ddlLotNo.SelectedValue), empid, Convert.ToInt32(txtsendFQty.Text),Washingid);
            ...
            else if (btnadd.Text == "Update")
            {
                ...
                for (int vLoop = 0; vLoop < gvcustomerorder.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        ...
                        int istas = objbs.updatetransJpWashing(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                  recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtsendFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Convert.ToInt32(ddlLotNo.SelectedValue), Washingid);
            ...
            else if (btnadd.Text == "Received")
            {
                ...
                if (ddltype.SelectedValue == "Damage")
                {
                    int istasHistory = objbs.processmaintablewash(Convert.ToInt32(Washingid), Convert.ToInt32(txtdamageqtymain.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }
                else
                {
                    int istasHistory = objbs.processmaintablewash(Convert.ToInt32(Washingid), Convert.ToInt32(txtrecFQty.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }
                ...
                for (int vLoop = 0; vLoop < gvnewwash.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        if (txtsendFQtycolor.Text != "0")
                        {
                            int istasHistory = objbs.inserttransjpwashHistory1new(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), recdate,
                                      recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Washingid, empid, Convert.ToInt32(txtsendFQty.Text), Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), ddltype.SelectedItem.Text);

                            if (vLoop == 0)
                            {
                                //int istasHistory = objbs.inserttransjpWashingHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                //          recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtsendFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Washingid, empid, Convert.ToInt32(txtsendFQty.Text));

                                int istas = objbs.JpWashingREC(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            if (ddltype.SelectedValue == "Damage")
                            {
                                int rec = objbs.DamageProcessStockRatiowash(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text), WASHING);
                            }
                            else
                            {
                                int rec = objbs.updateProcessStockRatiowash(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text));
        ...
        protected void gvnewwash_RowDataBound(object sender, GridViewRowEventArgs e)
        {
