...
{
    public partial class Cni : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Consaiid != null)
            {
                ...
                DataSet ds2 = objBs.JpConsaifor(Consaiid);
                if (ds2.Tables[0].Rows.Count > 0)
                {
                    ...
                    DataSet ds23 = objBs.Get_JpCni(Convert.ToString(Consaiid), "11", "Cni");
        ...
        protected void btnclick(object sender, EventArgs e)
        {
            ...
            int isucess = objBs.updprintforall(Consaiid, "tbltransjpConsaihistory", "ConsaiId");
        }
