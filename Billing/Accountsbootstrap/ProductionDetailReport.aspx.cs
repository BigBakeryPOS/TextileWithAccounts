...
{
    public partial class ProductionDetailReport : System.Web.UI.Page
    {
        ...
        protected void btnSearch_OnClick(object sender, EventArgs e)
        {
            ...
            DataSet ds = objBs.ProductionDetailReport1(BuyerOrderId, chkUseDate.Checked, From, To, ddlProcessLedger.SelectedValue, ddlProcess.SelectedValue);
        ...
        {
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename= ProductionDetailReport.xls");
            Response.Charset = "";
