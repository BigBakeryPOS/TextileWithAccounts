<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CuttingDetailsNew.aspx.cs"
    Inherits="Billing.Accountsbootstrap.CuttingDetailsNew" %>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-2">                               
                                <div class="form-group">
                                    <label>
                                        Cutting Report Type :</label>
                                    <asp:DropDownList ID="ddlChallan" runat="server" class="form-control">
                                        <asp:ListItem Text="Cutting Details" Value="CuttingDetails"></asp:ListItem>
                                        <asp:ListItem Text="Cutting Qty Details" Value="CuttingQty"></asp:ListItem>
                                        <asp:ListItem Text="Master Cutting Details" Value="MasterCutting"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-1">
                            <asp:Button ID="btnSearchNew" runat="server" CssClass="btn btn-primary" Text="Search"
                                    OnClick="btnSearchNew_OnClick" Width="110px" />
                            </div>
                        ...
                        <div id="Excel" runat="server">
                            <div class="col-lg-12">
                                ...
                                <br />
                                <asp:GridView ID="gvCuttingDetails2" CssClass="" runat="server" EmptyDataText="No Records Found"
                                    OnRowDataBound="gvCuttingDetails2_OnRowDataBound" Width="100%">
                                    <HeaderStyle BackColor="#ec600d" BorderStyle="Solid" BorderWidth="1px" Font-Names="arial"
