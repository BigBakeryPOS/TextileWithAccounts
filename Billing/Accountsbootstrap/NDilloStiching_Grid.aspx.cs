...
{
    public partial class NDilloStiching_Grid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objBs.StichingGridNew();
                if (ds != null)
                {
        ...
        protected void gvcustinfo_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "edit")
            {
                ...
                //{
                //    Response.Redirect("NDillo_Stiching.aspx?LotId=" + e.CommandArgument.ToString() + "&name=" + e.CommandName);
                //}
