<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DilloWashingGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.DilloWashingGrid" %>
...
<head>
    ...
    <title>Washing Grid Master - bootsrap</title>
    <!-- Bootstrap Core CSS -->
                    ...
                    <div class="row">
                        <div class="col-lg-12" align="center">
                            ...
                            <div id="Div3" runat="server"  class="col-lg-18">
                                <asp:Button ID="btnrefresh" runat="server" Visible="false" class="btn btn-primary" Text="Reset"
                                    Width="130px" />
                                    <asp:DropDownList ID="drpstus" runat="server" CssClass="form-control" OnSelectedIndexChanged="Status_chnaged" AutoPostBack="true">
                            ...
                            <div class="col-lg-4">
                                   <asp:Button ID="btnaddwashwork" runat="server" class="btn btn-danger" Text="Add New Job-Work"  PostBackUrl="~/Accountsbootstrap/Dillo_WashJobwork.aspx"
                                    Width="150px" />
                            </div>
                            <div class="col-lg-17">
                                <asp:Button ID="btnadd" runat="server" class="btn btn-danger" Text="Add New"  PostBackUrl="~/Accountsbootstrap/Dillo_Washing.aspx"
                                    Width="130px" />
                            </div>
                                    ...
                                    <asp:GridView ID="gvcust" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="S.No" ItemStyle-Width="10%">
                                             ...
                                             <asp:BoundField Visible="false"  DataField="WashingProcessID" />
                                            ...
                                            <asp:TemplateField HeaderText="view" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint" runat="server" CommandArgument='<%#Eval("WashingProcessID") %>'
                                                        CommandName="view">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("WashingProcessID") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("WashingProcessID") %>'
                                                        CommandName="Edit">
                                                    ...
                                                    <asp:ImageButton ID="imgdisable2" ImageUrl="~/images/edit.png" runat="server" Visible="false"
                                                        Enabled="false" ToolTip="Not Allow To Delete" />
                                                    <asp:HiddenField ID="ldgID2" runat="server" Value='<%# Bind("WashingProcessID") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("WashingProcessID") %>'
