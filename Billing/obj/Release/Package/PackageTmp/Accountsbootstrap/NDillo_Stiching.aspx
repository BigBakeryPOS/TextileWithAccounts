<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NDillo_Stiching.aspx.cs"
    Inherits="Billing.Accountsbootstrap.NDillo_Stiching" %>
                                  ...
                                  OnSelectedIndexChanged="StitchingInfo_Load" AutoPostBack="true"></asp:DropDownList>
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            <div id="but" runat="server" class="row">
                                                ...
                                                <asp:Button ID="btnexit" runat="server" class="btn btn-warning" Text="Exit" PostBackUrl="NDilloStiching_Grid.aspx"
