<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dillo_KajaWork.aspx.cs" Inherits="Billing.Accountsbootstrap.Dillo_KajaWork" %>
...
<head id="Head1" runat="server">
    ...
    <title>Flexible Apparels || Kaja Job Work</title>
...
<body style="background-color:#c6efce">
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-top: 6px">
            <h1 id="head" runat="server" class="page-header" style="text-align: center; color: #fe0002">Kaja Job Work
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
  ...
  <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
       <ContentTemplate>
                    ...
                    <div id="add" runat="server" class="row">
                        ...
                        <asp:ValidationSummary runat="server" HeaderText="Validation Messages" ValidationGroup="val1"
                          ...
                          <div id="div1" class="form-group" runat="server">
                            ...
                            <div style="overflow-y: scroll; width: 217px; height: 170px">
                                            <div class="panel panel-default" style="width: 217px">
                                <label>
                                    Unit</label>
                             
                                <asp:CheckBoxList  ID="chkunit" RepeatColumns="1" CssClass="chkChoice" RepeatDirection="Horizontal" runat="server"
                                  OnSelectedIndexChanged="chkunit_changed" AutoPostBack="true"></asp:CheckBoxList>
                                  </div>
                                  </div>
                            </div>
                        ...
                        <div class="col-lg-3">
                           ...
                           <div class="form-group" >
                            <div style="overflow-y: scroll; width: 317px; height: 170px">
                                ...
                                <asp:CheckBoxList  ID="chkLotNo" RepeatColumns="4" CssClass="chkChoice" RepeatDirection="Horizontal" runat="server"
                        ...
                        <asp:DropDownList ID="drpsupervisor" runat="server" CssClass="form-control"></asp:DropDownList>
						 ...
						 <div class="col-lg-4">
                          <div id="div4" class="form-group" runat="server">
                                <label>
                                   Sending Date</label>
                                <asp:TextBox CssClass="form-control" ID="txtsendingdate"  runat="server" onkeyup="ValidateDate(this, event.keyCode)"
                                                                    onkeydown="return DateFormat(this, event.keyCode)" style="width: 310px;margin-left: -15px"></asp:TextBox>
                         ...
                         <div style="width:50%" class="form-group col-lg-3">
                          <div id="divPiece" class="form-group" runat="server">
                                <label>
                                    Total Qty</label>
                                <asp:TextBox CssClass="form-control" style="width:98px" Enabled="false" ID="txtTotalQantity" Text="0" runat="server"></asp:TextBox>
                            </div>
                         </div>
                         ...
                         <div style="width:50%" class="form-group col-lg-3">
                          <div id="div2" class="form-group" runat="server">
                                <label>
                                    Dc Date</label>
                                <asp:TextBox CssClass="form-control" ID="txtdcdate"  runat="server" onkeyup="ValidateDate(this, event.keyCode)"
                                                                    onkeydown="return DateFormat(this, event.keyCode)" style="width:98px"></asp:TextBox>
                                                            ...
                                                            <Columns>
                                                              <asp:TemplateField HeaderText="S.No" ItemStyle-Width="10%">
                                                                ...
                                                                <asp:TemplateField HeaderText="Unit Name" ItemStyle-Width="15%">
                                                                   ...
                                                                   <asp:TextBox ID="txtprocess" Visible="false" Text='<%# Eval("Process")%>' runat="server" Enabled="false" ></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Brand Name" ItemStyle-Width="15%">
                                                                 ...
                                                                 <asp:TemplateField HeaderText="36HS" ItemStyle-Width="3%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txt36HS"  Text='<%# Eval("36HS")%>'  runat="server" Width="100%" Height="26px" Enabled="false" ></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="38HS" ItemStyle-Width="3%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txt38HS"  Text='<%# Eval("38HS")%>'  runat="server" Width="100%" Height="26px" Enabled="false" ></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="39HS" ItemStyle-Width="3%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txt39HS"  Text='<%# Eval("39HS")%>'  runat="server" Width="100%" Height="26px" Enabled="false" ></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="40HS" ItemStyle-Width="3%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txt40HS"  Text='<%# Eval("40HS")%>'  runat="server" Width="100%" Height="26px" Enabled="false" ></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="42HS" ItemStyle-Width="3%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txt42HS"  Text='<%# Eval("42HS")%>'  runat="server" Width="100%" Height="26px" Enabled="false" ></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="44HS" ItemStyle-Width="3%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txt44HS"  Text='<%# Eval("44HS")%>'  runat="server" Width="100%" Height="26px" Enabled="false" ></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="36FS" ItemStyle-Width="3%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txt36FS" Text='<%# Eval("36FS")%>' runat="server" Width="100%" Height="26px" Enabled="false" ></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="38FS" ItemStyle-Width="3%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txt38FS" Text='<%# Eval("38FS")%>'  runat="server" Width="100%" Height="26px" Enabled="false"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                
                                                                <asp:TemplateField HeaderText="39FS" ItemStyle-Width="3%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txt39FS"  Text='<%# Eval("39FS")%>'  runat="server" Width="100%" Height="26px" Enabled="false" ></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="40FS" ItemStyle-Width="3%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txt40FS"  Text='<%# Eval("40FS")%>'  runat="server" Width="100%" Height="26px" Enabled="false" ></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                <asp:TemplateField HeaderText="42FS" ItemStyle-Width="3%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txt42FS"  Text='<%# Eval("42FS")%>'  runat="server" Width="100%" Height="26px" Enabled="false" ></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                  <asp:TemplateField HeaderText="44FS" ItemStyle-Width="3%">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txt44FS"  Text='<%# Eval("44FS")%>'  runat="server" Width="100%" Height="26px" Enabled="false" ></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Rate"  ItemStyle-Width="15%">
                                                                   ...
                                                                   <asp:TemplateField HeaderText="Design No"  ItemStyle-Width="15%">
                                                                    <ItemTemplate>
                                                                    <asp:TextBox ID="txtdesign" Text='<%# Eval("Designno")%>' runat="server" Width="100%" Height="26px" AppendDataBoundItems="true"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                    ...
                    <asp:Button ID="btnadd" runat="server" class="btn btn-info" Text="Save" 
                            ...
                            <asp:Button ID="btnexit" runat="server" PostBackUrl="~/Accountsbootstrap/Dillo_KajaworkGrid.aspx" class="btn btn-warning" Text="Exit" 
