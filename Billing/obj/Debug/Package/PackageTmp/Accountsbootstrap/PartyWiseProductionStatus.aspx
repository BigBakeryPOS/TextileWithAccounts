<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartyWiseProductionStatus.aspx.cs"
    Inherits="Billing.Accountsbootstrap.PartyWiseProductionStatus" %>
...
<head id="Head1" runat="server">
    ...
    <title>Party Wise Production Status </title>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div id="Excel" runat="server">
                            <asp:GridView ID="gvPartyWiseProductionStatus" runat="server" EmptyDataText="No Records Found" Caption="Party Wise Production Status"  GridLines="Both"
                                Width="100%" AutoGenerateColumns="false" OnRowDataBound="gvPartyWiseProductionStatus_OnRowDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Shipment" HeaderText="Shipment" />
                                    <asp:BoundField DataField="StyleNo" HeaderText="Style" ItemStyle-HorizontalAlign="Left" />
