<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequirementSheetGrid.aspx.cs"
    Inherits="Billing.Accountsbootstrap.RequirementSheetGrid" %>
...
<head>
    ...
    <title>Requirement Order Sheet</title>
    <!-- Bootstrap Core CSS -->
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-3">
                                <h1 class="page-header" style="text-align: center; color: #fe0002; font-size: 18px;
                                    font-weight: bold">
                                    Requirement Order Sheet Details</h1>
                            </div>
                            <div class="col-lg-2">
                            ...
                            <div class="col-lg-3">
                                <asp:TextBox CssClass="form-control" Enabled="true" onkeyup="Search_Gridview(this, 'gvrequirmentOrder')"
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gvrequirmentOrder" runat="server" CssClass="myGridStyle1" EmptyDataText="No records Found"
                                        Width="100%" AutoGenerateColumns="false" OnRowCommand="gvBuyerOrder_RowCommand">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="ExcNo" DataField="ExcNo1" />
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("RequirementId") %>'
                                                        CommandName="edit">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("RequirementId") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("ExcNo") %>'
