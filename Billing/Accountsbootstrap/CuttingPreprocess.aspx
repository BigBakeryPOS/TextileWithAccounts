<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CuttingPreprocess.aspx.cs" Inherits="Billing.Accountsbootstrap.CuttingPreprocess" %>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <asp:DropDownList ID="drpjobwork" runat="server" AutoPostBack="true" class="form-control" OnSelectedIndexChanged="Change_LotNo">
                                        </asp:DropDownList>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>
                                         Lot Date:</label>
                                        <asp:TextBox ID="txtdate" runat="server" Text="-Select Date-" onkeyup="ValidateDate(this, event.keyCode)"
                                                                    onkeydown="return DateFormat(this, event.keyCode)" CssClass="form-control"> </asp:TextBox>
                                    ...
                                    <div id="Div1" runat="server" class="form-group ">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ValidationGroup="val1" Text="*" ID="RequiredFieldValidator2"
                                            ControlToValidate="txtformal" ErrorMessage="Please enter Sharp" Style="color: Red" />
                                        <asp:TextBox CssClass="form-control" ID="txtformal" MaxLength="6" runat="server">0</asp:TextBox>
                                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                            FilterType="Numbers,custom" ValidChars="." TargetControlID="txtformal" />
                                    </div>
                                    <div id="Div22" runat="server" class="form-group ">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ValidationGroup="val1" Text="*" ID="RequiredFieldValidator4"
                                            ControlToValidate="txtcasual" ErrorMessage="Please enter Margin" Style="color: Red" />
                                        <asp:TextBox CssClass="form-control" ID="txtcasual" MaxLength="6" runat="server">0</asp:TextBox>
                                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server"
                                            FilterType="Numbers,custom" ValidChars="." TargetControlID="txtcasual" />
                                    </div>
                                     <div id="Div13" runat="server" class="form-group ">
                                        <label>
                                            Boys</label>
                                        <asp:RequiredFieldValidator runat="server" ValidationGroup="val1" Text="*" ID="RequiredFieldValidator6"
                                            ControlToValidate="txtboys" ErrorMessage="Please enter Margin" Style="color: Red" />
                                        <asp:TextBox CssClass="form-control" ID="txtboys" MaxLength="6" runat="server">0</asp:TextBox>
                                        <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" runat="server"
                                            FilterType="Numbers,custom" ValidChars="." TargetControlID="txtboys" />
                                    </div>
                                ...
                                <div class="col-lg-3">
                                    <div id="Div44" visible="false" runat="server" class="form-group ">
                                        <label>
                                    ...
                                    <div id="Div55" runat="server" visible="false" class="form-group ">
                                        <label>
                                        ...
                                        <asp:TextBox CssClass="form-control" ID="txtadjmeter" Text="100" MaxLength="6" runat="server"></asp:TextBox>
                                    ...
                                    <div id="Div781" visible="false" class="form-group" runat="server">
                                        <label>
                                            Max Meter:</label>
                                        <asp:Label ID="lblmax" runat="server"></asp:Label>
                                    </div>
                                     <div id="Div666" visible="false" class="form-group " runat="server">
                                    ...
                                    <label>Rate Per Unit(Cutting Master)</label>
                                    <asp:TextBox ID="txtcuttingrate" CssClass="form-control" runat="server"></asp:TextBox>
                                    </div>
                                    <div id="Div101" visible="false" runat="server" class="col-lg-9">
                                        <div style="overflow-y: scroll; width: 284px; height: 244px">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <div id="mul" runat="server">
                                        <div id="Div78" visible="false" runat="server" class="col-lg-5">
                                ...
                                <div class="col-lg-3">
                                    <div class="panel panel-default" style="width: 195px">
                                        <label>
                                            Size</label>
                                        <asp:CheckBoxList ID="chkSizes" Enabled="true" OnSelectedIndexChanged="ckhsize_index" AutoPostBack="true"
                                            RepeatDirection="Horizontal" RepeatColumns="2" CssClass="chkChoice" runat="server">
                                        </asp:CheckBoxList>
                                    </div>
                                    <div id="Div81" visible="false" runat="server" class="col-lg-6">
                                        <div class="form-group">
                                    ...
                                    <div id="Div9" visible="false" runat="server" class="col-lg-6">
                                        <div class="form-group">
                                            <label>
                            ...
                            <table id="Table1" runat="server"   class="table" style="background-color: #ffb85f">
                                <tr>
                                    <td>
                                        <label>
                                            Design - Color</label>
                            ...
                            <table class="table table-striped table-bordered table-hover" style="background-color: #ffb85f">
                                <tr id="tr4" visible="false" runat="server">
                                    <td>
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                <div visible="false" id="Div10" runat="server" align="right">
                                                    <asp:Button ID="btnavgsize" runat="server" Text="calc." OnClick="callcclick" />
                                                </div>
                                                <asp:Panel ID="Panel2" Visible="false" runat="server" ScrollBars="Both" Height="200" Width="100%">
                                ...
                                <tr id="tr1" visible="false" runat="server">
                                    <td>
                                        <label id="Label11" runat="server" visible="false">
                                            Party Name</label>
                                    ...
                                    <td id="addsingle" runat="server" visible="false">
                                        <label>
                                            Add</label>
                                ...
                                <tr id="Tr2" visible="false" runat="server">
                                    ...
                                    <td id="sfs" runat="server">
                                        <label>
                                            S FS</label>
                                        <asp:TextBox ID="txtSFS2" runat="server" OnTextChanged="Schange36fs" AutoPostBack="true" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="mfs" runat="server">
                                        <label>
                                            M FS</label>
                                        <asp:TextBox ID="txtMFS2" runat="server" OnTextChanged="Schange38fs" AutoPostBack="true" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="lfs" runat="server">
                                        <label>
                                            L FS</label>
                                        <asp:TextBox ID="txtLFS2" runat="server" OnTextChanged="Schange39fs" AutoPostBack="true" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="xlfs" runat="server">
                                        <label>
                                            XL FS</label>
                                        <asp:TextBox ID="txtXLFS2" runat="server" OnTextChanged="Schange40fs" AutoPostBack="true" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                     <td id="xxlfs" runat="server">
                                        <label>
                                            XXL FS</label>
                                        <asp:TextBox ID="txtXXLFS2" runat="server" OnTextChanged="Schange42fs" AutoPostBack="true" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="shs" runat="server" >
                                        <label>
                                            S HS</label>
                                        <asp:TextBox ID="txtSHS2" runat="server" OnTextChanged="Schange36hs" AutoPostBack="true" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="mhs" runat="server">
                                        <label>
                                            M HS</label>
                                        <asp:TextBox ID="txtMHS2" runat="server" OnTextChanged="Schange38hs" AutoPostBack="true" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="lhs" runat="server">
                                        <label>
                                            L HS</label>
                                        <asp:TextBox ID="txtLHS2" runat="server" OnTextChanged="Schange39hs" AutoPostBack="true" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="xlhs" runat="server">
                                        <label>
                                            XL HS</label>
                                        <asp:TextBox ID="txtXLHS2" runat="server" OnTextChanged="Schange40hs" AutoPostBack="true" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="xxlhs" runat="server">
                                        <label>
                                            XXL HS</label>
                                        <asp:TextBox ID="txtXXLHS2" runat="server" OnTextChanged="Schange42hs" AutoPostBack="true" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td>
                                        <label>
                                            Aval.Meter</label>
                                    ...
                                    <td>
                                      ...
                                      <td id="Td8" runat="server">
                                        <label>
                                            Avg.Size</label>
                                        <asp:TextBox ID="txtavvgmeter2" Enabled="false" runat="server" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td runat="server" visible="false">
                                        <label>
                                            Add</label>
                                ...
                                <tr id="Tr3" visible="false" runat="server">
                                    ...
                                    <td id="b28fs" runat="server">
                                        <label>
                                            28 FS</label>
                                        <asp:TextBox ID="txt28FS3" OnTextChanged="Schange36fs" AutoPostBack="true" runat="server" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="b30fs" runat="server">
                                        <label>
                                            30 FS</label>
                                        <asp:TextBox ID="txt30FS3" OnTextChanged="Schange38fs" AutoPostBack="true" runat="server" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="b32fs" runat="server">
                                        <label>
                                            32 FS</label>
                                        <asp:TextBox ID="txt32FS3" OnTextChanged="Schange39fs" AutoPostBack="true" runat="server" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="b34fs" runat="server">
                                        <label>
                                            34 FS</label>
                                        <asp:TextBox ID="txt34FS3" OnTextChanged="Schange40fs" AutoPostBack="true" runat="server" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="b36fs" runat="server">
                                        <label>
                                            36 FS</label>
                                        <asp:TextBox ID="txt36FS3" OnTextChanged="Schange42fs" AutoPostBack="true" runat="server" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="b38fs" runat="server">
                                        <label>
                                            38 FS</label>
                                        <asp:TextBox ID="txt38FS3" OnTextChanged="Schange44fs" AutoPostBack="true" runat="server" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="b28hs" runat="server">
                                        <label>
                                            28 HS</label>
                                        <asp:TextBox ID="txt28HS3" runat="server" OnTextChanged="Schange36hs" AutoPostBack="true" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="b30hs" runat="server">
                                        <label>
                                            30 HS</label>
                                        <asp:TextBox ID="txt30HS3" runat="server" OnTextChanged="Schange38hs" AutoPostBack="true" CssClass="form-control">0</asp:TextBox>
                                   </td>
                                    <td id="b32hs" runat="server">
                                        <label>
                                            32 HS</label>
                                        <asp:TextBox ID="txt32HS3" OnTextChanged="Schange39hs" AutoPostBack="true" runat="server" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="b34hs" runat="server">
                                        <label>
                                            34 HS</label>
                                        <asp:TextBox ID="txt34HS3" OnTextChanged="Schange40hs" AutoPostBack="true" runat="server" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="b36hs" runat="server">
                                        <label>
                                            36 HS</label>
                                        <asp:TextBox ID="txt36HS3" OnTextChanged="Schange42hs" AutoPostBack="true" runat="server" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td id="b38hs" runat="server">
                                        <label>
                                            38 HS</label>
                                        <asp:TextBox ID="txt38HS3" OnTextChanged="Schange44hs" AutoPostBack="true" runat="server" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td>
                                        <label>
                                            Aval.Meter</label>
                                    ...
                                    <td>
                                      ...
                                      <td id="Td9" runat="server">
                                        <label>
                                            Avg.Size</label>
                                        <asp:TextBox ID="txtavvgmeter3" Enabled="false" runat="server" CssClass="form-control">0</asp:TextBox>
                                    </td>
                                    <td runat="server" visible="false">
                                        <label>
                                            Add</label>
                                ...
                                <asp:Button ID="btnprocessall"  runat="server" Visible="false" class="btn btn-info" Text="Process-All"
                                    OnClick="processclickall" ValidationGroup="val1" Style="width: 120px; margin-left: 1000px;
                                    margin-bottom: -32px" />
                                <asp:Button ID="btnprocess" Visible="false" runat="server" class="btn btn-info" Text="Process" OnClick="processclick"
                                    ValidationGroup="val1" Style="width: 120px; margin-left: 1136px" />
                                     <asp:Button ID="btngohead" runat="server" Visible="false" class="btn btn-info" Text="GO Head" OnClick="GOheadprocessclick"
                                    ValidationGroup="val1" Style="width: 120px; margin-left: 1136px" />
                            </table>
                                ...
                                <div class="col-lg-12" style="margin-top: -35px">
                                    <div class="panel-body">
                                        <div>
                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="Table2" width="100%">
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:Panel ID="panelformal" Visible="false" runat="server" ScrollBars="Both" Height="200" Width="100%">
                                                            <asp:GridView ID="gvcustomerorder" AutoGenerateColumns="False" ShowFooter="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Ava. meter" ControlStyle-Width="100%" ItemStyle-Width="6%">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtmet" Enabled="false" Text='<%# Eval("meter")%>' runat="server"></asp:TextBox>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                         ...
                                                         <asp:Panel ID="panelcasual" Visible="false" runat="server" ScrollBars="Both" Height="200" Width="100%">
                                                         ...
                                                         <asp:Panel ID="panelboys" Visible="false" runat="server" ScrollBars="Both" Height="200" Width="100%">
                                                            <asp:GridView ID="GridView2" AutoGenerateColumns="False" ShowFooter="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="44 FS" Visible="false" ControlStyle-Width="100%">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtfffs" Enabled="false" Text='<%# Eval("FFFS")%>' runat="server"
                                                                                Height="26px">0</asp:TextBox>
                                                                        </ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="44 HS" Visible="false" ControlStyle-Width="100%">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtffhs" Enabled="false" Text='<%# Eval("FFHS")%>' runat="server"
                                                                                Height="26px">0</asp:TextBox>
                                                                        </ItemTemplate>
                                                ...
                                                <tr>
                                                    <td id="Td7" runat="server" visible="false" align="right">
                                                        <asp:Button ID="ButtonAdd1" runat="server" EnableTheming="false" Text="Add New" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <table id="Table34" style="margin-top: -36px" width="45%">
                                                        <tr>
                                                            <td>
                                                                <label>
                                                                    <%--Total Qty.--%></label>
