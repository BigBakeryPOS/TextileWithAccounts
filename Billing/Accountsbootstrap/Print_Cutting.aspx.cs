...
//{
//    public partial class Print_Cutting : System.Web.UI.Page
//    {
...
//                DataSet dataset = objBs.Cuttingprintreportfornew(Convert.ToInt32(iSalesID));
//                //DataSet dataset = objBs.FabricreportCR(Convert.ToInt32(iSalesID));


//                ReportDocument CustomerReport = new ReportDocument();
//                CustomerReport.Load(Server.MapPath("~/Accountsbootstrap/Cuttingreport.rpt"));
