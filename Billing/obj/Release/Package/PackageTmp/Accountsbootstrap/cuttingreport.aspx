<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cuttingreport.aspx.cs" Inherits="Billing.Accountsbootstrap.cuttingreport" %>
...
<asp:scriptmanager id="ScriptManager1" runat="server">
                ...
                <div class="col-lg-12" style="margin-top:6px">
                    <h1  class="page-header" style="text-align:center;color:#fe0002;">Cutting Report</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
   <%-- <div class="row">
