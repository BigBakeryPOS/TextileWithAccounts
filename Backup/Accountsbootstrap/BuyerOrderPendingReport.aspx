<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyerOrderPendingReport.aspx.cs"
    Inherits="Billing.Accountsbootstrap.BuyerOrderPendingReport" %>
...
<head id="Head1" runat="server">
    ...
    <title>BuyerOrder Pending Report</title>
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-2">
                                <h1 class="page-header" style="text-align: center; color: #fe0002; font-size: 20px;
                                    font-weight: bold">
                                    BuyerOrder Pending Reports</h1>
                            </div>
                            <div class="col-lg-2" id="BuyerCode" runat="server" visible="true">
                                <div class="form-group">
                                    <label>
                                        Buyer Code:</label>
                                    <asp:DropDownList ID="ddlBuyerCode" runat="server" CssClass="chzn-select" OnSelectedIndexChanged="buyer_order" AutoPostBack="true"  Width="100%">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-1">
                                <div class="form-group" id="Date" runat="server" visible="true">
                                    <asp:Label ID="lblDate" runat="server" Text="Shipment Date" Width="110px" Style="font-weight: bold"></asp:Label>
                                    <br />
                        ...
                        <div id="Excel" runat="server">
                            <asp:GridView ID="gvBuyerOrderQty" runat="server" CssClass="myGridStyle1" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="MCQty" DataField="MCQty" />
                                    <asp:BoundField HeaderText="FinishingQty" DataField="FinishingQty" />
                                </Columns>
