...
{
    public partial class CAD_Entry_Grid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objBs.Grid_CADEntry();
                if (ds.Tables[0].Rows.Count > 0)
                {
                    gvcadgrid.DataSource = ds;
                    gvcadgrid.DataBind();
                }

                else
                {
                    gvcadgrid.DataSource = null;
                    gvcadgrid.DataBind();
                }
            }
        }
        ...
        {
            Response.Redirect("CAD_Entry.aspx");
        ...
        protected void refresh_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("../Accountsbootstrap/CAD_Entry.aspx");
        ...
        protected void gvcadgrid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                if (e.CommandArgument.ToString() != "")
                {
                    Response.Redirect("CAD_Entry.aspx?cadid=" + e.CommandArgument.ToString());
                }
            }
        }
