...
namespace Billing.Accountsbootstrap
{
    public partial class Printing : System.Web.UI.Page
    {
        ...
        {
            string Printingid = string.Empty;
            string Requests = string.Empty;
            Printingid = Request.QueryString.Get("Printingid");
            ...
            if (!IsPostBack)
            {
                ...
                //DataSet dsLotNo = objbs.Select_LotDetails("Print");
                ...
                if (Printingid != null)
                {
                    ...
                    if (Requests == "Receive")
                    {
                        ...
                        DataSet dgetcheck = objbs.getJpPrintingLot(Printingid);
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            ...
                            DataSet dsLot = objbs.Select_Lot("Print", drpbranch.SelectedValue);
                            ...
                            dlotprocess = objbs.Get_LotDetails(Convert.ToString(dgetcheck.Tables[0].Rows[0]["LotDetailID"]), "8", "Print");
                            ...
                            txtid.Text = dgetcheck.Tables[0].Rows[0]["Printingid"].ToString();
                            txtmultiid.Text = dgetcheck.Tables[0].Rows[0]["Printingid"].ToString();
                            txtmultiplecode.Text = dgetcheck.Tables[0].Rows[0]["Printingid"].ToString();
                            ...
                            DataSet ds = objbs.Get_JpPrinting(Convert.ToString(Printingid), "8", "Print");
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                dsstichinglot = objbs.Get_dsprintlotcolor(Convert.ToInt32(Printingid));
                                ...
                                gvnewprint.DataSource = dssstichinglot;
                                gvnewprint.DataBind();

                                if (chkSizes.SelectedIndex >= 0)
                                {
                                    gvnewprint.Columns[2].Visible = false; //30FS
                                    gvnewprint.Columns[3].Visible = false; //32FS

                                    gvnewprint.Columns[4].Visible = false;//34Fs
                                    gvnewprint.Columns[5].Visible = false;//36Fs

                                    gvnewprint.Columns[6].Visible = false; //XSFS
                                    gvnewprint.Columns[7].Visible = false; //SFS

                                    gvnewprint.Columns[8].Visible = false; //MFS
                                    gvnewprint.Columns[9].Visible = false; //LFS

                                    gvnewprint.Columns[10].Visible = false; //XLFS
                                    gvnewprint.Columns[11].Visible = false; //xxlFS

                                    gvnewprint.Columns[12].Visible = false; //3xlHS
                                    gvnewprint.Columns[13].Visible = false; //4xlHS

                                    gvnewprint.Columns[14].Visible = false; //30HS

                                    gvnewprint.Columns[15].Visible = false; //32HS

                                    gvnewprint.Columns[16].Visible = false; //34HS
                                    gvnewprint.Columns[17].Visible = false; //36HS

                                    gvnewprint.Columns[18].Visible = false; //XSHS
                                    gvnewprint.Columns[19].Visible = false; //SHS

                                    gvnewprint.Columns[20].Visible = false; //MHS
                                    gvnewprint.Columns[21].Visible = false; //LHS

                                    gvnewprint.Columns[22].Visible = false; //XLHS
                                    gvnewprint.Columns[23].Visible = false; //XXLHS

                                    gvnewprint.Columns[24].Visible = false; //3XLHS
                                    gvnewprint.Columns[25].Visible = false; //4XLHS
                                    ...
                                    foreach (ListItem item in chkSizes.Items)
                                    {
                                        ...
                                        if (item.Selected)
                                        {

                                            {
                                                if (item.Text == "30FS")
                                                {
                                                    gvnewprint.Columns[2].Visible = true;
                                                }
                                                if (item.Text == "32FS")
                                                {
                                                    gvnewprint.Columns[3].Visible = true;
                                                }
                                                if (item.Text == "34FS")
                                                {
                                                    gvnewprint.Columns[4].Visible = true;
                                                }
                                                if (item.Text == "36FS")
                                                {
                                                    gvnewprint.Columns[5].Visible = true;
                                                }
                                                if (item.Text == "XSFS")
                                                {
                                                    gvnewprint.Columns[6].Visible = true;
                                                }
                                                if (item.Text == "SFS")
                                                {
                                                    gvnewprint.Columns[7].Visible = true;
                                                }
                                                if (item.Text == "MFS")
                                                {
                                                    gvnewprint.Columns[8].Visible = true;
                                                }
                                                if (item.Text == "LFS")
                                                {
                                                    gvnewprint.Columns[9].Visible = true;
                                                }
                                                if (item.Text == "XLFS")
                                                {
                                                    gvnewprint.Columns[10].Visible = true;
                                                }
                                                if (item.Text == "XXLFS")
                                                {
                                                    gvnewprint.Columns[11].Visible = true;
                                                }
                                                if (item.Text == "3XLFS")
                                                {
                                                    gvnewprint.Columns[12].Visible = true;
                                                }
                                                if (item.Text == "4XLFS")
                                                {
                                                    gvnewprint.Columns[13].Visible = true;
                                                }
                                                ...
                                                if (item.Text == "30HS")
                                                {
                                                    gvnewprint.Columns[14].Visible = true;
                                                }

                                                if (item.Text == "32HS")
                                                {
                                                    gvnewprint.Columns[15].Visible = true;
                                                }

                                                if (item.Text == "34HS")
                                                {
                                                    gvnewprint.Columns[16].Visible = true;
                                                }

                                                if (item.Text == "36HS")
                                                {
                                                    gvnewprint.Columns[17].Visible = true;

                                                }

                                                if (item.Text == "XSHS")
                                                {
                                                    gvnewprint.Columns[18].Visible = true;
                                                }

                                                if (item.Text == "SHS")
                                                {
                                                    gvnewprint.Columns[19].Visible = true;
                                                }

                                                if (item.Text == "MHS")
                                                {
                                                    gvnewprint.Columns[20].Visible = true;
                                                }

                                                if (item.Text == "LHS")
                                                {
                                                    gvnewprint.Columns[21].Visible = true;
                                                }

                                                if (item.Text == "XLHS")
                                                {
                                                    gvnewprint.Columns[22].Visible = true;
                                                }

                                                if (item.Text == "XXLHS")
                                                {
                                                    gvnewprint.Columns[23].Visible = true;
                                                }

                                                if (item.Text == "3XLHS")
                                                {
                                                    gvnewprint.Columns[24].Visible = true;
                                                }

                                                if (item.Text == "4XLHS")
                                                {
                                                    gvnewprint.Columns[25].Visible = true;
                                                }
                                ...
                                for (int i = 0; i < gvnewprint.Rows.Count; i++)
                                {
                                    Label lblStockRatioId = (Label)gvnewprint.Rows[i].FindControl("lblStockRatioId");
                                    Label lblMasterid = (Label)gvnewprint.Rows[i].FindControl("lblMasterid");
                                    Label lblTransfabid = (Label)gvnewprint.Rows[i].FindControl("lblTransfabid");

                                    Label lblonlycolor = (Label)gvnewprint.Rows[i].FindControl("lblonlycolor");

                                    Label lbldesignno = (Label)gvnewprint.Rows[i].FindControl("lbldesignno");
                                    TextBox txts30fs = (TextBox)gvnewprint.Rows[i].FindControl("txts30fs");
                                    TextBox txts32fs = (TextBox)gvnewprint.Rows[i].FindControl("txts32fs");
                                    TextBox txts34fs = (TextBox)gvnewprint.Rows[i].FindControl("txts34fs");
                                    TextBox txts36fs = (TextBox)gvnewprint.Rows[i].FindControl("txts36fs");
                                    TextBox txtsxsfs = (TextBox)gvnewprint.Rows[i].FindControl("txtsxsfs");
                                    TextBox txtssfs = (TextBox)gvnewprint.Rows[i].FindControl("txtssfs");
                                    TextBox txtsmfs = (TextBox)gvnewprint.Rows[i].FindControl("txtsmfs");
                                    TextBox txtslfs = (TextBox)gvnewprint.Rows[i].FindControl("txtslfs");
                                    TextBox txtsxlfs = (TextBox)gvnewprint.Rows[i].FindControl("txtsxlfs");
                                    TextBox txtsxxlfs = (TextBox)gvnewprint.Rows[i].FindControl("txtsxxlfs");
                                    TextBox txts3xlfs = (TextBox)gvnewprint.Rows[i].FindControl("txts3xlfs");
                                    TextBox txts4xlfs = (TextBox)gvnewprint.Rows[i].FindControl("txts4xlfs");

                                    TextBox txts30hs = (TextBox)gvnewprint.Rows[i].FindControl("txts30hs");
                                    TextBox txts32hs = (TextBox)gvnewprint.Rows[i].FindControl("txts32hs");
                                    TextBox txts34hs = (TextBox)gvnewprint.Rows[i].FindControl("txts34hs");
                                    TextBox txts36hs = (TextBox)gvnewprint.Rows[i].FindControl("txts36hs");
                                    TextBox txtsxshs = (TextBox)gvnewprint.Rows[i].FindControl("txtsxshs");
                                    TextBox txtsshs = (TextBox)gvnewprint.Rows[i].FindControl("txtsshs");
                                    TextBox txtsmhs = (TextBox)gvnewprint.Rows[i].FindControl("txtsmhs");
                                    TextBox txtslhs = (TextBox)gvnewprint.Rows[i].FindControl("txtslhs");
                                    TextBox txtsxlhs = (TextBox)gvnewprint.Rows[i].FindControl("txtsxlhs");
                                    TextBox txtsxxlhs = (TextBox)gvnewprint.Rows[i].FindControl("txtsxxlhs");
                                    TextBox txts3xlhs = (TextBox)gvnewprint.Rows[i].FindControl("txts3xlhs");
                                    TextBox txts4xlhs = (TextBox)gvnewprint.Rows[i].FindControl("txts4xlhs");

                                    TextBox txtsendFQty = (TextBox)gvnewprint.Rows[i].FindControl("txtsendFQty");
                                    ...
                                    TextBox txts30fsac = (TextBox)gvnewprint.Rows[i].FindControl("txts30fsac");
                                    TextBox txts32fsac = (TextBox)gvnewprint.Rows[i].FindControl("txts32fsac");
                                    TextBox txts34fsac = (TextBox)gvnewprint.Rows[i].FindControl("txts34fsac");
                                    TextBox txts36fsac = (TextBox)gvnewprint.Rows[i].FindControl("txts36fsac");
                                    TextBox txtsxsfsac = (TextBox)gvnewprint.Rows[i].FindControl("txtsxsfsac");
                                    TextBox txtssfsac = (TextBox)gvnewprint.Rows[i].FindControl("txtssfsac");
                                    TextBox txtsmfsac = (TextBox)gvnewprint.Rows[i].FindControl("txtsmfsac");
                                    TextBox txtslfsac = (TextBox)gvnewprint.Rows[i].FindControl("txtslfsac");
                                    TextBox txtsxlfsac = (TextBox)gvnewprint.Rows[i].FindControl("txtsxlfsac");
                                    TextBox txtsxxlfsac = (TextBox)gvnewprint.Rows[i].FindControl("txtsxxlfsac");
                                    TextBox txts3xlfsac = (TextBox)gvnewprint.Rows[i].FindControl("txts3xlfsac");
                                    TextBox txts4xlfsac = (TextBox)gvnewprint.Rows[i].FindControl("txts4xlfsac");

                                    TextBox txts30hsac = (TextBox)gvnewprint.Rows[i].FindControl("txts30hsac");
                                    TextBox txts32hsac = (TextBox)gvnewprint.Rows[i].FindControl("txts32hsac");
                                    TextBox txts34hsac = (TextBox)gvnewprint.Rows[i].FindControl("txts34hsac");
                                    TextBox txts36hsac = (TextBox)gvnewprint.Rows[i].FindControl("txts36hsac");
                                    TextBox txtsxshsac = (TextBox)gvnewprint.Rows[i].FindControl("txtsxshsac");
                                    TextBox txtsshsac = (TextBox)gvnewprint.Rows[i].FindControl("txtsshsac");
                                    TextBox txtsmhsac = (TextBox)gvnewprint.Rows[i].FindControl("txtsmhsac");
                                    TextBox txtslhsac = (TextBox)gvnewprint.Rows[i].FindControl("txtslhsac");
                                    TextBox txtsxlhsac = (TextBox)gvnewprint.Rows[i].FindControl("txtsxlhsac");
                                    TextBox txtsxxlhsac = (TextBox)gvnewprint.Rows[i].FindControl("txtsxxlhsac");
                                    TextBox txts3xlhsac = (TextBox)gvnewprint.Rows[i].FindControl("txts3xlhsac");
                                    TextBox txts4xlhsac = (TextBox)gvnewprint.Rows[i].FindControl("txts4xlhsac");

                                    TextBox txtsendFQtyac = (TextBox)gvnewprint.Rows[i].FindControl("txtsendFQtyac");
        ...
        protected void company_SelectedIndexChnaged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSet dsLotNo = objbs.Select_LotDetails("Print", drpbranch.SelectedValue);
                if (dsLotNo.Tables[0].Rows.Count > 0)
                {
                    DataSet dsLotNoval = objbs.Select_LotDetailsnew("Print", drpbranch.SelectedValue, 7);
        ...
        protected void EmployeeRate_chnaged(object sender, EventArgs e)
        {
            if (ddlLotNo.SelectedValue != "Select Lot No")
            {
                ...
                {
                    DataSet getrate = objbs.getrateforjobworker(drpMultiemployee.SelectedValue, lblitemid.Text, "Print");
                    ...
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "myscript", "alert('Please Try Again Later.Rate Not confirmed.To this " + ddlLotNo.SelectedItem.Text + ". Thank you');", true);
                        return;
                    }
        ...
        protected void StitchingInfo_Load(object sender, EventArgs e)
        {
            ...
            if (ddlLotNo.SelectedValue != "Select Lot No")
            {
                int dcheck = objbs.checkcurrent(ddlLotNo.SelectedValue, "Print");
                if (dcheck == 1)
                {
                    #region
                    double printingrate = 0;
                    ...
                    //DataSet rateforprecost = objbs.getrateforprecost(Convert.ToString(ddlLotNo.SelectedItem.Text), "PRINTING");
                    //if (rateforprecost.Tables[0].Rows.Count > 0)
                    //{
                    //    printingrate = Convert.ToDouble(rateforprecost.Tables[0].Rows[0]["Cost"].ToString());
                    //}
                    //else
                    //{
                    ...
                    DataSet dlotprocess = new DataSet();
                    dlotprocess = objbs.Get_LotDetails(Convert.ToString(ddlLotNo.SelectedValue), "8", "Print");
                    if (dlotprocess.Tables[0].Rows.Count > 0)
                    {
                        txttotalqty.Text = dlotprocess.Tables[0].Rows[0]["TotalQuantity"].ToString();
                    ...
                    if (dlotprocess.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < gvcustomerorder.Rows.Count; i++)
                        {
                            ...
                            // txtrate.Text = temp.Tables[0].Rows[i]["rate"].ToString();
                            txtrate.Text = printingrate.ToString();
                            drpProcess.SelectedValue = temp.Tables[0].Rows[i]["ProcessTypeID"].ToString();
                            lblPattern.Text = temp.Tables[0].Rows[i]["Pattern"].ToString();
                            lblPatternid.Text = temp.Tables[0].Rows[i]["Patternid"].ToString();
                            txtdamageqty.Text = temp.Tables[0].Rows[i]["damageqty"].ToString();
                    ...
                    dsstichinglot = objbs.Get_dsPrintlot(Convert.ToInt32(ddlLotNo.SelectedValue), PRINTING);
                ...
                else
                {
                    ...
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Not Ready To Printing Process.Thank You!!!')", true);
                    return;
                }
            }
            //DataSet dataSet = objbs.getLotNoTransDetails(Convert.ToInt32(ddlLotNo.SelectedValue));
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            drpProcess = objbs.SelectAllProcessTypeLotProcess("8");
        ...
        protected void Add_LotProcessDetails(object sender, EventArgs e)
        {
            ...
            if (btnadd.Text == "Save")
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "myscript", "alert('Cutting Date And Printing Issue date MisMatch.Thank you!!!');", true);
                    return;
            ...
            else if (btnadd.Text == "Received")
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "myscript", "alert('Printing Issue Date And Printing Receive date MisMatch.Thank you!!!');", true);
                    return;
            ...
            if (btnadd.Text == "Save")
            {
                ...
                int istatus3 = objbs.insertJpPrinting(Convert.ToDouble(txtAmount.Text), Convert.ToInt32(ddlLotNo.SelectedValue), lbllotno.Text, MultiDate, Convert.ToInt32(drpMultiemployee.SelectedValue), Convert.ToDouble(txttotalqty.Text), empid, drpbranch.SelectedValue, ddlLotNo.SelectedItem.Text, Convert.ToInt32(txtsendFQtymain.Text), txtnarration.Text, ReceiveDate, txtitemnarration.Text);



                for (int vLoop = 0; vLoop < gvnewprint.Rows.Count; vLoop++)
                {
                    int vLoopp = 0;
                    ...
                    #region
                    Label lblitemname = (Label)gvnewprint.Rows[vLoop].FindControl("lbldesignno");

                    TextBox txts30fs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txts30fs");
                    TextBox txts32fs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txts32fs");
                    TextBox txts34fs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txts34fs");
                    TextBox txts36fs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txts36fs");
                    TextBox txtsxsfs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txtsxsfs");
                    TextBox txtssfs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txtssfs");
                    TextBox txtsmfs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txtsmfs");
                    TextBox txtslfs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txtslfs");
                    TextBox txtsxlfs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txtsxlfs");
                    TextBox txtsxxlfs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txtsxxlfs");
                    TextBox txts3xlfs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txts3xlfs");
                    TextBox txts4xlfs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txts4xlfs");

                    TextBox txts30hs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txts30hs");
                    TextBox txts32hs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txts32hs");
                    TextBox txts34hs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txts34hs");
                    TextBox txts36hs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txts36hs");
                    TextBox txtsxshs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txtsxshs");
                    TextBox txtsshs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txtsshs");
                    TextBox txtsmhs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txtsmhs");
                    TextBox txtslhs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txtslhs");
                    TextBox txtsxlhs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txtsxlhs");
                    TextBox txtsxxlhs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txtsxxlhs");
                    TextBox txts3xlhs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txts3xlhs");
                    TextBox txts4xlhs = (TextBox)gvnewprint.Rows[vLoop].FindControl("txts4xlhs");

                    Label lblStockRatioId = (Label)gvnewprint.Rows[vLoop].FindControl("lblStockRatioId");
                    Label lblMasterid = (Label)gvnewprint.Rows[vLoop].FindControl("lblMasterid");
                    Label lblTransfabid = (Label)gvnewprint.Rows[vLoop].FindControl("lblTransfabid");

                    TextBox txtsendFQtycolor = (TextBox)gvnewprint.Rows[vLoop].FindControl("txtsendFQty");
                    ...
                    else
                    {
                        ...
                        {
                            int istasHistory = objbs.inserttransjpPrintingHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            int istas = objbs.inserttransJpPrinting(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            if (vLoop == 0)
                            {
                                int istas1 = objbs.JpPrinting(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                ...
                int istatus3l = objbs.statusJpPrinting(Convert.ToInt32(ddlLotNo.SelectedValue));
            ...
            else if (btnadd.Text == "Received")
            {
                ...
                string Printingid = Request.QueryString.Get("Printingid");
                ...
                if (ddltype.SelectedValue == "Damage")
                {
                    int istasHistory = objbs.processmaintableprint(Convert.ToInt32(Printingid), Convert.ToInt32(txtdamageqtymain.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }
                else
                {
                    int istasHistory = objbs.processmaintableprint(Convert.ToInt32(Printingid), Convert.ToInt32(txtrecFQty.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }
                for (int vLoop = 0; vLoop < gvnewprint.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        if (txtsendFQtycolor.Text != "0")
                        {
                            int istasHistory = objbs.inserttransjpprintHistory1new(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), recdate,
                                      recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Printingid, empid, Convert.ToInt32(txtsendFQty.Text), Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), ddltype.SelectedItem.Text);

                            if (vLoop == 0)
                            {
                                //int istasHistory = objbs.inserttransjpPrintingHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text),date11,
                                //          recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Printingid, empid, Convert.ToInt32(txtsendFQty.Text));

                                int istas = objbs.JpPrintingREC(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            if (ddltype.SelectedValue == "Damage")
                            {
                                int rec = objbs.DamageProcessStockRatioprint(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text), PRINTING);
                            }
                            else
                            {
                                int rec = objbs.updateProcessStockRatioprint(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text));
        ...
        protected void gvnewprint_RowDataBound(object sender, GridViewRowEventArgs e)
        {
