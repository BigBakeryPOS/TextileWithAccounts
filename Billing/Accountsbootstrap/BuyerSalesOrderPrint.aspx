<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyerSalesOrderPrint.aspx.cs"
    Inherits="Billing.Accountsbootstrap.BuyerSalesOrderPrint" %>
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="1">
        ...
        <tr>
            <td colspan="3" align="center" style="width: 100%; height: 35px; font-weight: bold;
                font-size: larger">
                <hr />
                <asp:Label ID="lblprint" runat="server" Text="Buyer Order Sales Print"></asp:Label>
                <hr />
            </td>
        </tr>
    </table>
                ...
                <asp:GridView ID="gvItemProcessOrder" runat="server" EmptyDataText="No Records Found"
                    ...
                    <Columns>
                     ...
                     <asp:TemplateField>
                        ...
                        <asp:BoundField DataField="Salesfortype" Visible="true" HeaderText="Exc No" HeaderStyle-HorizontalAlign="Left" />
