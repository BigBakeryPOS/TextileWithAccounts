<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CuttingInfoGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.CuttingInfoGrid" %>
                                ...
                                <td>
                                    <asp:GridView ID="gvcustinfo" runat="server" CssClass="myGridStyle" EmptyDataText="No records Found"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Design Number" Visible="false" DataField="DesignNumber" />
                                            ...
                                            <asp:BoundField HeaderText="Design No" DataField="LotDesignNo" />
