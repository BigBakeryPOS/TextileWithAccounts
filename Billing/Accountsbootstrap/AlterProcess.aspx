<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlterProcess.aspx.cs" Inherits="Billing.Accountsbootstrap.AlterProcess" %>
...
<head id="Head1" runat="server">
    ...
    <title>Alter Issue / Receive</title>
                                    ...
                                    <div id="Div1" runat="server" class="row">
                                        ...
                                        <div id="Div6" runat="server" visible="false" class="form-group">
                                            <span onclick="openNav()">Process Details
                                                <asp:CheckBox ID="DetailView" runat="server" AutoPostBack="true" Text="" />
                                            </span>
                                        </div>
                                        <div id="Div7" runat="server" visible="false" class="form-group">
                                            <span onclick="openNav()">Rate Details
                                                <asp:CheckBox ID="Ratedetail" runat="server" AutoPostBack="true" Text="" />
                                            </span>
                                        </div>
                                                                ...
                                                                <asp:GridView ID="gvcustomerorder" AutoGenerateColumns="False" ShowFooter="True"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Lot No" Visible="false" ControlStyle-Width="100%"
                                                                            ItemStyle-Width="10%">
                                                                            <ItemTemplate>
                                                                                <asp:DropDownList ID="drpLotno" CssClass="chzn-select" AutoPostBack="true" Width="100%"
                                                                                    runat="server" Height="26px" AppendDataBoundItems="true">
                                                                                </asp:DropDownList>
                                                                        ...
                                                                        <asp:TemplateField HeaderText=" Process Type" ControlStyle-Width="100%" ItemStyle-Width="25%">
                                                                            <ItemTemplate>
                                                                                <asp:DropDownList ID="drpProcess" CssClass="chzn-select" AutoPostBack="true" Width="100%"
                                                                                    runat="server" Height="26px" AppendDataBoundItems="true">
                                                                                </asp:DropDownList>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                    ...
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Send Qty" ControlStyle-Width="100%" ItemStyle-Width="10%">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtsendFQty" Enabled="false" AutoPostBack="true" runat="server"
                                                                                    Width="100%" Height="26px" AppendDataBoundItems="true"></asp:TextBox>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                             ...
                                                             <RowStyle CssClass="GridviewScrollItem" BackColor="#c6efce" Font-Bold="True" /> --%>
                                                                ...
                                                                <asp:GridView ID="gvnewstiching" AutoGenerateColumns="False" ShowFooter="True" CssClass="chzn-container"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Send Qty" ControlStyle-Width="100%" ItemStyle-Width="3%"
                                                                            Visible="true">
                                                                            <ItemTemplate>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Transid" ControlStyle-Width="100%" ItemStyle-Width="3%"
                                                                            Visible="true">
                                                                            <ItemTemplate>
                                                                                <asp:Label ID="lblTransid" Text='<%#Eval("Transid") %>' Enabled="false"
                                                                                    runat="server" Width="100%" Height="26px" AppendDataBoundItems="true"></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Masterid" ControlStyle-Width="100%" ItemStyle-Width="3%"
                                                                            Visible="false">
                                                                            <ItemTemplate>
                                                                       ...
                                                                       <%-- <asp:TemplateField HeaderText="Transfabid" ControlStyle-Width="100%" ItemStyle-Width="3%"
                                                                            Visible="false">
                                                                            <ItemTemplate>
