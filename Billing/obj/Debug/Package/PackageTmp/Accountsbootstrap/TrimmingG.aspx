<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrimmingG.aspx.cs" Inherits="Billing.Accountsbootstrap.TrimmingG" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Trimming Print</title>
                                ...
                                <asp:GridView runat="server" BorderWidth="1" ID="GridView1" CssClass="myleft" GridLines="Vertical"
                                    ...
                                    <asp:BoundField DataField="ItemName"  HeaderText="ItemName" />
                                     <asp:BoundField DataField="Fit"  HeaderText="Fit" />
                                      <asp:BoundField DataField="Patternname" Visible="false"  HeaderText="Pattern" />
                                      <asp:BoundField DataField="rate"  HeaderText="Rate" DataFormatString='{0:f}' />
                                      <asp:BoundField DataField="Senddate"  HeaderText="Send Date" DataFormatString='{0:d}' />
                                      <asp:BoundField DataField="SendTotQty"  HeaderText="SendQty" />
                                       <asp:BoundField DataField="RemainQty"  HeaderText="RemainQty" />
                                        <asp:BoundField DataField="Damageqty"  HeaderText="Damageqty" />
                                         ...
                                         <asp:BoundField DataField="RecDate"  HeaderText="LastRecDate" DataFormatString='{0:d}' />
                                    </Columns>
                                </asp:GridView>
                            </td>
        ...
        <table width="595px" class="style1">
            <tr>
                <td align="center">
                    ...
                    <asp:Button ID="btnexit" runat="server" Text="Exit"  PostBackUrl="TrimmingGrid.aspx" />
                </td>
            </tr>
        </table>
    </center>
