<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockLedger.aspx.cs" Inherits="Billing.Accountsbootstrap.StockLedger" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div id="Excel" runat="server">
                            <div class="col-lg-12">
                                <asp:GridView ID="gvStockLedger" runat="server" EmptyDataText="No Records Found"  OnRowDataBound="gvStockLedger_OnRowDataBound"
                                    Width="100%" AutoGenerateColumns="false" Caption="Stock Ledger">
                                    <HeaderStyle BackColor="White" />
                                    <EmptyDataRowStyle BackColor="White" ForeColor="Black" />
                                    <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                                        NextPageText="Next" PreviousPageText="Previous" />
                                    <Columns>
                                        <asp:BoundField HeaderText="ChallanDate " DataField="ChallanDate" />
                                        ...
                                        <asp:BoundField HeaderText="InWard" DataField="InWard" DataFormatString="{0:f2}"
                                            HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                        <asp:BoundField HeaderText="OutWard" DataField="OutWard" DataFormatString="{0:f2}"
                                            HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
