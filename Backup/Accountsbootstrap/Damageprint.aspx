<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Damageprint.aspx.cs" Inherits="Billing.Damageprint" %>
                        ...
                        <tr valign="top">
                            <td style="border-bottom: 1px solid black" colspan="3" width="595px">
                                ...
                                <asp:GridView runat="server" BorderWidth="1" ID="gridprint" CssClass="myleft" GridLines="Vertical"
                                    AlternatingRowStyle-CssClass="even" AutoGenerateColumns="false" ShowHeader="true" OnRowCreated="gridprint_RowCreated"
                                    PrintPageSize="300" AllowPrintPaging="true" Width="1000px" OnRowDataBound="gridprint_RowDataBound"
                                    Style="font-family: 'Trebuchet MS'; font-size: 13px;">
                                    <HeaderStyle BorderStyle="Solid" BorderWidth="1px" />
                                    <Columns>
                                        <asp:BoundField HeaderText="Design no" DataField="designno" ItemStyle-Height="60" />
                                         <asp:BoundField HeaderText="Pre-Cutting Shirt" Visible="false" DataField="reqshirt" />
                                          <asp:BoundField HeaderText="Master Cutting Shirt" Visible="false" DataField="mas" />
                                           <asp:BoundField HeaderText="Variance Qty" DataField="damageqty" DataFormatString="{0:n3}" />
                                            <asp:BoundField HeaderText="Variance Meter" DataField="dmgmet" DataFormatString='{0:f}' />
                                             <asp:BoundField HeaderText="Rate" DataField="rate" DataFormatString='{0:f}' />
                                               <asp:BoundField HeaderText="Damage Amount" DataField="rraatt" DataFormatString='{0:f}' />
                                                <asp:BoundField HeaderText="Reason Type" DataField="te" />
                                            <asp:BoundField HeaderText="Comments" DataField="reason" />
                                            
                                             <asp:BoundField HeaderText="Supplier Name" DataField="supname" />
