...
{
    public partial class ItemMasterGroupGrid : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet ds = objBs.gridItemMaster();
        ...
        {
            Response.Redirect("ItemMasterGroup.aspx");
        ...
        protected void gvItemMaster_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Edit")
            {
                ...
                {
                    Response.Redirect("ItemMasterGroup.aspx?ItemMasterId=" + e.CommandArgument.ToString());
                }
            }
        }
