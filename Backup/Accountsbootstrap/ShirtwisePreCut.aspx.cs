...
{
    public partial class ShirtwisePreCut : System.Web.UI.Page
    {
        ...
        protected void ProcessShirt(object sender, EventArgs e)
        {
            ...
            //    NdrNew11["Actmeter"] = Convert.ToDouble(Convert.ToDouble(Nlblrequiredmeter.Text) / totalshirts).ToString("0.00");
