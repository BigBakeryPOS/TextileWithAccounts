<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseOrderReportNew.aspx.cs" Inherits="Billing.Accountsbootstrap.PurchaseOrderReportNew" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="col-lg-2">
                                <h1 class="page-header" style="text-align: center; color: #fe0002; font-size: 20px;
                                    ...
                                    <label>
                                        Type :</label>
                                    <asp:DropDownList ID="ddlChallan" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlChallan_SelectedIndexChanged">
                        ...
                        <div id="Excel" runat="server">
                            <asp:GridView ID="gvOrderReport" runat="server" CssClass="myGridStyle1" EmptyDataText="No Records Found" OnRowDataBound="gvOrderReport_OnRowDataBound"
                                Width="100%" AutoGenerateColumns="false" ShowFooter="true" Caption="Purchase Order Report">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Shrink " DataField="Shrink"  DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"/>
                                    <asp:BoundField HeaderText="TotalQty " DataField="TotalQty" DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                    ...
                                    <asp:BoundField HeaderText="Amount " DataField="Amount"  DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right"/>
                               ...
                               <asp:GridView ID="gvGRNReport" runat="server" CssClass="myGridStyle1" EmptyDataText="No Records Found" ShowFooter="true" OnRowDataBound="gvGRNReport_OnRowDataBound"
