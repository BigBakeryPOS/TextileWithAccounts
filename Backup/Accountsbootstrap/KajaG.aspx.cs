...
{
    public partial class KajaG : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (KajaButtonid != null)
            {
                ...
                DataSet ds2 = objBs.JpKajaButtonfor(KajaButtonid);
                if (ds2.Tables[0].Rows.Count > 0)
                {
                    ...
                    DataSet ds23 = objBs.Get_JpKaja(Convert.ToString(KajaButtonid), "2", "Kaja");
        ...
        protected void btnclick(object sender, EventArgs e)
        {
            ...
            int isucess = objBs.updprintforall(KajaButtonid, "tbltransjpKajaButtonhistory", "KajaButtonId");
        }
