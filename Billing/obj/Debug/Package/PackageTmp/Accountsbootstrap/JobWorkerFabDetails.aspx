<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobWorkerFabDetails.aspx.cs"
    Inherits="Billing.Accountsbootstrap.JobWorkerFabDetails" %>
...
<head id="Head1" runat="server">
    ...
    <title>JobWorker Fabric Details</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-1">
                                <asp:Label ID="Label3" runat="server">Type</asp:Label><br />
                                <div class="form-group ">
                                    <asp:DropDownList ID="ddltype" OnSelectedIndexChanged="company_SelectedIndexChnaged"
                                        AutoPostBack="true" runat="server" CssClass="form-control" Width="100px">
                            ...
                            <div class="col-lg-2">
                                <br />
                                <br />
                                <asp:TextBox CssClass="form-control" onkeyup="Search_Gridview(this, 'gvcust')" Enabled="true" AutoPostBack="true" OnTextChanged="txtsearch_OnTextChanged"
                            ...
                            <div class="col-lg-1">
                                ...
                                <asp:Button ID="btnexcel" runat="server" class="btn btn-warning" Text="Excel" Width="100px" OnClick="btnexcel_OnClick" />
                            </div>
                            <div class="col-lg-1">
                                ...
                                <td>
                                    <div id="Div5" runat="server" style="height: 300px; overflow: scroll;">
                                        <asp:GridView ID="gvcust" EmptyDataText="No records Found" runat="server" CssClass="myGridStyle"
                                            ...
                                            OnRowDataBound="RatioShirtProcess_OnDataBound">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="ActualMeter" DataField="ActualMeter" />
