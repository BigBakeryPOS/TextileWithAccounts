...
{
    public partial class EmbroidingGrid1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
               ...
               // DataSet dunit = objBs.JpEmbroidingformulti();
                DataSet pending = objBs.pendinglotdetail("tblJpEmbroiding", "tbltransJpEmbroiding", drpbranch.SelectedValue, drppending.SelectedValue, "EmbroidingId");
        ...
        protected void Barcode_indexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dss.Tables[0].Rows.Count > 0)
                {
                    ...
                    Response.Redirect("Embroid.aspx?name=Receive&lotid=" + muti);
                }
        ...
        protected void gvcust_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Editt")
            {
                ...
                Response.Redirect("Embroid.aspx?name=Edit&Embroidingid=" + e.CommandArgument.ToString());
            ...
            else if (e.CommandName == "Received")
            {
              ...
              //  ds = objBs.checkprocessthereornot(e.CommandArgument.ToString());
                ...
                {
                    Response.Redirect("Embroid.aspx?name=Receive&Embroidingid=" + e.CommandArgument.ToString());
                }
                //else
                //{
            ...
            else if (e.CommandName == "partial")
            {
                ...
                //if (ds.Tables[0].Rows.Count > 0)
                {
                    Response.Redirect("Embroid.aspx?name=partial&Embroidingid=" + e.CommandArgument.ToString());
                }
                //else
                //{
                //    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Check This Lot number Because this is used in another Process.Thank You!!!')", true);
            ...
            else if (e.CommandName == "Payment")
            {
                ...
                //if (ds.Tables[0].Rows.Count > 0)
                {
                    Response.Redirect("PaymentScreen.aspx?name=Emb&id=" + e.CommandArgument.ToString());
                }
                //else
                //{
                //    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Please Check This Lot number Because this is used in another Process.Thank You!!!')", true);
            ...
            //{
            //    Response.Redirect("EmbroidingG.aspx?Embroidingid=" + e.CommandArgument.ToString());

            //}
            else if (e.CommandName == "printt")
            {
                string YourURL ="StitchingG.aspx?PrintIdForAll=" + e.CommandArgument.ToString() + "&ScreenName=Emb";
            ...
            {
                string  YourURL = "StitchingG.aspx?PrintIdForAllrec=" + e.CommandArgument.ToString() + "&ScreenName=Emb";
            ...
            {
                Response.Redirect("Emb.aspx?Embroidingid=" + e.CommandArgument.ToString());
        ...
        protected void Date_OnTextChanged(object sender, EventArgs e)
        {
            ...
            DataSet pending = objBs.getallProcessdetails("tblJpEmbroiding", "tbltransjpEmbroiding", "EmbroidingId", drpbranch.SelectedValue, drppending.SelectedValue, ddljobworker.SelectedValue, FromDate, ToDate);
            if (pending.Tables[0].Rows.Count > 0)
            {
                gvcust.DataSource = pending;
                gvcust.DataBind();
