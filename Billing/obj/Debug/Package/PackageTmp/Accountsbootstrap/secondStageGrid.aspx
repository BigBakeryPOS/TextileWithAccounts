<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="secondStageGrid.aspx.cs" Inherits="Billing.Accountsbootstrap.secondStageGrid" %>
            ...
            <div class="panel panel-default">
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gvcust" EmptyDataText="No records Found" runat="server" CssClass="myGridStyle"
                                        AllowPaging="false"  OnPageIndexChanging="Page_Change" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            <asp:BoundField HeaderText="Sample Code" Visible="false" DataField="SecondStageid" />
                                            ...
                                            <asp:BoundField HeaderText="Transport" DataField="Transport" />
                                             ...
                                             <asp:BoundField HeaderText="Tin/Cst No" DataField="TinCst" />
                                            <asp:BoundField HeaderText="Shirt Total" DataField="totshirt" />
                                            <asp:BoundField HeaderText="Casual Total" DataField="totcasual"  />
                                            <asp:BoundField HeaderText="Trousers" DataField="tottou"  />
                                            ...
                                            <asp:TemplateField HeaderText="Edit" Visible="false"  ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%#Eval("SecondStageid") %>'
                                                        CommandName="edit">
                                                    ...
                                                    <asp:HiddenField ID="ldgID" runat="server" Value='<%# Bind("SecondStageid") %>' />
                ...
                <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Bind("ToCheque") %>' />--%>
                                            ...
                                            <asp:TemplateField HeaderText="Delete" Visible="false" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%#Eval("SecondStageid") %>'
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" Visible="false" HeaderText="Print">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprint" runat="server" CommandArgument='<%#Eval("SecondStageid") %>'
                                                        CommandName="print">
                                               ...
                                               <asp:TemplateField ItemStyle-HorizontalAlign="Center"  Visible="false" HeaderText="PrintCR">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnprintCR" runat="server" CommandArgument='<%#Eval("SecondStageid") %>'
                                                        CommandName="printCR">
