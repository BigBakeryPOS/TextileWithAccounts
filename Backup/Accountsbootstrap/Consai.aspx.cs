...
{
    public partial class Consai : System.Web.UI.Page
    {
        ...
        {
            string Consaiid = string.Empty;
            string Requests = string.Empty;
            Consaiid = Request.QueryString.Get("Consaiid");
            ...
            if (!IsPostBack)
            {
                ...
                //DataSet dsLotNo = objbs.Select_LotDetails("Cni");
                ...
                if (Consaiid != null)
                {
                    if (Requests == "Edit")
                    {
                        ...
                        DataSet dgetcheck = objbs.getJpConsaiLot(Consaiid);
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            drpbranch.SelectedValue = dgetcheck.Tables[0].Rows[0]["Companyid"].ToString();
                            drpbranch.Enabled = false;
                            DataSet dsLot = objbs.Select_Lot("Cni", drpbranch.SelectedValue);
                            ...
                            dlotprocess = objbs.Get_LotDetails(Convert.ToString(dgetcheck.Tables[0].Rows[0]["LotDetailID"]), "11", "Cni");
                            ...
                            btnadd.Visible = true;
                            btnadd.Text = "Update";
                            txtid.Text = dgetcheck.Tables[0].Rows[0]["Consaiid"].ToString();
                            txtmultiid.Text = dgetcheck.Tables[0].Rows[0]["Consaiid"].ToString();
                            txtmultiplecode.Text = dgetcheck.Tables[0].Rows[0]["Consaiid"].ToString();
                            ...
                            DataSet ds = objbs.Get_JpConsai(Convert.ToString(Consaiid), "11", "Cni");
                    ...
                    else if (Requests == "partial")
                    {
                        ...
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            ...
                            txtAmount.Text = dgetcheck.Tables[0].Rows[0]["TotalAmount"].ToString();
                            txtAmount.Enabled = false;
                            DataSet ds = objbs.Get_LotDetails(Convert.ToString(dgetcheck.Tables[0].Rows[0]["LotDetailID"]), "11", "Cni");
                            //= objbs.Get_JpConsai(Convert.ToString(Consaiid), "11", "Cni");
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                DataSet temp = new DataSet();
                                DataTable dtt = new DataTable();
                                ...
                                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                                {
                                    if (Convert.ToInt32(ds.Tables[0].Rows[i]["RemainQty"].ToString()) != 0)
                                    {
                                        ...
                                        dr["fit"] = ds.Tables[0].Rows[i]["fit"].ToString();
                                        dr["itemname"] = ds.Tables[0].Rows[i]["itemname"].ToString();
                                        dr["TotalQty"] = ds.Tables[0].Rows[i]["SendTotalQty"].ToString();
                                        dr["SendQty"] = ds.Tables[0].Rows[i]["SendTotalQty"].ToString();
                                        dr["RemainQty"] = ds.Tables[0].Rows[i]["RemainQty"].ToString();
                                        dr["ProcessTypeID"] = ds.Tables[0].Rows[i]["ProcessTypeID"].ToString();
                                        dr["rate"] = ds.Tables[0].Rows[i]["rate"].ToString();
                                        dr["damageqty"] = "0";
                                        dr["RecQty"] = "0";
                                        TotalQty = Convert.ToDouble(ds.Tables[0].Rows[i]["TotalQty"]);
                    ...
                    else if (Requests == "Receive")
                    {
                        ...
                        if (dgetcheck.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                ...
                                dsstichinglot = objbs.Get_dsconsailotcolor(Convert.ToInt32(Consaiid));
                                ...
                                gvnewconsai.DataSource = dssstichinglot;
                                gvnewconsai.DataBind();

                                for (int i = 0; i < gvnewconsai.Rows.Count; i++)
                                {
                                    Label lblStockRatioId = (Label)gvnewconsai.Rows[i].FindControl("lblStockRatioId");
                                    Label lblMasterid = (Label)gvnewconsai.Rows[i].FindControl("lblMasterid");
                                    Label lblTransfabid = (Label)gvnewconsai.Rows[i].FindControl("lblTransfabid");

                                    Label lbldesignno = (Label)gvnewconsai.Rows[i].FindControl("lbldesignno");
                                    TextBox txts30fs = (TextBox)gvnewconsai.Rows[i].FindControl("txts30fs");
                                    TextBox txts32fs = (TextBox)gvnewconsai.Rows[i].FindControl("txts32fs");
                                    TextBox txts34fs = (TextBox)gvnewconsai.Rows[i].FindControl("txts34fs");
                                    TextBox txts36fs = (TextBox)gvnewconsai.Rows[i].FindControl("txts36fs");
                                    TextBox txtsxsfs = (TextBox)gvnewconsai.Rows[i].FindControl("txtsxsfs");
                                    TextBox txtssfs = (TextBox)gvnewconsai.Rows[i].FindControl("txtssfs");
                                    TextBox txtsmfs = (TextBox)gvnewconsai.Rows[i].FindControl("txtsmfs");
                                    TextBox txtslfs = (TextBox)gvnewconsai.Rows[i].FindControl("txtslfs");
                                    TextBox txtsxlfs = (TextBox)gvnewconsai.Rows[i].FindControl("txtsxlfs");
                                    TextBox txtsxxlfs = (TextBox)gvnewconsai.Rows[i].FindControl("txtsxxlfs");
                                    TextBox txts3xlfs = (TextBox)gvnewconsai.Rows[i].FindControl("txts3xlfs");
                                    TextBox txts4xlfs = (TextBox)gvnewconsai.Rows[i].FindControl("txts4xlfs");

                                    TextBox txts30hs = (TextBox)gvnewconsai.Rows[i].FindControl("txts30hs");
                                    TextBox txts32hs = (TextBox)gvnewconsai.Rows[i].FindControl("txts32hs");
                                    TextBox txts34hs = (TextBox)gvnewconsai.Rows[i].FindControl("txts34hs");
                                    TextBox txts36hs = (TextBox)gvnewconsai.Rows[i].FindControl("txts36hs");
                                    TextBox txtsxshs = (TextBox)gvnewconsai.Rows[i].FindControl("txtsxshs");
                                    TextBox txtsshs = (TextBox)gvnewconsai.Rows[i].FindControl("txtsshs");
                                    TextBox txtsmhs = (TextBox)gvnewconsai.Rows[i].FindControl("txtsmhs");
                                    TextBox txtslhs = (TextBox)gvnewconsai.Rows[i].FindControl("txtslhs");
                                    TextBox txtsxlhs = (TextBox)gvnewconsai.Rows[i].FindControl("txtsxlhs");
                                    TextBox txtsxxlhs = (TextBox)gvnewconsai.Rows[i].FindControl("txtsxxlhs");
                                    TextBox txts3xlhs = (TextBox)gvnewconsai.Rows[i].FindControl("txts3xlhs");
                                    TextBox txts4xlhs = (TextBox)gvnewconsai.Rows[i].FindControl("txts4xlhs");

                                    TextBox txtsendFQty = (TextBox)gvnewconsai.Rows[i].FindControl("txtsendFQty");
                                    ...
                                    TextBox txts30fsac = (TextBox)gvnewconsai.Rows[i].FindControl("txts30fsac");
                                    TextBox txts32fsac = (TextBox)gvnewconsai.Rows[i].FindControl("txts32fsac");
                                    TextBox txts34fsac = (TextBox)gvnewconsai.Rows[i].FindControl("txts34fsac");
                                    TextBox txts36fsac = (TextBox)gvnewconsai.Rows[i].FindControl("txts36fsac");
                                    TextBox txtsxsfsac = (TextBox)gvnewconsai.Rows[i].FindControl("txtsxsfsac");
                                    TextBox txtssfsac = (TextBox)gvnewconsai.Rows[i].FindControl("txtssfsac");
                                    TextBox txtsmfsac = (TextBox)gvnewconsai.Rows[i].FindControl("txtsmfsac");
                                    TextBox txtslfsac = (TextBox)gvnewconsai.Rows[i].FindControl("txtslfsac");
                                    TextBox txtsxlfsac = (TextBox)gvnewconsai.Rows[i].FindControl("txtsxlfsac");
                                    TextBox txtsxxlfsac = (TextBox)gvnewconsai.Rows[i].FindControl("txtsxxlfsac");
                                    TextBox txts3xlfsac = (TextBox)gvnewconsai.Rows[i].FindControl("txts3xlfsac");
                                    TextBox txts4xlfsac = (TextBox)gvnewconsai.Rows[i].FindControl("txts4xlfsac");

                                    TextBox txts30hsac = (TextBox)gvnewconsai.Rows[i].FindControl("txts30hsac");
                                    TextBox txts32hsac = (TextBox)gvnewconsai.Rows[i].FindControl("txts32hsac");
                                    TextBox txts34hsac = (TextBox)gvnewconsai.Rows[i].FindControl("txts34hsac");
                                    TextBox txts36hsac = (TextBox)gvnewconsai.Rows[i].FindControl("txts36hsac");
                                    TextBox txtsxshsac = (TextBox)gvnewconsai.Rows[i].FindControl("txtsxshsac");
                                    TextBox txtsshsac = (TextBox)gvnewconsai.Rows[i].FindControl("txtsshsac");
                                    TextBox txtsmhsac = (TextBox)gvnewconsai.Rows[i].FindControl("txtsmhsac");
                                    TextBox txtslhsac = (TextBox)gvnewconsai.Rows[i].FindControl("txtslhsac");
                                    TextBox txtsxlhsac = (TextBox)gvnewconsai.Rows[i].FindControl("txtsxlhsac");
                                    TextBox txtsxxlhsac = (TextBox)gvnewconsai.Rows[i].FindControl("txtsxxlhsac");
                                    TextBox txts3xlhsac = (TextBox)gvnewconsai.Rows[i].FindControl("txts3xlhsac");
                                    TextBox txts4xlhsac = (TextBox)gvnewconsai.Rows[i].FindControl("txts4xlhsac");

                                    TextBox txtsendFQtyac = (TextBox)gvnewconsai.Rows[i].FindControl("txtsendFQtyac");
        ...
        protected void company_SelectedIndexChnaged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                DataSet dsLotNo = objbs.Select_LotDetails("Cni", drpbranch.SelectedValue);
                if (dsLotNo.Tables[0].Rows.Count > 0)
                {
                    DataSet dsLotNoval = objbs.Select_LotDetailsnew("Cni", drpbranch.SelectedValue, 10);
        ...
        protected void StitchingInfo_Load(object sender, EventArgs e)
        {
            ...
            if (ddlLotNo.SelectedValue != "Select Lot No")
            {
                int dcheck = objbs.checkcurrent(ddlLotNo.SelectedValue, "Cni");
                if (dcheck == 1)
                {
                    double Consairate = 0;

                    DataSet rateforprecost = objbs.getrateforprecost(Convert.ToString(ddlLotNo.SelectedItem.Text), "Consai Process");
                    if (rateforprecost.Tables[0].Rows.Count > 0)
                    {
                        Consairate = Convert.ToDouble(rateforprecost.Tables[0].Rows[0]["Cost"].ToString());
                    }
                    else
                    {
                    ...
                    DataSet dlotprocess = new DataSet();
                    dlotprocess = objbs.Get_LotDetails(Convert.ToString(ddlLotNo.SelectedValue), "11", "Cni");
                    if (dlotprocess.Tables[0].Rows.Count > 0)
                    {
                        txttotalqty.Text = dlotprocess.Tables[0].Rows[0]["TotalQuantity"].ToString();
                        ...
                        if (dlotprocess.Tables[0].Rows.Count > 0)
                        {
                            ...
                            for (int i = 0; i < gvcustomerorder.Rows.Count; i++)
                            {
                                ...
                                lblfitid.Text = temp.Tables[0].Rows[i]["fitid"].ToString();
                                //txtrate.Text = temp.Tables[0].Rows[i]["rate"].ToString();
                                txtrate.Text = Consairate.ToString();
                        ...
                        dsstichinglot = objbs.Get_dsConsailot(Convert.ToInt32(ddlLotNo.SelectedValue), ConsaiProcess);
                    ...
                    else
                    {
                        ...
                        ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Not Ready To Consai Process.Thank You!!!')", true);
                        return;
                    }
                }
                else
                {
                    //btnadd.Enabled = false;
                    ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Something Went Wrong While Fetching in Lotdetails.Please Contact administrator.Thank You!!!')", true);
                    return;
                }
        ...
        protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            drpProcess = objbs.SelectAllProcessTypeLotProcess("11");
        ...
        protected void Add_LotProcessDetails(object sender, EventArgs e)
        {
            ...
            if (btnadd.Text == "Partial")
            {
                ...
                if (ViewState["CurrentTable1"] != null)
                {
                    ...
                    for (int i = 0; i < gvcustomerorder.Rows.Count; i++)
                    {
                        ...
                        double qty = 0;
                        double qty1 = 0;
                        qty1 = Convert.ToDouble(txtTotalFQty.Text);
                        qty = Convert.ToDouble(txtsendFQty.Text);

                        if (qty1 < qty)
                        {
                            ScriptManager.RegisterStartupScript(Page, Page.GetType(), Guid.NewGuid().ToString(), "alert('Sending Qty is not Greater than That Total Qty.Thank You!!!.')", true);
                            txtsendFQty.Focus();
                            return;
                        }
            ...
            if (btnadd.Text == "Save")
            {
                ...
                int istatus3 = objbs.insertJpConsai(Convert.ToDouble(txtAmount.Text), Convert.ToInt32(ddlLotNo.SelectedValue), lbllotno.Text, MultiDate, Convert.ToInt32(drpMultiemployee.SelectedValue), Convert.ToDouble(txttotalqty.Text), empid, drpbranch.SelectedValue, ddlLotNo.SelectedItem.Text, Convert.ToInt32(txtsendFQtymain.Text),txtnarration.Text);



                for (int vLoop = 0; vLoop < gvnewconsai.Rows.Count; vLoop++)
                {
                    ...
                    #region
                    Label lblitemname = (Label)gvnewconsai.Rows[vLoop].FindControl("lbldesignno");

                    TextBox txts30fs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txts30fs");
                    TextBox txts32fs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txts32fs");
                    TextBox txts34fs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txts34fs");
                    TextBox txts36fs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txts36fs");
                    TextBox txtsxsfs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txtsxsfs");
                    TextBox txtssfs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txtssfs");
                    TextBox txtsmfs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txtsmfs");
                    TextBox txtslfs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txtslfs");
                    TextBox txtsxlfs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txtsxlfs");
                    TextBox txtsxxlfs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txtsxxlfs");
                    TextBox txts3xlfs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txts3xlfs");
                    TextBox txts4xlfs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txts4xlfs");

                    TextBox txts30hs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txts30hs");
                    TextBox txts32hs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txts32hs");
                    TextBox txts34hs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txts34hs");
                    TextBox txts36hs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txts36hs");
                    TextBox txtsxshs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txtsxshs");
                    TextBox txtsshs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txtsshs");
                    TextBox txtsmhs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txtsmhs");
                    TextBox txtslhs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txtslhs");
                    TextBox txtsxlhs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txtsxlhs");
                    TextBox txtsxxlhs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txtsxxlhs");
                    TextBox txts3xlhs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txts3xlhs");
                    TextBox txts4xlhs = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txts4xlhs");

                    Label lblStockRatioId = (Label)gvnewconsai.Rows[vLoop].FindControl("lblStockRatioId");
                    Label lblMasterid = (Label)gvnewconsai.Rows[vLoop].FindControl("lblMasterid");
                    Label lblTransfabid = (Label)gvnewconsai.Rows[vLoop].FindControl("lblTransfabid");

                    TextBox txtsendFQtycolor = (TextBox)gvnewconsai.Rows[vLoop].FindControl("txtsendFQty");
                    ...
                    else
                    {
                        ...
                        {
                            int istasHistory = objbs.inserttransjpIConsaiHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            int istas = objbs.inserttransJpConsai(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            if (vLoop == 0)
                            {
                                int istas1 = objbs.JpConsai(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                ...
                int istatus3l = objbs.statusJpConsai(Convert.ToInt32(ddlLotNo.SelectedValue));

                #endregion
            }
            else if (btnadd.Text == "Partial")
            {

                #region

                string Consaiid = Request.QueryString.Get("Consaiid");
                DateTime MultiDate = DateTime.ParseExact(txtmultidate.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture);

                int istatus3 = objbs.UpdJpConsai(Convert.ToDouble(txtAmount.Text), Convert.ToInt32(ddlLotNo.SelectedValue), lbllotno.Text, MultiDate, Convert.ToInt32(drpMultiemployee.SelectedValue), Convert.ToDouble(txttotalqty.Text), Consaiid, empid);
                ...
                for (int vLoop = 0; vLoop < gvcustomerorder.Rows.Count; vLoop++)
                {
                    ...
                    Label lblfit = (Label)gvcustomerorder.Rows[vLoop].FindControl("lblfit");
                    TextBox txtsendFQty = (TextBox)gvcustomerorder.Rows[vLoop].FindControl("txtsendFQty");
                    TextBox txtTotalFQty = (TextBox)gvcustomerorder.Rows[vLoop].FindControl("txtTotalFQty");
                    Label lblitemname = (Label)gvcustomerorder.Rows[vLoop].FindControl("lblitemname");
                    TextBox txtRemainQty = (TextBox)gvcustomerorder.Rows[vLoop].FindControl("txtRemainQty");
                    TextBox txtrate = (TextBox)gvcustomerorder.Rows[vLoop].FindControl("txtrate");
                    Label lblPattern = (Label)gvcustomerorder.Rows[vLoop].FindControl("lblPattern");
                    ...
                    {
                        //int istasHistory = objbs.inserttransjpIConsaiHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                        //          recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), "0", empid, Convert.ToInt32(txtsendFQty.Text));

                        int istas = objbs.inserttransJpConsaipartial(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                  recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Convert.ToInt32(ddlLotNo.SelectedValue), empid, Convert.ToInt32(txtsendFQty.Text), Consaiid);
            ...
            else if (btnadd.Text == "Update")
            {
                ...
                for (int vLoop = 0; vLoop < gvcustomerorder.Rows.Count; vLoop++)
                {
                    ...
                    {
                        //int istasHistory = objbs.inserttransjpstichingHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), Convert.ToDateTime(date1.Text),
                        //          Convert.ToDateTime(Recdate.Text), Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtsendFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text));

                        int istas = objbs.updatetransJpConsai(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                  recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtsendFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Convert.ToInt32(ddlLotNo.SelectedValue), Consaiid);
            ...
            else if (btnadd.Text == "Received")
            {
                ...
                if (ddltype.SelectedValue == "Damage")
                {
                    int istasHistory = objbs.processmaintableconsai(Convert.ToInt32(Consaiid), Convert.ToInt32(txtdamageqtymain.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }
                else
                {
                    int istasHistory = objbs.processmaintableconsai(Convert.ToInt32(Consaiid), Convert.ToInt32(txtrecFQty.Text), ddltype.SelectedValue, Convert.ToDouble(txtAmount.Text));
                }
                ...
                for (int vLoop = 0; vLoop < gvnewconsai.Rows.Count; vLoop++)
                {
                    ...
                    else
                    {
                        if (txtsendFQtycolor.Text != "0")
                        {
                            int istasHistory = objbs.inserttransjpconsaiHistory1new(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), recdate,
                                      recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtTotalFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Consaiid, empid, Convert.ToInt32(txtsendFQty.Text), Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), ddltype.SelectedItem.Text);

                            if (vLoop == 0)
                            {
                                //int istasHistory = objbs.inserttransjpIConsaiHistory1(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                                //          recdate, Convert.ToDouble(txtrate.Text), Convert.ToInt32(txtdamageqty.Text), Convert.ToInt32(txtsendFQty.Text), Convert.ToString(lblfitid.Text), Convert.ToString(lblitemname.Text), Convert.ToString(lblPatternid.Text), Consaiid, empid, Convert.ToInt32(txtsendFQty.Text));

                                int istas = objbs.JpConsaiREC(Convert.ToInt32(drpProcess.SelectedValue), Convert.ToInt32(txtrecQty.Text), date11,
                            ...
                            if (ddltype.SelectedValue == "Damage")
                            {
                                int rec = objbs.DamageProcessStockRatioconsai(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text), ConsaiProcess);
                            }
                            else
                            {
                                int rec = objbs.updateProcessStockRatioconsai(Convert.ToInt32(txts30fs.Text), Convert.ToInt32(txts32fs.Text), Convert.ToInt32(txts34fs.Text), Convert.ToInt32(txts36fs.Text), Convert.ToInt32(txtsxsfs.Text), Convert.ToInt32(txtssfs.Text), Convert.ToInt32(txtsmfs.Text), Convert.ToInt32(txtslfs.Text), Convert.ToInt32(txtsxlfs.Text), Convert.ToInt32(txtsxxlfs.Text), Convert.ToInt32(txts3xlfs.Text), Convert.ToInt32(txts4xlfs.Text), Convert.ToInt32(txts30hs.Text), Convert.ToInt32(txts32hs.Text), Convert.ToInt32(txts34hs.Text), Convert.ToInt32(txts36hs.Text), Convert.ToInt32(txtsxshs.Text), Convert.ToInt32(txtsshs.Text), Convert.ToInt32(txtsmhs.Text), Convert.ToInt32(txtslhs.Text), Convert.ToInt32(txtsxlhs.Text), Convert.ToInt32(txtsxxlhs.Text), Convert.ToInt32(txts3xlhs.Text), Convert.ToInt32(txts4xlhs.Text), Convert.ToInt32(lblStockRatioId.Text), Convert.ToInt32(lblMasterid.Text), Convert.ToInt32(lblTransfabid.Text));
        ...
        protected void gvnewconsai_OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
