<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShirtwisePreCut.aspx.cs" Inherits="Billing.Accountsbootstrap.ShirtwisePreCut" %>
...
<body>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header" style="text-align: center; color: #fe0002;">
                Shirt-Wise Pre-Cutting Process</h4>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-lg-12" style="padding-top: -60px">
            <div id="horizontalzTab" style="background-color: #D0D3D6; padding-left: 30px">
                 ...
                 <label style="color:Red; font-size:larger" >Cutting Details</label>
                    <div class="row">
                        <%--    <asp:ScriptManager ID="ScriptManager1" runat="server">
                        </asp:ScriptManager>--%>
                        <div class="col-lg-3">
                            ...
                            <div id="Div1" runat="server" visible="false" class="form-group ">
                                ...
                                <div id="Div20" runat="server" style="overflow: scroll; height: 10pc">
                                    <asp:CheckBoxList ID="ddlBottilot" OnSelectedIndexChanged="ddlBottilot_OnSelectedIndexChanged"
                                        CssClass="chkChoice1" AutoPostBack="true" runat="server" RepeatColumns="5"
                                        RepeatDirection="Horizontal" RepeatLayout="Table" Style="overflow: auto">
                                    </asp:CheckBoxList>
                                </div>
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group ">
                                ...
                                <div>
                                    ...
                                    <asp:TextBox ID="txtcompanysublot" Width="30%" Style="margin-left: 14pc; margin-top: -2pc;"
                                        OnTextChanged="Companylotchecked" MaxLength="2" AutoPostBack="true" runat="server"
                                    ...
                                    <%--  <asp:RequiredFieldValidator runat="server" ValidationGroup="val1" Text="*" ID="RequiredFieldValidator11"
                                        ControlToValidate="txtcompanysublot" ErrorMessage="Please enter Cutting No" Style="color: Red" />
                                    <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender10" runat="server"
                                        FilterType="UppercaseLetters,Numbers" ValidChars="" TargetControlID="txtcompanysublot" />--%>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3">
                            ...
                            <div id="ssDiv6" visible="false" class="form-group " runat="server">
                            ...
                            <div id="Div17" class="form-group" runat="server">
                                ...
                                <asp:DropDownList ID="ddlsample" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem Text="NotIssued" Value="NotIssued"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        ...
                        <div class="col-lg-3">
                            ...
                            <div id="sing" runat="server">
                                ...
                                <div id="fitdiv" runat="server">
                                    <label>
                                        Fit Label</label>
                                    <asp:DropDownList ID="drpNchkfit" class="form-control" runat="server" OnSelectedIndexChanged="Sfitchaged"
                                        AutoPostBack="true">
                                    </asp:DropDownList>
                                </div>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="col-lg-12">
                            ...
                            <label>
                                Fabric List</label>
                            <div id="Div12" runat="server" style="overflow: scroll; height: 24pc">
                                <asp:GridView ID="newgridfablist" AutoGenerateColumns="False" ShowFooter="True" CssClass="chzn-container"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Avl. KG" HeaderStyle-Width="9%" ItemStyle-Width="9%">
                                            <ItemTemplate>
                                                <asp:TextBox ID="newtxtAvlmeter" Enabled="false" Text='<%# Eval("AvaliableMeter","{0:n}")%>'
                                                    runat="server" CssClass="form-control"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Req. KG" HeaderStyle-Width="9%" ItemStyle-Width="9%">
                                            <ItemTemplate>
                ...
                <div class="row" id="tab-2" style="background-color: #D0D3D6; padding-top: -50px">
                    <div style="background-color: #D0D3D6;">
                        ...
                        <asp:Button ID="ratioprocessall" runat="server" Text="OK" OnClick="ProcessShirt" />
                    </div>
                </div>
                ...
                <label>T-Shirt Details</label>
                    <div style="background-color: #D0D3D6;">
                        <asp:Panel ID="Panel4" runat="server" ScrollBars="Both" Height="300" Width="100%">
                            <asp:GridView ID="RatioShirtProcess" AutoGenerateColumns="False" ShowFooter="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Given KG" ControlStyle-Width="100%">
                                        <ItemTemplate>
                                            <asp:Label ID="Nlblrequiredmeter" Text='<%# Eval("Givenmeter")%>' runat="server"
                                                Enabled="false"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Avg.gms" ControlStyle-Width="100%">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Actual T-Shirts" ControlStyle-Width="100%">
                                        <ItemTemplate>
                                                        ...
                                                        <div id="Div16" runat="server" style="overflow: scroll; height: 24pc">
                                                            <asp:GridView ID="contrastgridfab" AutoGenerateColumns="False" ShowFooter="True"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Req.KG" ControlStyle-Width="100%" HeaderStyle-Width="3%"
                                                                        ItemStyle-Width="3%">
                                                                        <ItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Avg. gms" ControlStyle-Width="100%" HeaderStyle-Width="3%"
                                                                        ItemStyle-Width="3%">
                                                                        <ItemTemplate>
                                        ...
                                        <asp:Panel ID="Panel1" runat="server" ScrollBars="Both" Height="200" Width="100%">
                                            <asp:GridView ID="gvcustomerorder" AutoGenerateColumns="False" ShowFooter="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Total Shirt" Visible="true" ControlStyle-Width="100%">
                                                        <ItemTemplate>
