<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dillo_WashWorks.aspx.cs" Inherits="Billing.Accountsbootstrap.Dillo_WashWorks" %>
...
<head id="Head1" runat="server">
    ...
    <title>Flexible Apparels || WASH Job Work</title>
...
<body style="background-color:#c6efce">
    ...
    <asp:Label Visible="false" runat="server" ID="lblWelcome" ForeColor="White" CssClass="label">Welcome : </asp:Label>
    <asp:Label runat="server" ID="lblUser" ForeColor="White" CssClass="label"> </asp:Label>
    <asp:Label runat="server" ID="lblUserID" ForeColor="White" CssClass="label" Visible="false"> </asp:Label>
    <div class="row">
        <div class="col-lg-12" style="margin-top: 6px">
            <h1 id="head" runat="server" class="page-header" style="text-align: center; color: #fe0002">Wash Job Work
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
                ...
                <div class="panel-body" style="background-color:#c6efce">
                    ...
                    <div id="add" runat="server" class="row">
                        ...
                        <asp:DropDownList ID="drpsupervisor" runat="server" CssClass="form-control"></asp:DropDownList>
                         ...
                         <div id="divsenddate" class="form-group" runat="server">
                                <label>
                                    Sending Date</label>
                    ...
                    <asp:Button ID="btnadd" runat="server" class="btn btn-info" Text="Save" 
                            ...
                            <asp:Button ID="btnexit" runat="server" PostBackUrl="~/Accountsbootstrap/Dillo_WashWorkGrid.aspx" class="btn btn-warning" Text="Exit" 
