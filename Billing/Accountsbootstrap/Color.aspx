<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Color.aspx.cs" Inherits="Billing.Accountsbootstrap.Color" %>
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                       <div class="panel-heading" style="background-color: #336699; color: White;">
                            <i class="fa fa-briefcase"></i>Add Color
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="list-group">
                                ...
                                <label>
                                    Color</label>
                                <asp:TextBox placeholder="Enter Color" ID="txtcolor" runat="server" CssClass="form-control"></asp:TextBox>
