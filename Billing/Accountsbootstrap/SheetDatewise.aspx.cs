...
{
    public partial class SheetDatewise : System.Web.UI.Page
    {
        ...
        public void sheetlist()
        {
            ...
            //lblMessage.Text = " Balance Sheet Report for  " + ddloutlet.SelectedItem.Text;
            //DateTime startDate = Convert.ToDateTime(txtfrmdate.Text);
            //DateTime endDate = Convert.ToDateTime(txttodate.Text);
            ...
            foreach (DataRow dr in grdDs.Tables[0].Rows)
            {
                ...
                if (groupid != "" && groupid != "9" && groupid != "7")
                {
                    if (groupid == "18")
                    {
                        DataSet ds = objBs.getLedgerTransactionDatewise(Convert.ToInt32(groupid), startDate, endDate, ddloutlet.SelectedValue);
                ...
                else if (groupid == "7")
                {
                    ...
                    if (Branch != "All")
                    {
                        ...
                        ////////{
                        ////////    netOp = opDr - opCr;
                        ////////    //lblOBDR.Text = netOp.ToString("f3");
                        ////////    //lblOBCR.Text = "0.000";
                        ////////}
                        ////////else
                        ////////{
                        ////////    netOp = opCr - opDr;
                        ////////    //lblOBDR.Text = "0.000";
                        ////////    //lblOBCR.Text = netOp.ToString("f3");
                        ////////}
                        ...
                        //////                if (dr1["Debit"] != "")
                        //////                {
                        //////                    drNew["Debit"] = Convert.ToDouble(dr1["Debit"]).ToString("f3");
                        //////                }
                        //////                else
                        //////                {
                        //////                    drNew["Debit"] = "";
                        ...
                        //////                if (dr1["Credit"] != "")
                        //////                {
                        //////                    drNew["Credit"] = Convert.ToDouble(dr1["Credit"]).ToString("f3");
                        //////                }
                        //////                else
                        //////                {
                        //////                    drNew["Credit"] = "";
                        ...
                        DataSet ds = objBs.getLedgerTransactionDatewise(Convert.ToInt32(7), startDate, endDate, ddloutlet.SelectedValue);
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            if (ds.Tables[0].Rows[0]["Ledgername"].ToString() != "")
                            {
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < ds1.Tables[0].Rows.Count; i++)
                        {
                            ...
                            //////                if (drh["Debit"] != "")
                            //////                {
                            //////                    drNew["Debit"] = Convert.ToDouble(drh["Debit"]).ToString("f3");
                            //////                }
                            //////                else
                            //////                {
                            //////                    drNew["Debit"] = "";
                            ...
                            //////                if (drh["Credit"] != "")
                            //////                {
                            //////                    drNew["Credit"] = Convert.ToDouble(drh["Credit"]).ToString("f3");
                            //////                }
                            //////                else
                            //////                {
                            //////                    drNew["Credit"] = "";
                            ...
                            DataSet ds = objBs.getLedgerTransactionDatewise(Convert.ToInt32(groupid), startDate, endDate, sbranch);
                            if (ds.Tables[0].Rows.Count > 0)
                            {
                                if (ds.Tables[0].Rows[0]["Ledgername"].ToString() != "")
                                {
                ...
                else if (groupid == "9")
                {
                    ...
                    ////                strDebit1 = Convert.ToString(totalSum1.ToString("f3"));
                    ////                strCredit1 = "";
                    ...
                    ////                strCredit1 = Convert.ToString(totalSum1.ToString("f3"));
                    ////                strDebit1 = "";
                    ////                if (totalSum1 < 0)
                    ////                {
                    ////                    strCredit1 = "";
            ...
            //////                strDebit2 = Convert.ToString(totalSum2.ToString("f3"));
            //////                strCredit2 = "";
            ...
            //////                strCredit2 = Convert.ToString(totalSum2.ToString("f3"));
            //////                strDebit2 = "";
            //////                if (totalSum2 < 0)
            //////                {
            //////                    strCredit2 = "";
            ...
            if (branch1 != "All")
            {
                ...
                if (doub > 0)
                {
                    dr11["Debit"] = doub.ToString("f3");
                    dr11["Credit"] = 0;
                }
                else
                {
                    dr11["Debit"] = 0;
                    dr11["Credit"] = Convert.ToDouble(-doub).ToString("f3");
                }
        ...
        public void pnlist(string branch)
        {
            ...
            foreach (DataRow dr in grdDs.Tables[0].Rows)
            {
                ...
                if (groupid != "" && groupid != "9")
                {
                    ...
                    DataSet ds = objBs.getLedgerTransactionDatewise(Convert.ToInt32(groupid), startDate, endDate, branch);
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        if (ds.Tables[0].Rows[0]["Ledgername"].ToString() != "")
                        {
        ...
        public void gBalance_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                //lblDebitSum.Text = damt.ToString("f3");
                //lblCreditSum.Text = camt.ToString("f3");
                ...
                if (dDiffamt >= 0)
                {
                    //lblDebitDiff.Text = dDiffamt.ToString("f3");
                    //lblCreditDiff.Text = "0.000";

                    dDiffamt = dDiffamt + OpBalance;
                    if (dDiffamt >= 0)
                    {
                        lblBal.Text = dDiffamt.ToString("f3") + " BHD";
                        lblBal.ForeColor = System.Drawing.Color.Blue;
                    }
                    else
                    {
                        lblBal.Text = Math.Abs(dDiffamt).ToString("f3") + " BHD";
                ...
                if (cDiffamt > 0)
                {
                    ...
                    //lblCreditDiff.Text = cDiffamt.ToString("f3");

                    cDiffamt = cDiffamt - OpBalance;
                    if (cDiffamt > 0)
                    {
                        lblBal.Text = cDiffamt.ToString("f3") + " BHD";
                        lblBal.ForeColor = System.Drawing.Color.Red;
                    }
                    else
                    {
                        lblBal.Text = Math.Abs(cDiffamt).ToString("f3") + " BHD";
                        lblBal.ForeColor = System.Drawing.Color.Blue;
                    }
            ...
            else if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[0].Text = "Total";
                e.Row.Cells[0].ForeColor = System.Drawing.Color.Red;
                e.Row.Cells[1].Text = debitTotaln.ToString("f3");
                e.Row.Cells[2].Text = creditTotaln.ToString("f3");
        ...
        protected void btnreport_Click(object sender, EventArgs e)
        {
            ...
            sheetlist();
            idt.Visible = true;
            DataSet assetDs = GetBalanceSheetDatewise("Asset");
            DataSet liabilityDs = GetBalanceSheetDatewise("Liability");
            ...
            if (dGp > 0)
            {
                ...
                if (netProfitLoss > 0)
                {
                    lblNetProfit.Text = "Capital + NetProfit: " + (captot + netProfitLoss).ToString("f3");
                    lblNetLoss.Text = "";
                ...
                {
                    lblNetLoss.Text = "Capital - NetLoss: " + (captot - netProfitLoss).ToString("f3");
                    lblNetProfit.Text = "";
            ...
            if (sumTotal > 0)
            {
                ...
                lblLib.Text = sumTotal.ToString("f3");
                dTot = liaTot + sumTotal;
                lblCreditTotal.Text = dTot.ToString("f3");
                lblDebitTotal.Text = assTot.ToString("f3");
            }
            else
            {
                ...
                pnlAst.Visible = true;
                sumTotal = Math.Abs(sumTotal);
                lblAst.Text = sumTotal.ToString("f3");
                dTot = assTot + sumTotal;
                lblDebitTotal.Text = dTot.ToString("f3");
                lblCreditTotal.Text = liaTot.ToString("f3");
            }
        }
                ...
                if (mainDs.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow mainRow in mainDs.Tables[0].Rows)
                    {
                        ...
                        if (mainRow["HeadingID"] != null)
                        {
                            ...
                            grdDt = GenerateDs(iHeading.ToString(), sHeading, netSum.ToString("f3"));
        ...
        public DataSet GetBalanceSheetDatewise(string btype)
        {
        ...
        public void gvLiabilityBalance_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                e.Row.Cells[0].Text = "Total";
                e.Row.Cells[1].Text = creditTotal.ToString("f3");
            }
            ...
            if (GroupDs != null)
            {
                if (GroupDs.Tables[0].Rows.Count > 0)
                {
                    ...
                    foreach (DataRow groupRow in GroupDs.Tables[0].Rows)
                    {
                        ...
                        netSum = netSum + totalSum;
                        grdDt = GenerateDs2(groupID.ToString(), sGroup, totalSum.ToString("f3"));
                        if (grdDt != null)
                        {
                            for (int k = 0; k <= grdDt.Rows.Count - 1; k++)
                            {
        ...
        protected void gridPur_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            if ((strPreviousRowID1 == string.Empty) && (DataBinder.Eval(e.Row.DataItem, "Date") != null))
            {
                ...
                if (netOp1 > 0)
                {
                    cell.Text = string.Format("{0:0.000}", netOp1);
                }
                else
                {
            ...
            if (IsSubTotalRowNeedToAdd1)
            {
                ...
                {
                    cell.Text = string.Format("{0:0.000}", dblSubTotalQuantity1);
                ...
                {
                    cell.Text = string.Format("{0:0.000}", dblSubTotalUnitPrice1);
                }
                else
                {
                    cell.Text = string.Format("{0:0.000}", "");
            ...
            if (IsTotalRowNeedToAdd1)
            {
                ...
                {
                    opday = ii;
                    cell.Text = string.Format("{0:0.000}", ii);
                    i = 1;
        ...
        protected void gridPurchase_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            if ((strPreviousRowID == string.Empty) && (DataBinder.Eval(e.Row.DataItem, "Date") != null))
            {
                ...
                if (netOp > 0)
                {
                    cell.Text = string.Format("{0:0.000}", netOp);
                }
                else
                {
                    cell.Text = string.Format("{0:0.000}", "");
            ...
            if (IsSubTotalRowNeedToAdd)
            {
                ...
                {
                    cell.Text = string.Format("{0:0.000}", dblSubTotalUnitPrice);
                }
                else
                {
                    cell.Text = string.Format("{0:0.000}", "");
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        if (dr["type"].ToString() == "Sales" || dr["type"].ToString() == "Purchase")
                        {
                            ...
                            if (dr["Debit"] != "")
                            {
                                drNew["Debit"] = Convert.ToDouble(dr["Debit"]).ToString("f3");
                            }
                            else
                            {
                                drNew["Debit"] = "";
                            ...
                            if (dr["Credit"] != "")
                            {
                                drNew["Credit"] = Convert.ToDouble(dr["Credit"]).ToString("f3");
                            }
                            else
                            {
                                drNew["Credit"] = "";
