<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeDatewise.aspx.cs" Inherits="Billing.Accountsbootstrap.EmployeeDatewise" %>
...
<head id="Head1" runat="server">
    ...
    <title>Employee Wise Process Report</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Employee Wise Process Report</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                                                    ...
                                                    <div visible="false" id="Div3" runat="server">
                                                        ...
                                                        <asp:GridView ID="Gridoverall" runat="server" AllowPaging="false" CssClass="myGridStyle"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <%--<asp:BoundField DataField="OutDate" HeaderText="Dispatcher" ItemStyle-HorizontalAlign="Center" />
                                                                <asp:BoundField DataField="nam" HeaderText="Supervisor" ItemStyle-HorizontalAlign="Center" />--%>
                                                            </Columns>
                                                            <HeaderStyle BackColor="#990000" />
                                                            <PagerSettings FirstPageText="First" LastPageText="Last" Mode="NumericFirstLast"
                                                                NextPageText="Next" PreviousPageText="Previous" />
