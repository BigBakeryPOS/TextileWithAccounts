...
{
    public partial class Dillo_EmbWorks : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                DataSet dsLotNo = objbs.getlotnoforcheckbox("emb");//tblCut
                ...
                if (lot != null)
                {
                    DataSet ds = objbs.SelectEmbWork_View(lot);
                    {
                ...
                else
                {
                    ...
                    dmaxbill = objbs.getmaxbillembwork();
        ...
        protected void Add_LotProcessDetails(object sender, EventArgs e)
        {
            ...
            if (chkLotNo.SelectedIndex >= 0)
            {
                ...
                if (btnadd.Text == "Save")
                {
                    int iscuscc = objbs.insertEmbwork(txtdcno.Text, deliverydate, sendingdate, sendingdate, drpsupervisor.SelectedValue, cond, txtTotalQantity.Text, design);
                    ...
                    for (int rowIndex = 0; rowIndex < gvcustomerorder.Rows.Count; rowIndex++)
                    {
                       ...
                       (TextBox)gvcustomerorder.Rows[rowIndex].Cells[2].FindControl("txtbrandname");
                        ...
                        int itrans = objbs.inserttransEmbwork(cuttid.Text, lotno.Text, drpjobwork.SelectedValue, txtRate.Text, txtqty.Text, unitid.Text, brandid.Text, txtdesgin.Text);
                ...
                {
                 //  int isss = objbs.update_Emb_LotProcess(Convert.ToInt32(lot));
                    ...
                    int iscuscc = objbs.Update_Embwork(Convert.ToInt32(lot), txtdcno.Text, txtdcdate.Text, txtsendingdate.Text, txtsendingdate.Text, drpsupervisor.SelectedValue, cond, txtTotalQantity.Text, design);

                    objbs.Delete_transEmbProcess (Convert.ToInt32(lot));
                    for (int rowIndex = 0; rowIndex < gvcustomerorder.Rows.Count; rowIndex++)
                    {
                        TextBox cuttid =
                          (TextBox)gvcustomerorder.Rows[rowIndex].Cells[2].FindControl("txtcutid");
                       ...
                       (TextBox)gvcustomerorder.Rows[rowIndex].Cells[2].FindControl("txtbrandname");
                        ...
                        int itrans = objbs.Update_transEmbwork(cuttid.Text, lotno.Text, drpjobwork.SelectedValue, txtRate.Text, txtqty.Text, unitid.Text, brandid.Text,Convert.ToInt32(lot), txtdesgin.Text);
